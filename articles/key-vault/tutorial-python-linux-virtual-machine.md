---
title: 教程 - 将 Azure Key Vault 与通过 Python 编写的 Azure 虚拟机配合使用 | Azure Docs
...
ms.author: v-biyu
ms.custom: mvc
ms.openlocfilehash: bb928c25c464faec4099c8edb3a76ee15c8f7e35
ms.sourcegitcommit: ae1b73a4248509f7afa6ffa466f53e59449f47d5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/21/2019
ms.locfileid: "54417353"
---
...
在本教程中，请执行相关的步骤，以便让 Azure Web 应用程序使用 Azure 资源的托管标识从 Azure Key Vault 读取信息。 你将学习如何执行以下操作：
...
按[教程](https://docs.azure.cn/virtual-machines/windows/connect-logon)说明登录到虚拟机
