...
ms.date: 11/30/2017
ms.author: v-junlch
ms.openlocfilehash: 754123e9a11b2e1d24c6ad4831e5e49aca8d98c3
...
## <a name="switch-to-using-azure-resource-manager"></a>切换到使用 Azure Resource Manager
密钥保管库需要 Azure Resource Manager，因此请键入以下内容以切换到 Azure Resource Manager 模式：
...
- **名称**：在本示例中为 ContosoKeyVault。 你会在其他密钥保管库 cmdlet 中使用此名称。
