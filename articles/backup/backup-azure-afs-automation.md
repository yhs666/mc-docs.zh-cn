...
ms.openlocfilehash: 59b2e9a87ad8d6e3a7ec5aa58d1a2d5230f4e413
ms.sourcegitcommit: 1456ace86f950acc6908f4f5a9c773b93a4d6acc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/04/2019
ms.locfileid: "54029216"
---
...
2. 键入以下命令查找可用的 Azure 备份 PowerShell cmdlet：
    ...
    ![恢复服务的列表](./media/backup-azure-afs-automation/list-of-recoveryservices-ps-az.png)
...
6. 可使用以下命令验证提供程序是否已成功注册：
    ...
    ```
    在命令输出中，**RegistrationState** 应当会变为 **Registered**。 如果未按此更改，只需再次运行 **Register-AzResourceProvider** cmdlet 即可。
...
使用 **Enable-AzRecoveryServicesBackupProtection** 通过给定的策略启用项保护。 将策略与保管库关联之后，将在策略计划中定义的时间触发备份工作流。
