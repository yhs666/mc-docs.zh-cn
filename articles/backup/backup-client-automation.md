...
ms.date: 04/26/2017
ms.author: v-junlch
ms.openlocfilehash: df97964a35a50f89a1961abd4b769499f800c55a
...
这将以所有默认选项安装代理。 将在后台执行安装几分钟。 如果没有指定 /nu 选项，则安装结束时，会打开“Windows 更新”窗口，检查是否有任何更新。 安装之后，代理将显示在已安装程序列表中。
