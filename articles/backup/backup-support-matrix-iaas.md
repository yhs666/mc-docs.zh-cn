...
ms.date: 05/08/2019
ms.author: v-lingwu
ms.openlocfilehash: 927cd3aac11b24881572edd18eb9d03c63753bc3
ms.sourcegitcommit: 5191c30e72cbbfc65a27af7b6251f7e076ba9c88
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/05/2019
ms.locfileid: "67571457"
---
...
启用资源组锁定后备份托管磁盘 | 不支持。<br/><br/> Azure 备份无法删除旧的资源点；如果达到了还原点数目的上限，备份将开始失败。
...
使用区域冗余存储 (ZRS) 还原到存储帐户 | 支持（适用于 2019 年 1 月以后备份的并且可以使用[可用性区域](https://azure.microsoft.com/global-infrastructure/availability-zones/)的 VM）
