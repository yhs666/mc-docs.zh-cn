...
ms.topic: article
ms.service: backup
ms.openlocfilehash: 278708d86e8933675733b75ec6b9640399604fb6
...
1. 在左侧菜单上，选择“更多服务”，然后在服务列表中键入“恢复服务”。 键入时，系统会筛选出资源列表。 看见列表中的恢复服务保管库时，请将其选中以打开“恢复服务保管库”菜单。
...
恢复服务保管库必须与当前受保护的虚拟机处于相同位置。 如果多个区域中有虚拟机，请在每个区域中创建恢复服务保管库。 本教程在中国北部创建恢复服务保管库的原因在于，中国北部是创建“myVM”（通过快速入门创建的虚拟机）的位置。
...
5. 在“立即备份”菜单中，输入恢复点保留的最后日期，然后单击“备份”。
    ...
    部署通知会告知已触发备份作业。可以在“备份作业”页面上监视作业的进度。 创建初始备份可能需要一些时间，具体取决于虚拟机的大小。
