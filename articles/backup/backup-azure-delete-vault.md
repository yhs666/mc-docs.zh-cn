...
ms.date: 08/23/2018
ms.author: v-junlch
ms.openlocfilehash: 1f3b62b804e143f05980f0be1c7e880a90affd06
ms.sourcegitcommit: 85cdb61361dc61147bac991d4907f454f0684ea0
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/23/2018
ms.locfileid: "42709729"
---
...
1. 在“停止备份”菜单中，选择“选择选项”菜单中的“删除备份数据”，键入项名称，再单击“停止备份”。
    ...
    （可选）可以提供删除数据的原因并添加注释。 若要验证作业是否已完成，请检查 Azure 消息![删除备份数据](./media/backup-azure-delete-vault/messages.png)。 <br/>
