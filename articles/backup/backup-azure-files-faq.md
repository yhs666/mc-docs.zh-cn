...
manager: carmonm
ms.openlocfilehash: ffb89bebc1b57b62048d8858e1cbf63b58714140
...
本文回答了有关如何备份 Azure 文件的常见问题。 Azure 文件共享的备份当前为预览版。 某些答案提供内含全面信息的文章的链接。 还可以在 [论坛](https://social.msdn.microsoft.com/forums/azure/home?forum=windowsazureonlinebackup)中发布有关 Azure 备份服务的问题。
