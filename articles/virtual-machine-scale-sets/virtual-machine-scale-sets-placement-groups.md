...
ms.date: 06/20/2017
ms.author: v-dazen
ms.openlocfilehash: e908e84cf4086af3953461d832e9eb4cc9add6d5
...
>[!NOTE] 
可以将规模集从仅支持单个放置组（默认行为）更改为支持多个放置组，但不能反过来进行转换。 因此，请确保在转换之前了解大型规模集的属性。 尤其是，确保你不需要使用 Azure 负载均衡器的第 4 层负载均衡。

## <a name="additional-notes"></a>附加说明
[_2016-04-30-preview_](https://github.com/Azure/azure-rest-api-specs/blob/master/arm-compute/2016-04-30-preview/swagger/compute.json) 版 Microsoft.Compute API 中增加了对大型规模集、规模集附加数据磁盘和 Azure 托管磁盘的支持。 可以使用此版本或更高版本的 API 构建的任何 SDK 或命令行工具。