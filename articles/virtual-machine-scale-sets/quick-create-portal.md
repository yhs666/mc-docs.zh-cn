...
ms.date: 03/27/2019
ms.author: v-junlch
ms.openlocfilehash: 17bce9c7b833aee9e18810b4dd6b3f13791a82b9
ms.sourcegitcommit: b8fb6890caed87831b28c82738d6cecfe50674fd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/29/2019
ms.locfileid: "58627253"
---
...
5. 输入所需资源组名称（如 myResourceGroup）和位置（如“中国北部”）。
6. 输入所需的用户名，并选择首选的身份验证类型。
   ...
   - 如果选择 Linux OS 磁盘映像，可选择 SSH 公钥。 仅提供公钥，如 *~/.ssh/id_rsa.pub*。 
     ...
     ![在 Azure 门户中创建虚拟机规模集所需的基本详细信息](./media/virtual-machine-scale-sets-create-portal/create-scale-set.png)
7. 在“选择负载均衡选项”下选择一个负载均衡选项，例如“负载均衡器”。 输入负载均衡选项的其余详细信息。 例如，对于“负载均衡器”，需输入**公共 IP 地址名称**和**域名标签**。
8. 在“配置虚拟网络”下输入虚拟网络详细信息。 例如，可以创建新的虚拟网络 *myVirtualNetwork* 和新的子网 *default*。
9. 若要确认规模集选项，请选择“创建”。
