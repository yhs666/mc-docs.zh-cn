...
description: "了解如何使用 Azure 资源管理器模板在虚拟机规模集上部署简单的自动缩放应用程序。"
...
ms.date: 12/06/2017
ms.author: v-junlch
ms.openlocfilehash: 07eb6e927b6b538e0639dc3678f2d2587cb2885a
...
[Azure 资源管理器模板](/azure-resource-manager/resource-group-overview#template-deployment)是部署成组的相关资源的好办法。 本教程基于[部署简单规模集](virtual-machine-scale-sets-mvss-start.md)，介绍如何使用 Azure 资源管理器模板在规模集上部署简单的自动缩放应用程序。  还可以使用 PowerShell、CLI 或门户设置自动缩放。 有关详细信息，请参阅[自动缩放概述](virtual-machine-scale-sets-autoscale-overview.md)。
...
除规模集资源外，azuredeploy.json 示例模板还声明虚拟网络、公共 IP 地址、负载均衡器和自动缩放设置资源。  
...
除规模集资源外，azuredeploy.json 示例模板还声明虚拟网络、公共 IP 地址、负载均衡器和自动缩放设置资源。 此外，该模板还演示了应用程序升级。
