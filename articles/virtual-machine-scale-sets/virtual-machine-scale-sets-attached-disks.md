...
ms.date: 07/31/2017
ms.author: v-dazen
ms.openlocfilehash: acd2fa20eb48f766f8fbe6ec7f22c1d916276425
...
也可通过以下方式添加磁盘：先向规模集定义的 storageProfile 中的 dataDisks 属性添加新条目，然后应用所做的更改。 选择“编辑”  并将新磁盘添加到数据磁盘列表。 例如 使用以上示例：
```json
"dataDisks": [
    {
    "lun": 1,
