...
ms.date: 06/20/2017
ms.author: v-dazen
ms.openlocfilehash: 35a8718fc8479be9b485627035ada30c53bbc1d3
...
---
# Azure VM 规模集及附加数据磁盘
<a id="azure-vm-scale-sets-and-attached-data-disks" class="xliff"></a>
...
## 创建具有附加数据磁盘的规模集
<a id="create-a-scale-set-with-attached-data-disks" class="xliff"></a>
...
## 将数据磁盘添加到现有规模集
<a id="adding-a-data-disk-to-an-existing-scale-set" class="xliff"></a>
> [!NOTE]
...
## 从规模集中删除数据磁盘
<a id="removing-a-data-disk-from-a-scale-set" class="xliff"></a>
