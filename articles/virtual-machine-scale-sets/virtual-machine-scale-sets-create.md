...
有关如何使用 Azure CLI 2.0 或 PowerShell 安装、设置和登录到 Azure 的详细信息，请参阅 [Azure CLI 2.0 入门](https://docs.microsoft.com/cli/azure/get-started-with-azure-cli.md)或 [Azure PowerShell cmdlet 入门](https://docs.microsoft.com/powershell/resourcemanager/)。
