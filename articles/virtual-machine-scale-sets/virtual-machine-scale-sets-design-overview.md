...
ms.date: 07/24/2017
ms.author: v-dazen
ms.openlocfilehash: 98a29cefa444cac1b183c61f153dde31f28b5580
...
---
# 设计规模化的 VM 规模集
<a id="designing-vm-scale-sets-for-scale" class="xliff"></a>
...
### 使用 Azure 托管磁盘创建规模集
<a id="scale-sets-with-azure-managed-disks" class="xliff"></a>
...
### 用户管理的存储
<a id="user-managed-storage" class="xliff"></a>
...
## 预配过度
<a id="overprovisioning" class="xliff"></a>
