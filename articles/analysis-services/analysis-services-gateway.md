...
ms.date: 08/07/2017
ms.author: v-yeche
ms.openlocfilehash: e9a6b7637f8ed56895d338f31a847eb239f622d2
...
建议在防火墙中针对数据区域列出 IP 地址允许列表。 可以下载 [Azure 数据中心 IP 列表](https://www.microsoft.com/download/details.aspx?id=41653)。 该列表每周都会进行更新。
...
如果在安装和配置网关时遇到问题，请参阅 [Power BI 网关故障排除](https://powerbi.microsoft.com/documentation/powerbi-gateway-onprem-tshoot/)。 如果认为防火墙有问题，请参阅“防火墙或代理”部分。
