...
2. 在 **odc:ConnectionString** 中，更改下列属性：
    ...
    *   在 **Data Source=asazure://*region*.asazure.chinacloudapi.cn/*servername* 中，将 *region* 更改为 Analysis Services 服务器的区域，并将 *servername* 更改为服务器的名称。

    *   在 **Initial Catalog=*database* 中，将 *database* 更改为数据库的名称。

3. 在 **&lt;odc:CommandText>*Model*&lt;/odc:CommandText> 中，将 *Model* 更改为模型或透视的名称。 
