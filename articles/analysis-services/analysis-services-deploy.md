...
ms.date: 08/07/2017
ms.author: v-yeche
ms.openlocfilehash: 85f942f3db637f91eeb694215294c6b63f4eef8c
...
* SSDT 中的**表格模型项目**或兼容级别为 1200 或更高的现有表格模型。 从未创建过？ 请尝试 [Adventure Works 教程](https://msdn.microsoft.com/library/hh231691.aspx)。
