...
ms.author: v-yiso
ms.date: 03/19/2018
ms.openlocfilehash: d4301af15795cc51e35d51d16c5990361d0491c3
...
2. 在 Azure 部署存储帐户以后，请获取存储帐户的访问密钥：
   ...
   也可使用 [Azure PowerShell](https://docs.microsoft.com/powershell/module/azurerm.storage/get-azurermstorageaccountkey) 或 [Azure CLI](/cli/azure/storage/account/keys?view=azure-cli-latest.md#az_storage_account_keys_list)。 
...
3. 为电子邮件附件创建存储容器。
   ...
   也可使用 [Azure PowerShell](https://docs.microsoft.com/powershell/module/azure.storage/new-azurestoragecontainer) 或 [Azure CLI](/cli/azure/storage/container?view=azure-cli-latest#az_storage_container_create)。 
...
1. 请先使用以下设置[创建函数应用](../azure-functions/functions-create-function-app-portal.md)，然后即可创建函数：
   ...
   如果函数应用没有在部署后自动打开，请在 <a href="https://portal.azure.cn" target="_blank">Azure 门户</a>中找到该应用。 在 Azure 主菜单中选择“应用服务”，然后选择函数应用。
