...
ms.author: v-yiso
ms.date: 08/26/2019
ms.openlocfilehash: e7eff8671b1d51981ee9f953aa260f27bbc386c7
ms.sourcegitcommit: d624f006b024131ced8569c62a94494931d66af7
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/16/2019
ms.locfileid: "69539194"
---
...
5. 提供“获取路线”操作的详细信息，如以下示例所示： 
   ...
   | **距离单位** | <*your-preference*> | 路线的距离单位。 本文使用的单位为“Mile”  | 
