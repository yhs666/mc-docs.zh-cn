...
ms.author: v-yiso
ms.date: 04/23/2018
ms.openlocfilehash: 0464ceb04a85ce50e9550d6a86d6227b38aaf40f
ms.sourcegitcommit: 6e80951b96588cab32eaff723fe9f240ba25206e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/16/2018
ms.locfileid: "31325321"
---
...
| 元素名称 | 必须 | 类型 | 说明 | 
| ------------ | -------- | ---- | ----------- | 
| frequency | 是 | String | 触发器执行频率的时间单位。 只使用以下值之一：“second”、“minute”、“hour”、“day”、“week”或“month” | 
...
启用基本功能时，此触发器运行起来与 HTTP 触发器类似。 但是，用于标识操作的参数有所不同。 以下是示例：   
...
| 默认值 | 否 | 对象 | 当没有 case 与结果匹配时运行的内部操作 | 
||||| 
