...
ms.date: 12/10/2018
ms.openlocfilehash: 2baa57b51a26e6ea7959f4d04826c03a74844458
ms.sourcegitcommit: 59db70ef3ed61538666fd1071dcf8d03864f10a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52675103"
---
...
有关详细信息，请参阅[逻辑应用定价](https://www.azure.cn/pricing/details/logic-apps)。

<a name="fixed-pricing"></a>

## <a name="fixed-pricing-model"></a>固定定价模型

对于在集成服务环境 (ISE) 中运行的新逻辑应用，需要为内置操作和标记为标准 ISE 的连接器支付固定月费。 ISE 提供了一种方法，用于创建和运行可访问 Azure 虚拟网络中资源的独立逻辑应用。  
