...
ms.date: 02/25/2019
ms.author: v-jay
ms.openlocfilehash: 28ed21c0db27297f541e00e67415c1cf61b5f524
ms.sourcegitcommit: dd6cee8483c02c18fd46417d5d3bcc2cfdaf7db4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/22/2019
ms.locfileid: "56666694"
---
# <a name="what-is-azure-data-box-heavy-preview"></a>什么是 Azure Data Box Heavy？ （预览版）

使用 Azure Data Box 混合解决方案可以通过快速、经济、可靠的方式将数百 TB 的数据发送到 Azure。 通过向你运送专有的存储设备（存储容量为 1 PB）来加速安全数据传输。 该设备具有坚固的外壳，可在运输过程中保护数据。
...
> [!IMPORTANT]
> - Data Box Heavy 以预览版提供。 
> - 若要请求设备，请在[预览门户](https://portal.azure.cn)中注册。
...
* **本地 Web 用户界面** - 基于 Web 的UI，用于配置设备，以便它可以连接到本地网络，并向 Data Box 服务注册该设备。 此外还可以使用本地 Web UI 关闭和重启该设备、查看副本日志，并联系 Azure 支持部门以提交服务请求。
