...
ms.date: 07/03/2017
ms.author: v-yeche
ms.openlocfilehash: df86294a6908f59f3f15b531cd56c9907039595e
...
<a id="azure-resource-manager-vs-classic-deployment-understand-deployment-models-and-the-state-of-your-resources" class="xliff"></a>
...
## 部署模型的历史
<a id="history-of-the-deployment-models" class="xliff"></a>
...
## 了解对模型的支持
<a id="understand-support-for-the-models" class="xliff"></a>
...
## Resource Manager 的特征
<a id="resource-manager-characteristics" class="xliff"></a>
...
* 通过 [经典管理门户](https://manage.windowsazure.cn)
...
## 对计算、网络和存储的更改
<a id="changes-for-compute-network-and-storage" class="xliff"></a>
...
<a id="migrate-from-classic-to-resource-manager" class="xliff"></a>
...
通过 Azure Resource Manager 创建的虚拟机、虚拟网络和存储帐户的配额与其他配额是分开的。 每个订阅将获取配额以使用新的 API 创建资源。 可以在[此处](../azure-subscription-service-limits.md)了解有关额外配额的详细信息。
