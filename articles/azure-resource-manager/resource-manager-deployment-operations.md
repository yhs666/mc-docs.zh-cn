...
ms.date: 11/25/2019
ms.openlocfilehash: 1e7aa3b0f92860f9486bf83662c0c4f5187fb542
ms.sourcegitcommit: 9e92bcf6aa02fc9e7b3a29abadf6b6d1a8ece8c4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/22/2019
ms.locfileid: "74389482"
---
...
相关 ID 可用于跟踪相关事件，在与技术支持人员合作排查部署问题时非常有用。 若要获取相关 ID，请使用：
...
注意操作的 serviceRequestId 和 trackingId。 与技术支持人员合作排查部署问题时，serviceRequestId 非常有用。 我们会在下一步使用 trackingId 重点关注特定操作。
...
Azure 中的每个部署操作均包括请求和响应内容。 在部署期间，可以使用 **DeploymentDebugLogLevel** 参数指定记录请求和/或响应。
...
使用 **azure group deployment show** 命令可获取部署的总体状态。

```azurecli
az group deployment show -g ExampleGroup -n ExampleDeployment
```

相关 ID 可用于跟踪相关事件，在与技术支持人员合作排查部署问题时非常有用。
...
使用[获取有关模板部署的信息](https://docs.microsoft.com/rest/api/resources/deployments)操作可获取有关部署的信息。
...
使用[列出所有模板部署操作](https://docs.microsoft.com/rest/api/resources/deployments)可获取有关部署的信息。 
