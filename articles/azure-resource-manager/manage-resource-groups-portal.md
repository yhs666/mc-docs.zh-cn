...
了解如何将 [Azure 门户](https://portal.azure.cn)与 [Azure 资源管理器](resource-group-overview.md)配合使用来管理 Azure 资源组。 若要管理 Azure 资源，请参阅[使用 Azure 门户管理 Azure 资源](./manage-resources-portal.md)。
...
有关导出模板的信息，请参阅[将单资源和多资源导出到模板 - 门户](export-template-portal.md)。
