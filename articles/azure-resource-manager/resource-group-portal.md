...
本主题演示如何使用 [Azure 门户](https://portal.azure.cn)和 [Azure Resource Manager](./resource-group-overview.md) 管理 Azure 资源。若要了解如何通过门户部署资源，请参阅[使用 Resource Manager 模板和 Azure 门户部署资源](./resource-group-template-deploy-portal.md)。
...
7. 若要了解有关将资源部署到新资源组的信息，请参阅[使用 Resource Manager 模板和 Azure 门户部署资源](./resource-group-template-deploy-portal.md)。
