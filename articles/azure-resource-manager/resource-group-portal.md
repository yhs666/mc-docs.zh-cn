...
ms.date: 09/04/2017
ms.author: v-yeche
ms.openlocfilehash: 7840e68204dc10da1f76499c37aad3d00bd870fd
...
本主题说明如何将 [Azure 门户](https://portal.azure.cn)与 [Azure 资源管理器](resource-group-overview.md)配合使用来管理 Azure 资源。 若要了解如何通过门户部署资源，请参阅[使用资源管理器模板和 Azure 门户部署资源](resource-group-template-deploy-portal.md)。
...
选择一个资源时，资源边栏选项卡会显示用于监视该资源类型的默认图形和表。
...
删除资源组会删除其包含的所有资源。 也可以删除资源组中的单个资源。 删除资源组时请多加小心，因为其中可能包含与其链接的其他资源组中的资源。 Resource Manager 不会删除链接资源，但如果没有所需资源，链接资源可能无法正常运行。
