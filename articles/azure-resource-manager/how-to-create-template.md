...
ms.date: 07/22/2019
ms.author: v-yeche
ms.openlocfilehash: cf92943531a7eee62eadbe5ff8c0665816ce2ad9
ms.sourcegitcommit: 5fea6210f7456215f75a9b093393390d47c3c78d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/19/2019
ms.locfileid: "68337504"
---
...
你可能想要自定义模板，以确保它完全符合需要。 首先，请查看已部署的资源。 可能需要在模板中添加、删除或更改资源。 有关资源的说明和语法，请参阅 [Azure 资源管理器模板参考](https://docs.microsoft.com/zh-cn/azure/templates/)。
...
![Web 应用依赖关系](./media/how-to-create-template/web-dependencies.png)
