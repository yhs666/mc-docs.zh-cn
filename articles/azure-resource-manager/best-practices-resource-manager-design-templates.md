...
ms.date: 07/03/2017
ms.author: v-yeche
ms.openlocfilehash: 27b5dd86448d2cb679625f9c3ef8c5d1aa95d7a2
...
<a id="design-patterns-for-azure-resource-manager-templates-when-deploying-complex-solutions" class="xliff"></a>
...
## 企业和系统集成商
<a id="enterprises-and-system-integrators" class="xliff"></a>
在大型组织中，我们常看到 Resource Manager 模板的两类使用者：内部软件开发团队和企业 IT 部门。 我们发现 SI 方案可对应到企业方案，因此相同的考虑因素同样适用。

### 内部软件开发团队
<a id="internal-software-development-teams" class="xliff"></a>
...
### 企业 IT
<a id="corporate-it" class="xliff"></a>
企业 IT 组织通常使用模板来传送云容量和云托管功能。

#### 云容量
<a id="cloud-capacity" class="xliff"></a>
...
#### 云托管功能
<a id="cloud-hosted-capabilities" class="xliff"></a>
...
## 云服务供应商
<a id="cloud-service-vendors" class="xliff"></a>
在与许多 CSV 沟通之后，我们找到了了许多方案让你为客户和针对相关要求部署服务。

### CSV 托管产品
<a id="csv-hosted-offering" class="xliff"></a>
...
### 将 CSV 产品注入客户订阅
<a id="csv-offering-injected-into-customer-subscription" class="xliff"></a>
可能想要将软件部署到客户拥有的订阅。 可以使用模板将不同的部署产品部署到客户的 Azure 帐户中。

这些部署使用 RBAC，因此，你可以在客户的帐户中更新和管理部署。

### Azure 应用商店
<a id="azure-marketplace" class="xliff"></a>
...
## OSS 项目
<a id="oss-projects" class="xliff"></a>
...
## 识别 VM 内部和外部的项
<a id="identifying-what-is-outside-and-inside-a-vm" class="xliff"></a>
...
### 所需状态配置 (DSC)
<a id="desired-state-configuration-dsc" class="xliff"></a>
...
## 选择自由格式配置与已知配置
<a id="choosing-free-form-vs-known-configurations" class="xliff"></a>
最初你可能认为模板应该为使用者提供最大的弹性，但有许多考虑因素影响到自由格式配置与已知配置的选择。 本部分将列出重要的客户要求，以及构成本文档所分享方案的技术考虑因素。

### 自由格式配置
<a id="free-form-configurations" class="xliff"></a>
...
### 已知配置 - T 恤尺寸法
<a id="known-configurations--the-t-shirt-sizing-approach" class="xliff"></a>
...
## 划归容量和功能的解决方案模板
<a id="capacity-and-capability-scoped-solution-templates" class="xliff"></a>
...
### 模板元数据
<a id="template-metadata" class="xliff"></a>
...
### 主模板
<a id="main-template" class="xliff"></a>
...
### 共享的资源模板
<a id="shared-resources-template" class="xliff"></a>
...
### 可选资源模板
<a id="optional-resources-template" class="xliff"></a>
...
### 已知配置资源模板
<a id="known-configuration-resources-template" class="xliff"></a>
...
### 成员资源模板
<a id="member-resources-template" class="xliff"></a>
...
### 广泛可重复使用的脚本
<a id="widely-reusable-scripts" class="xliff"></a>
...
### 自定义脚本
<a id="custom-scripts" class="xliff"></a>
...
## 划归功能的解决方案模板示例 - Redis
<a id="capability-scoped-solution-template-example---redis" class="xliff"></a>
...
### 创建模板文件
<a id="creating-the-template-files" class="xliff"></a>
...
### 链接模板
<a id="linking-the-templates" class="xliff"></a>
...
## 分解和划归到端到端解决方案的模板
<a id="decomposition-and-end-to-end-solution-scoped-templates" class="xliff"></a>
...
## 准备应用商店的模板
<a id="preparing-templates-for-the-marketplace" class="xliff"></a>
