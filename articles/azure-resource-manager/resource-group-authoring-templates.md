...
ms.date: 02/18/2019
ms.author: v-yeche
ms.openlocfilehash: f1ca1c831098b8c7c67c8db65d1968a936a9dc77
ms.sourcegitcommit: cdcb4c34aaae9b9d981dec534007121b860f0774
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/15/2019
ms.locfileid: "56306137"
---
...
有关定义参数的信息，请参阅 [Azure 资源管理器模板的 Parameters 节](resource-manager-templates-parameters.md)。
...
有关定义变量的信息，请参阅 [Azure 资源管理器模板的 Variables 节](resource-manager-templates-variables.md)。
...
有关详细信息，请参阅 [Azure 资源管理器模板的 Outputs 节](resource-manager-templates-outputs.md)。
