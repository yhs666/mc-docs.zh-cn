...
<!-- Not Available on [What is managed identities for Azure resources?](../active-directory/managed-identities-azure-resources/overview.md)-->
...
1. 选择要将应用程序分配到的特定订阅。
   ...
   ![选择要分配的订阅](./media/resource-group-create-service-principal-portal/select-one-subscription.png)
...
1. 选择“+ 添加”。
   ...
   ![选择“添加”](./media/resource-group-create-service-principal-portal/select-add.png)

1. 选择要分配到应用程序的角色。 若要允许应用程序执行诸如“重启”、“启动”和“停止”实例之类的操作，请选择“参与者”角色。 默认情况下，可用选项中不显示 Azure Active Directory 应用程序。 若要查找应用程序，请搜索其名称并选中它。
...
1. Select <bpt id="p1">**</bpt>Settings<ept id="p1">**</ept>.
   ...
   ![选择设置](./media/resource-group-create-service-principal-portal/select-settings.png)
...
1. 请注意你的角色。 如果角色为“用户”，则必须确保非管理员可以注册应用程序。
...
如果应用注册设置已设置为“否”，则只有[全局管理员](../active-directory/users-groups-roles/directory-assign-admin-roles.md)可以注册应用。 如果将帐户分配到“用户”角色，但应用注册设置仅限于管理员用户，请要求管理员为你分配“多区域管理员”角色或允许用户注册应用。
