...
<!--Not Available on 1. Open the [Cloud shell](https://shell.azure.com)-->
<!--Not Available on 1. Select **Upload/Download files**, and then select **Upload**.-->
<!--Not Available on 1. Specify the following URL and then select **Open**.-->

1. 在 [GitHub](https://github.com/Azure/azure-docs-json-samples/raw/master/tutorial-sql-extension/SQLDatabaseExtension.bacpac) 上下载示例 BACPAC 文件，并将其保存在本地电脑上。
...
1. 将以下 PowerShell 脚本复制并粘贴到 Shell 窗口中。
    ...
    $bacpacFile = "{path-of-your-bacpac-file}/SQLDatabaseExtension.bacpac"
    ...
    Write-Host "The BACPAC file URL is https://$storageAccountName.blob.core.chinacloudapi.cn/$containerName/$blobName"
...
3. 选择“打开”以打开该文件。 
    ...
    * `Microsoft.SQL.servers/databases`。
    ...
    <!--Not Available on [template reference](https://docs.microsoft.com/azure/templates/microsoft.sql/servers/securityalertpolicies)-->
...
New-AzResourceGroupDeployment `
    ...
    -TemplateFile "{path-of-your-bacpac-file}/azuredeploy.json" `
