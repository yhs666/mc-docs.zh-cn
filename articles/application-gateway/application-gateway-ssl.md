---
title: "配置 SSL 卸载 - Azure 应用程序网关 - PowerShell 经典 | Azure"
...
对于 SSL 证书配置，HttpListener 中的协议应更改为 Https（区分大小写）。 需要将 SslCert 元素添加到 HttpListener，其值设置为之前上传 SSL 证书部分中使用的相同名称。 前端端口应更新为 443。
