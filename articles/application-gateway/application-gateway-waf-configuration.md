...
ms.date: 10/17/2018
ms.author: v-junlch
ms.openlocfilehash: b8158e671c34858c3e8df0efa6fc73ed8e98992f
ms.sourcegitcommit: 4ead6b1d3527373b63c90680b6400a2e95b4064e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/17/2018
ms.locfileid: "49374994"
---
...
可以将请求标头、请求正文、请求 cookie 或请求查询字符串参数添加到 WAF 排除列表。 如果正文具有表单数据或 XML/JSON（键值对），则可以使用请求属性排除类型。
