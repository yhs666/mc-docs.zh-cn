...
> [!NOTE]
> 若需为应用程序网关配置自定义探测，请访问：[使用 PowerShell 创建带自定义探测的应用程序网关](application-gateway-create-probe-ps.md)。 有关详细信息，请查看[自定义探测和运行状况监视](application-gateway-probe-overview.md)。
