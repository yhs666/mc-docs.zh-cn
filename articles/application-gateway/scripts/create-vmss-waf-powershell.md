...
ms.author: v-junlch
ms.custom: mvc
ms.openlocfilehash: 409502916e391a4069dbf978a90933f8df1748a6
ms.sourcegitcommit: f0bfa3f8dca94099a2181492952e6a575fbdbcc8
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/02/2018
ms.locfileid: "37142669"
---
...
| [New-AzureRmApplicationGatewayWebApplicationFirewallConfiguration](https://docs.microsoft.com/powershell/module/azurerm.network/new-azurermapplicationgatewaywebapplicationfirewallconfiguration) | 创建 Web 应用程序防火墙配置。 |
...
| [Set-AzureRmDiagnosticSetting](https://docs.microsoft.com/powershell/module/azurerm.insights/set-azurermdiagnosticsetting) | 配置诊断以记录数据。 |
