...
ms.date: 10/23/2019
ms.author: v-junlch
ms.openlocfilehash: f683ba691712de1a2abeddfb0ce1b3bea6bdfe9f
ms.sourcegitcommit: 24b69c0a22092c64c6c3db183bb0655a23340420
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/23/2019
ms.locfileid: "72798491"
---
...
内部应用程序网关仅使用专用 IP 地址。 如果使用的是自定义，则域名应在内部可解析为应用程序网关的专用 IP 地址。 因此，内部负载均衡器只能路由有权访问应用程序网关虚拟网络的客户端发出的请求。
