...
* [Azure CLI 1.0](./application-gateway-create-gateway-cli-nodejs.md) - 用于经典部署模型和资源管理部署模型的 CLI。
* [Azure CLI 2.0](./application-gateway-create-gateway-cli.md) - 用于资源管理部署模型的下一代 CLI
