...
ms.date: 08/06/2019
ms.author: v-junlch
ms.openlocfilehash: 82cb59cd1705d3794d906b26c2362f6af8ea79cd
ms.sourcegitcommit: 17cd5461e7d99f40b9b1fc5f1d579f82b2e27be9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/06/2019
ms.locfileid: "68818833"
---
# <a name="create-an-application-gateway-using-the-azure-resource-manager-template"></a>使用 Azure Resource Manager 模板创建应用程序网关
...
本文介绍如何从 GitHub 下载并修改现有 [Azure 资源管理器模板](../azure-resource-manager/resource-group-authoring-templates.md)，以及如何通过 GitHub、Azure PowerShell 和 Azure CLI 部署该模板。
...
## <a name="deploy-the-azure-resource-manager-template-using-azure-powershell"></a>使用 Azure PowerShell 部署 Azure 资源管理器模板
...
## <a name="deploy-the-azure-resource-manager-template-using-the-azure-cli"></a>使用 Azure CLI 部署 Azure Resource Manager 模板
...
如果想要配置 SSL 卸载，请参阅：[配置应用程序网关以进行 SSL 卸载](application-gateway-ssl.md)。
