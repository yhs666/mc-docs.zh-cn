...
ms.author: v-junlch
ms.custom: mvc
ms.openlocfilehash: 9abce0d2505140a0df379d9ce29b5a2d1b775eb4
ms.sourcegitcommit: 756a4da01f0af2b26beb17fa398f42cbe7eaf893
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/12/2019
ms.locfileid: "67027440"
---
...
4. 选择“前端 IP 配置”。  在“前端 IP 配置”  下，验证“IP 地址类型”  是否设置为“公共”  。 在“公共 IP 地址”下，  验证是否已选择“新建”  。 <br>可根据用例将前端 IP 配置为公共或专用 IP。 本示例将选择公共前端 IP。
