...
ms.author: v-junlch
ms.custom: mvc
ms.openlocfilehash: db148d60c7dfade015f79e085441bfa293101950
ms.sourcegitcommit: 4fe9905d17a8df9f2270543a5a0ce1762a5830c9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/08/2018
ms.locfileid: "34855799"
---
...
6. 单击“确定”创建虚拟网络和子网。
6. 单击“选择公用 IP 地址” > “新建”，然后输入公用 IP 地址的名称。 在本示例中，公共 IP 地址名为 *myAGPublicIPAddress*。 接受其他设置的默认值，然后单击“确定”。
8. 接受侦听器配置的默认值，让 Web 应用程序防火墙保留禁用状态，然后单击“确定”。
9. 复查摘要页上的设置，然后单击“确定”以创建虚拟网络、公共 IP 地址和应用程序网关。 创建应用程序网关可能需要最多 30 分钟，请等到部署成功完成，然后转到下一部分。
...
1. 在“概述”屏幕上找到应用程序网关的公共 IP 地址。 单击“所有资源” > “myAGPublicIPAddress”。

    ![记下应用程序网关的公共 IP 地址](./media/quick-create-portal/application-gateway-record-ag-address.png)
