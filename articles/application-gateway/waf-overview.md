...
ms.date: 06/04/2018
ms.author: v-junlch
ms.openlocfilehash: 0dcb04dd165a6fe442678021e8358a0b4394a16d
ms.sourcegitcommit: 4fe9905d17a8df9f2270543a5a0ce1762a5830c9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/08/2018
ms.locfileid: "34855788"
---
...
每个应用程序网关日志与 [Azure Monitor](../monitoring-and-diagnostics/monitoring-overview.md) 集成。  这样，你便可以跟踪包括 WAF 警报和日志在内的诊断信息。 若要详细了解如何为应用程序网关启用诊断日志，请访问[应用程序网关诊断](application-gateway-diagnostics.md)
...
深入了解 WAF 的功能后，请参阅[如何在应用程序网关上配置 Web 应用程序防火墙](tutorial-restrict-web-traffic-powershell.md)。
