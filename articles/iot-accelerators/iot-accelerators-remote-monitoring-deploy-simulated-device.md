...
ms.date: 11/26/2018
ms.topic: conceptual
ms.openlocfilehash: 476e2d70a2b12f664b074c0224dd2588df1e25b1
...
- [远程监视解决方案加速器](https://www.azureiotsuite.cn)的一个部署实例。
...
1. 从 [Microsoft Azure IoT 解决方案加速器](https://www.azureiotsuite.cn)启动远程监视仪表板。
...
如果不再需要该解决方案加速器，请在[预配的解决方案](https://www.azureiotsuite.cn)页中选择它，然后单击“删除解决方案”将其删除。

## <a name="next-steps"></a>后续步骤

本指南介绍如何将自定义设备模型部署到远程监视解决方案加速器。 我们建议接下来了解如何[将物理设备连接到远程监视解决方案](iot-accelerators-connecting-devices-node.md)。
