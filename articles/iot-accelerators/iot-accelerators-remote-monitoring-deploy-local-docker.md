...
ms.date: 12/17/2018
ms.topic: conceptual
ms.openlocfilehash: 3ae7a4f42612bc48edd899954624b492b1078914
ms.sourcegitcommit: b64a6decfbb33d82a8d7ff9525726c90f3540d4e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/18/2018
ms.locfileid: "53569402"
---
# <a name="deploy-the-remote-monitoring-solution-accelerator-locally---docker"></a>在本地部署远程监视解决方案加速器 - Docker

[!INCLUDE [iot-accelerators-selector-local](../../includes/iot-accelerators-selector-local.md)]

本文展示了如何将远程监视解决方案加速器部署到本地计算机，用于测试和开发。 了解如何将微服务部署到本地 Docker 容器。 本地微服务部署使用以下云服务：云中的 IoT 中心、Cosmos DB、Azure 流分析和 Azure 时序见解服务。
...
为避免产生不必要的费用，在完成测试后，请从 Azure 订阅中删除云服务。 若要删除这些服务，请导航到 [Azure 门户](https://ms.portal.azure.cn)，并删除 **start.cmd** 脚本创建的资源组。
