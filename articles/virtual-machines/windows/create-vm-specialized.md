...
ms.date: 09/24/2018
ms.author: v-yeche
ms.openlocfilehash: 7232536e098a78ae3cde1a52c21910121a0dea1b
...
可拍摄整个 VM（包括所有磁盘）快照或仅拍摄单个磁盘快照。 以下步骤展示了如何使用 [New-AzureRmSnapshot](https://docs.microsoft.com/powershell/module/azurerm.compute/new-azurermsnapshot) cmdlet 拍摄仅 VM 的 OS 磁盘的快照。 
