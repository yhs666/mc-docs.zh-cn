...
ms.date: 07/03/2017
ms.author: v-dazen
ms.openlocfilehash: c15877c998830a40b7b71484be8ecec96e3f9a98
ms.sourcegitcommit: b1d2bd71aaff7020dfb3f7874799e03df3657cd4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/23/2017
---
# 通过使用 Azure 门户将 OS 磁盘附加到恢复 VM，对 Windows VM 进行故障排除
<a id="troubleshoot-a-windows-vm-by-attaching-the-os-disk-to-a-recovery-vm-using-the-azure-portal" class="xliff"></a>
...
模板已加载到 Azure 门户中进行部署。 请输入新 VM 和现有 Azure 资源的名称，然后粘贴现有虚拟硬盘的 URL。 若要开始部署，请在查看“法律条款”后单击“创建”，然后单击其中的“创建”按钮。
