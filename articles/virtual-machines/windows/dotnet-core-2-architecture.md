---
title: "使用 Azure Resource Manager 模板部署 Windows 计算资源 | Azure"
...
ms.openlocfilehash: d5c60052c29f69cbabfe5720414cda9969fa7682
ms.sourcegitcommit: b1d2bd71aaff7020dfb3f7874799e03df3657cd4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/23/2017
---
# <a name="application-architecture-with-azure-resource-manager-templates-for-windows-vms"></a>使用适用于 Windows VM 的 Azure Resource Manager 模板的应用程序体系结构
...
![虚拟机](./media/dotnet-core-2-architecture/vm-win.png)
...
部署后，可以在 Azure 门户中查看存储帐户。

![存储帐户](./media/dotnet-core-2-architecture/storacct-win.png)

单击进入存储帐户 Blob 容器，即可查看使用模板部署的每个虚拟机的虚拟硬盘文件。

![虚拟硬盘](./media/dotnet-core-2-architecture/vhd-win.png)

有关 Azure 存储的详细信息，请参阅 [Azure 存储文档](/storage/)。
...
![虚拟网络](./media/dotnet-core-2-architecture/vnet-win.png)
...
![网络接口](./media/dotnet-core-2-architecture/nic-win.png)

有关 Azure 虚拟网络的详细信息，请参阅 [Azure 虚拟网络文档](/virtual-network/)。
