...
ms.date: 01/22/2018
ms.author: v-yeche
ms.openlocfilehash: e92fbdd266c26a3a496c8a8adcb0101aa408c520
...
1. 可以从其中一个提供的 [Azure Marketplace 上的 Windows Server 映像](https://market.azure.cn/zh-cn/marketplace/apps/Microsoft.WindowsServer?tab=Overview)部署 VM
...
详细了解[如何使用多租户托管权限在 Azure 上部署 Windows 10](/virtual-machines/windows/windows-desktop-multitenant-hosting-deployment)
