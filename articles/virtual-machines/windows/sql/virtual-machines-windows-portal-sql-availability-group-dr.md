...
1. [向新 SQL Server 添加故障转移群集功能](../../windows/sql/virtual-machines-windows-portal-sql-availability-group-prereq.md#add-failover-cluster-features-to-both-sql-servers)

1. [将新 SQL Server 加入域](../../windows/sql/virtual-machines-windows-portal-sql-availability-group-prereq.md#joinDomain)。
...
1. [在新 SQL Server 上打开防火墙端口](../../windows/sql/virtual-machines-windows-portal-sql-availability-group-prereq.md#a-nameendpoint-firewall-configure-the-firewall-on-each-sql-server)。
