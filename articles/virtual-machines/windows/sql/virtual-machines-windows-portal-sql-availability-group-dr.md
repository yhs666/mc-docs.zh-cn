...
ms.date: 09/04/2017
ms.author: v-haiqya
ms.openlocfilehash: 34c1d20cb8c540448d582616fd95f1bab5833db0
...
最好是将客户端连接字符串更新为设置 `MultiSubnetFailover=Yes`。 请参阅[使用 MultiSubnetFailover 进行连接](http://msdn.microsoft.com/library/gg471494#Anchor_0)。
