...
ms.openlocfilehash: de40001958d09ced52120acfa57a5a349af5335b
...
> [!NOTE]
> 如果你已经熟悉 SQL Server，并且只是想了解如何部署 SQL Server VM，请参阅[在 Azure 门户中预配 SQL Server 虚拟机](virtual-machines-windows-portal-sql-server-provision.md)。
> 
> 
