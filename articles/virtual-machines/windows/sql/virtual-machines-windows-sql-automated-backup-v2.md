...
ms.date: 03/19/2018
ms.author: v-yeche
ms.openlocfilehash: e583dd543457e61eeb8464d8c68d489134670796
...
| **加密** |启用/禁用（已禁用） | 启用或禁用加密。 启用加密时，用于还原备份的证书位于指定的存储帐户中。 该证书与命令约定使用同一个“自动备份”容器。 如果密码发生更改，则使用该密码生成新证书，但旧证书在备份之前仍会还原。 |
