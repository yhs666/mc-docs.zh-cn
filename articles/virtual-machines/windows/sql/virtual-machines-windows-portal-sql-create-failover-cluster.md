...
ms.date: 04/01/2019
ms.author: v-yeche
ms.openlocfilehash: 257d85adec646e4d9ec6c9aa5c733ed61469874e
ms.sourcegitcommit: 3b05a8982213653ee498806dc9d0eb8be7e70562
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/04/2019
ms.locfileid: "59003740"
---
...
[使用远程桌面设置 S2D (Azure)](https://technet.microsoft.com/windows-server-docs/compute/remote-desktop-services/rds-storage-spaces-direct-deployment)
...
[S2D 的 SQL Server 支持](https://blogs.technet.microsoft.com/dataplatforminsider/2016/09/27/sql-server-2016-now-supports-windows-server-2016-storage-spaces-direct/)
