...
ms.date: 12/16/2016
ms.author: v-dazen
ms.openlocfilehash: 2170703d6b979eba74c164cfa539508c181b6f73
ms.sourcegitcommit: b1d2bd71aaff7020dfb3f7874799e03df3657cd4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/23/2017
---
# <a name="set-up-a-web-based-lob-application-in-a-hybrid-cloud-for-testing"></a>在混合云中设置基于 Web 的 LOB 应用程序以用于测试
...
有关在 Azure 中托管的生产型 LOB 应用程序的示例，请参阅 **Microsoft 软件体系结构关系图和蓝图** 上的 [业务线应用程序](http://msdn.microsoft.com/dn630664)体系结构蓝图。

## <a name="phase-1-set-up-the-simulated-hybrid-cloud-environment"></a>阶段 1：设置模拟混合云环境
创建[模拟的混合云测试环境](ps-hybrid-cloud-test-env-sim.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json)。 由于此测试环境不需要 Corpnet 子网上存在 APP1 服务器，因此现在可将其关闭。
...
接下来，在 Azure 门户中使用 LOB1 的本地管理员帐户的凭据连接到 LOB1。
...
* 使用 [Azure 门户](../virtual-machines-windows-hero-tutorial.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json)添加新虚拟机。