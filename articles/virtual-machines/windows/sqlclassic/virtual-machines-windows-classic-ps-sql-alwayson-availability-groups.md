---
title: "使用 PowerShell 在 Azure VM 中配置 AlwaysOn 可用性组 | Azure"
...
---
# <a name="configure-always-on-availability-group-in-azure-vm-with-powershell"></a>使用 PowerShell 在 Azure VM 中配置 AlwaysOn 可用性组
