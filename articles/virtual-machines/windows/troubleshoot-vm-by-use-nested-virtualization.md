...
ms.date: 11/27/2017
ms.author: v-yeche
ms.openlocfilehash: 6be19dda8548296629beec4c0144bc43ae77efd0
...
1.  创建新的恢复 VM：
    ...
    -  大小：任何支持嵌套虚拟化的 V3 系列至少具有双核。 有关详细信息，请参阅[引入新的 Dv3 和 Ev3 VM 大小](https://azure.microsoft.com/blogintroducing-the-new-dv3-and-ev3-vm-sizes/)。
