...
ms.date: 07/03/2017
ms.author: v-dazen
ms.openlocfilehash: 0740fe8321ef999c31e30befaaa3c664ca673882
...
<a id="troubleshoot-a-windows-vm-by-attaching-the-os-disk-to-a-recovery-vm-using-azure-powershell" class="xliff"></a>
...
在前一个命令的输出的 `StorageProfile` 部分中查找 `Vhd URI`。 下面这个截断的示例输出显示了代码块末尾的 `Vhd URI` ：
...
有关使用 Resource Manager 的详细信息，请参阅 [Azure Resource Manager 概述](../../azure-resource-manager/resource-group-overview.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json)。
