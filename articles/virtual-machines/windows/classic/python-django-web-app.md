---
title: "Windows Server Azure VM 上的 Django Web 应用 | Azure"
...
3. 在仪表板中，选择自己的 VM。 要使用远程桌面协议 (RDP) 远程登录到新创建的 Azure 虚拟机，请单击“连接”。  

> [!IMPORTANT] 
> 以下说明假定已正确登录到虚拟机。 同时还假设在虚拟机（而非本地计算机）中发出命令。

## <a id="setup"></a>安装 Python、Django 和 WFastCGI
> [!NOTE]
> 若要使用 Internet Explorer 下载，可能需要配置 Internet Explorer“增强的安全配置”设置。 为此，请单击“开始” > “管理工具” > “服务器管理器” > “本地服务器”。 单击“IE 增强的安全配置”，并选择“关闭”。
...
1. 在全局 applicationhost.config 文件中，解锁处理程序节。  这样，web.config 文件便可使用 Python 处理程序。 添加以下命令：
