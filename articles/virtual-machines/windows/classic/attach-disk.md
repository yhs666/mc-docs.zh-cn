...
ms.date: 09/04/2017
ms.author: v-dazen
ms.openlocfilehash: e07e2741d03e56656ea94c0d6d376fe2a0294fef
...
* 若要使用高级存储，需要一个 DS 系列虚拟机。 可以从高级存储帐户和标准存储帐户通过这些虚拟机使用磁盘。 高级存储只在某些区域可用。 有关详细信息，请参阅[高级存储：适用于 Azure 虚拟机工作负荷的高性能存储](../../../storage/common/storage-premium-storage.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json)。
