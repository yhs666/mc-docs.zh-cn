...
![Azure 门户预览中的 SQL Server IaaS 代理扩展](./media/sql-server-agent-extension/azure-sql-server-iaas-agent-portal.png)  
...
![在 Azure 门户预览中卸载 SQL Server IaaS 代理扩展](./media/sql-server-agent-extension/azure-sql-server-iaas-agent-uninstall.png)  
