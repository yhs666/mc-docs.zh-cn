...
有关详细信息，请参阅 [Azure 实例元数据服务](/virtual-machines/windows/instance-metadata-service)。
...
连接到 Windows VM 时，仅显示运行状况信息| [Windows 运行状况信号](https://github.com/Microsoft/azserialconsole/blob/master/Known_Issues/Windows_Health_Info)
...
A. 这是一个已知问题，若要解决此问题，只需在 bash 模式下打开 [Azure Cloud Shell](/cloud-shell/overview)，然后重试。
