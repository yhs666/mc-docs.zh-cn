...
ms.date: 07/03/2017
ms.author: v-dazen
ms.openlocfilehash: faa91f82f4b58965598b3fb7054ab61cae16d636
...
<a id="troubleshooting-specific-rdp-error-messages-to-a-windows-vm-in-azure" class="xliff"></a>
...
<a id="the-remote-session-was-disconnected-because-there-are-no-remote-desktop-license-servers-available-to-provide-a-license" class="xliff"></a>
...
## 远程桌面找不到计算机“名称”。
<a id="remote-desktop-cant-find-the-computer-name" class="xliff"></a>
...
## 发生身份验证错误。 无法联系本地安全机构。
<a id="an-authentication-error-has-occurred-the-local-security-authority-cannot-be-contacted" class="xliff"></a>
...
## Windows 安全性错误：凭据无效。
<a id="windows-security-error-your-credentials-did-not-work" class="xliff"></a>
原因：目标 VM 无法验证帐户名和密码。
...
## 此计算机无法连接到远程计算机。
<a id="this-computer-cant-connect-to-the-remote-computer" class="xliff"></a>
