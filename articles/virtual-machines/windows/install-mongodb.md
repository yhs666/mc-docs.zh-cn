...
* [使用 Azure 门户预览创建 Windows Server VM](../virtual-machines-windows-hero-tutorial.md) 或[使用 Azure PowerShell 创建 Windows Server VM](quick-create-powershell.md)
* [使用 Azure 门户预览将数据磁盘附加到 Windows Server VM](attach-disk-portal.md) 或[使用 Azure PowerShell 将数据磁盘附加到 Windows Server VM](https://msdn.microsoft.com/zh-cn/library/mt603673.aspx)
