...
ms.date: 07/10/2017
ms.author: v-dazen
ms.openlocfilehash: 6da7b1712ff4b38d422b93ff2ec08a454ced9e91
...
首先，需要将数据磁盘附加到虚拟机。 若要使用门户实现此操作，请参阅[如何在 Azure 门户中附加数据磁盘](attach-disk-portal.md)。
...
* 可以通过[附加更多数据磁盘](attach-disk-portal.md)来增加虚拟机的可用存储空间。
