...
* 如果 VM 位于本地，则现在可以[将 VHD 上载到 Azure](upload-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)。
* 如果 VM 已在 Azure 中，现在可以[从通用 VM 创建映像](capture-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)。
