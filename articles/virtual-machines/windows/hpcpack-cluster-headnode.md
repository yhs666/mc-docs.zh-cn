...
ms.date: 08/27/2018
ms.author: v-yeche
ms.openlocfilehash: ec0cbce8ffa658d2384659e396fa59a53c260c1f
ms.sourcegitcommit: bdffde936fa2a43ea1b5b452b56d307647b5d373
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/24/2018
ms.locfileid: "42871697"
---
# <a name="create-the-head-node-of-an-hpc-pack-cluster-in-an-azure-vm-with-a-marketplace-image"></a>在 Azure VM 中使用市场映像创建 HPC Pack 群集的头节点
使用 Azure 市场和 Azure 门户中的 [Microsoft HPC Pack 2012 R2 虚拟机映像](https://azure.microsoft.com/marketplace/partners/microsoft/hpcpack2012r2onwindowsserver2012r2/)创建 HPC 群集的头节点。 此 HPC Pack VM 映像基于预安装了 HPC Pack 2012 R2 Update 3 的 Windows Server 2012 R2 Datacenter。 使用此头节点在 Azure 中进行 HPC Pack 的概念证明部署。 然后，可以向该群集添加计算节点，以运行 HPC 工作负荷。
...
1. 在 Azure 市场的[“Windows Server 2012 R2 上的 HPC Pack 2012 R2”页](https://azure.microsoft.com/marketplace/partners/microsoft/hpcpack2012r2onwindowsserver2012r2/)上，单击“创建虚拟机”。 
1. 在门户的“Windows Server 2012 R2 上的 HPC Pack 2012 R2”页上，选择“Resource Manager”部署模型，然后单击“创建”。

    ![HPC Pack 映像][marketplace]
1. 使用门户配置设置并创建 VM。 如果不熟悉 Azure，请按照[在 Azure 门户中创建 Windows 虚拟机](../virtual-machines-windows-hero-tutorial.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json)教程中的说明操作。 若要进行概念证明部署，通常可以接受默认或推荐的设置。

   > [!NOTE]
   > 如果希望将头节点加入到 Azure 中的现有 Active Directory 域，请确保在创建 VM 时为该域指定了虚拟网络。
   > 
   > 
1. 创建 VM 并运行 VM 之后，通过远程桌面[连接到 VM](connect-logon.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json)。 
1. 选择以下选项之一，将 VM 加入到 Active Directory 域林：
...
1. 在 VM 运行并加入到 Active Directory 林后启动 HPC Pack 服务，如下所示：
