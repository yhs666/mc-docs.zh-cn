...
### 群集管理
* [在 Azure 中管理 HPC Pack 群集的计算节点](classic/hpcpack-cluster-node-manage.md)
* [增加和减少 HPC Pack 群集中的 Azure 计算资源](classic/hpcpack-cluster-node-autogrowshrink.md)
* [将作业提交到 Azure 中的 HPC Pack 群集](hpcpack-cluster-submit-jobs.md)
...
* [将 Azure“突发”节点添加到 Azure 中的 HPC Pack 头节点](classic/hpcpack-cluster-node-burst.md)
