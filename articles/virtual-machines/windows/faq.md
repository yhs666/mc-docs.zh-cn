...
ms.date: 05/21/2018
ms.author: v-yeche
ms.openlocfilehash: efcd48203c37a75b311bb2cfb8da321321ef97ed
...
是的。 计算机名称的最大长度为 15 个字符。 有关命名资源的详细信息，请参阅[命名约定规则和限制](https://docs.microsoft.com/azure/architecture/best-practices/naming-conventions#compute)。
