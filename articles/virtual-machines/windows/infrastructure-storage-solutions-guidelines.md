---
title: "Azure 中 Windows VM 的存储解决方案 | Azure"
...
ms.openlocfilehash: ecba90575f848179b93db61ead566ad0c610383b
...
Azure 将对可用的数据磁盘数和带宽加以限制，具体取决于 VM 大小。 有关详细信息，请参阅[虚拟机大小](sizes.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json)。
