...
ms.date: 06/29/2016
ms.author: v-dazen
ms.openlocfilehash: 41dc2ee33ae4e21dee2a2b29b2cdfbc9b424e582
...
可以从 Azure PowerShell 执行 Azure Resource Manager 模板。 一旦执行该模板，就可以从 Azure Resource Manager 或命令行工具查看扩展状态。
