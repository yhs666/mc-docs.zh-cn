...
ms.date: 10/22/2018
ms.author: v-yeche
ms.openlocfilehash: 5fda5581d151548fe9e762567ca9bc19b2505723
ms.sourcegitcommit: c5529b45bd838791379d8f7fe90088828a1a67a1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/25/2018
ms.locfileid: "50034815"
---
# <a name="update-the-storage-type-of-a-managed-disk"></a>更新托管磁盘的存储类型

托管磁盘提供两种存储选项：[高级 SSD](../windows/premium-storage.md) 和[标准 HDD](../windows/standard-storage.md)。 可以根据性能需要，切换托管磁盘的存储类型，从而使故障时间最短。 非托管磁盘不支持切换存储类型；但是，可以轻松地[将非托管磁盘转换为托管磁盘](convert-unmanaged-to-managed-disks.md)。
...
* 本文中的示例需要版本 6.0.0 或更高版本的 Azure PowerShell 模块。 运行 `Get-Module -ListAvailable AzureRM` 即可查找版本。 如果需要进行升级，请参阅 [Install Azure PowerShell module](https://docs.microsoft.com/powershell/azure/install-azurerm-ps)（安装 Azure PowerShell 模块）。 运行 [Connect-AzureRmAccount](https://docs.microsoft.com/powershell/module/azurerm.profile/connect-azurermaccount)创建与 Azure 的连接。
...
<!-- Not Available on ## Convert a managed disk from standard HDD to standard SSD-->
