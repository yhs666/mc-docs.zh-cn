...
ms.date: 07/03/2017
ms.author: v-dazen
ms.openlocfilehash: 860e228ccb91a7d32b6049a05ab5efc1bdad4f56
...
导出 VHD 后，请遵照[如何从 S3 存储桶中下载对象？](http://docs.aws.amazon.com/AmazonS3/latest/user-guide/download-objects.html)中的说明，从 S3 存储桶中下载 VHD 文件。 
