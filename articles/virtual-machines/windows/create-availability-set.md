...
ms.openlocfilehash: 2b42afa8e8d016c536a703b4ade533478ffdac9a
...
如果希望 VM 属于某个可用性集，需要先创建该可用性集或在该集中创建第一个 VM。 目前，在 Azure 中国，只能通过 Azure 门户创建非托管的可用性集。
...
2. 在“可用性集”边栏选项卡上，单击“添加”。
    ...
    ![显示用于创建新可用性集的“添加”按钮的屏幕截图。](./media/create-availability-set/add-availability-set.png)
3. 在“创建可用性集”  边栏选项卡上，填写可用性集的相关信息。

    ![显示创建可用性集时需要输入的信息的屏幕截图。](./media/create-availability-set/create-availability-set.png)
