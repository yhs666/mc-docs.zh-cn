...
ms.openlocfilehash: d7919b7a865fb9206e4e1e5ee126348047d70933
ms.sourcegitcommit: b1d2bd71aaff7020dfb3f7874799e03df3657cd4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/23/2017
---
# <a name="availability-and-scale-in-azure-resource-manager-templates-for-windows-vms"></a>用于 Windows VM 的 Azure Resource Manager 模板的可用性和缩放性
...
![可用性集](./media/dotnet-core-4-availability-scale/ase-win.png)

有关可用性集的深入信息，请参阅[管理虚拟机的可用性](manage-availability.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json)。 
...
![网络负载均衡器](./media/dotnet-core-4-availability-scale/nlb-win.png)
...
![网络负载均衡器规则](./media/dotnet-core-4-availability-scale/lbrule-win.png)
...
![网络负载均衡器探测](./media/dotnet-core-4-availability-scale/lbprobe-win.png)
...
![入站 NAT 规则](./media/dotnet-core-4-availability-scale/natrule-win.png)

有关 Azure 网络负载均衡器的深入信息，请参阅 [Azure 基础结构服务的负载均衡](load-balance.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json)。
...
有关复制函数的详细信息，请参阅[在 Azure Resource Manager 中创建多个资源实例](../../resource-group-create-multiple.md)。
