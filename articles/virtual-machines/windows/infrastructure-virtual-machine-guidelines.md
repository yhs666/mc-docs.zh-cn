...
ms.date: 08/21/2017
ms.author: v-dazen
ms.openlocfilehash: c502752f7a281adf3b104cde1eacbd64e59c3941
...
务必了解[不同 VM 大小](sizes.md)，以便从性能和成本的角度确定环境的适当大小。 如果 VM 的 CPU 核心数或内存不足，则无论应用程序的设计和开发如何完善，其性能都会受到影响。 在确定要用于基础结构中每个组件的 VM 大小之前，请首先检查每个 VM 系列的建议工作负荷。 完成部署后，可以[更改 VM 大小](resize-vm.md)。
