---
title: 在 Azure 中使用 Windows 客户端映像 | Azure
...
| 产品名称 | 产品编号 | 可用客户端映像 |
|:--- |:---:|:---:|
| [Visual Studio Professional 订户](https://www.azure.cn/offers/ms-mc-arz-msdn/) | MS-MC-AZR-59P | Windows 10 |
| [Visual Studio Test Professional 订户](https://www.azure.cn/offers/ms-mc-arz-msdn/) | MS-MC-AZR-60P | Windows 10 |
| [Visual Studio Enterprise 订户](https://www.azure.cn/offers/ms-mc-arz-msdn/) |MS-MC-AZR-63P | Windows 10 |
...
也可以从 Azure 帐户门户的 [订阅](http://account.windowsazure.cn/Subscriptions) 选项卡查看产品 ID：
