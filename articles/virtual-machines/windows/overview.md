---
title: Azure 中的 Windows 虚拟机概述 | Azure
...
ms.author: v-yeche
ms.custom: mvc
ms.openlocfilehash: 3667d98fd855ea947a21d8ad76d92ce066900417
ms.sourcegitcommit: 73715ebbaeb96e80046142b8fe5bbc117d85b317
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/28/2019
ms.locfileid: "74593755"
---
...
### <a name="naming"></a>命名
虚拟机有一个分配的[名称](https://docs.microsoft.com/azure/architecture/best-practices/naming-conventions)，另外，它还配置有一个在操作系统中使用的计算机名称。 VM 的名称最多可包含 15 个字符。
