...
在大多数情况下，应该通过 Azure 资源管理器部署模板来使用 DSC 扩展。 有关详细信息以及如何在资源管理器部署模板中包含 DSC 扩展的示例，请参阅 [Desired State Configuration 扩展与 Azure 资源管理器模板](extensions-dsc-template.md)。
...
1. 转到某个 VM。 
2. 在“设置” > “常规”下面，选择“扩展”。 
3. 此时会创建一个新窗格。在其中依次选择“添加”、“PowerShell DSC”。
