...
ms.openlocfilehash: f73497d611238a1d346d16b3a5c24631ba5391fc
...
使用 Azure 门户预览或 Azure CLI 2.0 获取托管磁盘的快照。
...
## <a name="use-azure-portal-preview-to-take-a-snapshot"></a>使用 Azure 门户预览版拍摄快照 
