...
![命令行屏幕截图，其中整个虚拟网络名称已突出显示。](./media/migration-classic-resource-manager-cli/vnet.png)
...
- [平台支持的从经典部署模型到 Resource Manager 部署模型的 IaaS 资源迁移](../windows/migration-classic-resource-manager-overview.md)
- [技术探讨：平台支持的从经典部署模型到 Resource Manager 部署模型的迁移](../windows/migration-classic-resource-manager-deep-dive.md)
