...
ms.date: 07/03/2017
ms.author: v-dazen
ms.openlocfilehash: 79989c6e6802369ffd66b9b502fda2c273a4c6c9
ms.sourcegitcommit: b1d2bd71aaff7020dfb3f7874799e03df3657cd4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/23/2017
---
<a id="linux-on-distributions-endorsed-by-azure" class="xliff"></a>
...
<a id="supported-distributions-and-versions" class="xliff"></a>

## 支持的发行版和版本
下表列出了 Azure 支持的 Linux 分发和版本。 有关详细信息，请参阅 [Support for Linux images in Azure](https://support.microsoft.com/kb/2941892)（Azure 中对 Linux 映像的支持）。
...
<a id="partners" class="xliff"></a>

## 合作伙伴

<a id="coreos" class="xliff"></a>
