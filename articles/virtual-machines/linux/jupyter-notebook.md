...
description: "了解如何在使用 Azure 中的 Resource Manager 部署模型创建的 Linux 虚拟机上部署 Jupyter/IPython Notebook。"
...
ms.openlocfilehash: 239c10c7f7411c83d1a6abae0b7835f8d9b4c9c5
...
在以下屏幕截图中，利用 Python 的许多用于科技计算的优秀库的功能，可以像执行复杂网络分析一样轻松地执行简单计算，且全部操作都在一个环境中完成。
