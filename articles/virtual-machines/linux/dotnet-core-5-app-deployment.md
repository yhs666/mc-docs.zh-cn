...
ms.openlocfilehash: 28b589d184ec5936f44cdd0044cb266e7084a542
ms.sourcegitcommit: 033f4f0e41d31d256b67fc623f12f79ab791191e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/21/2017
---
# <a name="application-deployment-with-azure-resource-manager-templates-for-linux-vms"></a>使用 Azure Resource Manager 模板为 Linux VM 部署应用程序
...
有关使用自定义脚本扩展的详细信息，请参阅[使用 Resource Manager 模板自定义脚本扩展](extensions-customscript.md?toc=%2fvirtual-machines%2flinux%2ftoc.json)。
