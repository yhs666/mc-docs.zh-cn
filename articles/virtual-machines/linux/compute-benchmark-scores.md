...
ms.date: 05/21/2018
ms.author: v-yeche
ms.openlocfilehash: d62f706c0574c9c6ceec9bfe45a23072edc3b9ca
ms.sourcegitcommit: c732858a9dec4902d5aec48245e2d84f422c3fd6
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/22/2018
ms.locfileid: "34450099"
---
...
Linux 分数是通过在 Ubuntu 上运行 [CoreMark](http://www.eembc.org/coremark/faq.php) 计算得出的。 CoreMark 中配置的线程数设置为虚拟 CPU 的数目，并发性设置为 PThreads。 目标迭代次数已根据预期性能进行调整，提供至少 20 秒（通常更长）的运行时。 最终分数表示已完成迭代次数除以运行测试所花费的秒数。 每项测试在每个 VM 上至少运行了七次。 测试运行日期如上所示。 于当天在支持 VM 的每个 Azure 公共区域中的多个 VM 上执行测试运行。 
<!-- Pending B Series Release -->
基本 A 和 B (Burstable) 系列未显示，因为其性能不稳定。 
<!-- Pending B Series Release -->
