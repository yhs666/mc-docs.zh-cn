---
title: "Linux VM 设备名称在 Azure 中发生更改 | Azure"
...
ms.date: 08/14/2017
ms.author: v-dazen
ms.openlocfilehash: d8da614613dccc03dfeea7e20b31bf7e46e7ab97
...
不保证 Linux 中的设备路径在重启后保持一致。 设备名称由主要编号（字母）和次要编号组成。  当 Linux 存储设备驱动程序检测到新设备时，会将可用范围内的主要和次要设备编号分配给新设备。 移除某个设备后，其设备编号会被释放，供将来重复使用。
