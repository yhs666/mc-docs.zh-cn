...
ms.date: 01/05/2017
ms.author: v-dazen
ms.openlocfilehash: 68c9649fdd4a542c4b8b15e435a21bf0a532ead5
ms.sourcegitcommit: 033f4f0e41d31d256b67fc623f12f79ab791191e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/21/2017
---
# <a name="apply-security-and-policies-to-linux-vms-with-azure-resource-manager"></a>通过 Azure Resource Manager 向 Linux VM 应用安全措施和策略
...
可以直接使用 REST API 或 PowerShell cmdlet 轻松创建策略。 你可以了解有关[创建和分配策略](../../resource-manager-policy.md)的详细信息。

## <a name="apply-the-policy"></a>应用策略
创建策略后，需要在所定义的范围中应用策略。 范围可以是订阅、资源组甚至是资源。 你可以了解有关[创建和分配策略](../../resource-manager-policy.md)的详细信息。
