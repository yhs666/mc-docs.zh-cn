---
title: "使用 Azure 门户将 Linux VM 部署到现有网络中 | Azure"
...
ms.date: 07/03/2017
ms.author: v-dazen
ms.openlocfilehash: f344981d7b7f9d5490040c9d2c13447edbb629f3
ms.sourcegitcommit: b1d2bd71aaff7020dfb3f7874799e03df3657cd4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/23/2017
---
# 如何使用 Azure 门户将 Linux 虚拟机部署到现有 Azure 虚拟网络
<a id="how-to-deploy-a-linux-virtual-machine-into-an-existing-azure-virtual-network-with-the-azure-portal" class="xliff"></a>

本文说明如何将虚拟机 (VM) 部署到现有虚拟网络 (VNet)。 需选择静态的、长期存在的且部署频率极低的资源作为 Azure 资产，例如 VNet 和网络安全组。 部署 VNet 后，不变的重新部署可以重复使用它，而不会对基础结构产生任何负面影响。 以充当传统硬件网络交换机的 VNet 为例，不需要每次部署时都配置全新的硬件交换机。  
...
虚拟网卡 (VNic) 可连接到不同的 VM，因此很重要。 此方法将 VNic 作为静态资源保存，而 VM 可以作为临时资源。 创建 VNic 并将其与上一步创建的子网相关联。
