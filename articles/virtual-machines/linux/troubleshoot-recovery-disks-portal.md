...
ms.date: 01/20/2017
ms.author: v-dazen
ms.openlocfilehash: e3efca1a028c66b5dd4801f5a08761eb5987043f
...
2. 现在从 VM 中分离虚拟硬盘。 在门户中选择 VM，然后单击“磁盘”。 Select your existing virtual hard disk and then click **Detach**:
