...
ms.date: 10/23/2017
ms.author: v-yeche
ms.openlocfilehash: 6b8d9dd7f75630c288d5edb31d635c6f066fb666
...
可以使用 [azure vm get-instance-view](https://docs.microsoft.com/cli/azure/vm?view=azure-cli-latest#az_vm_get_instance_view) 查看计划内维护信息。
