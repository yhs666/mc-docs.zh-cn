...
ms.date: 08/21/2017
ms.author: v-dazen
ms.openlocfilehash: 361d75c549d3734e6813273e753cc1bb6413b6a5
...
使用 [az vm create](https://docs.microsoft.com/cli/azure/vm#create) 创建 VM。 以下示例通过名为 *azureuser* 的用户使用 SSH 公钥身份验证创建名为 *myVM* 的 VM
