...
ms.date: 07/03/2017
ms.author: v-dazen
ms.openlocfilehash: bff39b438f1b4d306c64659cf836cbee24b3c3de
...
| 扩展名称 | 说明 | 详细信息 |
| --- | --- | --- |
| 适用于 Linux 的自定义脚本扩展 |针对 Azure 虚拟机运行脚本 |[适用于 Linux 的自定义脚本扩展](extensions-customscript.md?toc=%2fvirtual-machines%2flinux%2ftoc.json) |
| Docker 扩展 |安装 Docker 守护程序以支持远程 Docker 命令。 |[Docker VM 扩展](dockerextension.md?toc=%2fvirtual-machines%2flinux%2ftoc.json) |
