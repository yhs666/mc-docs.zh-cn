...
![在 Azure 门户预览版中重置 SSH 配置或凭据](./media/troubleshoot-ssh-connection/reset-credentials-using-portal.png)
...
如果创建并上载了自定义 Linux 磁盘映像，请确保已安装 [Azure Linux 代理](agent-user-guide.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) 2.0.5 或更高版本。 在使用库映像创建的 VM 上，系统已自动安装并配置了此访问扩展。
...
![在 Azure 门户预览版中重新启动 VM](./media/troubleshoot-ssh-connection/restart-vm-using-portal.png)
...
你可以将 VM 重新部署到 Azure 中的另一个节点，这可能可以更正任何潜在的网络问题。 有关重新部署 VM 的信息，请参阅[将虚拟机重新部署到新的 Azure 节点](../windows/redeploy-to-new-node.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)。
...
![在 Azure 门户预览版中重新部署 VM](./media/troubleshoot-ssh-connection/redeploy-vm-using-portal.png)
...
* 有关对应用程序访问进行故障排除的详细信息，请参阅[对在 Azure 虚拟机上运行的应用程序的访问进行故障排除](troubleshoot-app-connection.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
