...
查看资源管理器版本，请点击[这里](../troubleshoot-deployment-new-vm.md).
...
若要解决这两个错误，请上载原始 VHD、可用的本地设置、以及与该 OS（通用/专用）相同的设置。若要以通用设置上载，请记得先运行 -deprovision。有关详细信息，请参阅[创建并上载包含 Linux 操作系统的虚拟硬盘](create-upload-vhd.md)。
