...
9. 优化系统性能。有关详细信息，请参阅[性能调优策略](optimize-mysql.md)。
...
你可能希望了解[在 Linux 上对 MySQL 进行集群的其他方式](mysql-cluster.md)并探究如何[优化和测试 Azure Linux VM 上的 MySQL 性能](optimize-mysql.md)。
