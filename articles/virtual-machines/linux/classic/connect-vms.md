...
使用经典部署模型创建的 Linux 虚拟机始终放置在云服务中。 云服务充当容器，并提供唯一的公用 DNS 名称、公用 IP 地址，以及一组通过 Internet 访问虚拟机的终结点。 云服务可以位于虚拟网络中，但这不是必要条件。 也可以[将 Windows 虚拟机连接到虚拟网络或云服务](../../windows/classic/connect-vms.md?toc=%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json)。
