...
本文介绍如何通过 Azure 门户预览将新磁盘和现有磁盘附加到 Linux 虚拟机。 还可以[在 Azure 门户预览中将数据磁盘附加到 Windows VM](../windows/attach-disk-portal.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json)。
