---
title: "在 Azure 中部署 OpenShift 容器平台 | Azure"
...
ms.date: 11/27/2017
ms.openlocfilehash: ee74198f68d0aa6cd4928270e2e6172e334aadcb
...
> [!NOTE] 
> 以下命令需要 Azure CLI 2.0.8 或更高版本。 可以使用 `az --version` 命令检查 CLI 版本。 若要更新 CLI 版本，请参阅[安装 Azure CLI 2.0](https://docs.azure.cn/zh-cn/cli/install-azure-cli?view=azure-cli-latesti?view=azure-cli-latest)。
