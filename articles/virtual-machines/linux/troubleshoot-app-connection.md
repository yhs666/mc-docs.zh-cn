---
title: "排查 Azure 中 Linux VM 应用程序访问问题 | Azure"
description: "使用以下详细故障排除步骤，查明连接到 Azure 中 Linux 虚拟机上运行的应用程序的问题。"
...
ms.date: 02/05/2018
ms.author: v-yeche
ms.openlocfilehash: 5150841363707ef43f6b456c39505329f5a075a2
