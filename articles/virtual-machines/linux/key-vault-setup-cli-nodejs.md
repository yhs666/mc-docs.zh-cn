---
title: "使用 Azure CLI 1.0 为 Linux VM 设置 Key Vault | Azure"
...
- [Azure CLI 2.0](key-vault-setup.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) - 适用于资源管理部署模型的下一代 CLI
