---
title: "Azure 中 Linux VM 的订阅和帐户 | Azure"
...
ms.openlocfilehash: 23683304938ce5453e9455184b94baa9d41a916a
...
由于两个层次结构级别在帐户/订阅关系上的限制，根据计费要求调整帐户和订阅的命名约定至关重要。 例如，如果一家全国范围的公司使用 Azure，他们可以选择在每个区域建立一个帐户，并在区域级别管理订阅：
