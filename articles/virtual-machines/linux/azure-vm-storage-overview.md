...
ms.date: 04/24/2017
ms.author: v-dazen
ms.openlocfilehash: 09ae484752e3e7133a12c4ca5bec0dbc92bf20ad
ms.sourcegitcommit: b1d2bd71aaff7020dfb3f7874799e03df3657cd4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/23/2017
---
<a id="azure-and-linux-vm-storage" class="xliff"></a>
...
目前 Azure VM 支持使用 [Azure 托管磁盘](../../storage/storage-managed-disks-overview.md?toc=%2fvirtual-machines%2flinux%2ftoc.json)，使得你自身无需创建或管理任何 [Azure 存储帐户](../../storage/storage-introduction.md)便可创建 VM。 你指定是需要高级还是标准存储，以及磁盘应具有的容量，随之 Azure 便会为你创建 VM 磁盘。 使用托管磁盘的 VM 具有许多重要功能，包括：
...
<a id="azure-storage-standard-and-premium" class="xliff"></a>
...
<a id="creating-a-vm-with-a-managed-disk" class="xliff"></a>
...
<a id="create-a-vm-with-an-unmanaged-standard-disk-using-the-azure-cli-10" class="xliff"></a>

### 使用 Azure CLI 1.0 创建一个具有非托管标准磁盘的 VM
...
<a id="create-a-vm-with-premium-storage-using-the-azure-cli-10" class="xliff"></a>
...
<a id="premium-storage-supported-vms" class="xliff"></a>
...
<a id="hot-storage" class="xliff"></a>

## 热存储
Azure 热存储层为存储经常访问的数据进行了优化。  热存储是 Blob 存储的默认存储类型。

<a id="cool-storage" class="xliff"></a>
...
<a id="cost-savings" class="xliff"></a>
