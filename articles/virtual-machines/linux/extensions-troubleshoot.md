...
ms.date: 06/29/2016
ms.author: v-dazen
ms.openlocfilehash: 8598595e758c112372571ff0c55694b51cd4b9b6
...
可以从 Azure CLI 执行 Azure Resource Manager 模板。 一旦执行该模板，就可以从 Azure Resource Manager 或命令行工具查看扩展状态。
