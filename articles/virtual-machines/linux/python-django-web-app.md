...
>- [Windows](../windows/classic/python-django-web-app.md)
>- [Mac/Linux](python-django-web-app.md)
...
1. 按照[此处](quick-create-portal.md)提供的说明可创建 Ubuntu Server 14.04 LTS 分发的 Azure 虚拟机。如果你喜欢，你可以选择密码登陆，而不是 SSH 公钥。

1. 按照[这里](../../virtual-network/virtual-networks-create-nsg-arm-ps.md)的说明，编辑网络安全组，允许 http 访问端口 80

1. 默认情况下，你的心虚拟机没有完全限定域名（FQDN）。你可以按照[这里](portal-create-fqdn.md)的说明，创建一个。这个步骤对于本教程而言只是可选的。
