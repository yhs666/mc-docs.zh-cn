...
ms.date: 03/28/2017
ms.author: v-dazen
ms.openlocfilehash: b15c516ba17d411a9dd076ee1726be0606d32403
...
有工具可用于生成适用于 Azure 的 Debian VHD，如来自 [credativ](http://www.credativ.com/) 的 [azure-manage](https://github.com/credativ/azure-manage) 脚本。 这是建议的方法，而不是从头开始创建映像。 例如，若要创建 Debian 8 VHD，请运行以下命令来下载 azure-manage（以及依赖项），并运行 azure_build_image 脚本：
...
现在，你可以使用 Debian 虚拟硬盘在 Azure 中创建新的 Azure 虚拟机了。 如果这是第一次将 .vhd 文件上传到 Azure，请参阅[创建和上传包含 Linux 操作系统的虚拟硬盘](classic/create-upload-vhd.md?toc=%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)中的步骤 2 和步骤 3。
