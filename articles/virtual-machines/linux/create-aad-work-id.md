...
此外，利用最近所做的更改，你可以使用[此处](../../xplat-cli-connect.md)所述的 `azure login -e AzureChinaCloud` 交互式登录方法，通过任何类型的 Azure 帐户管理你的订阅。你可以使用该机制，也可以遵循后面的说明。你也可[在 Azure 活动目录创建一个工作或学校账户来使用 Windows VM](../windows/create-aad-work-id.md)。
