---
title: 在 Linux VM 上对 Azure 资源管理器部署中的存储资源删除错误进行故障排除 | Azure
...
ms.date: 06/04/2018
ms.author: v-yeche
ms.openlocfilehash: 83ed83d9775fd3bca95c5753af5bd1f4b5ab5068
ms.sourcegitcommit: d75065296d301f0851f93d6175a508bdd9fd7afc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52659192"
---
...
Azure VM 中使用的 VHD 是在 Azure 的标准或高级存储帐户中作为页 Blob 存储的 .vhd 文件。 有关 Azure 磁盘的详细信息，请参阅[有关 Azure Linux VM 的非托管和托管磁盘存储](about-disks-and-vhds.md)。 
...
<!-- Update_Description: new articles on storage resource deletion errors -->
<!--ms.date: 06/04/2018-->