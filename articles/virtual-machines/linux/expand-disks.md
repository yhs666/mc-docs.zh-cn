...
ms.date: 10/16/2017
ms.author: v-yeche
ms.openlocfilehash: 0b6c092f2fc35e8e804cc688865f7cf04bba0289
...
4. 使用相应的凭据通过 SSH 连接到 VM。 可使用 [az vm show](https://docs.azure.cn/zh-cn/cli/vm?view=azure-cli-latest#show) 获取 VM 的 公共 IP 地址：
