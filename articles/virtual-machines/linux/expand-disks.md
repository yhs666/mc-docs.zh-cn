...
ms.date: 09/04/2017
ms.author: v-haiqya
ms.openlocfilehash: f9b1512b5d156a9a720ac2dc7a1de557728fb63c
...
4. 使用相应的凭据通过 SSH 连接到 VM。 可使用 [az vm show](https://docs.microsoft.com/cli/azure/vm#show) 获取 VM 的 公共 IP 地址：
...
<Update_Description：添加步骤 4 到步骤 8>