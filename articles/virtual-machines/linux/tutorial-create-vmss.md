...
ms.date: 02/05/2018
ms.author: v-yeche
ms.openlocfilehash: a53f2940de7c46c3865eec23d629544ea2e81119
...
然后，可以使用 [az vmss scale](https://docs.azure.cn/zh-cn/cli/vmss?view=azure-cli-latest#scale) 手动增加或减少规模集中虚拟机的数目。 以下示例将规模集中 VM 的数目设置为 *3*：
