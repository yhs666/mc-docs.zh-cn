...
ms.date: 08/21/2017
ms.author: v-dazen
ms.openlocfilehash: 3f6f85c7c45ef47a6b5414c7d03092e02f8338e0
...
使用 [az vm redeploy](https://docs.microsoft.com/cli/azure/vm#redeploy) 重新部署 VM。 以下示例在名为 *myResourceGroup* 的资源组中重新部署名为 *myVM* 的 VM：
