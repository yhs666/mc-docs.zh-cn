...
首先，在 Linux VM 上使用 **deprovision** 参数运行 **waagent** 命令。 此命令删除文件和数据，使 VM 准备好进行通用化。 有关详细信息，请参阅 [Azure Linux 代理用户指南](../windows/agent-user-guide.md?toc=%2fvirtual-machines%2flinux%2ftoc.json)。
