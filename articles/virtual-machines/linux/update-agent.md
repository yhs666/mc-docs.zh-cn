...
ms.date: 12/26/2016
ms.author: v-dazen
ms.openlocfilehash: c1377316d437284a6598a069851d0984ecb72384
...
> [!NOTE]
> 如果从 Windows 计算机执行此任务，则可以使用 PuTTY 通过 SSH 登录到 Linux 计算机。 有关详细信息，请参阅[如何登录到运行 Linux 的虚拟机](mac-create-ssh-keys.md?toc=%2fvirtual-machines%2flinux%2ftoc.json)。
> 
> 
...
在命令行上键入 `#sudo yum install wget` 来安装 wget（有一些发行版在默认情况下未安装它，如 Redhat、CentOS 和 Oracle Linux 6.4 和 6.5 版）。
