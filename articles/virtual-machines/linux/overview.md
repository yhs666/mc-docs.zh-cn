...
ms.openlocfilehash: 6cfc812dac4696d04a7bb891f7e11711659631ea
...
---
# Azure 和 Linux
<a id="azure-and-linux" class="xliff"></a>
...
## Azure 虚拟机和实例
<a id="azure-virtual-machines--instances" class="xliff"></a>
...
### 使用 CLI 创建 VM
<a id="create-a-vm-using-the-cli" class="xliff"></a>
使用 CLI 创建 Linux VM 是部署 VM 的一种快速方法，无需离开正在使用的终端。  通过命令行标志或开关提供可以在 Web 门户上指定的所有内容。  

* [使用 CLI 创建 Linux VM](quick-create-cli.md?toc=%2fvirtual-machines%2flinux%2ftoc.json)

### 在门户中创建 VM
<a id="create-a-vm-in-the-portal" class="xliff"></a>
通过在 Azure Web 门户上创建 Linux VM，可以轻松地指向和单击用于访问部署的各个选项。  因此，不需要使用命令行标记或开关，而可以在布局良好的 Web 界面上查看各种选项和设置。  通过命令行接口提供的所有功能也都在门户中提供。

* [使用门户创建 Linux VM](quick-create-portal.md?toc=%2fvirtual-machines%2flinux%2ftoc.json)

### 不使用密码通过 SSH 登录
<a id="login-using-ssh-without-a-password" class="xliff"></a>
...
## 相关 Azure 组件
<a id="related-azure-components" class="xliff"></a>
## 存储
