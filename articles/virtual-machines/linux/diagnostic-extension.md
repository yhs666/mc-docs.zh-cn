...
ms.date: 09/04/2017
ms.author: v-haiqya
ms.openlocfilehash: dd98a3a876f8a5b162e02b4bb37e6ade0f253fba
...
storageAccountEndPoint | （可选）标识存储帐户所在云的终结点。 如果缺少此设置，则 LAD 默认为 Azure 公有云 `https://core.windows.net`。 若要使用 Azure 中国的存储帐户，请将此值设置为 `https://core.chinacloudapi.cn`。
...
* 了解如何使用指标[创建虚拟机规模集](/virtual-machines/linux/tutorial-create-vmss)以控制自动缩放。
