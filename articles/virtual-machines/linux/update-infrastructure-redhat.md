...
ms.date: 10/30/2017
ms.author: v-yeche
ms.openlocfilehash: 05f6bfcc75e37231249fece1a572d09c6308ebf1
...
2. 对 Azure 托管 RHUI 的访问限制为 [Azure 数据中心 IP 范围] (https://www.microsoft.com/download/details.aspx?id=42064) 内的 VM。
