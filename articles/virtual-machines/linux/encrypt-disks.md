...
ms.date: 08/21/2017
ms.author: v-dazen
ms.openlocfilehash: 5a8122291350003be9b8333b8c1f7b3daacb04ca
...
使用 [az vm create](https://docs.microsoft.com/cli/azure/vm#create) 创建 VM 并附加一个 5Gb 数据磁盘。 只有特定应用商店映像才支持磁盘加密。 下面的示例使用 Ubuntu 14.04 映像创建名为 `myVM` 的 VM：
