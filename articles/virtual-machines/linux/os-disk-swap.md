...
在交换磁盘之前，使用 [az vm stop](https://docs.azure.cn/zh-cn/cli/vm?view=azure-cli-latest#stop) 停止\取消分配 VM。
...
使用 [az vm start](https://docs.azure.cn/zh-cn/cli/vm?view=azure-cli-latest#start) 重启 VM：
