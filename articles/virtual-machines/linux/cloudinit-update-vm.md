---
title: "使用 cloud-init 在 Azure 上的 Linux VM 中更新和安装包 | Azure"
...
ms.date: 01/08/2018
ms.author: v-yeche
ms.openlocfilehash: b311c2e0caaab11b08383347fc455d9acf0da4ef
...
若要查看操作中的升级进程，请在当前 shell 中创建一个名为“cloud_init_upgrade.txt”的文件并粘贴下面的配置。 可使用任何想要使用的编辑器。 输入 `sensible-editor cloud_init_upgrade.txt` 以创建文件并查看可用编辑器的列表。 选择 #1 以使用 nano 编辑器。 请确保已正确复制整个 cloud-init 文件，尤其是第一行。  
