---
title: "获取 Azure Linux VM ID | Azure"
...
ms.date: 03/28/2017
ms.author: v-dazen
ms.openlocfilehash: f97b467a7b72df7c0a4d52e23121061d81018516
...
> [!NOTE]
> 如果自此新功能推出（2014 年 9 月 18 日）之后创建并运行了旧的 VM，请重启 VM 以自动获取 Azure 唯一 ID。
> 
> 
...
有关详细信息，请参阅 [Create a Virtual Machine](../windows/creation-choices.md?toc=%2fvirtual-machines%2flinux%2ftoc.json)（创建虚拟机）

## <a name="connect-to-the-vm"></a>连接到 VM
有关详细信息，请参阅 [SSH from Linux](mac-create-ssh-keys.md?toc=%2fvirtual-machines%2flinux%2ftoc.json)（从 Linux 执行 SSH）
