...
* [使用 Azure 门户预览创建 Windows Server VM](virtual-machines-windows-hero-tutorial.md) 或[使用 Azure PowerShell 创建 Windows Server VM](virtual-machines-windows-quick-create-powershell.md)
