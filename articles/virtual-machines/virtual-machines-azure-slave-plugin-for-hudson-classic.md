...
4. 单击“添加新云”>“Azure”。
    ...
    >[!NOTE]
    > 若要使用 Azure 中国区，需要单击“高级...”，然后用 "https://management.core.chinacloudapi.cn" 替换 "https://management.core.windows.net"。
...
## <a name="set-up-a-virtual-machine-template-for-the-azure-slave-plug-in"></a>为 Azure Slave 插件设置虚拟机模板
...
5. 在“名称”  字段中指定一个云服务名称。 如果指定的名称引用一个现有的云服务，则会在该服务中设置 VM。 否则，Azure 会创建一个新服务。
