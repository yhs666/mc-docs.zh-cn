...
description: "了解如何使用 Azure 门户预览版和 Resource Manager 部署模型连接并登录到 Windows VM。"
...
可以从 Windows 桌面使用 Azure 门户预览版中的“连接”按钮来启动远程桌面 (RDP) 会话。 首先连接到虚拟机，然后登录。
...
1. 登录到 [Azure 门户预览版](https://portal.azure.cn/)（如果未登录）。
2. 在“中心”菜单中，单击“虚拟机” 。
3. 从列表中选择虚拟机。
4. 在虚拟机边栏选项卡上，单击“连接”。

    ![显示如何连接到 VM 的 Azure 门户预览版屏幕截图。](./media/virtual-machines-windows-connect-logon/connect.png)
