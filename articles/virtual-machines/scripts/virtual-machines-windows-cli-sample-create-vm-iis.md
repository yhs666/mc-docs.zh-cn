...
ms.date: 04/17/2017
ms.author: v-dazen
ms.openlocfilehash: 3a50bdb6920ce9c08a96d70a28e30895d85a6316
...
| [az vm open-port](https://docs.microsoft.com/cli/azure/network/nsg/rule#create) | 创建网络安全组规则，以允许入站流量。 在此示例中，为 HTTP 流量打开端口 80。 |
