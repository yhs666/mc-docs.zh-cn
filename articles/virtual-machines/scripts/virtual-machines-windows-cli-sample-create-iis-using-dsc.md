...
ms.author: v-yeche
ms.custom: mvc
ms.openlocfilehash: 1be207d3e740e6643b4ab2d3a2e7392153d786f4
ms.sourcegitcommit: dd6cee8483c02c18fd46417d5d3bcc2cfdaf7db4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/22/2019
ms.locfileid: "56666324"
---
...
| [az vm extension set](https://docs.azure.cn/zh-cn/cli/vm?view=azure-cli-latest#az-vm-extension-set) | 将自定义脚本扩展添加到虚拟机，此扩展将调用脚本来安装 IIS。 |
