...
ms.date: 08/28/2017
ms.author: v-haiqya
ms.openlocfilehash: 59c4682e2325c81fb7167ad653d47bf14eeda599
...
| [az storage blob copy start](https://docs.microsoft.com/cli/azure/storage/blob/copy#start) | 以异步方式将 blob 从一个存储帐户复制到另一个存储帐户 |
