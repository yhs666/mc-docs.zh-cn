...
ms.author: v-yeche
ms.custom: mvc
ms.openlocfilehash: ada7b217d6d9a2e7648f6d93a687809ce741a030
...
有关 Azure CLI 的详细信息，请参阅 [Azure CLI 文档](https://docs.microsoft.com/cli/azure/overview?view=azure-cli-latest)。
