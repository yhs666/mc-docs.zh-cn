...
* 也可以[使用 PowerShell 创建 Windows VM](./virtual-machines-windows-quick-create-powershell.md) 或[使用 Azure CLI 创建 Linux 虚拟机](./virtual-machines-linux-quick-create-cli.md)。
