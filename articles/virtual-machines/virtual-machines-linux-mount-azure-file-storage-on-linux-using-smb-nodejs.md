...
* [安全外壳 (SSH) 公钥和私钥文件](virtual-machines-linux-mac-create-ssh-keys.md)
...
若要快速完成任务，请按照本部分的步骤执行操作。 如下更多详细信息和上下文，请从[“详细演练”](virtual-machines-linux-mount-azure-file-storage-on-linux-using-smb.md#detailed-walkthrough)部分开始。
