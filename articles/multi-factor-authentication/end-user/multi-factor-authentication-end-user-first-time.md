...
ms.author: v-junlch
ms.custom: end-user
ms.openlocfilehash: af914e967a180956a80894d761a666e5c80bf012
...
本文可帮助你设置工作或学校帐户。 如果想为自己的个人 Microsoft 帐户启用双重验证，请参阅 [关于双重验证](https://support.microsoft.com/help/12408/microsoft-account-about-two-step-verification)。
