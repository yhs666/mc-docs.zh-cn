...
ms.author: v-junlch
ms.custom: end-user
ms.openlocfilehash: 26219dfe07c359f3726a8b83d4c1e19093702461
...
---
# 将我的帐户设置为使用双重验证
<a id="set-up-my-account-for-two-step-verification" class="xliff"></a>
...
## 设置帐户
<a id="set-up-your-account" class="xliff"></a>

当 IT 部门要求开始使用双重验证时，屏幕上会显示“管理员要求设置此帐户以进行附加的安全性验证”：
...
## 确定验证登录的方式
<a id="decide-how-you-want-to-verify-your-sign-ins" class="xliff"></a>
...
## 使用移动应用作为联系方法
<a id="use-a-mobile-app-as-the-contact-method" class="xliff"></a>
...
## 使用移动电话作为联系方法
<a id="use-your-mobile-phone-as-the-contact-method" class="xliff"></a>
1. 从下拉列表中选择“身份验证电话”  。  
...
## 使用办公电话作为联系方法
<a id="use-your-office-phone-as-the-contact-method" class="xliff"></a>
1. 从下拉列表中选择“办公电话”   
