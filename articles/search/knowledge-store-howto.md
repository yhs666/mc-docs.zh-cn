...
ms.date: 09/26/2019
ms.author: v-tawe
ms.openlocfilehash: a84c24bfdf3cc8b2419c3827b702608040f6d6c7
ms.sourcegitcommit: a5a43ed8b9ab870f30b94ab613663af5f24ae6e1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/30/2019
ms.locfileid: "71674407"
---
...
+ [创建一个 Azure 存储帐户](https://docs.azure.cn/storage/common/storage-quickstart-create-account)用于存储示例数据和知识存储。 知识存储位于 Azure 存储中。 

+ 在 S0 即用即付层[创建认知服务资源](https://docs.azure.cn/cognitive-services/cognitive-services-apis-create-account)，用于广泛访问 AI 扩充中使用的一整套技能。 认知服务和 Azure 搜索服务需位于同一区域。
...
1. [创建一个 Blob 容器](https://docs.azure.cn/storage/blobs/storage-quickstart-blobs-portal)用于包含示例数据： 
...
导入首个文档后，可立即开始浏览。 对于此任务，请使用门户中的[存储资源管理器  ](https://docs.azure.cn/storage/blobs/storage-quickstart-blobs-storage-explorer)。
