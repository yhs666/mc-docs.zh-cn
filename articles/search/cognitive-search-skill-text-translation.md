---
title: 文本翻译认知搜索技能 - Azure 搜索
description: 对文本进行评估，并针对每个记录返回 Azure 搜索扩充管道中的已翻译为指定目标语言的文本。
services: search
manager: nitinme
author: careyjmac
ms.service: search
...
ms.openlocfilehash: af545e758dbab88e5bf0198a1a4ec10044a255c4
ms.sourcegitcommit: a5a43ed8b9ab870f30b94ab613663af5f24ae6e1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/30/2019
ms.locfileid: "71674470"
---
...
[文本翻译 API v3.0](https://docs.azure.cn/cognitive-services/translator/reference/v3-0-reference) 是一项非区域性认知服务，这意味着，我们不保证你的数据与 Azure 搜索或附加的认知服务资源位于同一区域。
...
>
> 当你行使内置技能时，我们会按现有的[认知服务预付费价格](https://www.azure.cn/pricing/details/cognitive-services/)收费。 图像提取定价如 [Azure 搜索定价页](https://www.azure.cn/pricing/details/search/)所述。
