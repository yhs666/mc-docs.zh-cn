...
使用任一工具都需要选择一个命令（GET、POST、PUT 等）并提供 URL 终结点；对于某些任务，需要在请求正文中提供 JSON。 将搜索服务名称 (YOUR-SEARCH-SERVICE-NAME) 替换为一个有效值。 
    ...
    https://<YOUR-SEARCH-SERVICE-NAME>.search.chinacloudapi.cn/indexes?api-version=2019-05-06
...
2. 复制此 URL `https://<YOUR-SEARCH-SERVICE-NAME>.search.chinacloudapi.cn/indexes/hotel?api-version=2019-05-06`。
...
2. 复制此 URL `https://<YOUR-SEARCH-SERVICE-NAME>.search.chinacloudapi.cn/indexes/hotels/docs/index?api-version=2019-05-06`。
...
2. 复制此 URL `https://<YOUR-SEARCH-SERVICE-NAME>.search.chinacloudapi.cn/indexes/hotels/docs?search=motel&$count=true&api-version=2019-05-06`。
...
还可以查询系统信息，获取文档计数和存储使用量：`https://<YOUR-SEARCH-SERVICE-NAME>.search.chinacloudapi.cn/indexes/hotels/stats?api-version=2019-05-06`
...
对于目标，请复制以下 URL 的修改版本：`https://<YOUR-SEARCH-SERVICE-NAME>.search.chinacloudapi.cn/indexes?api-version=2019-05-06`
...
将谓词更改为“PUT”。  复制此 URL 的修改版本：`https://<YOUR-SEARCH-SERVICE-NAME>.search.chinacloudapi.cn/indexes/hotel?api-version=2019-05-06`。 将上面提供的索引定义复制到请求正文。 页面应类似于以下屏幕截图。 单击右上角的“执行”发送已完成的请求。 
