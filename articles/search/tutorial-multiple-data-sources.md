...
ms.date: 09/26/2019
ms.author: v-tawe
ms.openlocfilehash: 16460d0436e8fa1e2b5175884f8b633b9c9634eb
ms.sourcegitcommit: a5a43ed8b9ab870f30b94ab613663af5f24ae6e1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/30/2019
ms.locfileid: "71674457"
---
...
- [创建一个 Cosmos DB 帐户](https://docs.azure.cn/storage/common/storage-quickstart-create-account)，用于存储示例酒店数据。
...
前两个条目使用 Azure 搜索服务的 URL 和管理密钥。 如果终结点为 `https://mydemo.search.chinacloudapi.cn`（例如），则要提供的服务名称为 `mydemo`。
