...
ms.openlocfilehash: e286ce0760ce9c9b5a565d46fee62102af3e6a0c
ms.sourcegitcommit: bf4afcef846cc82005f06e6dfe8dd3b00f9d49f3
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/22/2019
ms.locfileid: "66004895"
---
...
[创建一个 Azure 存储帐户](https://docs.azure.cn/zh-cn/storage/common/storage-quickstart-create-account)，用于存储示例数据。
...
1. [创建一个 Blob 容器](https://docs.azure.cn/zh-cn/storage/blobs/storage-quickstart-blobs-portal)用于包含示例数据。 可将“公共访问级别”设为任何有效值。
...
```http
PUT https://[servicename].search.chinacloudapi.cn/skillsets/demoskillset?api-version=2019-05-06
api-key: [admin key]
Content-Type: application/json
```
#### <a name="request-body-syntax"></a>请求正文语法
...
```http
PUT https://[servicename].search.chinacloudapi.cn/indexes/demoindex?api-version=2019-05-06
api-key: [api-key]
Content-Type: application/json
```
#### <a name="request-body-syntax"></a>请求正文语法
...
```http
PUT https://[servicename].search.chinacloudapi.cn/indexers/demoindexer?api-version=2019-05-06
api-key: [api-key]
Content-Type: application/json
```
#### <a name="request-body-syntax"></a>请求正文语法
...
```http
GET https://[servicename].search.chinacloudapi.cn/indexers/demoindexer/status?api-version=2019-05-06
api-key: [api-key]
Content-Type: application/json
```
...
```http
GET https://[servicename].search.chinacloudapi.cn/indexes/demoindex?api-version=2019-05-06
api-key: [api-key]
Content-Type: application/json
```
...
```http
GET https://[servicename].search.chinacloudapi.cn/indexes/demoindex/docs?search=*&$select=organizations&api-version=2019-05-06
api-key: [api-key]
Content-Type: application/json
```
...
```http
DELETE https://[servicename].search.chinacloudapi.cn/skillsets/demoskillset?api-version=2019-05-06
api-key: [api-key]
Content-Type: application/json
```
