...
ms.date: 06/03/2019
ms.author: v-biyu
ms.openlocfilehash: f2533b1d849f5a9373e072b7cb1e4033c2be2ab3
ms.sourcegitcommit: bf4afcef846cc82005f06e6dfe8dd3b00f9d49f3
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/22/2019
ms.locfileid: "66004883"
---
...
投影是构建数据结构以供用于下游应用的机制。 可以使用专为 Azure 存储打造的[存储资源管理器](https://docs.azure.cn/zh-cn/vs-azure-tools-storage-manage-with-storage-explorer?tabs=windows)，或连接到 Azure 存储的任何应用，这为使用扩充文档开辟了新的可能性。 一些示例包括，数据科学管道和自定义分析。
...
+ 优化 AI 索引管道，同时调试步骤和技能集定义。 知识存储展示 AI 索引管道中的技能集定义的结果。 这些结果可用于设计更好的技能集，因为你可以清楚地看到扩充是什么样的。 可以使用 Azure 存储中的[存储资源管理器](https://docs.azure.cn/zh-cn/vs-azure-tools-storage-manage-with-storage-explorer?tabs=windows)来查看知识存储的内容。
...
+ [存储资源管理器](https://docs.azure.cn/zh-cn/vs-azure-tools-storage-manage-with-storage-explorer?tabs=windows)：用于查看扩充文档的结构和内容。 将这视为用于查看知识存储内容的基线工具。
...
**步骤 2：[创建 Azure 存储帐户](https://docs.azure.cn/zh-cn/storage/common/storage-quickstart-create-account?tabs=azure-portal)** 
