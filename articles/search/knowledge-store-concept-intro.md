...
ms.date: 09/26/2019
ms.author: v-tawe
ms.openlocfilehash: 8edd4225d541eaee2dfb0627e625a85eb6968aed
ms.sourcegitcommit: a5a43ed8b9ab870f30b94ab613663af5f24ae6e1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/30/2019
ms.locfileid: "71674366"
---
...
投影是用于在知识存储中构造数据的机制。 例如，通过投影，可以选择是将输出保存为单个 blob 还是相关表的集合。 查看知识存储内容的一种简单方法是通过 Azure 存储的内置[存储资源管理器](https://docs.azure.cn/vs-azure-tools-storage-manage-with-storage-explorer?tabs=windows)。
...
```json
{
  ...
  "cognitiveServices": 
    ...
    "description": "mycogsvcs resource in China East 2",
...
+ [存储资源管理器](https://docs.azure.cn/vs-azure-tools-storage-manage-with-storage-explorer?tabs=windows)：用于查看扩充文档的结构和内容。 将这视为用于查看知识存储内容的基线工具。
...
**步骤 2：[创建 Azure 存储帐户](https://docs.azure.cn/storage/common/storage-quickstart-create-account?tabs=azure-portal)** 

**步骤 3：[创建认知服务资源](https://docs.azure.cn/cognitive-services/cognitive-services-apis-create-account)** 
