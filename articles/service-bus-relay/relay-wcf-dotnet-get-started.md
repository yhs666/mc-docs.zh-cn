...
ms.date: 10/16/2017
ms.author: v-yiso
ms.openlocfilehash: 5a1da4adce64ced5eb805bf022651f3d23c20abf
...
在此任务中，将构建一个简单的 WCF 服务并向其添加中继侦听程序。 此练习假定你熟悉 Visual Studio，因此不演练创建项目的所有详细信息， 而是侧重于代码。
...
现在可以生成客户端和服务，运行它们（首先运行服务），客户端调用该服务并输出 **9**。 可以在不同计算机上，甚至跨网络运行客户端和服务器，通信仍将进行。 客户端代码还可以在云中或在本地运行。
