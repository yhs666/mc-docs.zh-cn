...
ms.date: 03/23/2017
ms.author: v-yiso
ms.openlocfilehash: 210dc1038b3630db82a2c4bf4915341c747233d1
...
Azure 中继是 Azure 服务总线平台最重要的功能支柱之一。 该中继的新“混合连接”功能是在 HTTP 和 WebSocket 基础上的一个安全开放协议的演化版。 它取代了之前基于专用协议构建的名为“BizTalk 服务”的功能。 将混合连接集成到 Azure 应用服务并不影响原有的运行方式。
