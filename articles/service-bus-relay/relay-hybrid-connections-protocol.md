...
ms.author: v-yiso
ms.date: 08/21/2017
ms.openlocfilehash: 4b04154d9b5b96028bc6dc034fad2b94b8658004
...
## 交互模型
混合连接中继通过提供双方都可在自身网络发现并连接到的 Azure 云中的集合点来连接两方。 该集合点就是在本文和其他文档、API 及 Azure 门户中提及的“混合连接”。 混合连接服务终结点在本文其余部分被称为“服务”。 该交互模型倾向于使用由许多其他网络服务 API 创建的术语：
...
服务接受 WebSocket 后，注册完成并且建立的 WebSocket 作为“控制通道”保持活动状态，以支持所有后续交互。 在一个混合连接上服务最多可允许 25 个并行侦听器。 如果有两个或更多活动的侦听器，则会传入连接以随机顺序均衡分布在这些侦听器上，但不保证平均分配。
