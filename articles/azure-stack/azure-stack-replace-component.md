...
ms.date: 03/02/2018
ms.author: v-junlch
ms.openlocfilehash: cab43cc4dbe7df82ac14e399e507676aa62cd7f2
ms.sourcegitcommit: 9b5cc262f13a0fc9e0fd9495e3fbb6f394ba1812
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/08/2018
ms.locfileid: "29798135"
---
# <a name="replace-a-hardware-component-on-an-azure-stack-scale-unit-node"></a>更换 Azure Stack 缩放单位节点上的硬件组件
...
2. 缩放单位节点处于维护模式后，请使用[关闭电源](azure-stack-node-actions.md#scale-unit-node-actions)操作。 根据硬件的物理条件，可能不需要此操作。
...
5. 使用[修复](azure-stack-node-actions.md#scale-unit-node-actions)操作将缩放单位节点恢复到缩放单位。
...
- 有关更换物理节点的信息，请参阅[更换缩放单位节点](azure-stack-replace-node.md)。
