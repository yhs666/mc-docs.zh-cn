---
title: 按照 SQL Server 最佳做法提高 Azure Stack 虚拟机的性能 | Microsoft Docs
...
本文提供的 SQL Server 最佳做法可优化 Azure Stack 虚拟机中的 SQL Server 并提高性能。 在 Azure Stack 虚拟机中运行 SQL Server 时，请使用适用于本地服务器环境中的 SQL Server 的相同数据库性能优化选项。 关系数据库在 Azure Stack 云中的性能取决于许多因素， 其中包括虚拟机的系列大小和数据磁盘的配置。
