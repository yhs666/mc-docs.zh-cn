...
ms.openlocfilehash: adebe108723c33f3c90cbfba9153f2b5b087940f
...
1.  **com.microsoft.azure.profile\_2018\_03\_01\_hybrid**：为 Azure Stack 生成的最新配置文件。 请将此配置文件用于与 Azure Stack 最兼容的服务，前提是使用 1808 或更高的戳记。
