...
ms.author: v-jay
ms.reviewer: waltero
ms.openlocfilehash: 9b9ad9163d7a2219bdbe8098b4c28908059a083f
ms.sourcegitcommit: 98142af6eb83f036d72e26ebcea00e2fceb673af
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/14/2018
ms.locfileid: "53396162"
---
...
3.  查看 VM 创建文件。 可能遇到了以下问题：  
    ...
    - 确保 VM 的完全限定的域名 (FDQN) 以重复的前缀开头。
4.  如果 VM **正常**，请评估 DVM。 如果 DVM 有一条错误消息：

    - 公钥可能无效。 查看创建的密钥。  
    - 需要与 Azure Stack 管理员联系，以使用特权终结点检索 Azure Stack 的日志。 有关详细信息，请参阅 [Azure Stack 诊断工具](/azure-stack/azure-stack-diagnostics)。
5. 如果对部署有疑问，可以在 [Azure Stack 论坛](https://social.msdn.microsoft.com/Forums/zh-CN/home)中提问，或查看是否已经有人回答了该问题。 
