...
ms.author: v-jay
ms.reviewer: ''
ms.openlocfilehash: cb917bac53af6db95e0eef07d4435abb0e3becd8
ms.sourcegitcommit: 98142af6eb83f036d72e26ebcea00e2fceb673af
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/14/2018
ms.locfileid: "53396234"
---
...
Azure Stack 快速入门模板存储在 GitHub 上的[公共 Azure Stack 快速入门模板存储库](https://github.com/Azure/AzureStack-QuickStart-Templates)中。 此存储库包含的 Azure 资源管理器部署模板已经使用 Azure Stack 开发工具包 (ASDK) 测试过。 可以通过这些模板更轻松地评估 Azure Stack 并使用 ASDK 环境。 
