...
ms.date: 03/09/2018
ms.author: v-junlch
ms.openlocfilehash: 17a6cb8cd1f130ed0640554386ed71a72a1db8c4
...
|大小 - 大小\名称 |vCPU     |内存 | 最大临时磁盘大小 | 最大 OS 磁盘吞吐量：(IOPS) | 最大临时存储吞吐量 (IOPS) | 最大数据磁盘吞吐量 (IOPS) |
|-----------------|-----|---------|---------|-----|------|-----------|
...
|----------------|--|------|----|----|----|-------|---------|
|**Standard_A0** |1 |0.768 |20 个  |500 |500 |1x500  |2 / 100  |
