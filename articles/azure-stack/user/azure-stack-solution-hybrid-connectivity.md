...
ms.openlocfilehash: ec3063b1912a5d06feab9b9ed38199e2c41117b3
ms.sourcegitcommit: 8a17603589d38b4ae6254bb9fc125d668442ea1b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/27/2018
ms.locfileid: "37027194"
---
...
本教程中的示例使用以下值。 可使用这些值创建测试环境，或根据这些值来更好地理解示例。 有关通用 VPN 网关设置的详细信息，请参阅[关于 VPN 网关设置](/vpn-gateway/vpn-gateway-about-vpn-gateway-settings)。
...
请执行以下步骤，以便通过门户创建虚拟网络。 如果将本文用作教程，则可使用这些[示例值](/vpn-gateway/vpn-gateway-howto-site-to-site-resource-manager-portal#values)。 但是，如果根据本文来配置生产型环境，请将示例设置替换为你自己的值。
...
1. 使用浏览器连接到 [Azure 门户](http://portal.azure.cn/)并使用 Azure 帐户登录。
