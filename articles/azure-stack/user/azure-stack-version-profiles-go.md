---
title: 在 Azure Stack 中将 API 版本配置文件与 GO 配合使用 | Azure
...
ms.author: v-junlch
ms.reviewer: sijuman
ms.openlocfilehash: 980b3090f8d33edd497d2a08d2f4bcba10c80a96
ms.sourcegitcommit: d75065296d301f0851f93d6175a508bdd9fd7afc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52657455"
---
...
在 Azure Stack 上运行 Go 代码的示例：
  ...
  3. 如果不可用，请创建订阅，并保存订阅 ID 供稍后使用。 有关创建订阅的信息，请参阅[在 Azure Stack 中创建套餐的订阅](/azure-stack/azure-stack-subscribe-plan-provision-vm)。 
