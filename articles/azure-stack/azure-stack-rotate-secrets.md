...
## <a name="pre-steps-for-secret-rotation"></a>机密轮换前的步骤
   ...
   > 必须通过[特权终结点](/azure-stack/azure-stack-privileged-endpoint)执行机密轮换，且需要有 Azure Stack 操作员凭据。
...
1. 在前期步骤中新建的 **\Certificates\\\<标识提供者>** 目录内，根据 [Azure Stack PKI 证书要求](/azure-stack/azure-stack-pki-certs#mandatory-certificates)的“必需证书”部分中所述的格式，将新的替换外部证书集放入目录结构。
