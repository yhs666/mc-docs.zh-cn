...
ms.date: 12/31/2018
ms.author: v-jay
ms.openlocfilehash: 8ae80f282320ebb55ad7c7648646cecd5adce962
ms.sourcegitcommit: 7423174d7ae73e8e0394740b765d492735349aca
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/29/2018
ms.locfileid: "53814624"
---
...
在为 Azure Stack 创建和配置 VPN 网关之前，请查看 [Azure Stack 网络的注意事项](user/azure-stack-network-differences.md)，以了解 Azure Stack 的配置与 Azure 的不同之处。
...
站点到站点 (S2S) VPN 网关连接是通过 IPsec/IKE（IKEv1 或 IKEv2）VPN 隧道建立的连接。 此类连接需要一个位于本地的 VPN 设备，并需要为此类连接分配公共 IP 地址。 此设备不能位于 NAT 的后面。 S2S 连接可用于跨界和混合配置。
