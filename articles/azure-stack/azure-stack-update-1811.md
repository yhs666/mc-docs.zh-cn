...
ms.openlocfilehash: a7e33967047bb6aae6e65dc87720eee85bd74988
...
- 在开始安装此更新之前，请使用以下参数运行 [Test-AzureStack](azure-stack-diagnostic-test.md)，以验证 Azure Stack 的状态并解决发现的所有操作问题，包括所有警告和故障。 另外，请查看活动警报，并解决所有需要采取措施的警报。  
    ...
    https://docs.azure.cn/azure-stack/azure-stack-extension-host-prepare`
...
- Azure Stack 1811 更新要求将必需的扩展主机证书正确导入 Azure Stack 环境。 若要继续安装 1811 更新，必须导入扩展主机所需的 SSL 证书。 若要导入证书，请参阅[此部分](azure-stack-extension-host-prepare.md#import-extension-host-certificates)。
    ...
    Extension Host: https://docs.azure.cn/azure-stack/azure-stack-extension-host-prepare,
...
- 通过 System Center Operations Manager (SCOM) 管理 Azure Stack 时，请务必在应用 1811 之前将适用于 Azure Stack 的管理包更新到版本 1.0.3.11。
