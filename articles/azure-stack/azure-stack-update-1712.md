...
ms.date: 03/04/2018
ms.author: v-junlch
ms.openlocfilehash: ecdd7f0f3441658a813ef7dc703127687dd89bd6
...
> [!IMPORTANT]
> 在安装 1712 更新过程中，请勿尝试创建虚拟机。 有关详细信息，请参阅[有关在 Azure Stack 中管理更新的概述](/azure-stack/azure-stack-updates#plan-for-updates)。

### <a name="prerequisites"></a>先决条件

在应用此更新之前，必须先安装 Azure Stack [1711 更新](/azure-stack/azure-stack-update-1711)。
