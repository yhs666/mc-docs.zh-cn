...
ms.author: v-junlch
ms.reviewer: wfayed
ms.openlocfilehash: 6e5ad82a8f733499770a1f014f394f1418a5eccb
...
1. 若要使用 PowerShell，请确保已针对 Azure Stack 操作员环境[安装并配置 PowerShell](azure-stack-powershell-configure-quickstart.md)。 在可以访问资源管理器（管理员）终结点的本地计算机上安装 PowerShell (https://adminmanagement.[region].[External_FQDN])。
