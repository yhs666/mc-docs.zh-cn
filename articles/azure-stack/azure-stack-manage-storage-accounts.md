...
ms.openlocfilehash: b365beca1850c4f9838112a75374ee9c5e5de4fe
...
5. 接下来，在存储资源提供程序管理员边栏选项卡中，向下滚动到“存储帐户”选项卡并单击它。
...
1. 单击边栏选项卡顶部的“筛选”。
2. 在“筛选”边栏选项卡上，可以指定“帐户名”、“订阅 ID”或“状态”，以调整要显示的存储帐户列表。 适当地使用筛选器。
3. 单击“更新”。 列表会相应地刷新。
   
    ![](./media/azure-stack-manage-storage-accounts/image5.png)
4. 若要重置筛选器，请单击“筛选”、清除选择内容，然后更新。

使用搜索文本框（位于存储帐户列表边栏选项卡的顶部）可以突出显示帐户列表中选择的文本。 如果无法轻松获取完整名称或 ID，使用搜索功能会很方便。
...
找到想要查看的帐户后，可以单击特定的帐户查看特定的详细信息。 此时将打开新的边栏选项卡，其中包含帐户详细信息，例如：帐户类型、创建时间、位置等等。
...
- 已删除的帐户显示“超出保留期”状态。
  ...
  这意味着，已删除的帐户超出了保留期，可能无法恢复。
- 已删除的帐户未显示在帐户列表中。
  
  这可能意味着，已删除的帐户已作为垃圾回收。 在此情况下，无法恢复该帐户。 请参阅本主题中的[回收容量](#reclaim)。
