...
ms.date: 05/24/2018
ms.author: v-junlch
ms.openlocfilehash: 99b57ec3894f27522cb1aa6dbe6d506df8774f28
ms.sourcegitcommit: 036cf9a41a8a55b6f778f927979faa7665f4f15b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/24/2018
ms.locfileid: "34475143"
---
...
- Azure Stack 不支持 cloud-init。 必须为 VM 配置支持的 Azure Linux 代理 (WALA) 版本。
...
现在，可以使用 Red Hat Enterprise Linux 虚拟硬盘在 Azure Stack 中创建新的虚拟机。 如果这是第一次将 .vhd 文件上传到 Azure Stack，请参阅[使用 Marketplace 工具包创建和发布 Marketplace 项](azure-stack-marketplace-publisher.md)。
