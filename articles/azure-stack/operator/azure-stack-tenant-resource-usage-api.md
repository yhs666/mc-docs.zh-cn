...
ms.openlocfilehash: b0af4959089686cb7789345e590848c964f0a925
ms.sourcegitcommit: 713bd1d1b476cec5ed3a9a5615cfdb126bc585f9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/18/2019
ms.locfileid: "72578433"
---
# <a name="tenant-resource-usage-api"></a>租户资源使用情况 API

租户可以使用租户 API 来查看租户自己的资源用量数据。 这些 API 与 Azure 使用情况 API 一致。

与在 Azure 中类似，可以使用 Windows PowerShell cmdlet [Get-UsageAggregates](https://docs.microsoft.com/powershell/module/azurerm.usageaggregates/get-usageaggregates) 获取用量数据。
