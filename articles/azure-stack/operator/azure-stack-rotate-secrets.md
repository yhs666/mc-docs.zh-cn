...
ms.openlocfilehash: bf1c36395a6fdfffd33894fd8ef9de256993bbe8
ms.sourcegitcommit: 7dfb76297ac195e57bd8d444df89c0877888fdb8
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/13/2019
ms.locfileid: "74020282"
---
...
## <a name="overview-to-rotate-secrets"></a>轮换机密概述
...
4. 可以找到有关[机密轮换前的步骤](#pre-steps-for-secret-rotation)的更多信息。
5. [验证 Azure Stack PKI 证书](/azure-stack/operator/azure-stack-validate-pki-certs)。 请确保密码中没有特殊字符，例如 `*` 或 `)`。
6. 请确保 PFX 加密为 **TripleDES-SHA1**。 如果遇到问题，请参阅[修正 Azure Stack PKI 证书的常见问题](/azure-stack/operator/azure-stack-remediate-certs#pfx-encryption)。
...
>[!NOTE]
> OEM 可能提供附加的管理应用程序。 更新其他管理应用程序的用户名或密码不会影响 BMC 用户名或密码。   
