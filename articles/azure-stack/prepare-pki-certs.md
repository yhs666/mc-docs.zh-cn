...
ms.author: v-junlch
ms.reviewer: ppacent
ms.openlocfilehash: e9dc3999b16764f3503043f62f07eeb4d3aa985f
...
2. 将证书导入到本地计算机证书存储：
    ...
    d.单击“验证存储凭据”以验证存储帐户。  在“私钥保护”页上，输入证书文件的密码，然后启用“将此密钥标记为可导出。这可让你在稍后备份或传输密钥”选项。 选择“**下一步**”。

    ![将密钥标记为可导出](./media/prepare-pki-certs/2.png)

    e.在“新建 MySQL 数据库”边栏选项卡中，接受法律条款，并单击“确定”。  选择“将所有证书放在以下存储中”，然后选择“企业信任”作为位置。 单击“确定”以关闭“证书存储选择”对话框，然后单击“下一步”。

    ![配置证书存储](./media/prepare-pki-certs/3.png)

    f.单击“保存”以保存设置。  单击“完成”以完成证书导入向导。
...
3. 按照 Azure Stack 的需求将证书导出为 PFX 文件格式：
    ...
    d.单击“验证存储凭据”以验证存储帐户。  从证书管理员控制台的任务栏中，选择“操作” > “所有任务” > “导出”。

    e.在“新建 MySQL 数据库”边栏选项卡中，接受法律条款，并单击“确定”。  选择“**下一步**”。

    f.单击“保存”以保存设置。  选择“是，导出私钥”，并单击“下一步”。
