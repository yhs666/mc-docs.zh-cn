...
有关在 Azure 中创建虚拟网络的详细信息，请参阅[创建包含多个子网的虚拟网络](../virtual-network/virtual-networks-create-vnet-arm-pportal.md)。
...
1. 使用租户帐户登录到 Microsoft Azure Stack 用户门户。
