...
ms.openlocfilehash: bdab242725b5f166f04e69f58b34175e367b11ae
...
- 两台符合 [Azure Stack 部署先决条件](azure-stack-deploy.md)所定义的 Azure Stack 开发工具包硬件要求的服务器。 此外，请确保符合[此文](azure-stack-deploy.md)中提到的其他先决条件。
