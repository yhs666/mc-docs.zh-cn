...
ms.openlocfilehash: 90658cb1a85b38621d8081afbcd69308e4a3f9df
...
> [!IMPORTANT]
> 在开始执行这些步骤之前，必须已将 Ubuntu VM 映像（在此示例中为 Ubuntu Server 16.04 LTS）[添加到 Azure Stack Marketplace](asdk-marketplace-item.md)。
...
> [了解高级评估任务](asdk-advanced-eval.md)
