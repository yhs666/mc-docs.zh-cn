...
ms.openlocfilehash: 9b0238cf9eae92e9f4706ed650b73911fffbd415
ms.sourcegitcommit: c82fb6f03079951442365db033227b07c55700ea
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/20/2018
ms.locfileid: "39168501"
---
...
3. 在标识提供者的“类型”下拉框中，选择“Azure 云”或“AD FS”。 在“本地管理员密码”下的“密码”框中，键入本地管理员密码（必须与当前配置的本地管理员密码相符），然后单击“下一步”。
    - **Azure 云**：将 Azure Active Directory (Azure AD) 配置为标识提供者。 若要使用此选项，需要建立 Internet 连接，采用 *domainname*.partner.onmschina.cn 格式的 Azure AD 目录租户的完整名称或 Azure AD 验证的自定义域名，并指定目录的全局管理员凭据。 
