...
ms.openlocfilehash: 7a4ffcb8e736f497e879a9ae05bd61cf3e3fecd5
ms.sourcegitcommit: b8fb6890caed87831b28c82738d6cecfe50674fd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/29/2019
ms.locfileid: "58625117"
---
...
2. 从 PowerShell 提示符下，运行以下命令将 *$serviceAdminCredential* 设置为你的 Azure AD 租户的服务管理员。  将 <em>serviceadmin@contoso.partner.onmschina.cn</em> 替换为你的帐户和租户。 
    ```powershell
...
3. 从 PowerShell 提示符下，运行以下命令来启动对 Azure AD 的验证：
   ...
   - 为 **AzureEnvironment** 指定环境名称值。 环境名称参数支持的值是 AzureChinaCloud，具体取决于所使用的 Azure 订阅。  
   - 将 **contoso.partner.onmschina.cn** 替换为 Azure Active Directory 租户名称。
