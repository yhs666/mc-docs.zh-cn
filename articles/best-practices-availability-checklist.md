...
---
# 可用性核对清单
<a id="availability-checklist" class="xliff"></a>
...
## 部署和维护
<a id="deployment-and-maintenance" class="xliff"></a>
...
- **利用数据复制** 。 Azure 存储中的数据会自动复制，以防止基础结构故障时发生数据丢失，你可以配置这种复制的某些方面。 例如，可以在多个地理区域中复制数据的只读副本（称为全局读取访问冗余存储，简称 RA-GRS）。 请注意，使用 RA-GRS 会产生额外的费用。 有关详细信息，请参阅 [Azure Storage Pricing](https://www.azure.cn/pricing/details/storage/)（Azure 存储定价）。
...
## 错误和故障
<a id="errors-and-failures" class="xliff"></a>
...
## 监视和灾难恢复
<a id="monitoring-and-disaster-recovery" class="xliff"></a>
