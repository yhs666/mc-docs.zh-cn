...
ms.author: v-junlch
ms.subservice: B2C
ms.openlocfilehash: 7645e9103a428b88e727e1843225e2ba7c284335
ms.sourcegitcommit: 817faf4e8d15ca212a2f802593d92c4952516ef4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/24/2019
ms.locfileid: "72847057"
---
...
本文提供了有关在 Azure Active Directory B2C (Azure AD B2C) 中如何使用[自定义策略](active-directory-b2c-overview-custom.md)管理令牌、会话和单一登录 (SSO) 配置的信息。
