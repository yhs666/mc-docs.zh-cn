...
ms.author: v-junlch
ms.subservice: B2C
ms.openlocfilehash: 29924332dc1757147809b80a81a066cfc2acf698
ms.sourcegitcommit: 3b05a8982213653ee498806dc9d0eb8be7e70562
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/04/2019
ms.locfileid: "59004296"
---
...
9. 为 OAuth2.0“授权设置”(redirect URL) 输入 `https://your-tenant-name.b2clogin.com/your-tenant-name.partner.onmschina.cn/oauth2/authresp`。 例如，如果租户名称是 contoso，请将 URL 设置为 `https://contoso.b2clogin.com/contoso.partner.onmschina.cn/oauth2/authresp`。
10. 选择“提交”(submit)。  
