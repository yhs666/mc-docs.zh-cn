...
ms.author: v-junlch
ms.subservice: B2C
ms.openlocfilehash: 1dd2b4e7a45c5a98df459ea463488d71a7d12621
ms.sourcegitcommit: 3b05a8982213653ee498806dc9d0eb8be7e70562
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/04/2019
ms.locfileid: "59004335"
---
...
7. 在“授权回调域”(callback URL) 中输入 `https://your-tenant-name.b2clogin.com/your-tenant-name}.partner.onmschina.cn/oauth2/authresp`。 例如，如果 `tenant_name` 是 contoso，请将 URL 设置为 `https://contoso.b2clogin.com/contoso.partner.onmschina.cn/oauth2/authresp`。
