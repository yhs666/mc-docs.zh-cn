---
title: 令牌概述 - Azure Active Directory B2C | Microsoft Docs
...
ms.author: v-junlch
ms.subservice: B2C
ms.openlocfilehash: 49e88eb8a2c7e6014fcda6a41848bd6858789859
ms.sourcegitcommit: 26e99f63fe3c2ffbdcdcc17691199bbacabdd048
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/05/2019
ms.locfileid: "66687609"
---
...
- `https://{tenant}.b2clogin.com/{tenant}.partner.onmschina.cn/oauth2/v2.0/authorize`
- `https://{tenant}.b2clogin.com/{tenant}.partner.onmschina.cn/oauth2/v2.0/token`
...
| 身份验证时间 | `auth_time` | `1438535543` | 用户最后一次输入凭据的时间，以纪元时间表示。 |
...
```
https://contoso.b2clogin.com/contoso.partner.onmschina.cn/discovery/v2.0/keys?p=b2c_1_signupsignin1
```
...
```
https://contoso.b2clogin.com/contoso.partner.onmschina.cn/v2.0/.well-known/openid-configuration?p=b2c_1_signupsignin1
```
