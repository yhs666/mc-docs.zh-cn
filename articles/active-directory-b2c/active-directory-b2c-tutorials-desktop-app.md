...
ms.subservice: B2C
ms.openlocfilehash: dbd8a8033b895be483e1c4b8f386faf8f4a05fc5
ms.sourcegitcommit: 3b05a8982213653ee498806dc9d0eb8be7e70562
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/04/2019
ms.locfileid: "59004471"
---
...
> [教程：从桌面应用使用 Azure Active Directory B2C 授予对 Node.js Web API 的访问权限](active-directory-b2c-tutorials-spa-webapi.md)
