...
3. 按照步骤注册新应用程序。
4. 在“授权回调域”  (callback URL) 中输入 `https://your-tenant_name.b2clogin.cn/your-tenant-name.partner.onmschina.cn/oauth2/authresp`。 例如，如果租户名称是 contoso，请将 URL 设置为 `https://contoso.b2clogin.cn/contoso.partner.onmschina.cn/oauth2/authresp`。
