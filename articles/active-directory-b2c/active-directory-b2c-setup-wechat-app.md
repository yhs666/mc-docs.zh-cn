...
ms.author: v-junlch
ms.subservice: B2C
ms.openlocfilehash: 8d92ff17dfa7682616a12fcd41072fe7659a6852
ms.sourcegitcommit: 3b05a8982213653ee498806dc9d0eb8be7e70562
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/04/2019
ms.locfileid: "59004345"
---
...
3. 按照步骤注册新应用程序。
4. 在“授权回调域”(callback URL) 中输入 `https://your-tenant_name.b2clogin.com/your-tenant-name.partner.onmschina.cn/oauth2/authresp`。 例如，如果租户名称是 contoso，请将 URL 设置为 `https://contoso.b2clogin.com/contoso.partner.onmschina.cn/oauth2/authresp`。
