...
ms.author: v-junlch
ms.subservice: B2C
ms.openlocfilehash: f93cf3008fbe466460b02a94cefbab6fd4ac3119
ms.sourcegitcommit: 3b05a8982213653ee498806dc9d0eb8be7e70562
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/04/2019
ms.locfileid: "59004469"
---
...
“Protocol”元素的“Name”属性必须设置为 `Proprietary`。 “handler”属性必须包含 Azure AD B2C 用来自断言的协议处理程序程序集的完全限定名称：
...
| 属性 | 必须 | 说明 |
| --------- | -------- | ----------- |
| setting.showContinueButton | 否 | 显示“继续”按钮。 可能的值：`true`（默认值）或 `false` |
| setting.showCancelButton | 否 | 显示“取消”按钮。 可能的值：`true`（默认值）或 `false` |
...
| setting.showSignupLink | 否 | 显示“注册”按钮。 可能的值：`true`（默认值）或 `false` |
