...
ms.author: v-junlch
ms.subservice: B2C
ms.openlocfilehash: 3708c19483c7f9373aa5f776d9a0b8c7a2e89f18
ms.sourcegitcommit: 5fc46672ae90b6598130069f10efeeb634e9a5af
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/19/2019
ms.locfileid: "67236426"
---
...
不可以，Azure AD Connect 不是为与 Azure AD B2C 一起使用而设计的。 请考虑使用 [Azure AD 图形 API](active-directory-b2c-devquickstarts-graph-dotnet.md) 进行用户迁移。 
