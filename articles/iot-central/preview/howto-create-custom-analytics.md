...
ms.custom: mvc
manager: philmea
ms.openlocfilehash: 579679da7bc6be8d1a04389990638989cd53d615
ms.sourcegitcommit: 6ffa4d50cee80c7c0944e215ca917a248f2a4bcd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/06/2019
ms.locfileid: "74883037"
---
# <a name="extend-azure-iot-central-with-custom-analytics-using-azure-databricks-preview-features"></a>使用 Azure Databricks 通过自定义分析扩展 Azure IoT Central（预览版功能）
...
使用 [Azure 门户](https://portal.azure.cn/#create/Microsoft.ResourceGroup)创建名为 **IoTCentralAnalysis** 的资源组，用于包含创建的其他资源。 在 IoT Central 应用程序所在的同一位置创建 Azure 资源。
...
在 [Azure 门户中使用以下设置创建一个 Azure Databricks 服务](https://portal.azure.cn/#create/Microsoft.Databricks)：
...
了解如何创建自定义分析后，建议接下来了解如何在 Power BI 仪表板中[可视化和分析 Azure IoT Central 数据](../core/howto-connect-powerbi.md?toc=/azure/iot-central/preview/toc.json&bc=/azure/iot-central/preview/breadcrumb/toc.json)。
