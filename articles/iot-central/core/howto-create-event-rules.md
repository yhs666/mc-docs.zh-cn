...
manager: peterpr
ms.openlocfilehash: 13232d37975c89d173d38a7ad4daa54f84aa9b2e
ms.sourcegitcommit: 6ffa4d50cee80c7c0944e215ca917a248f2a4bcd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/06/2019
ms.locfileid: "74883203"
---
...
1. 在“规则”选项卡上，选择“+ 新建规则”可以查看能够创建的规则类型。  
...
1. 若要立即为从此模板创建的所有设备启用规则，请切换到“为此模板的所有设备启用规则”  。
...
1. 或者，还可将“计数”设为“聚合”，并提供相应阈值   。
   ...
   - 如无聚合，此规则对每个满足此条件的事件数据点均会触发。 例如，如果将规则的条件配置为在发生**风扇电机错误**事件时触发，则当设备报告该事件时，该规则几乎立即触发。
   - 如果“计数”用作聚合函数，则必须提供“阈值”和“聚合时间段”（此期间内需评估条件）   。 在这种情况下，事件计数会聚合，且此规则仅在聚合事件计数匹配阈值时触发。
     ...
     >[!NOTE]
     >“条件”下可添加多个事件度量  。 如果指定多个条件，必须满足所有条件才能触发该规则。 每个条件都通过“AND”子句隐式联接。 使用聚合时，必须聚合每个度量。
...
- [将多个操作分组以从一个或多个规则运行](howto-use-action-groups.md)
