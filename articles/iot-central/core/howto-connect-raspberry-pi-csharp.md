...
description: 如何使用 C# 以设备开发人员身份将 Raspberry Pi 连接到 Azure IoT Central 应用程序。
author: viv-liu
ms.author: v-yiso
...
manager: peterpr
ms.openlocfilehash: 467715f05a03354a9ee2534206430938ff965c2c
ms.sourcegitcommit: 6ffa4d50cee80c7c0944e215ca917a248f2a4bcd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/06/2019
ms.locfileid: "74883024"
---
...
在 Azure IoT Central 应用程序中，从 **Raspberry Pi** 设备模板添加真实设备。 记下设备连接详细信息（**作用域 ID**、**设备 ID** 和**主密钥**）。 有关详细信息，请参阅[将真实设备添加到 Azure IoT Central 应用程序](tutorial-add-device.md)。
...
1. 打开 **Program.cs**，将内容替换为以下代码。 将 `{your Scope ID}`、`{your Device ID}` 和 `{your Device Primary Key}` 更新为以前记下的值：
    ...
    namespace pisample
    {
      class Program
      {
        ...
        static string GlobalDeviceEndpoint = "global.azure-devices-provisioning.cn";
...
现在，你已了解如何将 Raspberry Pi 连接到 Azure IoT Central 应用程序，建议下一步是了解如何为自己的 IoT 设备[设置自定义设备模板](howto-set-up-template.md)。
