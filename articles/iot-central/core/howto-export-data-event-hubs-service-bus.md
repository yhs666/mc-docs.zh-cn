...
manager: peterpr
ms.openlocfilehash: 7c1184d8def74e6e9b6d02cee60fd266239d1611
ms.sourcegitcommit: 6ffa4d50cee80c7c0944e215ca917a248f2a4bcd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/06/2019
ms.locfileid: "74882986"
---
...
1. [在 Azure 门户中创建新的事件中心命名空间](https://ms.portal.azure.cn/#create/Microsoft.EventHub)。 可以在 [Azure 事件中心文档](/event-hubs/event-hubs-create)中进行详细的了解。
2. 选择订阅。 
...
1. [在 Azure 门户中创建新的服务总线命名空间](https://ms.portal.azure.cn/#create/Microsoft.ServiceBus.1.0.5)。 可以在 [Azure 服务总线文档](/service-bus-messaging/service-bus-create-namespace-portal)中进行详细的了解。
2. 选择订阅。 
...
现在已经有了要将数据导出到的事件中心/服务总线目标，请按照以下步骤设置连续数据导出。 
...
2. 在左侧窗格中，选择“连续数据导出”  。
    ...
    > [!Note]
    > 如果在左侧窗格中看不到“连续数据导出”，则说明你不是应用中的管理员。 请与管理员联系以设置数据导出。

3. 选择右上角的“+ 新建”  按钮。 选择“Azure 事件中心”  或“Azure 服务总线”  之一作为导出的目标。 
...
4. 在下拉列表框中，选择自己的**事件中心命名空间/服务总线命名空间**。 也可选取列表中的最后一个选项，即“输入连接字符串”。  
