...
ms.topic: conceptual
manager: philmea
ms.openlocfilehash: cb97cf81f0cac234b9f448f6f337defcabc68c75
ms.sourcegitcommit: 6ffa4d50cee80c7c0944e215ca917a248f2a4bcd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/06/2019
ms.locfileid: "74883226"
---
...
作为 CSP，你只能创建即用即付应用程序。 若要向客户展示 Azure IoT Central，你可以单独创建试用版应用程序。 在 [Azure IoT Central 定价页](htps://www.azure.cn/pricing/details/iot-central/)上详细了解试用版和即用即付应用程序。
