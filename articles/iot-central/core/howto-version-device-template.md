---
title: Azure IoT Central 应用的设备模板版本控制 | Microsoft Docs
...
manager: peterpr
ms.openlocfilehash: b8a0a5603c35ec3c6ed242fa4aca4c2cee49f9cd
ms.sourcegitcommit: 6ffa4d50cee80c7c0944e215ca917a248f2a4bcd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/06/2019
ms.locfileid: "74883809"
---
...
以前版本的设备模板上的**规则**将继续不变地工作。 这些规则不会自动迁移到新的设备模板版本。 可以照常在新模板版本上创建规则。 有关详细信息，请参阅[在 Azure IoT Central 应用程序中创建遥测规则并设置通知](howto-create-telemetry-rules.md)操作指南文章。
