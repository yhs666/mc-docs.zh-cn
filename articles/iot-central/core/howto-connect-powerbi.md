...
author: viv-liu
ms.author: v-yiso
origin.date: 10/4/2019
ms.date: 12/16/2019
ms.topic: conceptual
ms.openlocfilehash: 7542107891c19b5023d78fd7c557667c9ab293a1
ms.sourcegitcommit: 6ffa4d50cee80c7c0944e215ca917a248f2a4bcd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/06/2019
ms.locfileid: "74883702"
---
...
设置此解决方案需要以下各项：
- Azure 订阅的访问权限
- 不支持 IoT 即插即用的 IoT Central 应用程序（目前为预览版应用）
- 设置从 IoT Central 应用到 Azure Blob 存储的连续数据导出
    - 确保数据格式为 Avro
