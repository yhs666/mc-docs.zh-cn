...
若要了解如何使用 REST API 编辑属性，请参阅 [Edit a property using the REST API](https://docs.microsoft.com/en-us/rest/api/apimanagement/2019-01-01/property?patch)（使用 REST API 编辑属性）。
...
若要了解如何使用 REST API 删除属性，请参阅 [Delete a property using the REST API](https://docs.microsoft.com/en-us/rest/api/apimanagement/2019-01-01/property/delete)（使用 REST API 删除属性）。
