...
本指南介绍了如何对 Azure Resource Manager 请求进行身份验证以及如何备份和还原 API 管理服务实例。
...
依次单击“添加”、“添加我的组织正在开发的应用程序”，并选择“本机客户端应用程序”。 输入描述性名称，并单击“下一步”箭头。 输入占位符 URL，例如，为“重定向 URI”输入 `http://resources`，因为它是必填字段，但以后不使用该值。 单击此复选框以保存应用程序。
