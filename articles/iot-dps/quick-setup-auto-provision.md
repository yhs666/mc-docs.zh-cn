...
manager: timlt
ms.custom: mvc
ms.openlocfilehash: bc88bd613bbe0c24a81299eb42b357e2e727c280
ms.sourcegitcommit: 66e360fe2577c9b7ddd96ff78e0ede36c3593b99
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/15/2019
ms.locfileid: "57988426"
---
...
3. 提供新的设备预配服务实例的以下信息，然后单击“创建”。
    ...
    * **资源组：** 此字段允许你创建新的资源组，或选择现有资源组来包含新实例。 选择包含你之前创建的 IoT 中心的同一资源组，例如 **TestResources**。 通过将所有相关资源都放在一个组中，可以一起管理它们。 例如，删除资源组会删除包含在该组中的所有资源。 
    * **位置：** 选择离你的设备最近的位置。
