...
description: 本文帮助你使用 Azure CLI 配置 ExpressRoute Direct（预览版）
...
ms.author: v-yiso
ms.openlocfilehash: 4ca4b44f563025f528d795b60e380977f486a75f
ms.sourcegitcommit: 59db70ef3ed61538666fd1071dcf8d03864f10a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52676639"
---
...
1. 登录到 Azure 并选择包含 ExpressRoute 的订阅。 ExpressRoute Direct 资源和 ExpressRoute 线路必须位于同一订阅中。 在 Azure CLI 中运行下列命令：
...
4. 创建 ExpressRoute Direct 资源，该资源基于在上一步骤中所选择的位置。
  ...
  > [!NOTE]
  > 还可以将 **Encapsulation** 属性设置为 **Dot1Q**。 
  >
