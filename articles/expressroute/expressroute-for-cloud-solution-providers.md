...
ms.author: v-yiso
ms.date: 
ms.openlocfilehash: 9dcc6cd2f41650527611c7635599adf6c3c1d6a5
...
- Azure Active Directory (AAD) – AAD 提供针对 Microsoft Azure 和第三方 SaaS 应用程序的标识管理。 有关 Azure AD 的更多详细信息，请参阅[此处](/active-directory/)。  
