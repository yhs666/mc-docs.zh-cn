...
如果需要有关 Azure PowerShell 的更多信息，请参阅 [Azure PowerShell cmdlet 入门](https://docs.microsoft.com/en-us/powershell/azure/overview)来获取有关如何配置计算机以使用 Azure PowerShell 模块的分步指导。
