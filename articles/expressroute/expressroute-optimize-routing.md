...
---
# 优化 ExpressRoute 路由
<a id="optimize-expressroute-routing" class="xliff"></a>
...
## 从客户到 Microsoft 的非最优路由
<a id="suboptimal-routing-from-customer-to-microsoft" class="xliff"></a>
...
### 解决方案：使用 BGP 社区
<a id="solution-use-bgp-communities" class="xliff"></a>
...
<a id="suboptimal-routing-from-microsoft-to-customer" class="xliff"></a>
...
### 解决方案：使用 AS PATH 追加
<a id="solution-use-as-path-prepending" class="xliff"></a>
...
## 虚拟网络之间的路由欠佳
<a id="suboptimal-routing-between-virtual-networks" class="xliff"></a>
...
### 解决方法：将高权重分配给本地连接
<a id="solution-assign-a-high-weight-to-local-connection" class="xliff"></a>
