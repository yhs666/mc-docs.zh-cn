...
ms.date: 12/29/2017
ms.author: v-junlch
ms.openlocfilehash: 5c6f88f9e02ffb4eeb450b842337955c9344434d
...
使用提升的权限打开 PowerShell 控制台，并登录 Azure 帐户。 以下 cmdlet 会提示您提供 Azure 帐户的登录凭据。 登录后将下载您的帐户设置，以便 Azure PowerShell 使用这些设置。
