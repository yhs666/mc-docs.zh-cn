...
ms.date: 03/12/2018
ms.author: v-junlch
ms.openlocfilehash: bb4987162f5c7a62be88d3959459f994be94441d
...
2. 若要安装该包，请双击它。 如果显示 SmartScreen 弹出窗口，请依次单击“更多信息”、“仍要运行”。
...
5. 在客户端配置文件下载到的 **Generic** 文件夹中打开 **VpnSettings.xml** 文件。 找到名为 **VpnServer** 的标记，并复制以“azuregateway”开头、以“.chinacloudapp.cn”结尾的名称。
...
1. 选择一个配置包，将其安装在客户端设备上。 对于 64 位处理器体系结构，请选择“VpnClientSetupAmd64”安装程序包。 对于 32 位处理器体系结构，请选择“VpnClientSetupX86”安装程序包。 如果显示 SmartScreen 弹出窗口，请依次单击“更多信息”、“仍要运行”。 也可将要安装的包保存在其他客户端计算机上。
