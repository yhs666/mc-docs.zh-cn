...
ms.date: 03/01/2017
ms.author: v-dazen
ms.openlocfilehash: 9bb09b0e7c6e75d01106c55541cdaf0293bbc915
...
还可以播发更大的前缀，可以包括一些 VNet 地址前缀，如大型专用 IP 地址空间（例如，10.0.0.0/8）。 但请注意，这些前缀不能与任一 VNet 前缀相同。 与 VNet 前缀相同的这些路由将被拒绝。
