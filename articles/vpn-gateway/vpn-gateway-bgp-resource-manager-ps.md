---
title: "在 Azure VPN 网关上配置 BGP：Resource Manager：PowerShell | Azure"
...
ms.date: 05/31/2017
ms.author: v-dazen
ms.openlocfilehash: 260374d2d95adef2a0bcc4b6aa5374895a6fe0d4
...
在此示例中，虚拟网络属于同一订阅。 可以在不同订阅之间设置 VNet 到 VNet 连接，若要了解更多详细信息，请参阅[配置 VNet 到 VNet 连接](vpn-gateway-vnet-vnet-rm-ps.md)。 请确保在创建连接时添加“-EnableBgp $True”，以启用 BGP。
