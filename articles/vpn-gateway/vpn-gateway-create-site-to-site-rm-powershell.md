...
ms.date: 05/31/2017
ms.author: v-dazen
ms.openlocfilehash: 95cbab9aba61b1fe2728448ff4a6eabe84ebc527
...
* 验证是否需要使用 Resource Manager 部署模型。 [!INCLUDE [deployment models](../../includes/vpn-gateway-deployment-models-include.md)] 
