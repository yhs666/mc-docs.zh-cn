...
ms.date: 08/31/2017
ms.author: v-junlch
ms.openlocfilehash: 4a31339f3ffd7d4466346924b7648de8f467c6c8
...
本文介绍如何在 Resource Manager 部署模型中使用 Azure 门户通过点到站点连接来创建 VNet。 此配置使用证书来验证正在进行连接的客户端。 也可使用不同的部署工具或部署模型创建此配置，方法是从以下列表中选择另一选项：
...
1. 在“点到站点配置”页上，单击“下载 VPN 客户端”可打开“下载 VPN 客户端”页。 生成包需要一到两分钟。
