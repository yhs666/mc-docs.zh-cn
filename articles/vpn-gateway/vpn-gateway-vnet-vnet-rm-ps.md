...
ms.date: 05/31/2017
ms.author: v-dazen
ms.openlocfilehash: 43a9bb61c6d09c8afe69e247a90f17da2da546d0
...
### 步骤 4 - 连接网关
<a id="step-4---connect-the-gateways" class="xliff"></a>
1. 获取两个虚拟网关。
...
### 步骤 5 - 验证其他 IP 地址范围
<a id="step-5---verify-the-additional-ip-address-ranges" class="xliff"></a>
...
<a id="step-6---create-and-configure-testvnet5" class="xliff"></a>
...
### 步骤 7 - 连接网关
<a id="step-7---connecting-the-gateways" class="xliff"></a>
