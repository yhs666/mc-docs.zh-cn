...
ms.date: 01/11/2018
ms.author: v-nany
ms.openlocfilehash: 9711eed01e0c5806b51f4539ac9fced6b96b0a5e
...
| Cmdlet | 说明 |
|:--- |:--- |
| [Get-AzureAutomationCredential](https://docs.microsoft.com/powershell/module/azure/get-azureautomationcredential?view=azuresmps-3.7.0) |检索有关凭据资产的信息。 只能从 **Get-AutomationPSCredential** 活动中检索凭据本身。 |
| [New-AzureAutomationCredential](https://docs.microsoft.com/powershell/module/azure/new-azureautomationcredential?view=azuresmps-3.7.0) |创建新的自动化凭据。 |
| [Remove- AzureAutomationCredential](https://docs.microsoft.com/powershell/module/azure/new-azureautomationcredential?view=azuresmps-3.7.0) |删除自动化凭据。 |
| [Set- AzureAutomationCredential](https://docs.microsoft.com/powershell/module/azure/new-azureautomationcredential?view=azuresmps-3.7.0) |设置现有自动化凭据的属性。 |
