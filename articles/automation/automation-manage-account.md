...
ms.date: 01/15/2018
ms.author: v-nany
ms.openlocfilehash: f7c3378d123911038cebe3c9ba75713a80846134
...
![不完整的运行方式配置警告消息](media/automation-manage-account/automation-account-runas-incomplete-config-msg.png)上获取。
