...
ms.topic: conceptual
manager: carmonm
ms.openlocfilehash: 354fffe780856f011f9d84391891ae5878347241
ms.sourcegitcommit: c4812614cd0af1b13f911895b6b0582f0b140886
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/14/2019
ms.locfileid: "67135568"
---
...
1. 在“库”控件的搜索文本框中，键入“Add-AzureRmAccount”  。
   ...
   > [!IMPORTANT]
   > **Add-AzureRmAccount** 现在是 **Add-AzureRmAccount** 的别名。 搜索库项时，如果未看到 **Add-AzureRmAccount**，可以使用 **Add-AzureRmAccount**，或者在自动化帐户中更新模块。
