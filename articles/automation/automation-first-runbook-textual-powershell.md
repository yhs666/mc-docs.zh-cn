...
ms.date: 01/15/2018
ms.author: v-nany
ms.openlocfilehash: 1ce6f93e4edb41da418b6c3055ed920177c5efbe
...
我们创建的 Runbook 仍处于草稿模式。 我们需要发布该 Runbook，才可将其用于生产。  当发布 Runbook 时，可以用草稿版本覆盖现有的已发布版本。  在本例中，我们还没有已发布版本，因为我们刚刚创建 Runbook。
...
7. 一旦此 Runbook 状态显示“已完成”，单击“输出”。 *Hello World*的简单 Runbook 。<br><br> ![作业输出](./media/automation-first-runbook-textual-powershell/job-pane-status-blade-outputtile.png)<br> 
8. 关闭“输出”窗格。
