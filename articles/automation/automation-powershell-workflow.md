...
ms.date: 01/15/2018
ms.author: v-nany
ms.openlocfilehash: 8ecfaca74eb6b018607ddda35b353e783786d322
...
> [!NOTE]
> 我们不建议并行运行子 Runbook，这是由于这已被证实会导致不可靠的结果。  子 Runbook 的输出有时不显示，一个子 Runbook 中的设置可能会影响其他并行子 Runbook
>
