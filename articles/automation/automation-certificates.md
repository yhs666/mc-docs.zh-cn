...
ms.date: 01/09/2017
ms.author: v-dazen
ms.openlocfilehash: 22177dd78e93a4c6a06dfaf649a0247bb7c0525d
...
可以安全地将证书存储在 Azure 自动化中，以便使用 Get-AzureAutomationCertificate 活动通过 Runbook 访问这些证书。 这样，便可以创建使用证书进行身份验证的 Runbook，或者将证书添加到 Azure 或第三方资源。
...
|Cmdlet|说明|
|:---|:---|
|[Get-AzureAutomationCertificate](https://msdn.microsoft.com/library/dn913765.aspx)|检索有关证书的信息。 只能从 Get-AzureAutomationCertificate 活动中检索证书本身。|
|[New-AzureAutomationCertificate](https://msdn.microsoft.com/library/dn913764.aspx)|将新证书创建到 Azure 自动化中。|
[Remove-AzureAutomationCertificate](https://msdn.microsoft.com/library/dn913773.aspx)|从 Azure自动化中删除证书。|
|[Set-AzureAutomationCertificate](https://msdn.microsoft.com/library/dn913763.aspx)|设置现有证书的属性，包括上传证书文件和设置 .pfx 的密码。|
...
### <a name="to-create-a-new-certificate-with-the-azure-classic-management-portal"></a>使用 Azure 经典管理门户创建新证书
...
必须通过 **Get-AutomationCertificate** 活动来使用证书。 不能使用 [Get-AzureAutomationCertificate](https://msdn.microsoft.com/library/dn913765.aspx) cmdlet，因为它返回有关证书资产的信息，而不是证书本身的信息。
