...
ms.date: 05/02/2017
ms.author: v-dazen
ms.openlocfilehash: fae53ec08f206dbd270d7e5fc4c927738c023577
...
<a id="my-first-powershell-workflow-runbook" class="xliff"></a>
...
## 步骤 1 - 创建新的 Runbook
<a id="step-1---create-new-runbook" class="xliff"></a>
...
## 步骤 2 - 将代码添加到 Runbook
<a id="step-2---add-code-to-the-runbook" class="xliff"></a>
...
<a id="step-5---add-authentication-to-manage-azure-resources" class="xliff"></a>
...
## 步骤 6 – 添加用于启动虚拟机的代码
<a id="step-6---add-code-to-start-a-virtual-machine" class="xliff"></a>
...
<a id="step-7---add-an-input-parameter-to-the-runbook" class="xliff"></a>
