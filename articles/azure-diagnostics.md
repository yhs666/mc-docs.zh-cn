...
ms.date: 12/23/2016
ms.author: v-junlch
ms.openlocfilehash: 771aa230dcfb2a9db9db41f964dc23e8769a7078
...
<a id="what-is-microsoft-azure-diagnostics" class="xliff"></a>
...
## 可以收集的数据
<a id="data-you-can-collect" class="xliff"></a>
Azure 诊断可以收集以下类型的数据：
...
| .NET 事件源 |使用 .NET EventSource 类的代码编写事件 [](https://msdn.microsoft.com/library/system.diagnostics.tracing.eventsource.aspx) |
...
Azure 诊断扩展可将此数据传输到 Azure 存储帐户，或者发送到服务。 可以将这些数据用于调试和故障排除、度量性能、监视资源使用状况、进行流量分析和容量规划以及进行审核。
...
请注意，Web 应用不使用 Azure 诊断。 请在 [Web 应用](./app-service-web/web-sites-enable-diagnostic-log.md)中查找相应的信息

## 使用 Azure 诊断的云服务
<a id="cloud-services-using-azure-diagnostics" class="xliff"></a>
...
## 使用 Azure 诊断的虚拟机
<a id="virtual-machines-using-azure-diagnostics" class="xliff"></a>
...
- [使用 Azure Resource Manager 模板创建具有监视和诊断功能的 Windows 虚拟机](./virtual-machines/virtual-machines-windows-extensions-diagnostics-template.md)

## 使用 Azure 诊断的 Service Fabric
<a id="service-fabric-using-azure-diagnostics" class="xliff"></a>
...
## 一般的 Azure 诊断文章
<a id="general-azure-diagnostics-articles" class="xliff"></a>
