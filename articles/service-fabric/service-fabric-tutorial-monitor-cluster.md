...
ms.author: v-yeche
ms.custom: mvc
ms.openlocfilehash: 8f7bbb4802d1202c98f9dde2b815bb8031a4d3d9
ms.sourcegitcommit: 731da97453f3bd6b333dc2ec1058b9b91031d240
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/29/2019
ms.locfileid: "64871631"
---
...
可以使用 [Service Fabric 客户端库](https://docs.azure.cn/zh-cn/dotnet/api/overview/service-fabric?view=azure-dotnet#client-library)以编程方式查询 EventStore API。
...
<!--Update_Description: new articles on service fabric tutorial monitor cluster -->
<!--ms.date: 04/29/2019-->