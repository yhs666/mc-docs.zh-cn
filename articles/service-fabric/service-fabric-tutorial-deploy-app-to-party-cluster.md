...
3. 打开首选的浏览器，键入群集地址（不带端口信息的连接终结点 - 例如 win1kw5649s.chinanorth.cloudapp.chinacloudapi.cn）。
...
1. 使用合作群集注册页提供的链接浏览到 Service Fabric Explorer。 例如，http://win1kw5649s.chinanorth.cloudapp.chinacloudapi.cn:19080/Explorer/index.html。
