...
wacn.date: 
ms.author: v-yeche
ms.openlocfilehash: 12c56327dfcf7d239fb85102e844044c540cdc68
...
3. 打开首选的浏览器，键入群集地址（不带端口信息的连接终结点 - 例如 win1kw5649s.chinanorth.chinacloudapp.cn），将 `/api/values` 添加到 URL。
