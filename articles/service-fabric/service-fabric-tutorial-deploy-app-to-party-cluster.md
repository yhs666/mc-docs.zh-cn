---
title: 将 Azure Service Fabric 应用程序部署到群集 | Azure
...
ms.author: v-yeche
ms.custom: mvc
ms.openlocfilehash: 3cd054295439c49611192079503d9abfe37e3db3
ms.sourcegitcommit: f0bfa3f8dca94099a2181492952e6a575fbdbcc8
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/02/2018
ms.locfileid: "37142662"
---
...
<!-- Not Available on party clusters -->
...
在下一步，请在“创建群集”对话框的“高级”选项卡中指定此端口。  如果要将应用程序部署到现有的群集，可以在 Azure 负载均衡器中使用 [PowerShell 脚本](./scripts/service-fabric-powershell-open-port-in-load-balancer.md)来打开此端口，也可以在 [Azure 门户](https://portal.azure.cn)中将其打开。

### <a name="create-a-cluster-in-azure-through-visual-studio"></a>通过 Visual Studio 在 Azure 中创建群集
在解决方案资源管理器中右键单击应用程序项目，选择“发布”。

使用 Azure 帐户登录，以便访问订阅。
<!-- Not Available on This step is optional if you're using a party cluster-->

选择**连接终结点**对应的下拉列表，然后选择“<Create New Cluster...>”选项。

![“发布”对话框](./media/service-fabric-tutorial-deploy-app-to-party-cluster/publish-app.png)
...
打开首选的浏览器，键入群集地址（不带端口信息的连接终结点 - 例如 win1kw5649s.chinanorth.cloudapp.chinacloudapi.cn）。
