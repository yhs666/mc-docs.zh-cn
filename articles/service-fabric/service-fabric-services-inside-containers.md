...
ms.date: 05/28/2018
ms.author: v-yeche
ms.openlocfilehash: 611e35b9caf557e1abdde80eb9d8b5a9137763b8
ms.sourcegitcommit: e50f668257c023ca59d7a1df9f1fe02a51757719
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/26/2018
ms.locfileid: "34554609"
---
...
此功能处于预览版，本文提供了各种步骤来获取在容器内运行的服务。  

> [!NOTE]
> 此功能处于预览版，在生产环境中不受支持。 当前此功能仅适用于 Windows。 若要运行容器，必须在包含容器的 Windows Server 2016 上运行群集。
...
5. 对于每个需要容器化的代码包，运行 PowerShell 脚本 [CreateDockerPackage.ps1](https://github.com/Azure/service-fabric-scripts-and-templates/blob/master/scripts/CodePackageToDockerPackage/CreateDockerPackage.ps1)。 用法如下：
 ...
 ```
  该脚本在 $dockerPackageOutputDirectoryPath 处生成包含 Docker 项目的文件夹。 可以根据需要修改生成的 Dockerfile 来公开任何端口，以及运行设置脚本等。
