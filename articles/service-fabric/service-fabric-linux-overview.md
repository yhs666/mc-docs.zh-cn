...
ms.date: 10/02/2017
ms.author: v-yeche
ms.openlocfilehash: e8a26ac4d99997979d4f13c4e20f9677258e0920
...
Linux 版 Service Fabric 在概念上等同于 Windows 版 Service Fabric（OS 细节和编程语言支持除外）。 因此，我们的大部分[现有文档](../service-fabric/index.yml)都能帮助你熟悉该技术。
