...
## EventSource 事件
Reliable Actors 运行时的 EventSource 提供程序名称为“Microsoft-ServiceFabric-Actors”。当[在 Visual Studio 中调试](./service-fabric-debugging-your-application.md)执行组件应用程序时，来自此事件源的事件显示在[诊断事件](./service-fabric-diagnostics-how-to-monitor-and-diagnose-services-locally.md#view-service-fabric-system-events-in-visual-studio)窗口中。
...
Reliable Actors 运行时发出与 [Actor 方法](./service-fabric-reliable-actors-introduction.md)相关的以下事件。
...
### 与执行组件副本相关的事件
Reliable Actors 运行时发出与[执行组件副本](./service-fabric-reliable-actors-platform.md#service-fabric-partition-concepts-for-stateful-actors)相关的以下事件。
