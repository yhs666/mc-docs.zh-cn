...
ms.openlocfilehash: aab4f1c2399bab81be01483cff5042405e480e64
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>在 Linux 上通过 C# 开始使用 Service Fabric</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>通过 Java 开始使用 Service Fabric</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>命令行</h3>
                        <p><a href="https://docs.microsoft.com/powershell/servicefabric/vlatest/servicefabric">PowerShell</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>语言</h3>
                        <p><a href="https://docs.microsoft.com/java/api/microsoft.servicefabric.services">Java API</a></p>
                        <p><a href="https://docs.microsoft.com/dotnet/api/microsoft.servicefabric.services">.NET</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="https://docs.microsoft.com/rest/api/servicefabric">REST API 参考</a></p>
                    </div>
                </div>
            </div>
        </div>
