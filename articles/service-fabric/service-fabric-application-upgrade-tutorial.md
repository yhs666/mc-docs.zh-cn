...
ms.date: 04/07/2017
ms.author: v-johch
ms.openlocfilehash: a9d3ce1152b30344f2862f02ac3c2dfde4356d96
...
<a id="service-fabric-application-upgrade-tutorial-using-visual-studio" class="xliff"></a>
...
## 步骤 1：构建和发布可视对象示例
<a id="step-1-build-and-publish-the-visual-objects-sample" class="xliff"></a>
...
## 步骤 2：更新可视对象示例
<a id="step-2-update-the-visual-objects-sample" class="xliff"></a>
...
## 步骤 3：升级应用程序
<a id="step-3--upgrade-your-application" class="xliff"></a>
