...
一个 Service Fabric 群集必须至少包含 3 个节点。 可以根据设置向此部分添加更多节点。 下表说明了每个节点的配置设置。
...
reliabilityLevel 的概念定义可在群集的主节点上运行的 Service Fabric 系统服务副本或实例的数量。 它确定这些服务以及群集的可靠性。 在群集创建和升级时，由系统计算该值。
