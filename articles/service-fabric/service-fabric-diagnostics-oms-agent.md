---
title: Azure Service Fabric - 使用 Log Analytics 设置性能监视 | Azure
...
ms.date: 03/04/2019
ms.author: v-yeche
ms.openlocfilehash: 144965f75bc6ef8a45574d2a2c23ced8abbbb4c1
ms.sourcegitcommit: ea33f8dbf7f9e6ac90d328dcd8fb796241f23ff7
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/01/2019
ms.locfileid: "57204258"
---
...
将 Log Analytics 代理添加到群集的最佳方法是使用 Azure CLI 提供的虚拟机规模集 API。 如果尚未设置 Azure CLI，请转至 Azure 门户并打开 [Cloud Shell](../cloud-shell/overview.md) 实例，或[安装 Azure CLI](https://docs.azure.cn/zh-cn/cli/install-azure-cli?view=azure-cli-latest)。
...
<!--Update_Description: new articles on service fabric diagnostics oms agent-->
<!--ms.date: 03/04/2019-->