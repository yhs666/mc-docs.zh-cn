...
ms.date: 05/04/2017
ms.author: v-johch
ms.openlocfilehash: ae274caa2053857ba695c0bd72b015c4a4e8c003
...
1. 安装 Service Fabric SDK 包。 系统会请求用户确认安装并同意许可协议。
    ...
    ```
    若要自动完成安装，可以跳过许可协议提示，方法是：为 Service Fabric 包设置 debconf 选项。 可以运行以下两个命令
...
## 设置 Azure 跨平台 CLI
<a id="set-up-the-azure-cross-platform-cli" class="xliff"></a>
...
## 安装 .NET Core SDK（如果希望使用 .NET Core 编程模型，则可以选择执行此步骤）
