...
* 主节点类型的 **VM 大小下限**取决于你选择的**耐久性层**。 默认持续性层为“青铜”。 请参阅[群集的持续性特征](/service-fabric/service-fabric-cluster-capacity#the-durability-characteristics-of-the-cluster)以了解更多详细信息。  
...
| ---------------- |  ----------------------------  | ---------------------------------------------------------------------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| 金牌服务             | 5                              | 专用于单个客户的完整节点 SKU（例如 DS15_v2、D15_v2）       | 可延迟到 Service Fabric 群集批准 | 每个 UD 可以暂停 2 小时，提供额外的时间让副本从之前的故障中恢复 |
