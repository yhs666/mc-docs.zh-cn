...
ms.date: 03/12/2018
ms.author: v-yeche
ms.openlocfilehash: d538de281cd45c64075c9aab28fefa2f54b97b34
...
如果已安装 Service Fabric 插件，请确保使用最新版本。 若要检查可用的更新，请转到“帮助” > “安装详细信息”。 在已安装插件的列表中选择“Service Fabric”，然后单击“更新”。 随后会安装可用的更新。
