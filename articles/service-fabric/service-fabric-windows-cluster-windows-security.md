...
ms.date: 04/30/2018
ms.author: v-yeche
ms.openlocfilehash: 791e358a4448d7d9599c594b19903ed7c491af1e
...
以下示例 **security** 节使用 gMSA 配置 Windows 安全性，并指定 ServiceFabric.clusterA.contoso.com gMSA 中的计算机位于群集中，同时还指定 CONTOSO\usera 拥有管理客户端访问权限：  
