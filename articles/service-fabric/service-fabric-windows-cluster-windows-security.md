...
ms.date: 10/02/2017
ms.author: v-yeche
ms.openlocfilehash: d0aa031cbd4ef5593916b9de48f3cc09ab48c5c1
...
随 [Microsoft.Azure.ServiceFabric.WindowsServer<version>.zip](http://go.microsoft.com/fwlink/?LinkId=730690) 独立群集包下载的 ClusterConfig.Windows.MultiMachine.JSON 示例配置文件包含用于配置 Windows 安全性的模板。  在“属性”  部分中配置 Windows 安全性：
...
| **配置设置** | **说明** |
| --- | --- |
| ClusterCredentialType |**ClusterCredentialType** 设置为 *Windows* 。 |  
