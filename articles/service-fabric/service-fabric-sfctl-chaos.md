...
ms.date: 11/13/2017
ms.author: v-yeche
ms.openlocfilehash: 4f8e2845621e3b51ae4b61a250fb52d6b3261408
...
| --end-time-utc   | 时钟计时周期计数，表示要生成 Chaos 报告的时间范围的结束时间。 有关时钟计时周期的详细信息，请参阅 [DateTime.Ticks 属性](https://msdn.microsoft.com/library/system.datetime.ticks%28v=vs.110%29)。|
| --start-time-utc | 时钟计时周期计数，表示要生成 Chaos 报告的时间范围的开始时间。 有关时钟计时周期的详细信息，请参阅 [DateTime.Ticks 属性](https://msdn.microsoft.com/library/system.datetime.ticks%28v=vs.110%29)。|
