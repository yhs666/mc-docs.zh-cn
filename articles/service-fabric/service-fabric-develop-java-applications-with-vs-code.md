---
title: 使用 Visual Studio Code 开发 Java Azure Service Fabric 应用程序 | Azure
...
<!-- Update_Description: new articles on service fabric develop java applications with VS code  -->
<!--ms.date: 08/20/2018-->