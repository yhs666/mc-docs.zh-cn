...
description: "了解如何在本地开发计算机上监视和诊断使用 Microsoft Azure Service Fabric 编写的服务。"
...
ms.date: 04/24/2017
ms.author: v-johch
ms.openlocfilehash: 2c98cffd7cc15a9c018b73dd68a6d1d38887bfb9
...
将自定义 ETW 跟踪添加到服务代码之后，可以再次生成、部署和运行应用程序以在诊断事件查看器中查看事件。 如果使用 **F5**调试应用程序，则将自动打开诊断事件查看器。
