---
title: 如何在 Azure Service Fabric 中删除节点类型 | Azure
...
ms.date: 01/21/2019
ms.author: v-yeche
ms.openlocfilehash: 5d7313f16f725681795e7e0aeafd1cba069ce779
ms.sourcegitcommit: 35a09a86cbb3d896fa9784471ece41df7728bd71
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/18/2019
ms.locfileid: "54396712"
---
...
使用 Remove-AzureRmServiceFabricNodeType 时，安全性优先于速度。 建议使用银级或金级[持续性特征](/service-fabric/service-fabric-cluster-capacity#the-durability-characteristics-of-the-cluster)，因为：
- 铜级未提供任何关于保存状态信息的保证。
...
3.  对将受节点类型删除影响的 VM 运行 [Remove-AzureRmVmss](/virtual-machine-scale-sets/virtual-machine-scale-sets-manage-powershell#remove-vms-from-a-scale-set)。
...
<!-- Update_Description: new articles on service fabric how to remove node type -->
<!--ms.date: 01/21/2019-->