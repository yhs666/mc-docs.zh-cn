---
title: Azure Service Fabric 服务模型 XML 架构复杂类型 | Azure
...
ms.date: 05/28/2018
ms.author: v-yeche
ms.openlocfilehash: 5594ad7d3127edb990b04918cb078754d6f12b43
ms.sourcegitcommit: e50f668257c023ca59d7a1df9f1fe02a51757719
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/26/2018
ms.locfileid: "34554711"
---
...
终结点协议。 还必须在应用程序清单中为 HTTPS 终结点声明 EndpointCertificate 和 EndpointBindingPolicy。 以后在执行应用程序升级时无法更改该协议。 
|属性|值|
|---|---|
|type|xs:string|
|name|协议|
...
相对块 IO 权重。 必须是介于 10 和 1000 之间的正整数。
|属性|值|
|---|---|
|type|xs:string|
|name|BlockIOWeight|
...
服务清单中定义的资源类型（Endpoint 或 Certificate）。
|属性|值|
|---|---|
|默认值|终结点|
|name|ResourceType|
...
|---|---|
|name|NodeList|
<!-- Update_Description: new articles on service fabric service model schema complex types  -->
<!--ms.date: 05/28/2018-->