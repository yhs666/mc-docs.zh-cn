...
以下脚本使用 [az sf cluster create](https://docs.azure.cn/zh-cn/cli/sf/cluster?view=azure-cli-latest#az-sf-cluster-create) 命令和模板在 Azure 中部署新群集。 该 cmcommand 还会在 Azure 中创建新的密钥保管库、向密钥保管库添加新的自签名证书，并将证书文件下载到本地。
