...
可以使用 Azure CLI 2.0 命令与 Service Fabric 群集交互并对其进行管理。 若要获取最新版的 Azure CLI，请按 [Azure CLI 2.0 标准安装过程](https://docs.microsoft.com/cli/azure/install-azure-cli)操作。

有关详细信息，请参阅 [Azure CLI 2.0 概述](https://docs.microsoft.com/cli/azure/overview)。
