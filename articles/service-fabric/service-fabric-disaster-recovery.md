...
<a id="disaster-recovery-in-azure-service-fabric" class="xliff"></a>
...
<a id="physical-layout-of-service-fabric-clusters-in-azure" class="xliff"></a>
...
### 地理分布
<a id="geographic-distribution" class="xliff"></a>
...
## 应对故障
<a id="dealing-with-failures" class="xliff"></a>
有多种类型的故障可能会影响群集，而每种类型都有其自身的缓解方式。 我们将按照发生故障的可能性大小进行探讨。

### 单个计算机故障
<a id="individual-machine-failures" class="xliff"></a>
...
#### 将仲裁丢失的风险降到最低
<a id="minimizing-the-risk-of-quorum-loss" class="xliff"></a>
...
### 数据中心服务中断或损坏
<a id="data-center-outages-or-destruction" class="xliff"></a>
...
### 软件故障和其他数据丢失根源
<a id="software-failures-and-other-sources-of-data-loss" class="xliff"></a>
