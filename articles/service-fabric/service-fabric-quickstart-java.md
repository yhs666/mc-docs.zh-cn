...
ms.openlocfilehash: 797be3603860923b6f2f002748dc299397556266
...
Service Fabric Explorer 在所有 Service Fabric 群集中运行，并能通过浏览器进行访问，访问方法是转到群集 HTTP 管理端口 19080（例如，`http://lnxxug0tlqm5.chinanorth.cloudapp.chinacloudapi.cn:19080`）。
