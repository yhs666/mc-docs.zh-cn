...
ms.date: 08/14/2017
ms.author: v-yeche
ms.openlocfilehash: cf4678811f19107401275191d15e37542dff8aef
...
应该通过资源模型模板或 Azure 门户在 Azure 上创建群集。 有关详细信息，请参阅[使用资源管理器模板创建 Service Fabric 群集](service-fabric-cluster-creation-via-arm.md)或[在 Azure 门户中创建 Service Fabric 群集](service-fabric-cluster-creation-via-portal.md)。
