...
在 Azure 上创建群集是通过资源模型模板或 Azure 门户完成的。 有关详细信息，请参阅[使用 Resource Manager 模板创建 Service Fabric 群集](service-fabric-cluster-creation-via-arm.md)或[在 Azure 门户中创建 Service Fabric 群集](service-fabric-cluster-creation-via-portal.md)。
