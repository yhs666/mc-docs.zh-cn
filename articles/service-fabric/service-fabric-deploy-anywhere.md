...
ms.date: 03/08/2017
ms.author: v-johch
ms.openlocfilehash: 2dcac51e8a8f311ccece75024d84775107b38274
...
<a id="create-service-fabric-clusters-on-windows-server-or-linux" class="xliff"></a>
...
<a id="create-service-fabric-clusters-on-azure" class="xliff"></a>
...
## Azure 上支持的群集操作系统
<a id="supported-operating-systems-for-clusters-on-azure" class="xliff"></a>
...
<a id="create-service-fabric-standalone-clusters-on-premise-or-with-any-cloud-provider" class="xliff"></a>
...
### 任何云部署与本地部署
<a id="any-cloud-deployments-vs-on-premises-deployments" class="xliff"></a>
...
<a id="benefits-of-creating-standalone-service-fabric-clusters" class="xliff"></a>
* 可以自由选择任何云提供商来托管群集。
...
## 独立群集支持的操作系统
<a id="supported-operating-systems-for-standalone-clusters" class="xliff"></a>
...
<a id="advantages-of-service-fabric-clusters-on-azure-over-standalone-service-fabric-clusters-created-on-premises" class="xliff"></a>
