...
ms.date: 05/28/2018
ms.author: v-yeche
ms.openlocfilehash: 46ad5a988f649c046abcf51e6359c1d040f7a06e
ms.sourcegitcommit: e50f668257c023ca59d7a1df9f1fe02a51757719
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/26/2018
ms.locfileid: "34554311"
---
...
通过资源模型模板或 [Azure 门户](https://portal.azure.cn)在 Azure 上创建群集。 有关详细信息，请参阅[使用资源管理器模板创建 Service Fabric 群集](service-fabric-cluster-creation-via-arm.md)或[在 Azure 门户中创建 Service Fabric 群集](service-fabric-cluster-creation-via-portal.md)。
...
## <a name="create-service-fabric-standalone-clusters-on-premises-or-with-any-cloud-provider"></a>在本地或者通过任何云提供商创建 Service Fabric 独立群集
