---
title: "在 Azure Service Fabric 中针对 ASP.NET Core 服务进行的监视和诊断 | Azure"
...
Application Insights 是 Azure 的应用程序性能管理平台，也是 Service Fabric 建议用于应用程序监视和诊断的平台。 若要创建 Application Insights 资源，请导航到 [Azure 门户](https://portal.azure.cn)。 单击左侧导航菜单中的“新建”，打开 Azure Marketplace。 单击“监视 + 管理”，然后单击“Application Insights”。
