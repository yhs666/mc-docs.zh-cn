...
ms.date: 09/10/2018
ms.author: v-yeche
ms.openlocfilehash: 0a2dddec6ba5f937ba0d0b7bbdb4342c24b9e41f
ms.sourcegitcommit: 30046a74ddf15969377ae0f77360a472299f71ab
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/12/2018
ms.locfileid: "44515716"
---
...
| --delta-unhealthy-nodes | 群集升级过程中允许的节点运行状况降级最大百分比。  默认值\: 10。 <br><br> 在开始升级时的节点状态与运行状况评估时的节点状态之间测得的增量值。 每个升级域升级完成后执行检查，以确保群集的多区域状态在允许的限制内。 |
