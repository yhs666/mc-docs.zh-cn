...
ms.date: 04/07/2017
ms.author: v-johch
ms.openlocfilehash: 183ce74eeac98ce99e1cfc9734c3799d21d95537
...
<a id="how-reliable-actors-use-the-service-fabric-platform" class="xliff"></a>
...
## 服务分层
<a id="service-layering" class="xliff"></a>
...
### 使用执行组件服务
<a id="using-the-actor-service" class="xliff"></a>
...
### 执行组件服务方法
<a id="actor-service-methods" class="xliff"></a>
...
#### 枚举执行组件
<a id="enumerating-actors" class="xliff"></a>
...
#### 删除执行组件
<a id="deleting-actors" class="xliff"></a>
...
### 自定义执行组件服务
<a id="custom-actor-service" class="xliff"></a>
...
#### 实现执行组件备份和还原
<a id="implementing-actor-backup-and-restore" class="xliff"></a>
...
## 应用程序模型
<a id="application-model" class="xliff"></a>
执行组件服务都是 Reliable Services，因此服务的应用程序模型是相同的。 但是，执行组件框架生成工具为你生成某些应用程序模型文件。

### 服务清单
<a id="service-manifest" class="xliff"></a>
...
##<a name="service-fabric-partition-concepts-for-stateful-actors"></a><a name="service-fabric-partition-concepts-for-actors"></a> 针对执行组件的 Service Fabric 分区概念
