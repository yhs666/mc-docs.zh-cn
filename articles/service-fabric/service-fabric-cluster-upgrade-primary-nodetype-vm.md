---
title: 升级 Azure Service Fabric 群集 VM 的 SKU 或 OS | Azure
...
* [缩小或扩大独立群集](service-fabric-cluster-windows-server-add-remove-nodes.md)。<!-- Update_Description: new articles on service fabric cluster upgrade primary nodetype VM -->
<!--ms.date: 07/09/2018-->