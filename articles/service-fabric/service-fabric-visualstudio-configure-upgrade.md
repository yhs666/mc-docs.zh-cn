---
title: "配置 Service Fabric 应用程序的升级 | Microsoft Docs"
...
ms.date: 11/18/2016
ms.author: v-johch
ms.openlocfilehash: ebbdb4edf837695fcdedafc9f011ed1ecf32b85d
...
2. 选择想要使用的升级模式，然后填写参数网格。
    ...
    每个参数都有默认值。 可选参数 DefaultServiceTypeHealthPolicy 采用哈希表输入。 Here’s an example of the hash table input format for *DefaultServiceTypeHealthPolicy*:
