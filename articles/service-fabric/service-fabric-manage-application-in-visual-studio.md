...
ms.date: 09/10/2018
ms.author: v-yeche
ms.openlocfilehash: 5906851a762f4c97db759990c2b16bfc90b3f97c
ms.sourcegitcommit: 30046a74ddf15969377ae0f77360a472299f71ab
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/12/2018
ms.locfileid: "44515698"
---
...
1. 刷新应用程序此模式能快速更改和调试代码并支持调试时编辑静态 Web 文件。 此模式只能在本地开发群集处于 [1 节点模式](./service-fabric-get-started-with-a-local-cluster.md#one-node-and-five-node-cluster-mode)下时有效。 这是默认的应用程序调试模式。
