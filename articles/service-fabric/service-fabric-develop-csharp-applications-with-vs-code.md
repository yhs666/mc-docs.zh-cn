---
title: 使用 Visual Studio Code 开发 .NET Core Azure Service Fabric 应用程序 | Azure
...
<!-- Update_Description: new articles on service fabric develop csharp application with visual studio code  -->
<!--ms.date: 08/20/2018-->