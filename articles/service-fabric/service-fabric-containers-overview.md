...
ms.date: 11/13/2017
ms.author: v-yeche
ms.openlocfilehash: 9d9e8476408b82deb2de3ab96741f8b8cce5f7b4
...
包含 Hyper-V 支持的 Windows 容器提供更多隔离性和安全性，因为每个容器不与其他容器或主机共享操作系统内核。 由于具有这么高的安全隔离性，启用 Hyper-V 的容器适合用于对付恶意的多租户方案。
...
此外，也可在容器内运行 Service Fabric 服务。 目前针对在容器内运行 Service Fabric 服务的支持有限，但在即将发布的版本中会进行改进。
...
[了解更多关于 Windows 容器的信息](https://msdn.microsoft.com/virtualization/windowscontainers/about/)
