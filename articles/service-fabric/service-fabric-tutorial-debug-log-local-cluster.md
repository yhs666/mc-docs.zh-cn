---
title: 调试本地 Azure Service Fabric 群集上的 Java 应用程序 | Azure
...
ms.author: v-yeche
ms.custom: mvc
ms.openlocfilehash: 17b230ec68e27ac07485420605a0106a25698af0
...
4. 更新要调试的服务的 entryPoint.sh，以便使用远程调试参数启动 Java 进程。 本教程使用了无状态前端：*Voting/VotingApplication/VotingWebPkg/Code/entryPoint.sh*。设置了端口 8001，以便在此示例中进行调试。
