...
ms.date: 04/30/2018
ms.author: v-yeche
ms.openlocfilehash: 443ffc4c35594adc4f6ad1b6e461feab06efec58
...
如果应用程序对性能的依赖程度很高，则最好使用 **EventSource**。 与 ASP.NET Core 日志记录或任何可用的第三方解决方案相比，**EventSource** 使用的资源通常更少，并且性能更佳。  对于许多服务来说这并不是一个问题，但如果服务以性能为中心，则 **EventSource** 可能是更好的选择。 但是，若要获得结构化日志记录的这些优势，**EventSource** 要求工程团队做出大笔投资。 如果可能，建议对一些日志记录选项执行快速原型，然后选择最符合需求的选项。
