---
title: "使用 Azure CLI 1.0 管理 Azure DNS 中的 DNS 记录 | Azure"
description: "在 Azure DNS 上托管域时管理 Azure DNS 上的 DNS 记录集和记录。 记录集和记录上的操作的所有 CLI 1.0 命令。"
services: dns
...
ms.date: 12/18/2017
ms.author: v-nany
ms.openlocfilehash: 9a49f9d00b419ee5a7fa60faa41d1698e326dc2d
