---
title: "通过 Azure CLI 1.0 开始使用 Azure DNS | Microsoft 文档"
description: "了解如何在 Azure DNS 中创建 DNS 区域和记录。 这是有关使用 Azure CLI 1.0 创建和管理第一个 DNS 区域和记录的分步指南。"
services: dns
...
ms.date: 12/18/2017
ms.author: v-nany
ms.openlocfilehash: b019242d56a79eb15b971bfdfffe9519b69daeb2
...
以下示例在资源组“MyResourceGroup”的 DNS 区域“contoso.com”中创建相对名称为“www”的记录集。 记录集的完全限定名称为“www.contoso.com”。 记录类型为“A”，IP 地址为“1.2.3.4”，使用默认 TTL（3600 秒，1 小时）。

```azurecli
azure network dns record-set add-record MyResourceGroup contoso.com www A -a 1.2.3.4
```

对于其他记录类型，对于具有一条以上记录的记录集，若要使用其他 TTL 值并修改现有记录，请参阅[使用 Azure CLI 1.0 管理 DNS 记录和记录集](dns-operations-recordsets-cli-nodejs.md)。
