...
ms.author: v-lingwu
ms.custom: mvc
ms.openlocfilehash: 88df81fe5c1e2fcd003911ed4a10ff3e83b6a36a
ms.sourcegitcommit: f818003595bd7a6aa66b0d3e1e0e92e79b059868
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/06/2019
ms.locfileid: "66731380"
---
...
8. 首次为新的 Log Analytics 工作区配置 Windows 性能计数器时，可以选择快速创建几个通用的计数器。 将这些计数器在一个复选框中依次列出。
    ...
    ![选中的默认 Windows 性能计数器](media/quick-collect-windows-computer/windows-perfcounters-default.png)上获取。
