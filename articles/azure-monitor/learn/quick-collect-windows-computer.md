...
ms.author: v-lingwu
ms.custom: mvc
ms.openlocfilehash: 409f5e5a6a89ca06c34f3484c5cbb3a4db66f885
ms.sourcegitcommit: 7e25a709734f03f46418ebda2c22e029e22d2c64
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/20/2019
ms.locfileid: "56440279"
---
...
1. 在 Azure 门户中，单击“所有服务”。 在资源列表中，键入“Log Analytics”。 开始键入时，会根据输入筛选该列表。 选择“Log Analytics”。<br><br> ![Azure 门户](media/quick-collect-windows-computer/azure-portal-01.png)<br><br>  
2. 单击“创建”，然后为以下各项选择选项：
...
在安装适用于 Windows 的 Azure Monitoring Agent 之前，需要先获得 Log Analytics 工作区的工作区 ID 和密钥。  安装向导需要使用此信息来正确配备代理，并确保它能与 Log Analytics 成功通信。  
...
3. 选择“高级设置”。<br><br> ![Log Analytics 高级设置](media/quick-collect-windows-computer/log-analytics-advanced-settings-01.png)<br><br>  
4. 选择“已连接的源”，然后选择“Windows 服务器”。   
5. “工作区 ID”和“主密钥”右侧的值。 将它们复制并粘贴到喜爱的编辑器中。   

## <a name="install-the-agent-for-windows"></a>安装适用于 Windows 的代理
以下步骤使用计算机上 Azure Monitoring Agent 的设置在 Azure 和 Azure China Cloud 云中安装并配置 Log Analytics 的代理。  
...
7. 提供所需的配置设置后，单击“下一步”。<br><br> ![粘贴工作区 ID 和主键](media/quick-collect-windows-computer/log-analytics-mma-setup-laworkspace.png)<br><br>
8. 在“准备安装”页上检查所做的选择，并单击“安装”。
9. 在“配置已成功完成”页上，单击“完成”。

完成后，**Microsoft Monitoring Agent** 将显示在“**控制面板**”中。 可以检查配置，并验证代理是否已连接到 Log Analytics。 处于已连接状态时，在“Azure Log Analytics”选项卡上，代理会显示一条消息：“Azure Monitoring Agent 已成功连接到 Azure Log Analytics 服务”。<br><br> ![MMA 与 Log Analytics 的连接状态](media/quick-collect-windows-computer/log-analytics-mma-laworkspace-status.png)
...
2. 选择“高级设置”。<br><br> ![Log Analytics 高级设置](media/quick-collect-windows-computer/log-analytics-advanced-settings-01.png)<br><br> 
...
2. 在“日志搜索”窗格上的查询字段中键入 `Perf`，然后按 Enter 或单击查询字段右侧的搜索按钮。<br><br> ![Log Analytics 日志搜索查询示例](media/quick-collect-windows-computer/log-analytics-portal-queryexample.png)<br><br> 例如，下图中的查询返回了 735 条性能记录。<br><br> ![Log Analytics 日志搜索结果](media/quick-collect-windows-computer/log-analytics-search-perf.png)
...
若要删除工作区，请选择前面创建的 Log Analytics 工作区，在资源页上单击“删除”。<br><br> ![删除 Log Analytics 资源](media/quick-collect-windows-computer/log-analytics-portal-delete-resource.png)
