...
| System Center Operations Manager 管理组 | 是 | 服务映射在连接的 System Center Operations Manager 管理组中通过 Windows 和 Linux 代理分析和收集数据。 <br><br>需要从 System Center Operations Manager 代理计算机直接连接到 Log Analytics。 |
...
在 Log Analytics 工作区中激活服务映射时，将向该工作区中的所有 Windows 服务器转发到 300KB 的管理包。 若在连接的管理组中使用 System Center Operations Manager 代理，则会从 System Center Operations Manager 部署服务映射管理包。 
