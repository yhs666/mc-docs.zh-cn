...
ms.date: 07/30/2019
ms.author: v-lingwu
ms.openlocfilehash: 12cbb0c8c3bfbd977fbe6751f877d4e69a87b790
ms.sourcegitcommit: dd0ff08835dd3f8db3cc55301815ad69ff472b13
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/06/2019
ms.locfileid: "70736980"
---
...
|------------|-------------|
|LogicalDisk |可用空间百分比 |
|LogicalDisk |平均值磁盘秒数/读取 |
|LogicalDisk |平均值磁盘秒数/传输 |
|LogicalDisk |平均值磁盘秒数/写入 |
|LogicalDisk |磁盘字节/秒 |
...
使用 Log Analytics 工作区启用和配置用于 VM 的 Azure Monitor 时，会将管理包转发到向该工作区报告的所有 Windows 计算机。 如果已将 System Center Operations Manager 管理组与 Log Analytics 工作区集成，则服务映射管理包将从管理组部署到向管理组报告的 Windows 计算机。  
