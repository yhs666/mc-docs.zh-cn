...
ms.date: 6/4/2019
ms.author: v-lingwu
ms.openlocfilehash: 8231da21fa52b4b10be76c75f30c0edee6d8ace0
...
Application Insights 支持捕获通过 ILogger 发送的日志。 若要设置日志记录，请在[此处](https://docs.microsoft.com/azure/azure-monitor/app/ilogger)签出代码示例。
...
下表描述了 [.NET 和 .NET Core](https://docs.azure.cn/zh-cn/dotnet/standard/choosing-core-framework-server?view=azure-dotnet) 之间的更多差异和权衡：
...
该功能的部分原因是，NuGet 包 Microsoft.AspNetCore.All  使用 [_Microsoft.ASPNetCoreApplicationInsights.HostingStartup_](https://docs.azure.cn/zh-cn/dotnet/api/microsoft.aspnetcore.applicationinsights.hostingstartup.applicationinsightshostingstartup?view=azure-dotnet?view=aspnetcore-2.1) 作为依赖项。
...
但在 Visual Studio 中，可以通过使用 [IHostingStartup 接口](https://docs.azure.cn/zh-cn/dotnet/api/microsoft.aspnetcore.hosting.ihostingstartup?view=azure-dotnet?view=aspnetcore-2.1)从外部程序集启用本地 Application Insights 功能。 接口会在调试期间动态添加 Application Insights。
