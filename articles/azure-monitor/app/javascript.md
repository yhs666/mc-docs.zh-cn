...
![在 portal.azure.cn 中，打开应用的资源，并单击“浏览器”](media/javascript/03.png)

首先需要订阅[世纪互联 Azure](https://www.azure.cn)。 如果团队拥有组织订阅，请咨询所有者将 Microsoft 帐户添加到其中。
...
![在 portal.azure.cn 中，打开应用的资源，并单击“设置”、“浏览器”](./media/javascript/03.png)
