...
ms.reviewer: aruna
ms.author: v-lingwu
ms.openlocfilehash: e0c9129a4a1badd8c602b3701f63096b2c9fb8c2
ms.sourcegitcommit: f818003595bd7a6aa66b0d3e1e0e92e79b059868
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/06/2019
ms.locfileid: "66732414"
---
...
![Application Insights 趋势](./media/release-notes-vsix/Trends.png)
...
![CodeLens 中的异常](./media/release-notes-vsix/ExceptionsCodeLens.png)
...
![ASP.NET Core 支持](./media/release-notes-vsix/NetCoreSupport.png)
...
![诊断工具支持](./media/release-notes-vsix/DiagnosticTools.png)
...
![适用于 Windows 窗体应用的项目上下文菜单](./media/release-notes-vsix/WinFormContextMenu.png)

这会打开 HockeyApp 上传对话框，它类似于通用 Windows 应用中的对话框。

![Windows 窗体应用的上传对话框](./media/release-notes-vsix/WinFormsUploadDialog.png)
...
![上传完成](./media/release-notes-vsix/LocalSearch.png)
...
![日志记录通知](./media/release-notes-vsix/LoggingToast.png)

在已安装日志记录适配器后，运行应用程序，并确保在诊断工具选项卡中看到数据，如下所示：

![跟踪](./media/release-notes-vsix/Traces.png)
...
![查找匹配项](./media/release-notes-vsix/FindMatch.png)
...
![搜索窗口](./media/release-notes-vsix/SearchWindow.png)
...
![相关项](./media/release-notes-vsix/RelatedItems.png)

### <a name="forward-and-back-history-in-search"></a>前进和后退搜索中的历史记录
现在，可以在搜索结果之间来回切换。

![回退](./media/release-notes-vsix/GoBAck.png)
...
![搜索窗口](./media/release-notes-vsix/search.png)
...
![诊断工具页](./media/release-notes-vsix/diagtools.png)
...
![“新建项目”对话框](./media/release-notes-vsix/newproject.png)
