---
title: Azure Application Insights 中的仪表板和导航 | Azure Docs
...
ms.date: 6/4/2019
ms.author: v-lingwu
ms.openlocfilehash: f83a6c148604cb4404be09d1e5e461ec584e0fc4
ms.sourcegitcommit: f818003595bd7a6aa66b0d3e1e0e92e79b059868
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/06/2019
ms.locfileid: "66732233"
---
# <a name="navigation-and-dashboards-in-the-application-insights-portal"></a>Application Insights 门户中的导航与仪表板
[在项目中设置 Application Insights](../../azure-monitor/app/app-insights-overview.md) 之后，有关应用性能和使用情况的遥测数据将出现在 [Azure 门户](https://portal.azure.cn)中项目的 Application Insights 资源内。

## <a name="find-your-telemetry"></a>查找遥测数据
登录到 [Azure 门户](https://portal.azure.cn)，并导航到为应用创建的 Application Insights 资源。
...
登录[世纪互联 Azure 门户](https://portal.azure.cn)后，最先看到的是仪表板。 可以将所有最重要的 Azure 资源的图表整合到此处，包括来自 [Azure Application Insights](../../azure-monitor/app/app-insights-overview.md) 的遥测数据。
...
5. **编辑仪表板**：将鼠标悬停在某个磁贴上，然后使用其上栏来移动、自定义或删除该磁贴。
...
* 时间范围最多为 1 小时：每 5 分钟刷新一次
* 时间范围 1 - 24 小时：每 15 分钟刷新一次
* 时间范围为 24 小时以上：（时间范围）/60。

### <a name="pin-any-query-in-analytics"></a>固定 Analytics 中的任何查询
还可以[将 Analytics 图表固定](../../azure-monitor/log-query/get-started-portal.md)到共享的仪表板。 这样，便可以添加任意查询以及标准指标的图表。 
...
* [**指标资源管理器**](../../azure-monitor/app/metrics-explorer.md) - 创建自己的性能和使用情况图表。
...
* [**自动化脚本**](../../azure-monitor/app/powershell.md) - 导出 Azure 资源的定义，以便可以将它用作模板来创建新资源。
...
|  |  |
| --- | --- |
| [指标资源管理器](../../azure-monitor/app/metrics-explorer.md)<br/>筛选器和分段指标 |![搜索示例](./media/app-insights-dashboards/64.png) |
| [诊断搜索](../../azure-monitor/app/diagnostic-search.md)<br/>查找和检查事件及其相关事件，以及创建 Bug |![搜索示例](./media/app-insights-dashboards/61.png) |
| [分析](../../azure-monitor/app/analytics.md)<br/>功能强大的查询语言 |![搜索示例](./media/app-insights-dashboards/63.png) |
