...
ms.date: 01/21/19
ms.author: v-lingwu
ms.openlocfilehash: c999b3244e4fe176c48780834e2aa45ff821bb06
ms.sourcegitcommit: 7e25a709734f03f46418ebda2c22e029e22d2c64
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/20/2019
ms.locfileid: "56440445"
---
...
存储在数据库中的已收集数据的保留期取决于所选的定价计划。 对于“免费”层，收集的数据可以使用 7 天。 对于*付费*层，收集的数据默认情况下可以使用 31 天，但可以延长到 730 天。 数据在 Azure 存储中采用静态加密存储，以确保数据机密性，并且数据通过本地冗余存储 (LRS) 在本地区域内进行复制。 最近两周的数据也存储在基于 SSD 的缓存中，此缓存已加密，但以下区域除外：
