---
title: 在 Azure Monitor 中收集 Nagios 和 Zabbix 警报 | Azure Docs
...
> [!NOTE]
> [Azure Monitor 创建的警报](alerts-overview.md)与日志数据分开存储，无法通过日志查询进行访问。
...
* 了解 Azure Monitor 中的[警报](alerts-overview.md)。
