...
ms.date: 01/21/19
ms.author: v-lingwu
ms.openlocfilehash: 3860ab2c14e4733b37933e8101243b70b1668190
ms.sourcegitcommit: b8fb6890caed87831b28c82738d6cecfe50674fd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/29/2019
ms.locfileid: "58625267"
---
...
| 错误代码  |                                                                                                                                                                                                      含义                                                                                                                                                                                                      |
|-------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| NOT_DEFINED |                                                                                                                                                        由于未安装必需的依赖项，将不会安装 auoms auditd 插件                                                                                                                                                        |
...
3. 仔细检查下列 Log Analytics 终结点是否在允许列表中：
