...
ms.date: 11/19/2018
ms.author: v-lingwu
ms.openlocfilehash: e938201175d16eb87440418b9d3ab6f0332df89c
ms.sourcegitcommit: fd927ef42e8e7c5829d7c73dc9864e26f2a11aaa
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/04/2019
ms.locfileid: "67562880"
---
...
- 查看代码或工具中引用的 URI。 经典 API 使用 URI https://management.core.chinacloudapi.cn 。 应使用基于资源管理器的 API 的较新 URI，它以 https://management.azure.com/ 开头。
