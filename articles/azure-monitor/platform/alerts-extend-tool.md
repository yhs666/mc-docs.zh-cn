---
title: 将警报从 Log Analytics 扩展到 Azure China Cloud 云
...
ms.openlocfilehash: 870a6dc409b2e8acfaa87ec7ad1efd6d5b0e2340
ms.sourcegitcommit: 7e25a709734f03f46418ebda2c22e029e22d2c64
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/20/2019
ms.locfileid: "56440380"
---
# <a name="extend-alerts-from-log-analytics-into-azure-alerts"></a>将警报从 Log Analytics 扩展为 Azure 警报
OMS 门户中的警报功能正在被 Azure China Cloud 云中的 Azure 警报所取代。 在此过渡过程中，最初在 Log Analytics 中配置的警报将扩展到 Azure 中。 如果不想等待它们自动移入 Azure，可以启动该过程：

- 从 Operations Management Suite 门户手动启动。 
- 使用 AlertsVersion API 以编程方式启动。  

> [!NOTE]
> 从 2019 年 3 月 1 日开始，Azure 会以系统方式将在 Log Analytics 的 Azure China Cloud OMS 门户实例中创建的警报自动扩展到 Azure 警报。 如果在创建[操作组](../../azure-monitor/platform/action-groups.md)的过程中出现任何问题，请执行[这些修正步骤](alerts-extend-tool.md#troubleshooting)，以便自动创建操作组。 2019 年 3 月 15 日之前，可以在 Azure China Cloud OMS 门户中使用这些步骤。

## <a name="option-1-initiate-from-the-operations-management-suite-portal"></a>选项 1：从 Operations Management Suite 门户启动
以下步骤介绍了如何从 Azure China Cloud 云的 Operations Management Suite 门户扩展工作区的警报。  
...
> [!IMPORTANT]
> 如果基于 Azure China Cloud 云的 OMS 门户用户在 2019 年 3 月 15 日之前未采取以下补救措施，警报将在 Azure 中运行，但不会触发任何操作或通知。 若要获取警报的通知，必须在 Azure 中手动编辑其警报规则并添加[操作组](../../azure-monitor/platform/action-groups.md)
