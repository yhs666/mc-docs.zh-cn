...
ms.date: 01/21/19
ms.author: v-lingwu
ms.openlocfilehash: 02397b5cb933fbc77a99a6b5b65163af7afbf524
ms.sourcegitcommit: 7e25a709734f03f46418ebda2c22e029e22d2c64
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/20/2019
ms.locfileid: "56440769"
---
...
>[!NOTE]
>在从 Azure Operations Management Suite (OMS) 持续过渡到 Azure Monitor 期间，OMS 网关将称为 Log Analytics 网关。 
>
...
* 装有的 Azure Monitoring Agent 直接连接到 Log Analytics 工作区的 Windows 计算机
...
1. 从[下载中心](https://www.microsoft.com/download/details.aspx?id=54443)下载。
...
若要了解如何设计和部署 Windows Server 2016 网络负载均衡群集，请参阅[网络负载均衡](https://technet.microsoft.com/windows-server-docs/networking/technologies/network-load-balancing)。  以下步骤介绍如何配置 Azure 网络负载均衡群集。  

1. 使用管理帐户登录到属于 NLB 群集的 Windows 服务器。  
1. 在服务器管理器中打开网络负载均衡管理器，单击“工具”，并单击“网络负载均衡管理器”。
1. 若要连接装有 Azure Monitoring Agent 的 Log Analytics 网关服务器，请右键单击群集的 IP 地址，然后单击“将主机添加到群集”。<br><br> ![网络负载均衡管理器 – 将主机添加到群集](./media/gateway/nlb02.png)<br> 
...
* 已在网关服务器上安装 Azure Monitoring Agent（代理版本 - **8.0.10900.0** 或以上），并在其中配置了相同的 Log Analytics 工作区，且管理组已配置为向这些工作区报告。
...
1. 在“重写属性”对话框中，勾选“WebProxyAddress”参数旁边的“重写”列。  在“重写值”字段中，输入 Log Analytics 网关服务器的 URL，请确保以 `http://` 前缀开头。  
    ...
    >[!NOTE]
    > 不需要启用该规则，因为面向 Azure System Center 顾问监视服务器组的 Azure System Center 顾问安全引用重写管理包中包含的某个重写会自动管理该规则。
    >   
