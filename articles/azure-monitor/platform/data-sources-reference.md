...
ms.author: johnkem
ms.component: ''
ms.openlocfilehash: fd97a678286fd8a92f2d8bd0a64521cc2610f926
ms.sourcegitcommit: 023ab8b40254109d9edae1602c3488d13ef90954
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/09/2019
ms.locfileid: "54141762"
---
...
| 账单数据 | 指标 | 所有 Azure 服务 | <ul><li>**REST API：**[Azure 资源使用状况和 RateCard API](../../billing/billing-usage-rate-card-overview.md)</li></ul> |
...
| Azure Monitor 诊断日志 | 事件 | [请参阅此处的列表](tutorial-dashboards.md) | <ul><li>**存储 blob 或事件中心：**[诊断设置](diagnostic-logs-overview.md#diagnostic-settings)</li></ul> |
...
| Active Directory 报告 | 事件 | Azure Active Directory | <ul><li>**REST API：**[Azure Active Directory 图形 API](../../active-directory/reports-monitoring/concept-reporting-api.md)</li></ul> |
