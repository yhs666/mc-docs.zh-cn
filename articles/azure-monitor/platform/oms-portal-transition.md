...
ms.date: 04/12/19
ms.author: v-lingwu
ms.openlocfilehash: 2bd35445ceb6d0b9d7a09dd232e1c07cd7903371
ms.sourcegitcommit: 5738c2b28f5cd95a52847591b26cf310afd81394
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/14/2019
ms.locfileid: "65586758"
---
...
**Azure 公有云的 OMS 门户已正式停用。Azure 美国政府云的 OMS 门户将于 2019 年 5 月 15 日正式停用。** 我们很高兴能够转移到 Azure 门户，并且希望实现轻松过渡。 但我们也知道，变化会带来一定的困扰。 将任何问题、反馈或疑虑发送到 **LAUpgradeFeedback\@microsoft.com**。 本文的剩余部分介绍此项过渡的关键场景和路线图。
...
参阅 [Log Analytics 用户从 OMS 门户过渡到 Azure 门户时的常见问题](oms-portal-faq.md)，了解有关如何过渡到 Azure 门户的信息。 将任何反馈、问题或疑虑发送到 **LAUpgradeFeedback\@microsoft.com**。
...
Azure 网络安全组分析解决方案将被最近推出的[流量分析](https://azure.microsoft.com/blog/traffic-analytics-in-preview/)取代。在流量分析中可以洞察云网络上的用户和应用程序活动。 流量分析可帮助你审核组织的网络活动、保护应用程序和数据、优化工作负荷性能和保持符合性。 
