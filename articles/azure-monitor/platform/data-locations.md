...
ms.date: 05/21/2019
ms.author: v-lingwu
ms.openlocfilehash: 661d22a729561a6c20ba96421375f63cdf0d1067
ms.sourcegitcommit: fd927ef42e8e7c5829d7c73dc9864e26f2a11aaa
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/04/2019
ms.locfileid: "67562878"
---
...
| Azure Monitor 日志    | 基于 Azure 数据资源管理器的 Log Analytics 工作区，它提供了功能强大的分析引擎和丰富的查询语言。 | Log Analytics<br>[Log Analytics API](https://dev.loganalytics.io/)<br>[Application Insights API](https://dev.applicationinsights.io/reference/get-query) |
