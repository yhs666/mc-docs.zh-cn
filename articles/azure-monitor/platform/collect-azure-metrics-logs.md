---
title: 为 Log Analytics 收集 Azure 服务日志和指标 | Azure 文档
...
ms.date: 01/21/19
ms.author: v-lingwu
ms.openlocfilehash: 270014dae662c92641e5b44970ceef7d37f61c15
ms.sourcegitcommit: 7e25a709734f03f46418ebda2c22e029e22d2c64
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/20/2019
ms.locfileid: "56440960"
---
...
| 服务                 | 资源类型                           | 日志        | 指标     | 解决方案 |
| --- | --- | --- | --- | --- |
| 应用程序网关    | Microsoft.Network/applicationGateways   | 诊断 | 诊断 | 
| Application insights    |                                         | 连接器   | 连接器   |
...
| 密钥保管库               | Microsoft.KeyVault/vaults               | 诊断 |             | [密钥保管库分析](../../azure-monitor/insights/azure-key-vault.md) |
...
| 网络安全组 | Microsoft.Network/networksecuritygroups | 诊断 |             | 
...
需要 [Azure PowerShell](https://docs.microsoft.com/powershell/azure/overview) 的 2016 年 11 月版 (v2.3.0) 或更高版本。

下面的 PowerShell 示例演示如何使用 [Set-AzureRmDiagnosticSetting](https://docs.microsoft.com/powershell/module/azurerm.insights/set-azurermdiagnosticsetting) 对网络安全组启用诊断。 同一方法适用于所有受支持的资源 - 将 `$resourceId` 设置为要为其启用诊断的资源的资源 ID。
...
Azure 模板库有[使用 Azure 自动化的示例](https://www.azure.cn/resources/templates/?term=OMS)，可从服务收集数据并将数据发送到 Log Analytics。
