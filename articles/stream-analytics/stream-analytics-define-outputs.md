...
ms.date: 07/10/2017
ms.author: v-yeche
ms.openlocfilehash: 5a298e17839b1a923aeefb1231f4f241d34700fb
...
Blob 存储提供了一种经济高效且可缩放的解决方案，用于在云中存储大量非结构化数据。  有关 Azure Blob 存储及其用法的简介，请参阅[如何使用 Blob](../storage/storage-dotnet-how-to-use-blobs.md) 处的文档。
