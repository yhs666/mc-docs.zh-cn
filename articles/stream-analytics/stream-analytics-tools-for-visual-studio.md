...
ms.date: 11/06/2017
ms.author: v-yeche
ms.openlocfilehash: 1aed652f9eba0a83746836714a17e75841bc01d6
...
* 安装 Visual Studio 2017、Visual Studio 2015、Visual Studio 2013 Update 4。 支持 Enterprise (Ultimate/Premium)、Professional、Community 版本；不支持 Express 版本。 
* 请按照[安装说明](/stream-analytics/stream-analytics-tools-for-visual-studio-install)安装用于 Visual Studio 的流分析工具。

## <a name="create-a-stream-analytics-project"></a>创建流分析项目
在 Visual Studio 中，单击“文件”菜单并选择“新建项目”。 从左侧的模板列表中选择“流分析”，并单击“Azure 流分析应用程序”。
...
9.  单击页面底部的“保存”，完成向导操作。 现在，可以添加另一个输入源来创建出口流。 右键单击输入节点，并单击“新建项”。
...
11. 在项目中双击“ExitStream.json”，并遵循配置入口流时使用的相同步骤填写信息。 请确保按以下屏幕截图所示输入“事件中心名称”的值：
...
12. 在项目中右键单击“输入”节点，并遵循配置流输入时使用的相同过程，但这次要选择“引用数据”而不是“数据流”，并且“输入别名”是 **Registration**。
...
1.  在“解决方案资源管理器”中展开“输入”节点，并双击“Output.json”。
2.  将“输出别名”设置为 **output**，并将“接收器”设置为“SQL 数据库”。
...
在“服务器资源管理器”中单击“流分析作业”，并单击“刷新”。 “流分析作业”下面应会出现作业。
