...
ms.date: 10/02/2017
ms.author: v-yeche
ms.openlocfilehash: d11938a2847ade0e51728a832bc28b129ef0289f
...
**System.Timestamp** 列包含已分配给事件的时间戳。 当事件抵达源时，会在输入源中分配到达时间。 到达时间是事件中心输入的 **EventEnqueuedTime**，Blob 输入的 [Blob 上次修改时间](https://docs.microsoft.com/dotnet/api/microsoft.windowsazure.storage.blob.blobproperties.lastmodified?view=azurestorage-8.1.3)。 生成事件时，会分配应用程序时间。应用程序时间是有效负载的一部分。 
