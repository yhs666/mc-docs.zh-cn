...
* **用户定义函数：** 流分析已与 Azure 机器学习集成，可定义机器学习服务中的函数调用作为流分析查询的一部分。 这可扩展流分析的功能，以便利用现有的 Azure 机器学习解决方案。 关于这方面的详细信息，请参阅 [机器学习集成教程](stream-analytics-machine-learning-integration-tutorial.md)。
