...
|应用服务|5|启用应用服务中的诊断日志|启用日志并将其保留长达一年。 这样便可以在发生安全事件或网络遭泄露时，重新创建活动线索用于调查目的。 |
...
|应用服务|10 个|为 Web 应用程序配置 IP 限制|定义允许访问应用程序的 IP 地址列表。 使用 IP 限制保护 Web 应用程序免受常见攻击的威胁。|
...
|计算资源 (Service Fabric)|10 个|在 Service Fabric 中使用 Azure Active Directory 进行客户端身份验证|在 Service Fabric 中仅通过 Azure Active Directory 执行客户端身份验证。|
|计算资源（自动化帐户）|5| 启用自动化帐户加密|存储敏感数据时，请启用自动化帐户变量资产加密。|
|计算资源（负载均衡器）|5|启用负载均衡器中的诊断日志|启用日志并将其保留长达一年。 这样便可以在发生安全事件或网络遭泄露时，重新创建活动线索用于调查目的。 |
|计算资源（搜索）|5|启用搜索服务中的诊断日志|启用日志并将其保留长达一年。 这样便可以在发生安全事件或网络遭泄露时，重新创建活动线索用于调查目的。 |
|计算资源（服务总线）|5|启用服务总线中的诊断日志|启用日志并将其保留长达一年。 这样便可以在发生安全事件或网络遭泄露时，重新创建活动线索用于调查目的。 |
|计算资源（流分析）|5|启用 Azure 流分析中的诊断日志|启用日志并将其保留长达一年。 这样便可以在发生安全事件或网络遭泄露时，重新创建活动线索用于调查目的。 |
|计算资源 (Service Fabric)|5|启用 Service Fabric 中的诊断日志|启用日志并将其保留长达一年。 这样便可以在发生安全事件或网络遭泄露时，重新创建活动线索用于调查目的。 |
|计算资源 (Batch)|5|启用 Batch 帐户中的诊断日志|启用日志并将其保留长达一年。 这样便可以在发生安全事件或网络遭泄露时，重新创建活动线索用于调查目的。 |
|计算资源（事件中心）|5|启用事件中心内的诊断日志|启用日志并将其保留长达一年。 这样便可以在发生安全事件或网络遭泄露时，重新创建活动线索用于调查目的。 |
...
|虚拟机规模集|10 个|在虚拟机规模集上安装 Endpoint Protection 解决方案|在虚拟机规模集上安装 Endpoint Protection 解决方案，使其免受威胁和漏洞的侵害。 |
