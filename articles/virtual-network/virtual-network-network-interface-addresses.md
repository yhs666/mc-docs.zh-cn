...
ms.date: 06/05/2017
ms.author: v-dazen
ms.openlocfilehash: 62c176196ea41f2dd375747cd2572b1d07294282
...
7. 可以遵循[将多个 IP 地址分配到虚拟机](virtual-network-multiple-ip-addresses-portal.md#os-config)一文中的说明，手动将辅助专用 IP 地址添加到 VM 操作系统。 请勿向 VM 操作系统添加任何公共 IP 地址。
