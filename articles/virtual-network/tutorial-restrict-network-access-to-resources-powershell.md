...
ms.author: v-yeche
ms.custom: ''
ms.openlocfilehash: b3169a908f7db0d29decb5e7f1eb46a9f801c3e2
ms.sourcegitcommit: cdcb4c34aaae9b9d981dec534007121b860f0774
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/15/2019
ms.locfileid: "56306262"
---
...
通过虚拟网络服务终结点，可以将某些 Azure 服务资源限制为仅允许某个虚拟网络子网通过网络进行访问。 还可以删除对资源的 Internet 访问。 服务终结点提供从虚拟网络到受支持 Azure 服务的直接连接，使你能够使用虚拟网络的专用地址空间访问 Azure 服务。 通过服务终结点发往 Azure 资源的流量始终保留在 Azure 主干网络上。 在本文中，学习如何：
...
使用 [New-AzureStorageShare](https://docs.microsoft.com/powershell/module/azure.storage/new-azurestorageshare) 创建一个文件共享：
...
访问被拒绝，并且会收到 *Get-AzureStorageFile：远程服务器返回了错误：(403) 禁止访问。HTTP 状态代码：403 - HTTP 错误消息：此请求无权执行此操作* 错误，因为你的计算机不在 *MyVirtualNetwork* 虚拟网络的 *Private* 子网中。
