...
ms.date: 03/31/2017
ms.author: v-dazen
ms.openlocfilehash: 11601b16ae688da26c6c111d51686501a8754df6
...
- [Azure CLI 1.0](#create-a-virtual-network) - 适用于经典部署模型和资源管理部署模型（本文）的 CLI
...
1. 请按照[安装和配置 Azure CLI](../cli-install-nodejs.md) 一文中的步骤安装和配置 Azure CLI。
