...
### 如何开始？
请访问[虚拟网络文档](./index.md)帮助自己入门。这些内容提供了所有 VNet 功能的概述和部署信息。
...
### VNet 的 DNS 选项有哪些？
使用[](./virtual-networks-name-resolution-for-vms-and-role-instances.md)“VM 和角色实例的名称解析”页的决策表，引导你浏览提供的所有 DNS 选项。
...
### 是否有 VNet 的工具支持？
是的。详细了解以下操作：
- 使用 Azure 门户预览通过 [Azure Resource Manager](./virtual-networks-create-vnet-arm-pportal.md) 和[经典](./virtual-networks-create-vnet-classic-pportal.md)部署模型部署 VNet。
