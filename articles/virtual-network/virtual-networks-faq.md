...
ms.date: 03/26/2018
ms.author: v-yeche
ms.openlocfilehash: f913da049d209f260629742a857b2f08700f4f37
...
是的。 可以通过 Azure 应用商店部署许多供应商提供 [WAN 优化网络虚拟设备](https://market.azure.cn/zh-cn/marketplace/apps?search=wan+optimization) 。
...
是的。 可以通过 Azure 应用商店部署许多供应商提供 [防火墙网络虚拟设备](https://market.azure.cn/zh-cn/marketplace/apps?search=firewall) 。
...
- 使用 PowerShell 来管理通过 [Resource Manager](https://docs.microsoft.com/powershell/module/azurerm.network) 和[经典](https://docs.microsoft.com/powershell/module/azure/?view=azuresmps-3.7.0)部署模型部署的 VNet。
