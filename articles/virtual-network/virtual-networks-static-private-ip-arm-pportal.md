---
title: "为 VM 配置专用 IP 地址 - Azure 门户预览版 | Azure"
description: "了解如何使用 Azure 门户预览版为虚拟机配置专用 IP 地址。"
...
---
# <a name="configure-private-ip-addresses-for-a-virtual-machine-using-the-azure-portal-preview"></a>使用 Azure 门户预览版为虚拟机配置专用 IP 地址

> [!div class="op_single_selector"]
> * [Azure 门户预览版](virtual-networks-static-private-ip-arm-pportal.md)
> * [PowerShell](virtual-networks-static-private-ip-arm-ps.md)
> * [Azure CLI](virtual-networks-static-private-ip-arm-cli.md)
> * [Azure 门户预览版（经典）](virtual-networks-static-private-ip-classic-pportal.md)
...
在 Resource Manager 部署模型中创建 VM 时，不能使用 Azure 门户预览版设置静态专用 IP 地址。 必须先创建 VM，然后再将其专用 IP 设置为静态。
...
2. 单击“**新建**” > “**计算**” > “**Windows Server 2012 R2 Datacenter**”（注意此时“**选择部署模型**”列表已显示“**Resource Manager**”），然后单击“**创建**”，如下图所示。
    ...
    ![在 Azure 门户预览版中创建 VM](./media/virtual-networks-static-ip-arm-pportal/figure01.png)
...
7. 在“**摘要**”边栏选项卡中，单击“**确定**”。 注意，以下磁贴将显示在仪表板中。
    ...
    ![在 Azure 门户预览版中创建 VM](./media/virtual-networks-static-ip-arm-pportal/figure06.png)
...
1. 在 Azure 门户预览版中，单击“全部浏览” > “虚拟机” > “DNS01” > “所有设置” > “网络接口”，然后单击列出的唯一网络接口。
...
2. 键入 *192.168.1.101* 作为“**IP 地址**”，然后单击“**保存**”。
    ...
    ![在 Azure 门户预览版中创建 VM](./media/virtual-networks-static-ip-arm-pportal/figure09.png)
