...
description: "了解如何使用 Azure 门户预览版将多个 IP 地址分配给虚拟机 | Resource Manager。"
...
---
# <a name="assign-multiple-ip-addresses-to-virtual-machines-using-the-azure-portal-preview"></a>使用 Azure 门户预览版将多个 IP 地址分配给虚拟机

>[!INCLUDE [virtual-network-multiple-ip-addresses-intro.md](../../includes/virtual-network-multiple-ip-addresses-intro.md)]
>
本文介绍如何使用 Azure 门户预览版通过 Azure Resource Manager 部署模型创建虚拟机 (VM)。 无法将多个 IP 地址分配给通过经典部署模型创建的资源。 若要详细了解 Azure 部署模型，请阅读 [Understand deployment models](../resource-manager-deployment-model.md)（了解部署模型）一文。
...
1. 根据需要浏览到 Azure 门户预览版（网址为 https://portal.azure.cn）并登录。
