...
ms.date: 12/12/2016
ms.author: v-dazen
ms.openlocfilehash: 22ed02db7200e39931842237733a4167a787f4ca
...
本文介绍经典部署模型。 你还可以[在 Resource Manager 部署模型中创建 NSG](virtual-networks-create-nsg-arm-cli.md)。
...
3. 运行 **`azure network nsg create`** 命令来创建 NSG。
...
1. 运行 **`azure network nsg create`** 命令来创建 NSG。
