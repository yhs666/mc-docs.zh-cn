...
ms.date: 12/11/2017
ms.author: v-yeche
ms.openlocfilehash: a10885ea330add8d6191cdd40268e541d995773f
...
与不使用 RSS 的 VM 相比，使用接收方缩放 (RSS) 的 VM 可达到更高的最大吞吐量。 RSS 在 Windows VM 中默认已禁用。 完成以下步骤以确定是否启用了 RSS 并在已禁用它时启用它。
