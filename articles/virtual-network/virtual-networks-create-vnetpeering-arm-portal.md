...
ms.date: 03/31/2017
ms.author: v-dazen
ms.openlocfilehash: b8f5287192a3bdf470b90f32c2df491ce06056fe
...
5. 以用户 B 身份登录到 Azure 门户，该用户是订阅 B 的特权用户。 遵循上述步骤将用户 A 添加到“网络参与者”角色，如下图中所示：
...
3. 若要在此方案中建立 VNET 对等互连，只需创建一个链接，从 Azure Resource Manager 中的虚拟网络连接到经典部署模型中的另一个虚拟网络。 即，从 **VNET1** 到 **VNET2**。 在门户中，单击“浏览”>，然后选择“虚拟网络”
