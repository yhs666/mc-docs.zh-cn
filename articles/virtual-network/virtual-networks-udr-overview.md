...
ms.author: v-yeche
ms.custom: ''
ms.openlocfilehash: 5795d8453db53692e0152775c88fee72a4799737
...
- [确定下一跃点类型](../network-watcher/network-watcher-check-next-hop-portal.md?toc=%2fvirtual-network%2ftoc.json)（虚拟机和目标 IP 地址之间）。 Azure 网络观察程序下一跃点功能用于确定流量是否离开子网并路由到你所期望的位置。
