...
ms.openlocfilehash: ae559ed75384d9e3fadf736dc5120ec3e21d7795
...
需要先创建具有此方案需要的所有资源的 *IaaSStory* 资源组，才能创建数据库服务器。 若要创建这些资源，请完成以下步骤。 若要创建虚拟网络，请完成[创建虚拟网络](virtual-networks-create-vnet-classic-netcfg-ps.md)一文中的步骤。
