...
ms.date: 07/24/2017
ms.author: v-dazen
ms.openlocfilehash: 2bdb4ac1069bd16d1580a1768a33a75110f637a9
...
- 若要了解用于将虚拟网络连接到本地网络的选项，请参阅[关于 VPN 网关](../vpn-gateway/vpn-gateway-about-vpngateways.md?toc=%2fvirtual-network%2ftoc.json#about-vpn-gateway)。
