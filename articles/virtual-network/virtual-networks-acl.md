...
> [!IMPORTANT]
> Azure 具有两种不同的[部署模型](../azure-resource-manager/resource-manager-deployment-model.md?toc=%2fvirtual-network%2ftoc.json)，用于创建和处理资源：资源管理器部署模型和经典部署模型。 本文介绍使用经典部署模型的情况。 Azure 建议大多数新部署使用 Resource Manager 部署模型。 
