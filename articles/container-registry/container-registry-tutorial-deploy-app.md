...
![在浏览器中查看已部署的 Web 应用程序][deployed-app-chinanorth]
...
![在浏览器中查看已部署的 Web 应用程序][deployed-app-chinaeast]
...
[deployed-app-chinanorth]: ./media/container-registry-tutorial-deploy-app/deployed-app-westus.png
[deployed-app-chinaeast]: ./media/container-registry-tutorial-deploy-app/deployed-app-eastus.png
<!--Notice: image should be eastus and westus -->
<!-- Update_Description: new article on container registry tutorial deploy app -->
<!--ms.date: 07/02/2018-->