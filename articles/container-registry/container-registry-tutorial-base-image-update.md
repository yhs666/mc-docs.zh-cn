...
如果想本地使用 Azure CLI，则必须已安装 Azure CLI 版本 2.0.32 或更高版本。 运行 `az --version` 即可查找版本。 如果需要安装或升级 CLI，请参阅[安装 Azure CLI][azure-cli]。
...
[az-acr-build]: https://docs.azure.cn/zh-cn/cli/acr?view=azure-cli-latest#az-acr-build-run
...
<!-- Update_Description: new article on container registry tutorial base image update -->
<!--ms.date: 07/02/2018-->