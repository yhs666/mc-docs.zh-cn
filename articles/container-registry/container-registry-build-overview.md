...
Azure CLI 中的 [az acr build][az-acr-build] 命令使用我们熟悉的 `docker build` 格式，它会提取本地上下文，将其发送到 ACR Build 服务，并在完成后，默认将生成的映像推送到其注册表。 ACR Build 遵循异地复制的注册表，可让分散在各地的开发团队利用最靠近的复制注册表。 在预览期，ACR Build 只能在中国东部和中国北部区域使用。
...
[az-acr-build-task]: https://docs.azure.cn/zh-cn/cli/acr?view=azure-cli-latest#az-acr-build-task
[az-login]: https://docs.azure.cn/zh-cn/cli/reference-index?view=azure-cli-latest#az-login
[az-login-service-principal]: https://docs.azure.cn/zh-cn/cli/authenticate-azure-cli?view=azure-cli-latest#log-in-with-a-service-principal

<!-- IMAGES -->
[quick-build-01-fork]: ./media/container-registry-tutorial-quick-build/quick-build-01-fork.png
[quick-build-02-browser]: ./media/container-registry-tutorial-quick-build/quick-build-02-browser.png

<!-- Update_Description: new article on container registry build overview -->
<!--ms.date: 07/02/2018-->
