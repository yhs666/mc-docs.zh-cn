...
ms.date: 07/10/2017
ms.author: v-yiso
ms.openlocfilehash: 81414ec6d990f6d8e48fa15a22be987a36601c6d
...
<a id="comparison-of-azure-iot-hub-and-azure-event-hubs" class="xliff"></a>
...
| 缩放 |已经过优化，可支持数百万个同时连接的设备。 |按照 [Azure 服务总线配额][Azure Service Bus quotas]计量连接。 另一方面，事件中心可让你为每个发送的消息指定分区。 |
