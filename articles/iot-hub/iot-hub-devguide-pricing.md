...
ms.date: 07/10/2017
ms.author: v-yiso
ms.openlocfilehash: 5b429474edddef90de874106e524df2dad1b3715
...
---
# Azure IoT 中心定价信息
<a id="azure-iot-hub-pricing-information" class="xliff"></a>

[Azure IoT 中心定价][lnk-pricing] 概述了 IoT 中心的不同 SKU 和定价。 本文还详述了 IoT 中心如何按消息对各种 IoT 中心功能计费。

## 每个操作的费用
<a id="charges-per-operation" class="xliff"></a>
...
| 设备孪生更新（标记和属性） | 设备间进行的设备孪生更新作为消息以 512 字节块大小为单位收费。 例如，读取 6-KB 的设备孪生按 12 条消息收费。 |
