...
ms.openlocfilehash: 90bf91d546537b003beded50266d3dc12f53b76c
...
* Maven 3。  <br/> [准备开发环境][lnk-dev-setup]介绍了如何在 Windows 或 Linux 上安装本教程所用的 [Maven][lnk-maven]。
...
1. 使用文本编辑器，打开 invoke-direct-method 文件夹中的 pom.xml 文件，并在 **dependencies** 节点中添加以下依赖项。 此依赖项使得你可以使用应用中的 iot-service-client 包来与 IoT 中心进行通信：
...
1. 将以下类级变量添加到 **App** 类。 将 **{youriothubname}** 替换为你的 IoT 中心名称，将 **{yourhubkey}** 替换为在*创建设备标识*部分中生成的设备密钥值：
