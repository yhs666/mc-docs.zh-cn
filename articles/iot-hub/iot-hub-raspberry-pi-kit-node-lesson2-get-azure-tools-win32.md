...
ms.date: 05/08/2017
ms.author: v-yiso
ms.openlocfilehash: dc83196e8b2d41bcf7acfc4807686e9a2f74341c
...
安装 Python 和 Azure 命令行接口 (Azure CLI)。 如果有任何问题，请在[故障排除页面](./iot-hub-raspberry-pi-kit-node-troubleshooting.md )上查找解决方案。
