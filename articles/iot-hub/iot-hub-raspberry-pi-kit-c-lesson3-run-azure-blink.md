...
ms.date: 05/08/2017
ms.author: v-yiso
ms.openlocfilehash: f104c0bbf39987fc926d85c2a2de75a3d617c095
...
本文介绍如何在 Raspberry Pi 3 上部署和运行示例应用程序，以便将消息发送到 IoT 中心。 如果有任何问题，请在[故障排除页面](./iot-hub-raspberry-pi-kit-c-troubleshooting.md)上查找解决方案。
