...
ms.date: 05/08/2017
ms.author: v-yiso
ms.openlocfilehash: add42285aedeefa01f29cd8dc75f4e8007b63be3
...
安装 Python 和 Azure 命令行接口 (Azure CLI)。 如果有任何问题，请在[故障排除页面](./iot-hub-raspberry-pi-kit-c-troubleshooting.md)上查找解决方案。
