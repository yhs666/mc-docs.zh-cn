...
ms.date: 05/08/2017
ms.author: v-yiso
ms.openlocfilehash: 0af6684a766be14ece01575b1c270a4fea143059
...
安装 Azure 命令行界面 (Azure CLI)。 如果遇到任何问题，请在适用于 Adafruit Feather M0 WiFi Arduino 开发板的[故障排除页](./iot-hub-adafruit-feather-m0-wifi-kit-arduino-troubleshooting.md)查找解决方案。
