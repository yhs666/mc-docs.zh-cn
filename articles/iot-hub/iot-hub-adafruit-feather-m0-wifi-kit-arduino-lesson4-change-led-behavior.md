...
ms.date: 05/08/2017
ms.author: v-yiso
ms.openlocfilehash: c571345a331166cd383b909b36c66adb8f13f7cc
...
自定义这些消息，以便更改 LED 的开关行为。 如果遇到任何问题，请在适用于 Adafruit Feather M0 WiFi Arduino 开发板的[故障排除页](./iot-hub-adafruit-feather-m0-wifi-kit-arduino-troubleshooting.md)查找解决方案。
