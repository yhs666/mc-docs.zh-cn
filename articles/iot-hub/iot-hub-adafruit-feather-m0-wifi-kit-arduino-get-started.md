...
* 一个有效的 Azure 订阅。 如果没有 Azure 帐户，只需花费几分钟就能[创建一个 Azure 试用帐户](https://azure.microsoft.com/free/)。
...
### <a name="install-the-package-for-feather-m0-wifi-in-the-arduino-ide"></a>在 Arduino IDE 中安装 Feather M0 WiFi 的包
