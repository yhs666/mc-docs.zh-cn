---
title: "使用 Python 将设备上的文件上传到 Azure IoT 中心"
...
ms.date: 03/19/2018
ms.author: v-yiso
ms.openlocfilehash: cd478ee74d9045bf7056997ffdfe7df64286e097
...
此教程介绍了如何使用 [IoT 中心的文件上传功能](iot-hub-devguide-file-upload.md)将文件上传到 [Azure Blob 存储](/storage/)。 本教程介绍如何：
