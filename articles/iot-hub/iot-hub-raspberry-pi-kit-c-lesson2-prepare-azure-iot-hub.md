...
ms.date: 05/08/2017
ms.author: v-yiso
ms.openlocfilehash: af9e25b2566d6a44309142fe6c7c623eebf7b55f
...
[创建 Azure 函数应用和 Azure 存储帐户，以便处理和存储 IoT 中心消息](./iot-hub-raspberry-pi-kit-c-lesson3-deploy-resource-manager-template.md)。