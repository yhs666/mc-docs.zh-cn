...
1. 在 dm-get-started 文件夹的命令提示符处，使用以下命令创建名为 trigger-reboot 的 Maven 项目。 请注意，这是一条很长的命令：
...
1. 在 dm-get-started 文件夹的命令提示符处，使用以下命令创建名为 simulated-device 的 Maven 项目。 请注意，这是一条很长的命令：
...
1. 将以下代码添加到 main 方法，实例化 DeviceClient：
