...
- 使用 Azure CLI 获取 BLE（蓝牙低能耗）示例应用程序的 IoT 中心和 SensorTag 信息。 配置和运行 BLE 示例应用程序。 
...
## <a name="set-up-the-connectivity-between-sensortag-and-intel-nuc"></a>设置 SensorTag 与 Intel NUC 之间的连接
...
## <a name="verify-that-the-ble-sample-application-works"></a>确认 BLE 示例应用程序可以正常运行
