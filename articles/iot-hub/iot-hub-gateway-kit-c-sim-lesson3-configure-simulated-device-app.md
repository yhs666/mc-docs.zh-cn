...
ms.date: 05/08/2017
ms.author: v-yiso
ms.openlocfilehash: 8b0a78e50bb5efc028e070ab46b25758bcba26b9
ms.sourcegitcommit: 033f4f0e41d31d256b67fc623f12f79ab791191e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/21/2017
---
# <a name="configure-and-run-a-simulated-device-sample-app"></a>配置和运行模拟设备示例应用
...
## <a name="verify-the-sample-application-works"></a>确认示例应用程序可以正常运行
