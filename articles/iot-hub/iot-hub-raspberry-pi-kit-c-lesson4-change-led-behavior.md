...
ms.date: 05/08/2017
ms.author: v-yiso
ms.openlocfilehash: e517bf4ed19ad3e2cdde0b35b96a1008a6a96868
...
自定义这些消息，以便更改 LED 的开关行为。 如果有任何问题，请在[故障排除页面](./iot-hub-raspberry-pi-kit-c-troubleshooting.md)上查找解决方案。
