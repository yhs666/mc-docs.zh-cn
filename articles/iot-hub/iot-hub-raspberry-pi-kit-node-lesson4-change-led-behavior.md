...
ms.date: 05/08/2017
ms.author: v-yiso
ms.openlocfilehash: 7e42a051b0b6d2483549ea23702b3bf57ac4b3ae
...
自定义这些消息，以便更改 LED 的开关行为。 如果有任何问题，请在[故障排除页面](./iot-hub-raspberry-pi-kit-node-troubleshooting.md)上查找解决方案。
