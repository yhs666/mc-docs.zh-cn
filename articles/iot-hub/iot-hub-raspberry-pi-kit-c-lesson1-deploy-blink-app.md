...
ms.date: 05/08/2017
ms.author: v-yiso
ms.openlocfilehash: dbbe0db679f67d45727ab640607a0364b2edf7eb
...
克隆 GitHub 提供的示例 C 应用程序，并使用 gulp 工具将该示例应用程序部署到 Raspberry Pi 3。 此示例应用程序每隔两秒让连接到板的 LED 闪烁一次。 如果有任何问题，请在[故障排除页面](./iot-hub-raspberry-pi-kit-c-troubleshooting.md)上查找解决方案。
...
### <a name="install-the-azure-iot-hub-sdk-on-pi"></a>在 Pi 上安装 Azure IoT 中心 SDK
