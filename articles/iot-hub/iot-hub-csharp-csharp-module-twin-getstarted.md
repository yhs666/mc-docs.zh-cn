...
3. **获取模块连接字符串** -- 现在，如果登录到 [Azure 门户](https://portal.azure.cn/)。 导航到 IoT 中心并单击 IoT 设备。 查找并打开 myFirstDevice，可以看到 myFirstModule 已成功创建。 复制模块连接字符串。 下一步将需要它。
