...
ms.date: 05/08/2017
ms.author: v-yiso
ms.openlocfilehash: e5e9dda65d6a009edb56f1d8ac6af49b7a04daf5
...
安装 Python 和 Azure 命令行接口 (Azure CLI)。 如果遇到任何问题，请在适用于 Adafruit Feather M0 WiFi Arduino 开发板的[故障排除页](./iot-hub-adafruit-feather-m0-wifi-kit-arduino-troubleshooting.md)查找解决方案。
