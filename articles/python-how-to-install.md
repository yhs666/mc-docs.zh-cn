...
ms.date: 09/06/2016
ms.author: v-junlch
ms.openlocfilehash: 87c5b7844e5db5ff2b23eefdac1638bc3a070265
...
---
# 安装 Python 和 SDK
<a id="installing-python-and-the-sdk" class="xliff"></a>
...
<a id="whats-in-the-python-azure-sdk" class="xliff"></a>
...
## 要使用哪种 Python 以及哪个版本
<a id="which-python-and-which-version-to-use" class="xliff"></a>
...
## 从哪里获得 Python？
<a id="where-to-get-python" class="xliff"></a>
...
<a id="sdk-installation-on-windows-linux-and-macos-client-libraries-only" class="xliff"></a>
...
## 获取多个软件包
<a id="getting-more-packages" class="xliff"></a>

[Python 包索引][] (PyPI) 提供丰富的 Python 库。  如果选择安装发行版本，表明你重点关注的是从 Web 开发到技术计算的各种方案。

## Python Tools for Visual Studio
<a id="python-tools-for-visual-studio" class="xliff"></a>
...
PTVS 适用于你现有的 Visual Studio 2013 或 2015 版本的安装。  有关文档、下载和讨论的信息，请参阅 [针对 Visual Studio 的 Python 工具]。  

## Python Azure 方案适用于 Linux 和 MacOS
<a id="python-azure-scenarios-for-linux-and-macos" class="xliff"></a>
...
对于 VM 方案，只需启动所选的 Linux VM（Ubuntu、CentOS、Suse）并运行/管理所需内容。  例如，您可以在 Windows/Mac/Linux 计算机上运行 [IPython][] REPL/notebook，并使您的浏览器指向在 Azure 上运行 IPython 引擎的 Linux 或 Windows 多处理器 VM。 请参阅 [Azure 上的 IPython Notebook][] 教程，以了解详细信息。
...
## 其他软件和资源：
<a id="additional-software-and-resources" class="xliff"></a>
...
[针对 Visual Studio 的 Python 工具]: http://aka.ms/ptvs
...
[使用 Azure 网站配置 Python]:./app-service-web/web-sites-python-configure.md
