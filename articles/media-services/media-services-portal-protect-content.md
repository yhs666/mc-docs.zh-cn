...
ms.date: 09/25/2017
ms.author: v-johch
ms.openlocfilehash: 828031738af09e2ba76a2a8e51bb43413b5ffc93
...
> [!NOTE]
> 如果使用 Azure 经典门户创建了保护策略，这些策略可能不会在 [Azure 门户](https://portal.azure.cn/)中显示。 但是，所有旧的策略仍然存在。 可以使用 Azure 媒体服务 .NET SDK 或 [Azure 媒体服务资源管理器](https://github.com/Azure/Azure-Media-Services-Explorer/releases)工具进行检查（若要查看这些策略，右键单击此资产 ->“显示信息 (F4)”->单击“内容密钥”选项卡 ->单击此密钥）。 
> 
...
AMS 支持通过多种方式对发出密钥或许可证请求的用户进行身份验证。 必须配置内容密钥授权策略且客户端必须遵守该策略，才能将密钥/许可证传送到客户端。 内容密钥授权策略可能受到一种或多种授权限制：**开放**或**令牌**限制。
