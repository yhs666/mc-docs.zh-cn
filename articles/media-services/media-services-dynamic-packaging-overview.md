...
ms.date: 08/07/2017
ms.author: v-haiqya
ms.openlocfilehash: 41a91a0a1024e423f3896fe035594d4468bc52f1
...
1. [使用 Media Encoder Standard 编码器生成 H.264 MP4 自适应比特率集](./media-services-dotnet-encode-with-media-encoder-standard.md)。
1. [流式传输内容](./media-services-deliver-content-overview.md)。
