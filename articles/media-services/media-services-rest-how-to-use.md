...
ms.date: 01/13/2017
ms.author: v-johch
ms.openlocfilehash: 336c5f63a722ca4e11ed65fafa5b3220e7e9d67e
...
client-request-id|字符串|调用方定义的值，用于标识给定请求。 如果指定，此值将包含在响应消息中，作为一种映射请求的方法。 <p><p>重要说明<p>值的上限应为 2096b (2k)。
