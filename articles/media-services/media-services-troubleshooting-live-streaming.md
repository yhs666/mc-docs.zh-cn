...
ms.date: 10/12/2016
ms.author: v-johch
ms.openlocfilehash: 1deef8546a4f7c21664a2214af9d93b484aa21f6
...
###<a name="problem-unable-to-playback-the-published-stream"></a>问题：无法播放已发布的流。
...
>[!NOTE]
> 如果遵循故障排除步骤后仍然无法成功流式处理，请使用 Azure 管理门户提交支持票证。