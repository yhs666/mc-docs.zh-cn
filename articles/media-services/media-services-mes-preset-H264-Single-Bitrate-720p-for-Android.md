...
ms.date: 09/04/2017
ms.author: v-haiqya
ms.openlocfilehash: 8ec26974f58af17eec8e8d208955a5fea0901ad4
...
此预设会生成单个 MP4 文件，其比特率为 2000 kbps，并且带有立体声 AAC。 若要深入了解此预设的配置文件、比特率、采样率等，请检查下面定义的 XML 或 JSON。 有关这些预设中的每个元素的含义及其有效值的说明，请参阅 [Media Encoder Standard 架构](media-services-mes-schema.md)主题。  
