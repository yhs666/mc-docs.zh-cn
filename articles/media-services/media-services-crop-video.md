...
ms.date: 01/23/2017
ms.author: v-johch
ms.openlocfilehash: 7450f3ae128f3b7ce8a1ad2b7ca7134a9a5819e1
...
假设输入视频的分辨率为 1920x1080 像素（16:9 纵横比），不过因为左侧和右侧有黑色长条（圆柱框），导致包含活动视频的区域只有 4:3 窗口或 1440x1080 像素。 你可以使用 MES 裁剪或去掉黑色长条，然后编码 1440x1080 区域。
