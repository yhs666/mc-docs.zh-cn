---
title: 从 Azure 媒体服务 v2 迁移到 v3 | Azure
...
* 在媒体服务 v3 中，仅当资产是使用媒体服务 v2 创建的时才支持存储加密（AES-256 加密）以实现向后兼容性。 这意味着 v3 会处理现有的存储加密资产，但不会允许创建新资产。
    ...
    对于使用 v3 创建的资产，媒体服务支持 [Azure 存储](https://docs.azure.cn/storage/common/storage-service-encryption?toc=%2fazure%2fstorage%2fblobs%2ftoc.json)服务器端存储加密。
