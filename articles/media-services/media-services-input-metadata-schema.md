...
ms.date: 12/12/2016
ms.author: v-johch
ms.openlocfilehash: b60e9ce2e71024062a469c8b0c4d7691cda5525c
...
若要检查元数据文件，可以创建 **SAS** 定位器并将文件下载到本地计算机。 可以就如何创建 SAS 定位器并下载[使用媒体服务 .NET SDK 扩展](./media-services-dotnet-get-started.md)的文件，找到相关示例。  
