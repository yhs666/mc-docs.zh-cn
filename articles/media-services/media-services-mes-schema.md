...
本主题介绍 [Media Encoder Standard 预设](./media-services-mes-presets-overview.md)以其为基础的 XML 架构的一些元素和类型。本主题介绍元素及其有效值。将在以后发布完整架构。
...
## 示例
有关基于此架构生成的 XML 预设的示例，请参阅 [MES \(Media Encoder Standard\) 的任务预设](./media-services-mes-presets-overview.md)。
