...
ms.date: 12/25/2017
ms.author: v-nany
ms.openlocfilehash: bfa04aabb286d762d5d1e02e25bf6baf7b7ae7df
...
本文介绍如何使用 .NET 通过 Media Encoder Standard (MES) 对资产进行编码。 Media Encoder Standard 使用[此处](media-services-mes-presets-overview.md)所述的编码器预设之一进行配置。
