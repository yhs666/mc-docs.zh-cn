...
ms.date: 09/25/2017
ms.author: v-johch
ms.openlocfilehash: 80f39d62ac642b8e8bdfc3f35089dbf7f882436a
...
启动频道时可[配置编码器](media-services-configure-elemental-live-encoder.md#configure_elemental_rtp)。
...
3. 创建新的输出时，可选择“新建流”，然后单击“添加输出”。  
   ...
   >
   >
4. 由于已创建输出，此时可单击“添加流”。 现在可以配置输出设置。
...
1. 一旦确认频道可以播放，则可创建节目。 在 AMSE 工具的“实时”选项卡下，右键单击节目区域，然后选择“新建节目”。  
