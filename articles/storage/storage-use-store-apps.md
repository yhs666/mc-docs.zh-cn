...
ms.date: 06/15/2017
ms.author: v-johch
ms.openlocfilehash: 0498a7827537a18d4c1112447d01562c818196c6
...
此代码假定有两个字符串变量：*accountName* 和 *accountKey*。 它们分别表示存储帐户名称及与该帐户关联的帐户密钥。
...
引用 WCF 数据服务 NuGet 程序包后，在按钮的 Click 事件中更改代码： 
