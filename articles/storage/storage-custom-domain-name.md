...
ms.date: 06/26/2017
ms.author: v-johch
ms.openlocfilehash: fde00e1b26507f521b04b100384e90a1c47de781
...
---
# 为 Blob 存储终结点配置自定义域名
<a id="configure-a-custom-domain-name-for-your-blob-storage-endpoint" class="xliff"></a>
...
## 直接域映射与中间域映射
<a id="direct-vs-intermediary-domain-mapping" class="xliff"></a>

可以通过两种方法将自定义域映射到存储帐户的 Blob 终结点：直接 CNAME 映射和使用 asverify 中间子域。

### 直接 CNAME 映射
<a id="direct-cname-mapping" class="xliff"></a>
...
### 使用 asverify 进行中间映射
<a id="intermediary-mapping-with-asverify" class="xliff"></a>
...
## 注册自定义域
<a id="register-a-custom-domain" class="xliff"></a>
...
## 使用 asverify 子域注册自定义域
<a id="register-a-custom-domain-using-the-asverify-subdomain" class="xliff"></a>
...
1. 在“自定义域”边栏选项卡上选择“保存”注册自定义域。 如果注册成功，你将看到一条门户通知，指出存储帐户已成功更新。 此时，你的自定义域已由 Azure 进行了验证，但传输到你的域的流量尚未路由到你的存储帐户。
...
## 测试自定义域
<a id="test-your-custom-domain" class="xliff"></a>
...
## 取消注册自定义域
<a id="deregister-a-custom-domain" class="xliff"></a>
...
成功删除自定义域后，你将看到一条门户通知，指出已成功更新存储帐户。
