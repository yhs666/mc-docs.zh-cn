...
ms.date: 03/27/2017
ms.author: v-johch
ms.openlocfilehash: d72961a4b844fee409866aeb7ebcbb3021d64e0b
...
本指南将演示如何使用 Azure Blob 服务执行常见方案。 示例是用 PHP 编写的，并使用了 [Azure SDK for PHP][download]。 涉及的任务包括上传、列出、下载和删除 Blob。 有关 Blob 的详细信息，请参阅 [后续步骤](#next-steps) 部分。
