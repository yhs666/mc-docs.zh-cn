...
ms.date: 03/05/2018
ms.author: v-johch
ms.openlocfilehash: 2cf5d3f4e185832b22e2b95270e8315f9bc0b59a
...
本指南演示如何使用 Azure Blob 服务执行常见方案。 示例采用 PHP 编写，并使用了[适用于 PHP 的 Azure 存储 Blob 客户端库][download]。 涉及的任务包括上传、列出、下载和删除 Blob。 有关 Blob 的详细信息，请参阅 [后续步骤](#next-steps) 部分。
...
若要创建 Azure Blob 服务客户端，需要使用 BlobRestProxy 类。 方法：
