...
ms.date: 05/07/2018
ms.author: v-johch
ms.openlocfilehash: 1bb551cedfd37e4d35dc9887923efd82d5836cf5
...
如果选择在本地安装并使用 CLI，此快速入门教程要求运行 Azure CLI 2.0.4 版或更高版本。 运行 `az --version` 即可确定你的版本。 如果需要进行安装或升级，请参阅[安装 Azure CLI 2.0](/cli/install-azure-cli)。
