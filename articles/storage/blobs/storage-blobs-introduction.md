...
ms.author: v-jay
ms.component: blobs
ms.openlocfilehash: 4e4adbb6a588b6855ccde73ed5ee6469d2ef5cc4
ms.sourcegitcommit: 5eff40f2a66e71da3f8966289ab0161b059d0263
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/10/2019
ms.locfileid: "54192915"
---
...
- Azure 导入/导出服务提供了一种方法，可将大量数据从存储帐户导出到你提供的硬盘，然后 Azure 会将带数据的硬盘寄回给你。 有关详细信息，请参阅[使用 Azure 导入/导出服务将数据传输到 Blob 存储中](../common/storage-import-export-service.md)。
