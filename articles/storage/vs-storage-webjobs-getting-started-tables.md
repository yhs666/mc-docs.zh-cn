...
ms.date: 01/06/2017
ms.author: v-johch
ms.openlocfilehash: de831fb10b0ce8afdca1ae4ba46501e638a77cfd
...
本文提供了 C# 代码示例，用于演示如何在 Azure 表存储服务中使用 Azure WebJobs SDK 版本 1.x。 这些代码示例使用 [WebJobs SDK](../app-service-web/websites-dotnet-webjobs-sdk.md) 版本 1.x。
...
有关如何处理队列消息触发的表处理，或者不特定于表处理的 WebJobs SDK 方案的信息，请参阅[开始使用 Azure 队列存储和 Visual Studio 连接服务（Web 作业项目）](./vs-storage-webjobs-getting-started-queues.md)。 
