...
ms.date: 08/14/2017
ms.author: v-haiqya
ms.openlocfilehash: 17e430f15125607d1b88a94b65878ab8b827ceb8
...
例如，如果应用程序需要最大 250 MB/秒的吞吐量，而使用的是有单个 P30 磁盘的 DS4 VM。 该 DS4 VM 可以提供高达 256 MB/秒的吞吐量。 但是，单个 P30 磁盘的吞吐量限制为 200 MB/秒。 因此，应用程序会因磁盘限制而限制为 200 MB/秒。 为了克服此限制，可为 VM 预配多个数据磁盘，或者将磁盘大小调整为 P40 或 P50。
