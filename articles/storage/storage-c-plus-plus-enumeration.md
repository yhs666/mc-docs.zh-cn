...
ms.date: 03/20/2017
ms.author: v-johch
ms.openlocfilehash: 0ebe58623eecbaea5fbb2e272589103d9edce480
...
如果还要使用 C# 或 Oracle Java SDK，则应熟悉枚举型编程模式，该模式提供懒惰形式的列表，仅在需要时才提取具有特定偏移量的数据。 在 C++ 中，基于迭代器的模板也提供了类似方法。
