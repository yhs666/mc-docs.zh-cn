...
ms.date: 01/06/2017
ms.author: v-johch
ms.openlocfilehash: 413252340477e33e1d9f302de9f8319183badb19
...
PartitionKey 和 RowKey 都必须是字符串值。 有关详细信息，请参阅 [Understanding the Table Service Data Model](http://msdn.microsoft.com/zh-cn/library/azure/dd179338.aspx)（了解表服务数据模型）。
...
如果操作成功，`result` 将包含插入记录的 [ETag](http://zh.wikipedia.org/wiki/HTTP_ETag)，并且 `response` 将包含有关操作的信息。
