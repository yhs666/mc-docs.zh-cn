---
title: "有关 Azure IaaS VM 磁盘的常见问题解答 (FAQ) | Azure"
...
ms.date: 08/14/2017
ms.author: v-haiqya
ms.openlocfilehash: 0b651e0e35dd43f952109991361e0df8e2e8aa39
...
* [使用 Azure CLI 复制托管磁盘](/storage/scripts/storage-linux-cli-sample-copy-managed-disks-to-same-or-different-subscription?toc=%2fcli%2fmodule%2ftoc.json)
* [使用 PowerShell 复制托管磁盘](/storage/scripts/storage-windows-powershell-sample-copy-managed-disks-to-same-or-different-subscription?toc=%2fcli%2fmodule%2ftoc.json)
...
如果未在此处找到相关问题，请联系我们获取帮助。 可以在本文末尾的评论中发布问题。 若要与 Azure 存储团队和其他社区成员就本文进行沟通，请使用 MSDN [Azure 存储论坛](https://social.msdn.microsoft.com/Forums/en-US/home?forum=windowsazuredata)。
