...
---
# <a name="frequently-asked-questions-about-azure-iaas-vm-disks-and-managed-and-unmanaged-premium-disks"></a>有关 Azure IaaS VM 非托管高级磁盘的常见问题

本文提供有关非托管磁盘和高级存储的一些常见问题的解答。

## <a name="premium-disks--both-managed-and-unmanaged"></a>高级磁盘 – 非托管
