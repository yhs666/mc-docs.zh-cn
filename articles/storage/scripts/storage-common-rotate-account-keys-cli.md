...
ms.date: 10/23/2017
ms.author: v-johch
ms.openlocfilehash: 706b4662c69bada9cb5c2130410fbe8cd3fce2d9
...
| [az storage account keys list](https://docs.microsoft.com/cli/azure/storage/account/keys#list) | 显示指定帐户的存储帐户访问密钥。 |
| [az storage account keys renew](https://docs.microsoft.com/cli/azure/storage/account/keys#renew) | 重新生成主或辅助存储帐户访问密钥。 |
