...
ms.openlocfilehash: 5f1c8a7f6c996cb4a2a9b8b77d1019a96d41a14b
...
与 Hadoop 中的其他 FileSystem 实现一样，ABFS 驱动程序自行定义 URI 方案，让资源（目录和文件）能够得到明确处理。 如需了解 URI 方案，请参阅[使用 Azure Data Lake Storage Gen2 URI](./introduction-abfs-uri.md)。 URI 的结构是 `abfs[s]://file_system@account_name.dfs.core.chinacloudapi.cn/<path>/<path>/<file_name>`
