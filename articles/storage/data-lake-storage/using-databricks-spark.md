...
ms.date: 12/10/2018
ms.author: v-jay
ms.openlocfilehash: c272148d92809611391f517f522518e4ca0a320d
ms.sourcegitcommit: 5f2849d5751cb634f1cdc04d581c32296e33ef1b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/07/2018
ms.locfileid: "53028760"
---
...
1. 创建一个 [Databricks 服务](https://ms.portal.azure.cn/#create/Microsoft.Databricks)，将其命名为 **myFlightDataService**（确保在创建此服务时勾选“固定到仪表板”复选框）。
...
14. 将以下代码粘贴到 **Cmd 1** 单元格中，将值替换为存储帐户中保留的值。
    ...
    dbutils.fs.ls("abfs://<file_system>@<account_name>.dfs.core.chinacloudapi.cn/")
...
azcopy cp "<DOWNLOAD_FILE_PATH>" https://<ACCOUNT_NAME>.dfs.core.chinacloudapi.cn/dbricks/folder1/On_Time --recursive 
```
...
source = "abfs://<FILE_SYSTEM_NAME>@<ACCOUNT_NAME>.dfs.core.chinacloudapi.cn/"
