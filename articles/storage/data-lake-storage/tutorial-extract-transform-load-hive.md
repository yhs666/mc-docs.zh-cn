...
* **Azure CLI 2.0**。 如果尚未安装 Azure CLI，请参阅[安装 Azure CLI](/cli/install-azure-cli?view=azure-cli-latest)了解详细步骤。
...
[azure-1rmb-trial]: https://www.azure.cn/zh-cn/pricing/1rmb-trial-full/?form-type=identityauth
