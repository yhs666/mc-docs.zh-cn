...
> [!NOTE]
>有关虚拟机容量的详细信息，请参阅 [Linux 虚拟机的大小](../virtual-machines/virtual-machines-linux-sizes.md)。
> 
...
## 后续步骤
* [附加磁盘](../virtual-machines/virtual-machines-linux-add-disk.md)可为 VM 添加额外的存储。
* [配置软件 RAID](../virtual-machines/virtual-machines-linux-configure-raid.md) 以实现冗余。
* [捕获 Linux 虚拟机](../virtual-machines/virtual-machines-linux-classic-capture-image.md) 以便可以快速部署更多 VM。
