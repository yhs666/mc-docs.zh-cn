...
ms.date: 06/26/2017
ms.author: v-johch
ms.openlocfilehash: 874c7aeb02765f2210a6fde2091a3ccc02542553
ms.sourcegitcommit: cc3f528827a8acd109ba793eee023b8c6b2b75e4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/23/2017
---
# 确定何时使用 Azure Blob、Azure 文件或 Azure 数据磁盘
<a id="deciding-when-to-use-azure-blobs-azure-files-or-azure-data-disks" class="xliff"></a>
...
## 比较：文件和 Blob
<a id="comparison-files-and-blobs" class="xliff"></a>
...
## 比较：文件和数据磁盘
<a id="comparison-files-and-data-disks" class="xliff"></a>
...
有关数据磁盘的详细信息，请参阅[管理磁盘和映像](storage-about-disks-and-vhds-linux.md)和[如何将数据磁盘附加到 Windows 虚拟机](../virtual-machines/windows/classic/attach-disk.md)。