...
ms.date: 08/28/2017
ms.author: v-haiqya
ms.openlocfilehash: 5f6b64f4eca8a7347be4f0b15e2987509e658638
...
在创建导入作业之前，需要通过调用 [列出位置](https://docs.microsoft.com/rest/api/storageimportexport/listlocations) 操作获取寄送位置名称和地址。 
