---
title: 使用 Azure 门户通过 RBAC 管理 Azure AD 对 Azure 存储的访问权限 - Azure 存储 | Microsoft Docs
...
ms.openlocfilehash: f364671ac885cf86b2dd05d8cd719ccaed997165
ms.sourcegitcommit: a0b9a3955cfe3a58c3cd77f2998631986a898633
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/13/2019
ms.locfileid: "65549968"
---
# <a name="grant-access-to-azure-storage-with-rbac-in-the-azure-portal"></a>在 Azure 门户中通过 RBAC 授予对 Azure 存储的访问权限

Azure Active Directory (Azure AD) 通过[基于角色的访问控制 (RBAC)](../../role-based-access-control/overview.md) 授权访问受保护的资源。 Azure 存储定义一组内置的 RBAC 角色，这些角色包含常见的用于访问存储资源的权限集。 
