---
title: "排查删除 Azure 存储帐户、容器或 VHD 时发生的错误 | Azure"
...
ms.date: 08/28/2017
ms.author: v-haiqya
ms.openlocfilehash: 414ac64e0fdba85aae2733b19f7c323c7f5a8bbd
...
2. 检查“磁盘 URL”来识别存储帐户以及阻止删除该存储帐户的 VHD。 在以下示例中，“.blob.core.chinacloudapi.cn”前面的字符串是存储帐户名称，“SCCM2012-2015-08-28.vhd”是 VHD 名称。  
...
6. 应删除 VM，但可以保留 VHD。 但是，VHD 上不应该再有租约。 可能需要几分钟才能释放租约。 若要确认是否已释放租用，请转到“所有资源” > “存储帐户名称” > “Blob” > “VHD”。 在“Blob 属性”窗格中，“租用状态”值应为“已解锁”。
