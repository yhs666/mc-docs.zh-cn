...
| *T5*     | 从次要区域 <br>读取实体                           |                                  | T1                 | 获取员工实体的过时值， <br> 因为事务 B 尚未 <br> 复制。 得到管理员角色实体<br> 的新值，因为 C <br> 复制。 上次同步时间仍未<br> 更新，因为事务 B<br> 尚未复制。 可以判断出<br>管理员角色实体不一致， <br>因为实体日期/时间晚于 <br>上次同步时间。 |
