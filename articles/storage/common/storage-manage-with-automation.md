...
[Azure 自动化](https://www.azure.cn/home/features/automation/)是用于通过流程自动化简化云管理的一项 Azure 服务。 对于长时间运行、需人工操作、易出错和经常重复的任务，使用 Azure 自动化可自动提高其可靠性、效率并减少组织实现价值所需的时间。
