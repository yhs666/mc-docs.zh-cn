...
ms.openlocfilehash: 4e450e280bd163498745b839787765006d96c880
ms.sourcegitcommit: 0fd74557936098811166d0e9148e66b350e5b5fa
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/22/2019
ms.locfileid: "56665644"
---
...
|`ContainerSas`|String|当且仅当未指定 `StorageAccountKey` 时，导入作业才需要此元素。 用于访问与作业关联的 Blob 的容器 SAS。 有关其格式，请参阅[放置作业](https://docs.microsoft.com/rest/api/storageimportexport/jobs)。导出操作的清单中会省略此元素。|  
