...
如果没有 Azure 订阅，可在开始前创建一个 [1 元人民币试用订阅](https://www.azure.cn/zh-cn/pricing/1rmb-trial-full/?form-type=identityauth)。

## <a name="prerequisites"></a>先决条件

要完成本教程，请下载最新版本的 AzCopy on [Linux](/storage/common/storage-use-azcopy-linux#download-and-install-azcopy) 或 AzCopy on [Windows](https://aka.ms/downloadazcopy)。 
