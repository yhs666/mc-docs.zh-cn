...
ms.date: 08/28/2017
ms.author: v-haiqya
ms.openlocfilehash: e4b726cf5ce417238db13cd3f6a5b4d8a7bb5105
...
如果应用程序的需求超过单个存储帐户的可伸缩性目标，可在构建应用程序时让应用程序使用多个存储帐户，并将数据对象分布到这些存储帐户中。 有关批量定价的信息，请参阅 [Azure 存储定价](https://www.azure.cn/pricing/details/storage/) 。
...
请参阅 [Windows VM 大小](../../virtual-machines/windows/sizes.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json)或 [Linux VM 大小](../../virtual-machines/windows/sizes.md?toc=%2fvirtual-machines%2flinux%2ftoc.json)了解其他详细信息。
