...
ms.author: v-jay
ms.component: common
ms.openlocfilehash: 1b023090d5b3bdd4cfe5a70d0008bd62d27dd34c
ms.sourcegitcommit: 317ea7e3b2d307569d3bf7777bd3077013ae4df6
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/16/2019
ms.locfileid: "54334501"
---
...
如果数据的使用模式有所更改，可以随时在这些访问层之间切换。 有关访问层的详细信息，请参阅 [Azure Blob 存储：热存储层和冷存储层](../blobs/storage-blob-storage-tiers.md)。
