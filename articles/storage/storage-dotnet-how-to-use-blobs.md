...
<a id="get-started-with-azure-blob-storage-using-net" class="xliff"></a>
...
### 创建 Blob 服务客户端
<a id="create-the-blob-service-client" class="xliff"></a>
...
## 下载 Blob
<a id="download-blobs" class="xliff"></a>
...
## 删除 Blob
<a id="delete-blobs" class="xliff"></a>
...
## 以异步方式列出页中的 Blob
<a id="list-blobs-in-pages-asynchronously" class="xliff"></a>
...
## 写入追加 Blob
<a id="writing-to-an-append-blob" class="xliff"></a>
...
## 管理 Blob 安全性
<a id="managing-security-for-blobs" class="xliff"></a>
...
### 控制对 Blob 数据的访问
<a id="controlling-access-to-blob-data" class="xliff"></a>
...
### 加密 Blob 数据
<a id="encrypting-blob-data" class="xliff"></a>
...
### Azure 存储资源管理器
<a id="azure-storage-explorer" class="xliff"></a>
...
### Blob 存储参考
<a id="blob-storage-reference" class="xliff"></a>
* [.NET 存储客户端库参考](https://msdn.microsoft.com/library/azure/mt347887.aspx)
* [REST API 参考](https://docs.microsoft.com/rest/api/storageservices/fileservices/azure-storage-services-rest-api-reference)

### 概念性指南
<a id="conceptual-guides" class="xliff"></a>
