...
ms.date: 05/25/2018
ms.author: v-junlch
ms.openlocfilehash: 4777f7fcd45b578f8b97f63ce4f14014b536ae94
ms.sourcegitcommit: 00c8a6a07e6b98a2b6f2f0e8ca4090853bb34b14
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/11/2018
ms.locfileid: "38939534"
---
...
创建并配置缓存后，下一步就是删除托管缓存服务配置，并添加 Azure Redis 缓存配置和引用，让缓存客户端可以访问缓存。
...
如果此命名空间并未解析，请确保已如[快速入门：在 .NET 应用程序中使用 Azure Redis 缓存](cache-dotnet-how-to-use-azure-redis-cache.md)中所述添加了 StackExchange.Redis NuGet 包。
