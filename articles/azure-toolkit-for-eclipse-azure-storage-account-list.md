...
ms.date: 08/25/2017
ms.author: v-junlch
ms.openlocfilehash: dab114418e2814dd9cff2dc6dc3ec3f93a8bc82e
...
2. （如果已在本地计算机上保存了发布设置文件，请跳过此步骤。）在“导入订阅信息”对话框中，单击“下载发布设置文件”。 如果你尚未登录到 Azure 帐户，则系统将提示登录。 然后系统将提示用户保存 Azure 发布设置文件。 （可以忽略登录页中显示的最终说明 - 它们是由 Azure 门户提供的，适用于 Visual Studio 用户。）） 请将该文件保存到本地计算机。
