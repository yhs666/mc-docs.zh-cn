...
命名空间中的任何事件中心启用了捕获选项时，即可启用捕获功能。 事件中心捕获按所购买的吞吐量单位以小时计费。 吞吐量单位计数增加或减少时，事件中心捕获计费将在整个小时增量中反映这些改变。 有关事件中心捕获计费的详细信息，请参阅[事件中心定价信息](https://www.azure.cn/pricing/details/event-hubs/)。
