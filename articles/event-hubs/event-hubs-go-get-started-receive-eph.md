...
按照[使用 Azure CLI 2.0 创建 Azure 服务主体](https://docs.azure.cn/zh-cn/cli/create-an-azure-service-principal-azure-cli?view=azure-cli-latest)中的说明创建新的服务主体。 使用以下名称将提供的凭据保存在环境中。 预先配置 Azure SDK for Go 和事件中心包，以便查找这些变量名称。
