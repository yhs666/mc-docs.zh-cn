...
az eventhubs namespace create --name namespaceName --resource-group myResourceGroup -l chinaeast

# Create an event hub
az eventhubs eventhub create --name eventHubName --resource-group myResourceGroup --namespace-name namespaceName

# Create a general purpose standard storage account
az storage account create --name storageAccountName --resource-group myResourceGroup --location chinaeast --sku Standard_RAGRS --encryption blob
...
final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
        .setEndpoint("Your Event Hubs Endpoint URL")
