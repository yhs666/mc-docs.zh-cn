...
ms.date: 10/14/2019
ms.author: v-jay
ms.openlocfilehash: 58c59b9bb3b564cba03c6e6b9912feee67936518
ms.sourcegitcommit: aea45739ba114a6b069f782074a70e5dded8a490
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/11/2019
ms.locfileid: "72275524"
---
...
>[!TIP]
>有关使用 Azure 数据资源管理器连接器的演练，请参阅[使用 Azure 数据工厂向/从 Azure 数据资源管理器复制数据](../data-explorer/data-factory-load-data.md)。
...
>[!NOTE]
>使用 ADF UI 创作时，登录用户帐户用于列出 Azure 数据资源管理器群集、数据库和表。 如果没有此类操作的权限，请手动输入名称。
...
| noTruncation | 指示是否截断返回的结果集。 默认情况下，结果在 500,000 条记录或 64 MB 之后被截断。 强烈建议截断以确保活动的行为正常。 |否 |
