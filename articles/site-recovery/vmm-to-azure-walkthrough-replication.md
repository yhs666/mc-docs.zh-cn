---
title: "设置复制策略以使用 Azure Site Recovery 将 Hyper-V VM（包含 VMM）复制到 Azure | Azure"
...
ms.date: 08/28/2017
ms.author: v-yeche
ms.openlocfilehash: 567a4d97591304ac7d89cd688304245c159b3a2e
ms.sourcegitcommit: 1ca439ddc22cb4d67e900e3f1757471b3878ca43
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/25/2017
---
# <a name="step-10-set-up-a-replication-policy-for-hyper-v-vm-replication-with-vmm-to-azure"></a>步骤 10：设置复制策略以将 Hyper-V VM 复制（使用 VMM）到 Azure
