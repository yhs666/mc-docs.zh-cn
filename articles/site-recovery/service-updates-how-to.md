---
title: Azure Site Recovery 更新 | Azure
...
ms.date: 08/05/2019
ms.author: v-yeche
ms.openlocfilehash: 742fb3d4cda8bfa00c8a2e16946af7c53d581a2b
ms.sourcegitcommit: a1c9c946d80b6be66520676327abd825c0253657
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/06/2019
ms.locfileid: "68819582"
---
...
## <a name="expiry-of-components"></a>组件到期
Site Recovery 通过电子邮件通知（如果已订阅）或门户中的保管库仪表板通知客户即将到期或已过期的组件。 如果你现在要保护 Hyper-V VM，则无法使用保管库仪表板通知。 此外，如果你导航到与方案相对应的基础结构视图，则组件旁边会有一个“可用更新”按钮，它会将你重定向到下载最新版本的链接。
...
2. 请参阅[服务更新](https://www.azure.cn/what-is-new/)，确定哪个 Site Recovery 组件版本支持所要升级到的特定版本。
...
对于此方案，我们强烈建议[启用](/site-recovery/azure-to-azure-autoupdate)自动更新。 可选择允许 Site Recovery 通过以下方式管理更新：
...
1. 下载 Azure Site Recovery 提供程序的更新汇总。
