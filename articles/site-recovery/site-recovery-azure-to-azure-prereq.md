...
ms.date: 08/28/2017
ms.author: v-yeche
ms.openlocfilehash: ac85ba8ec070e64d985fd19f989fa6f2fe73e565
...
存储指南 | 请确保按照源 Azure 虚拟机的[存储指南](../storage/common/storage-scalability-targets.md)进行操作，避免出现任何性能问题。 如果按照默认设置，Site Recovery 会基于源配置创建所需的存储帐户。 如果自定义和选择自己的设置，请确保遵从[虚拟机磁盘的可伸缩性目标](../storage/common/storage-scalability-targets.md)。
<!-- Not Available on #scalability-targets-for-virtual-machine-disks -->
**联网指南** | 需要将特定 URL 或 IP 范围的 Azure VM 出站连接列入允许列表。 有关更多详细信息，请参阅[有关复制 Azure 虚拟机的网络指南](site-recovery-azure-to-azure-networking-guidance.md)一文。
