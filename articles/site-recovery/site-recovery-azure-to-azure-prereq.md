...
ms.date: 07/31/2017
ms.author: v-yeche
ms.openlocfilehash: 37facba44529cde3a909b32105d0f1f77f1241ba
...
存储指南 | 请确保按照源 Azure 虚拟机的[存储指南](../storage/storage-scalability-targets.md#scalability-targets-for-virtual-machine-disks)进行操作，避免出现任何性能问题。 如果按照默认设置，Site Recovery 会基于源配置创建所需的存储帐户。 如果自定义和选择自己的设置，请确保遵从[虚拟机磁盘的可伸缩性目标](../storage/storage-scalability-targets.md#scalability-targets-for-virtual-machine-disks)。
