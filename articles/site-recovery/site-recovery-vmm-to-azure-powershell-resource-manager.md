...
* 需要一个 [Azure](https://www.azure.cn/) 帐户。 如果没有帐户，可先使用[试用帐户](https://www.azure.cn/pricing/1rmb-trial)。 此外，可以阅读 [Azure Site Recovery Manager 定价](https://www.azure.cn/pricing/details/site-recovery/)。
...
* [如何在 Azure 中配置和监视虚拟网络](/virtual-network/)
