...
ms.date: 07/10/2017
ms.author: v-yeche
ms.openlocfilehash: 91930de365bcfd91d267159a2807ca24bd894039
...
<a id="replicate-hyper-v-virtual-machines-in-vmm-clouds-to-azure-using-powershell-and-azure-resource-manager" class="xliff"></a>
...
### VMM 先决条件
<a id="vmm-prerequisites" class="xliff"></a>
...
## 步骤 5：创建 Azure 存储帐户
<a id="step-5-create-an-azure-storage-account" class="xliff"></a>
...
<a id="step-6-install-the-azure-recovery-services-agent" class="xliff"></a>

1. 从 [http://aka.ms/latestmarsagent](https://technet.microsoft.com/zh-cn/library/jj721575.aspx) 下载 Azure 恢复服务代理，并将其安装在 VMM 云中要保护的每个 Hyper-V 主机服务器上。
...
## 步骤 7：配置云保护设置
<a id="step-7-configure-cloud-protection-settings" class="xliff"></a>
...
## 步骤 8：配置网络映射
<a id="step-8-configure-network-mapping" class="xliff"></a>
...
## 步骤 9：为虚拟机启用保护
<a id="step-9-enable-protection-for-virtual-machines" class="xliff"></a>
