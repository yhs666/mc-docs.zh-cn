...
ms.date: 07/31/2017
ms.author: v-yeche
ms.openlocfilehash: 76edfe065147c4963e7363c166415df5a510b2a5
ms.sourcegitcommit: 66db84041f1e6e77ef9534c2f99f1f5331a63316
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/28/2017
---
#  <a name="prerequisites-for-replication-from-on-premises-to-azure-using-azure-site-recovery"></a>使用 Azure Site Recovery 从本地复制到 Azure 时所要满足的先决条件
...
| **先决条件** | **详细信息** |
| --- | --- |
| **Hyper-V 主机** |一台或多台本地服务器，其中运行装有最新更新的 Windows Server 2012 R2 并已启用 Hyper-V 角色，或者运行 Microsoft Hyper-V Server 2012 R2。<br/><br/>Hyper-V 服务器应包含一个或多个虚拟机。<br/><br/>Hyper-V 服务器应直接或通过代理连接到 Internet。<br/><br/>Hyper-V 服务器上应已安装 [KB2961977](https://support.microsoft.com/kb/2961977) 中提到的修补程序。
