...
ms.date: 08/28/2017
ms.author: v-yeche
ms.openlocfilehash: 89b87d41836b04e19850253edead8390b62d9a35
...
1. 请确保 VMM 服务器符合[支持要求](site-recovery-support-matrix-to-sec-site.md)和[部署先决条件](vmm-to-vmm-walkthrough-prerequisites.md)。
...
1. 请确保 Hyper-V 主机/群集符合[支持要求](site-recovery-support-matrix-to-sec-site.md)和[部署先决条件](vmm-to-vmm-walkthrough-prerequisites.md)。
...
3. 如本文中所述设置 Site Recovery。 在保管库中创建和注册 VMM 服务器、设置复制策略，并启用复制。 源和目标 VMM 名称是相同的。 指定要通过网络进行初始复制。
