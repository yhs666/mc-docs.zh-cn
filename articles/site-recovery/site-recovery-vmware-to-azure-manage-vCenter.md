...
ms.date: 08/28/2017
ms.author: v-yeche
ms.openlocfilehash: 26e6d44b22025825e45bf54bb5ef467bb931b1ca
...
* **迁移**：如果只想要将 VMware 虚拟机迁移到 Azure，而不对其进行故障回复，可以使用具有只读角色的 VMware 帐户。 此类角色可以运行故障转移，但无法关闭受保护的源计算机。 执行迁移不需要关闭受保护的源计算机。
