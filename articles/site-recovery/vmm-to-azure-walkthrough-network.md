---
title: "为使用 Azure Site Recovery 进行从 Hyper-V（带有 System Center VMM）到 Azure 的复制规划网络 | Azure"
description: "本文介绍在将 Hyper-V VM（带有 VMM）复制到 Azure 时所需要进行的网络规划"
...
ms.date: 08/28/2017
ms.author: v-yeche
ms.openlocfilehash: 25dbaee0a29463c0877c15f297e08dd0136687f6
ms.sourcegitcommit: 1ca439ddc22cb4d67e900e3f1757471b3878ca43
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/25/2017
---
# <a name="step-4-plan-networking-for-hyper-v-with-vmm-to-azure-replication"></a>步骤 4：规划网络以将 Hyper-V（带有 VMM）复制到 Azure
...
- **网络连接** - 故障转移后，所有复制的 Azure VM 均已连接到映射的 Azure 网络。 在同一网络中进行故障转移的所有计算机可以相互连接，即使它们在不同的恢复计划中进行故障转移。
...
1. 如果没有 VMM，请准备与 Hyper-V 主机所在云关联的 [VMM 逻辑网络](/system-center/vmm/network-logical)。
2. 如果没有，请创建链接到前面准备的逻辑网络的 [VM 网络](/system-center/vmm/network-virtual)。
