...
ms.date: 05/07/2018
ms.author: v-yeche
ms.openlocfilehash: dc94f543165195a29aaba7ba694641ffe111fd77
ms.sourcegitcommit: 0b63440e7722942ee1cdabf5245ca78759012500
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/07/2018
ms.locfileid: "33815136"
---
...
**创建网络** | 根据在“逻辑网络”及其相关网站中指定的设置，自动创建一个临时测试网络。<br/><br/> 故障转移会检查是否已创建 VM。 |如果恢复计划使用多个 VM 网络，则应使用此选项。<br/><br/> 如果使用 Windows 网络虚拟化网络，此选项可使用副本虚拟机网络中的相同设置（子网和 IP 地址池）自动创建 VM 网络。 测试故障转移完成后，将自动清理这些 VM 网络。<br/><br/> 将在副本虚拟机所在的主机上创建测试 VM。 该 VM 不会添加到云中。
