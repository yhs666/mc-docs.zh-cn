...
ms.date: 10/02/2017
ms.author: v-yeche
ms.openlocfilehash: 13ff46dad4ec40191e30901f0ae6839429d5a57c
...
通过下表了解 Azure Site Recovery 为不同对故障转移情况提供的故障转移选项。
...
##<a name="failover-and-failback"></a> 计划的故障转移
使用 Site Recovery 保护的虚拟机/物理服务器也支持计划的故障转移。 这是一个没有数据丢失的故障转移选项。 触发计划的故障转移时，首先会关闭源虚拟机，同步尚未同步的数据，然后触发故障转移。
