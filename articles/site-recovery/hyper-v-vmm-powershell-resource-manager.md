---
title: "使用 PowerShell 将 VMM 云中的 Hyper-V VM 复制到辅助站点（Azure 资源管理器）| Azure"
...
ms.date: 03/05/2018
ms.author: v-yeche
ms.openlocfilehash: 791dbc254c7d89946f0a4902b76ed8edabdae072
...
- 如果已使用 PowerShell，则升级到 0.8.10 或更高版本。  [详细了解](https://docs.microsoft.com/powershell/azureps-cmdlets-docs)如何设置 PowerShell。
- 设置并配置 PowerShell 后，请参阅[服务 cmdlet](https://docs.microsoft.com/powershell/azure/overview)。
- 若要详细了解如何在 Azure PowerShell 中使用参数值、输入和输出，请参阅[入门](https://docs.microsoft.com/powershell/azure/get-started-azureps)指南。
...
若要测试部署，可针对一个虚拟机运行测试性故障转移，或者创建一个包括多个 VM 的恢复计划并针对该计划运行测试性故障转移。 测试故障转移在隔离的网络中模拟用户的故障转移和恢复机制。
...
[详细了解](https://docs.microsoft.com/powershell/module/azurerm.recoveryservices.backup/#recovery)如何将 Site Recovery 和 Azure 资源管理器 PowerShell cmdlet 配合使用。
