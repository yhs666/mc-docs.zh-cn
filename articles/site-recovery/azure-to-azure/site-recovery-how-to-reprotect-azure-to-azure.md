...
ms.date: 01/01/2018
ms.author: v-yeche
ms.openlocfilehash: dd031c07a2aaa8779c973aef8a9be3142fc3dcce
...
为了解释重新保护过程，我们举例假设受保护 VM 的主站点为“中国东部”区域，恢复站点为“中国东南部”。 故障转移期间，会将 VM 故障转移到“中国东南部”区域。 在故障回复之前，需要将 VM 从“中国东南部”复制回“中国东部”。 本文介绍重新保护所要执行的步骤。

> [!WARNING]
> 如果已经完成迁移、已将虚拟机转移至另一资源组或已删除 Azure 虚拟机，则无法进行故障回复。

重新保护完成并且正在复制 VM 后，可在 VM 上启动故障转移，将其回复到“中国东部”区域。

## <a name="prerequisites"></a>先决条件
1. VM 应已提交。
2. 目标站点（中国东部）应该可用，并且应该能够访问/创建该区域中的新资源。
...
这会触发一个使用最新数据植入目标站点种子的重新保护作业，完成该作业后，将在故障回复到中国东部之前复制增量数据。
