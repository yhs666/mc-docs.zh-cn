---
title: "为使用 Azure Site Recovery 执行 Hyper-V VM 到 Azure 的复制（使用 VMM）规划容量和缩放 | Azure"
description: "使用 Azure Site Recovery 将 VMM 云中的 Hyper-V VM 复制到 Azure 时，请根据本文规划容量和缩放"
...
ms.date: 08/28/2017
ms.author: v-yeche
ms.openlocfilehash: caf0558f0e04db55027a54056768fc2726019ba5
ms.sourcegitcommit: 1ca439ddc22cb4d67e900e3f1757471b3878ca43
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/25/2017
---
# <a name="step-3-plan-capacity-and-scaling-for-hyper-v-with-vmm-to-azure-replication"></a>步骤 3：为执行 Hyper-V（使用 VMM）到 Azure 的复制规划容量和缩放
...
转到[步骤 4：规划网络](vmm-to-azure-walkthrough-network.md)。
