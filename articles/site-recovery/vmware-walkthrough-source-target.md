---
title: "为使用 Azure Site Recovery 执行 VMware 到 Azure 的复制设置源和目标 | Azure"
description: "总结了为使用 Azure Site Recovery 执行 VMware VM 到 Azure 存储的复制设置源和目标设置的步骤"
...
ms.date: 08/28/2017
ms.author: v-yeche
ms.openlocfilehash: 081b35103e2a10d598a0345cf8782a39052e2351
ms.sourcegitcommit: 1ca439ddc22cb4d67e900e3f1757471b3878ca43
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/25/2017
---
# <a name="step-8-set-up-the-source-and-target-for-vmware-replication-to-azure"></a>步骤 8：为执行 VMware 到 Azure 的复制设置源和目标
