...
ms.author: v-yeche
ms.custom: mvc
ms.openlocfilehash: 695026cd77fff1ddb4b2514e276be68129487128
...
3.  使用 Azure Site Recovery 的恢复计划功能来添加脚本，以[装载 Azure 文件共享](/storage/files/storage-how-to-use-files-windows)并访问虚拟机中的共享。
...
6.  当本地环境中发生灾难时，可使用恢复计划执行故障转移，并添加脚本来[装载 Azure 文件共享](/storage/files/storage-how-to-use-files-windows)和访问虚拟机中的共享。
