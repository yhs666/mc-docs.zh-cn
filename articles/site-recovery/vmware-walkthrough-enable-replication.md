...
description: "总结了使用 Azure Site Recovery 服务启用 VMware VM 到 Azure 的复制所需的步骤"
documentationcenter: 
author: rockboyfor
manager: digimobile
editor: 
...
ms.date: 08/28/2017
ms.author: v-yeche
ms.openlocfilehash: fada4b5c5b960af2a75bd4882ab448966da65702
...
本文介绍如何在 Azure 门户中使用 [Azure Site Recovery](site-recovery-overview.md) 服务启用本地 VMware 虚拟机到 Azure 的复制。

请将评论和问题发布到这篇文章的底部，或者发布到 [Azure 恢复服务论坛](https://social.msdn.microsoft.com/Forums/en-US/home?forum=hypervrecovmgr)。

## <a name="before-you-start"></a>开始之前

- VMware VM 必须已[安装移动服务组件](vmware-walkthrough-install-mobility.md)。 - 如果已为推送安装准备了 VM，那么在启用复制时，进程服务器将自动安装移动服务。
