...
1. 在从备份还原的虚拟机中[强制实施仲裁](/sql/sql-server/failover-clusters/windows/force-a-wsfc-cluster-to-start-without-a-quorum#PowerShellProcedure)。
