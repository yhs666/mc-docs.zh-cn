...
## [将 Hyper-V 复制到 Azure 的工作原理是什么？](site-recovery-hyper-v-azure-architecture.md)
...
### [从 Azure 回复故障](site-recovery-failback-azure-to-vmware.md)
...
### [管理横向扩展进程服务器](site-recovery-vmware-to-azure-manage-scaleout-process-server.md)
