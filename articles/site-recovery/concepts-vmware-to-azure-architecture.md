...
ms.date: 01/22/2018
ms.author: v-yeche
ms.openlocfilehash: b811176d686226a33529e5c1358f3174193b4e5e
...
**配置服务器** | 需要部署单个本地 VMware VM 来运行所有本地 Site Recovery 组件。 VM 运行配置服务器、进程服务器和主目标服务器。 | 配置服务器在本地与 Azure 之间协调通信并管理数据复制。
...
根据[此教程](tutorial-vmware-to-azure.md)启用 VMware 到 Azure 复制。
