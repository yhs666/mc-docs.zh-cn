---
title: " 管理在 Azure 中运行的进程服务器 (Resource Manager) | Azure"
...
4. 填写其余的进程服务器属性
  ...
  ![添加进程服务器库摘要](./media/site-recovery-vmware-setup-azure-ps-arm/add-ps-page-2.png)
|**字段名称**|**值**|
|-|-|
|服务器名称|进程服务器虚拟机的显示名称和主机名|
| 用户名|成为该虚拟机上的管理员的用户名|
|存储帐户|其中放置虚拟机的虚拟磁盘的存储帐户的名称|
|子网|虚拟机连接到的 Azure VNet 的子网|
| IP 地址|进程服务器启动后希望其使用的 IP 地址|
