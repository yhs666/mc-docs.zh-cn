---
title: "准备 Azure 资源以便使用 Azure Site Recovery 将本地物理服务器复制到 Azure | Azure"
description: "介绍了需要先在 Azure 中准备哪些资源，才能开始使用 Azure Site Recovery 服务将本地服务器复制到 Azure"
...
请按照本文中的说明操作，准备 Azure 资源，以便可以使用 [Azure Site Recovery](site-recovery-overview.md) 服务将本地服务器复制到 Azure。



## <a name="before-you-start"></a>开始之前

请确保已阅读[先决条件](physical-walkthrough-prerequisites.md)。
...
- 详细了解故障转移后的 [Azure VM 连接性](physical-walkthrough-network.md)。
