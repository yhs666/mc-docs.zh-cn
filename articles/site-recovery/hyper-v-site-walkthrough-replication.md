---
title: "为使用 Azure Site Recovery 执行 Hyper-V VM 到 Azure 的复制（不使用 System Center VMM）设置复制策略 | Azure"
...
本文介绍在 Azure 门户中使用 [Azure Site Recovery](site-recovery-overview.md) 服务将 Hyper-V VM（不使用 System Center VMM）复制到 Azure 时如何设置复制策略。
