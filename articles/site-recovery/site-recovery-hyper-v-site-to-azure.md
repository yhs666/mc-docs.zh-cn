...
ms.date: 07/10/2017
ms.author: v-yeche
ms.openlocfilehash: e34cc6c1049d829c5c5c5c45206aaf29624e1b52
ms.sourcegitcommit: f119d4ef8ad3f5d7175261552ce4ca7e2231bc7b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/30/2017
---
# 结合使用 Azure Site Recovery 和 Azure 门户将 Hyper-V 虚拟机（不包含 VMM）复制到 Azure
<a id="replicate-hyper-v-virtual-machines-without-vmm-to-azure-using-azure-site-recovery-with-the-azure-portal" class="xliff"></a>
...
##<a name="on-premises-prerequisites"></a>先决条件
...
**Azure URL** | Hyper-V 主机需访问以下 URL：<br/><br/> [!INCLUDE [site-recovery-URLS](../../includes/site-recovery-URLS.md)]<br/><br/> 如果设置了基于 IP 地址的防火墙规则，请确保这些规则允许与 Azure 通信。<br/></br> 允许 [Azure 数据中心 IP 范围](https://www.microsoft.com/download/confirmation.aspx?id=41653)和 HTTPS (443) 端口。<br/></br> 允许订阅的 Azure 区域的 IP 地址范围以及中国东部的 IP 地址范围（用于访问控制和标识管理）。
...
### 准备 Hyper-V 主机
<a id="prepare-the-hyper-v-hosts" class="xliff"></a>
...
4. [创建新资源组](../azure-resource-manager/resource-group-template-deploy-portal.md)或选择现有的资源组，并指定 Azure 区域。 计算机将复制到此区域。 若要查看受支持的区域，请参阅 [Azure Site Recovery 定价详细信息](https://www.azure.cn/pricing/details/site-recovery/)中的“地域可用性”。
...
5. 在“应用一致性快照频率”中，指定创建包含应用程序一致性快照的恢复点的频率（1-12 小时）。
    ...
    - 如果启用了应用程序一致性快照，它将影响在源虚拟机上运行的应用程序的性能。 请确保你设置的值小于你配置的额外恢复点的数目。
...
##<a name="step-5-capacity-planning"></a> 容量规划
...
##<a name="step-6-enable-replication"></a>启用复制
...
## 命令行提供程序和代理安装
<a id="command-line-provider-and-agent-installation" class="xliff"></a>
