...
ms.author: v-yeche
ms.custom: MVC
ms.openlocfilehash: 367accfd74861119ed014583f060d037722678d2
ms.sourcegitcommit: 440d53bb61dbed39f2a24cc232023fc831671837
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/30/2019
ms.locfileid: "66390865"
---
...
本文介绍如何为 System Center Virtual Machine Manager (VMM) 托管的本地 Hyper-V VM 启用复制，以便使用 [Azure Site Recovery](site-recovery-overview.md) 服务灾难恢复到 Azure。 如果不使用 VMM，则[按照此教程操作](hyper-v-azure-tutorial.md)。
...
2. [准备本地 Hyper-V](tutorial-prepare-on-premises-hyper-v.md) 此教程为系列教程中的第三个教程。 本教程假设你已完成前面教程中的以下任务：

## <a name="select-a-replication-goal"></a>选择复制目标

1. 在“恢复服务保管库”中选择保管库。  在前面的教程中，我们已准备好保管库 **ContosoVMVault**。
...
2. 本教程不需要部署规划器。 在“是否已完成部署规划?”  中选择“我将稍后进行”  。  。
