---
title: "运行测试故障转移以便使用 Azure Site Recovery 将物理服务器复制到 Azure | Azure"
...
本文介绍如何运行测试故障转移，以便在 Azure 门户中使用 [Azure Site Recovery](site-recovery-overview.md) 服务将本地物理服务器复制到 Azure。
...
2. 在“说明”中，记录并保存与测试故障转移相关联的任何观测结果。
