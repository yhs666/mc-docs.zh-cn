...
ms.date: 08/13/2018
ms.openlocfilehash: dc1fe8f5c3e06b47367dddd2555610695c285aa2
ms.sourcegitcommit: 15355a03ed66b36c9a1a84c3d9db009668dec0e3
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/09/2018
ms.locfileid: "39722949"
---
...
1. 设置主服务器
   ...
   *使用 SSL 复制*
   ...
   ```sql
   CALL mysql.az_replication_change_primary('primary.mysql.database.chinacloudapi.cn', 'syncuser', 'P@ssword!', 3306, 'mysql-bin.000002', 120, @cert);
   ```
   *不使用 SSL 复制*
   ...
   ```sql
   CALL mysql.az_replication_change_primary('primary.mysql.database.chinacloudapi.cn', 'syncuser', 'P@ssword!', 3306, 'mysql-bin.000002', 120, '');
   ```
