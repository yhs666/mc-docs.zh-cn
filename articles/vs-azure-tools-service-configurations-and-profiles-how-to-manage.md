...
ms.date: 03/30/2017
ms.author: v-junlch
ms.openlocfilehash: 05b60503890b1982c6b0ba7ba4b26a422f305cf4
...
---
# 如何管理服务配置和配置文件
<a id="how-to-manage-service-configurations-and-profiles" class="xliff"></a>
## 概述
...
## 服务配置
<a id="service-configurations" class="xliff"></a>
...
### 添加服务配置
<a id="to-add-a-service-configuration" class="xliff"></a>
...
### 删除服务配置
<a id="to-delete-a-service-configuration" class="xliff"></a>
1. 在解决方案资源管理器中，打开 Azure 项目的快捷菜单，然后选择“管理配置” 。
...
### 重命名服务配置
<a id="to-rename-a-service-configuration" class="xliff"></a>
1. 在解决方案资源管理器中，打开 Azure 项目的快捷菜单，然后选择“管理配置” 。
...
### 更改服务配置
<a id="to-change-a-service-configuration" class="xliff"></a>
...
## 使用配置文件指定不同的设置组合
<a id="make-different-setting-combinations-by-using-profiles" class="xliff"></a>
...
### 添加配置文件
<a id="to-add-a-profile" class="xliff"></a>
...
### 重命名或删除配置文件
<a id="to-rename-or-delete-a-profile" class="xliff"></a>
1. 打开 Azure 项目的快捷菜单，然后选择“发布” 。
...
### 更改配置文件
<a id="to-change-a-profile" class="xliff"></a>
1. 打开 Azure 项目的快捷菜单，然后选择“发布” 。
