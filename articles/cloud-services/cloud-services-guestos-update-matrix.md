...
ms.date: 05/15/2017
ms.author: v-yiso
ms.openlocfilehash: 4a831c0a8c753f4e25640b0fbb4e6dd0717e7761
...
<a id="azure-guest-os-releases-and-sdk-compatibility-matrix" class="xliff"></a>
...
## 新闻更新
<a id="news-updates" class="xliff"></a>
###### **2017 年 5 月 12 日**
<a id="may-12-2017" class="xliff"></a>
5 月版来宾 OS 将从 5 月 12 日开始推出，预计于 6 月 13 日正式发行。

###### **2017 年 4 月 18 日**
<a id="april-18-2017" class="xliff"></a>
4 月版来宾 OS 于 4 月 18 日开始推出，预计于 5 月 9 日正式发行。

###### **2017 年 4 月 10 日**
<a id="april-10-2017" class="xliff"></a>
3 月版来宾 OS 已于 2017 年 3 月 14 日开始推出，已于 2017 年 4 月 10 日发行。

###### **2017 年 1 月 10 日**
<a id="january-10-2017" class="xliff"></a>
...
## 系列 4 发行版本
<a id="family-4-releases" class="xliff"></a>
...
## 系列 3 发行版本
<a id="family-3-releases" class="xliff"></a>
**Windows Server 2012**
...
## 系列 2 发行版本
<a id="family-2-releases" class="xliff"></a>
...
## MSRC 修补程序更新
<a id="msrc-patch-updates" class="xliff"></a>
[此处][patches]提供了每月来宾 OS 版本随附的修补程序列表。

## SDK 支持
<a id="sdk-support" class="xliff"></a>
...
## 来宾 OS 版本信息
<a id="guest-os-release-information" class="xliff"></a>
...
## 来宾 OS 系列版本解释
<a id="guest-os-family-version-explanation" class="xliff"></a>
...
## 来宾 OS 系统更新过程
<a id="guest-os-system-update-process" class="xliff"></a>
...
Azure 不断地发布更新。 来宾 OS 只不过是此类更新的其中一种。 一个发行版本会受到许多因素影响，不胜列举。 此外，Azure 实际上在成千上万的计算机上运行。 这意味着无法提供重新启动你角色的准确日期和时间。 我们意识到这对于客户构成问题，并正在致力于限制重新启动或为重新启动定时的计划。 
...
## 来宾 OS 可支持性和停用策略
<a id="guest-os-supportability-and-retirement-policy" class="xliff"></a>
