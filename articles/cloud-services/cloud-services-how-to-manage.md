...
1. 在 [Azure 经典门户](https://manage.windowsazure.cn)中的仪表板、“云服务”页或“实例”页上，单击“更新”。
...
5. 若要升级云服务中的所有角色，请在“角色”中选择“全部”。 若要执行单一角色更新，请选择要更新的角色。 即使选择更新特定角色，服务配置文件中的更新也会应用于所有角色。
...
使用“交换”可将云服务的过渡部署提升到生产环境。 决定部署云服务的新版本时，可在云服务过渡环境中暂存和测试新版本，同时让客户在生产环境中继续使用当前版本。 准备好将新版本提升到生产环境时，可使用“交换” 来切换这两个部署 URL。 
...
- 在执行交换之前，角色的所有实例必须都在运行。 可以在 Azure 经典门户中或使用 [Windows PowerShell 中的 Get-AzureRole 命令](https://docs.microsoft.com/en-us/powershell/module/azure/get-azurerole?view=azuresmps-3.7.0)检查实例的状态。
...
1. 在 [Azure 经典门户](http://manage.windowsazure.cn)中，单击“云服务”。 然后单击云服务的名称打开仪表板。
...
3. 若要删除部署，请单击“删除生产部署”或“删除暂存部署”。 然后，在出现确认提示时单击“是”。 
