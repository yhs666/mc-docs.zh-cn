...
## <a name="how-to-find-more-information-about-failed-deployments"></a>如何：查找有关失败部署的详细信息
“概述”边栏选项卡的顶部提供了一个状态栏。 单击该栏时，将打开一个新的边栏选项卡，其中显示了所有错误信息。 如果部署不包含任何错误，则信息边栏选项卡是空白的。
