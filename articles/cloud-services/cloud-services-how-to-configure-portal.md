...
此时无法使用 **Azure 门户** 配置远程桌面。不过，你可以通过 [Azure 管理经典门户](./cloud-services-role-enable-remote-desktop.md)、[PowerShell](./cloud-services-role-enable-remote-desktop-powershell.md) 或 [Visual Studio](../vs-azure-tools-remote-desktop-roles.md) 对其进行设置。
