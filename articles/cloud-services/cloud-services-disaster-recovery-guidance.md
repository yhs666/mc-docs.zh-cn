...
ms.date: 04/04/2017
ms.author: v-yiso
ms.openlocfilehash: 06f4b82279de609427192535a0d833857e49951d
...
根据应用程序数据源，你可能需要检查应用程序数据源的恢复过程。
  * 有关 Azure 存储数据源，请参阅 [Azure 存储复制](../storage/storage-redundancy.md#read-access-geo-redundant-storage)以了解基于所选复制模型而可用于应用程序的选项。
