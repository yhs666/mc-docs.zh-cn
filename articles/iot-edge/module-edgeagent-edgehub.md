...
services: iot-edge
ms.custom: seodec18
ms.openlocfilehash: 93c7fd448aa72974c68c490bc894c3a1dd778953
ms.sourcegitcommit: 49b42f8057226e8f82bde84ccef3c63197461509
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/18/2019
ms.locfileid: "54396771"
---
...
| systemModules.edgeHub.exitCode | 退出时，IoT Edge 中心容器报告的退出代码 |
...
| storeAndForwardConfiguration.timeToLiveSecs | 在断开路由终结点连接的情况下（例如断开与 IoT 中心或本地模块的连接），IoT Edge 中心保留消息的时间（以秒为单位） | 是 |
