...
ms.openlocfilehash: a6de5281500f919f9a75e7b9f1bc5d11b5b20f32
ms.sourcegitcommit: b7cefb6ad34a995579a42b082dcd250eb79068a2
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/03/2019
ms.locfileid: "58890205"
---
...
4. 在命令面板中，输入并运行 **`Azure: Sign in`** 命令，然后按说明登录 Azure 帐户。 如果已登录，则可跳过此步骤。

5. 在命令面板中，输入并运行命令 **`Azure IoT Edge: New IoT Edge Solution`**。 按命令面板中的提示创建解决方案。
...
>* 你的容器存储库是否正确？ 打开“模块” > “cmodule” > “module.json”并查找 **repository** 字段。 映像存储库应当类似于 **\<registryname\>.azurecr.cn/pythonmodule**。 
