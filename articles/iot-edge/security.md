...
services: iot-edge
ms.custom: seodec18
ms.openlocfilehash: 19f9d76cb67aa458667776b1700a09b5b7a58406
ms.sourcegitcommit: 332ae4986f49c2e63bd781685dd3e0d49c696456
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/27/2019
ms.locfileid: "71340750"
---
...
IoT Edge 在不同的硬件品牌和型号上运行，支持多种操作系统，并且适用于各种部署方案。 部署方案的风险取决于多种因素，包括解决方案所有权、部署地理位置、数据敏感性、隐私、垂直应用和法规要求。 IoT Edge 是一个可扩展的安全框架，它基于针对规模设计的有充分根据的原则，而不是为特定的场景提供具体解决方案。
 
