...
ms.date: 08/18/2016
ms.author: v-johch
ms.openlocfilehash: 967b37ea88de392145db85c44b81c69315a50236
...
---
# Azure 计划程序中的计划和计费方式
<a id="plans-and-billing-in-azure-scheduler" class="xliff"></a>
## 作业集合计划
<a id="job-collection-plans" class="xliff"></a>
...
## 升级和降级作业集合计划
<a id="upgrades-and-downgrades-of-job-collection-plans" class="xliff"></a>
...
## 计费和 Azure 计划
<a id="billing-and-azure-plans" class="xliff"></a>
...
## 标准计费单位
<a id="standard-billable-units" class="xliff"></a>
...
## P10 高级计费单位
<a id="p10-premium-billable-units" class="xliff"></a>
...
## P20 高级计费单位
<a id="p20-premium-billable-units" class="xliff"></a>
...
## 计费和活动状态
<a id="billing-and-active-status" class="xliff"></a>
