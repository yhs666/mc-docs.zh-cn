...
ms.date: 08/16/2016
ms.author: v-johch
ms.openlocfilehash: a032e1bbf2a1c4f264863848bb5be1dcba1a73f0
...
---
# 计划程序高可用性和可靠性
<a id="scheduler-high-availability-and-reliability" class="xliff"></a>
## Azure 计划程序高可用性
<a id="azure-scheduler-high-availability" class="xliff"></a>
作为一个核心 Azure 平台服务，Azure 计划程序高度可用，并提供地域冗余服务部署和地理区域作业复制功能。

### 异地冗余的服务部署
<a id="geo-redundant-service-deployment" class="xliff"></a>

Azure 计划程序已在中国的两个区域推出：中国东部和中国北部。 如果托管区域中的某个数据中心服务中断，则 Azure 计划程序的故障转移功能便可发挥作用，使你能够从另一个数据中心使用该服务。

### 地理区域作业复制
<a id="geo-regional-job-replication" class="xliff"></a>
...
## Azure 计划程序可靠性
<a id="azure-scheduler-reliability" class="xliff"></a>
...
<a id="configurable-retry-policy-via-retrypolicy" class="xliff"></a>
...
<a id="alternate-endpoint-configurability-via-erroraction" class="xliff"></a>
