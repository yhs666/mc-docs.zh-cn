...
ms.date: 06/05/2017
ms.author: v-dazen
ms.openlocfilehash: 9bccb74435c20488df2e1ee00e671ba632221aba
...
<a id="what-are-the-hadoop-components-and-versions-available-with-hdinsight" class="xliff"></a>

了解 Azure HDInsight 中的 Hadoop 生态系统组件和版本, 了解如何查看 HDInsight 中的 Hadoop 组件版本。 
...
<a id="hadoop-components-available-with-different-hdinsight-versions" class="xliff"></a>
...
## 如何检查当前的 Hadoop 组件版本信息
<a id="how-to-check-current-hadoop-component-version-information" class="xliff"></a>
...
## 支持的 HDInsight 版本
<a id="supported-hdinsight-versions" class="xliff"></a>
...
## HDI 版本 3.3 接近弃用日期
<a id="hdi-version-33-nearing-deprecation-date" class="xliff"></a>
如果有 HDI 3.3 群集，请尽快将群集升级到 HDI 3.5 或 HDI 3.6。 HDI 3.3 Windows 的弃用时间表可能因区域而异。 如果区域所计划的弃用日期不同，你会单独收到通知。

### HDInsight 群集版本的服务级别协议
<a id="the-service-level-agreement-for-hdinsight-cluster-versions" class="xliff"></a>
...
<a id="hortonworks-release-notes-associated-with-hdinsight-versions" class="xliff"></a>
...
### 定价和 SLA
<a id="pricing-and-sla" class="xliff"></a>
