...
ms.date: 08/27/2018
ms.author: v-yiso
ms.openlocfilehash: f5b3325871b68c28acba25a371273b9453012b53
ms.sourcegitcommit: bae4e9e500e3e988ef8fa0371777ca9cc49b4e94
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/14/2018
ms.locfileid: "45584865"
---
...
从 HDInsight 版本 3.4 开始，Microsoft 仅在 Linux OS 上发行了 HDInsight。 因此，HDInsight 中的某些组件仅可供 Linux 使用。 这些组件包括 Apache Ranger、Kafka、交互式查询、Spark 以及作为主文件系统的 HDInsight 应用程序。 
