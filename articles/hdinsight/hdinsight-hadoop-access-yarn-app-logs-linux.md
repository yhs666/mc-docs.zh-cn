---
title: 在基于 Linux 的 HDInsight 上访问 Hadoop YARN 应用程序日志 | Azure
...
* 必须先[创建 SSH 隧道](./hdinsight-linux-ambari-ssh-tunnel.md)，然后才能访问 ResourceManager 日志 Web UI。
...
YARN ResourceManager UI 在群集头节点上运行，并且可通过 Ambari Web UI 访问；但是，必须先[创建 SSH 隧道](./hdinsight-linux-ambari-ssh-tunnel.md)，然后才能访问 ResourceManager UI。
