...
ms.author: v-yiso
ROBOTS: NOINDEX
ms.openlocfilehash: a1dc5cd010f84ddbabf2df352f485c2e9244314e
...
请使用以下步骤运行 Hive 查询，该查询通过 Tez 执行。
...
3. 选择“提交”  按钮。 页面底部的“作业会话”  部分显示查询的状态。 一旦状态更改为“已完成”，即可选择“查看详细信息”链接查看结果。 “作业输出”  应如下所示：
