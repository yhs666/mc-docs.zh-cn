---
title: 使用 Azure HDInsight (Hadoop) 运行 Apache Sqoop 作业 | Azure
...
6. 将数据文件导出到 Azure SQL 数据库。
    ...
    <p> * **Azure HDInsight 3.1**：有关在虚拟网络上创建群集的信息，请参阅[使用自定义选项在 HDInsight 中创建 Hadoop 群集](./hdinsight-hadoop-provision-linux-clusters.md)。
