...
* Azure 订阅。 如果还没有 Azure 订阅，可以在开始前创建一个[免费帐户](https://www.azure.cn/pricing/1rmb-trial)。
...
* Azure IoT 中心。 建议先阅读[将 Raspberry Pi 在线模拟器连接到 Azure IoT 中心](../../iot-hub/iot-hub-raspberry-pi-web-simulator-get-started.md)文档，然后再学习本教程。
