...
ms.date: 10/23/2017
ms.author: v-yiso
ms.openlocfilehash: 42b4ba5a978aa65afe0e92cb83f0cb7d74da6e63
...
* 基于 Linux 的 HDInsight 群集。 有关创建群集的信息，请参阅[开始在 HDInsight 中使用 Hadoop](hdinsight-hadoop-linux-tutorial-get-started.md)。
