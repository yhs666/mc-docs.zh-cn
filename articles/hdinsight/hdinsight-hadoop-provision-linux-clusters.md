...
有关使用辅助 Azure 存储帐户的详细信息，请参阅 [Using Azure Storage with HDInsight](./hdinsight-hadoop-use-blob-storage.md)（将 Azure 存储与 HDInsight 配合使用）。
...
有关辅助 Azure 存储帐户的详细信息，请参阅 [Using Azure Storage with HDInsight](./hdinsight-hadoop-use-blob-storage.md)（将 Azure 存储与 HDInsight 配合使用）。
