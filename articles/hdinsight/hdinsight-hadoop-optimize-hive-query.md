...
* 在预配时，可以使用 Azure 门户预览、Azure PowerShell 或跨平台命令行界面指定辅助节点的数目。  有关详细信息，请参阅[创建 HDInsight 群集](hdinsight-hadoop-provision-linux-clusters.md)。 以下屏幕截图显示了 Azure 门户预览上的辅助节点配置：
