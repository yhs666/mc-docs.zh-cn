...
ms.date: 09/04/2017
ms.author: v-haiqya
ms.openlocfilehash: c5720ea76bee52e37f498de374e265daa4233ce9
...
3. 在笔记本列表中找到“Stream-Tweets-To_Kafka.ipynb”项，然后选择其旁边的“上传”按钮。
    ...
    ![使用 KafkaStreaming.ipynb 条目旁边的“上传”按钮将其上传到 notebook 服务器](./media/hdinsight-apache-kafka-spark-structured-streaming/upload-notebook.png)
...
在 Jupyter Notebook 主页上，选择“Spark-Structured-Streaming-From-Kafka.ipynb”项。 在 Notebook 中，按照步骤使用 Spark 结构化流式处理加载 Kafka 中的推文。
