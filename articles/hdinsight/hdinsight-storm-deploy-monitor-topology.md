...
ms.author: v-dazen
ROBOTS: NOINDEX
ms.openlocfilehash: b358cd9f1263cb8da9b16b44ff9dd85e52aa6436
...
> [!IMPORTANT]
> 本文档中的步骤需要将 Windows 作为操作系统的 Storm on HDInsight 群集。 Linux 是在 HDInsight 3.4 版或更高版本上使用的唯一操作系统。 有关详细信息，请参阅 [HDInsight Deprecation on Windows](hdinsight-component-versioning.md#hdi-version-33-nearing-deprecation-date)（HDInsight 在 Windows 上即将弃用）。
>
...
* 对于 **Visual Studio** - Azure SDK 2.5.1 或更高版本，以及适用于 Visual Studio 的 HDInsight 工具。 请参阅[开始使用 HDInsight Tools for Visual Studio](hdinsight-hadoop-visual-studio-tools-get-started.md)，安装并配置 HDInsight Tools for Visual Studio。
...
从 Storm 仪表板的顶部，选择“提交拓扑”。 根据页面上的说明运行示例拓扑，或者上传并运行已创建的拓扑。
...
HDInsight 群集上的 REST API 的基本 URI 是 https://&lt;clustername>.azurehdinsight.cn/stormui/api/v1/，其中 clustername 是 Storm on HDInsight 群集的名称。
