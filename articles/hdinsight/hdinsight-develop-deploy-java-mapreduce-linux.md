---
title: 为基于 Linux 的 HDInsight 开发 Java MapReduce 程序 | Azure
...
1. 使用 SSH 连接到 HDInsight，如以下文章所述：
    ...
    * [从 Linux、Unix、OS X 以及 Windows 10 上的 Bash 中将 SSH 与 HDInsight 上基于 Linux 的 Hadoop 配合使用](./hdinsight-hadoop-linux-use-ssh-unix.md)
