...
ms.date: 10/21/2019
ms.author: v-yiso
ms.openlocfilehash: d615392b4065857d490bf3a5560905fa9d94a2ed
ms.sourcegitcommit: b83f604eb98a4b696b0a3ef3db2435f6bf99f411
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/12/2019
ms.locfileid: "72292637"
---
...
3. 配置以下属性：
   ...
   * **边缘节点大小**：选择一个 VM 大小。 VM 大小必须满足工作节点 VM 大小要求。 有关建议的工作节点 vm 的大小信息，请参阅[在 HDInsight 中创建 Apache Hadoop 群集](hdinsight-hadoop-provision-linux-clusters.md#cluster-types)。
...
3. 单击“应用程序”  。 此时显示该边缘节点。  默认名称为 **new-edgenode**。
