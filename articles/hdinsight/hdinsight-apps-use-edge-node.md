...
边缘节点虚拟机大小必须满足 HDInsight 群集工作节点 VM 大小要求。有关建议的工作节点 VM 大小，请参阅[在 HDInsight 中创建 Hadoop 群集](./hdinsight-hadoop-provision-linux-clusters.md#cluster-types)。
...
3. 配置以下属性：
    ...
    * **边缘节点大小**：选择一个 VM 大小。VM 大小必须满足工作节点 VM 大小要求。有关建议的工作节点 VM 大小，请参阅[在 HDInsight 中创建 Hadoop 群集](./hdinsight-hadoop-provision-linux-clusters.md#cluster-types)。
