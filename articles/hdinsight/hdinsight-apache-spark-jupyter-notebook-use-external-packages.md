---
title: "在 Azure 上的 Spark 中将 Maven 包与 Jupyter 笔记本配合使用 | Azure"
...
1. 在 [Azure 门户预览版](https://portal.azure.cn/)上的启动板中，单击 Spark 群集的磁贴（如果已将它固定到启动板）。 也可以单击“全部浏览” > “HDInsight 群集”导航到群集。   
