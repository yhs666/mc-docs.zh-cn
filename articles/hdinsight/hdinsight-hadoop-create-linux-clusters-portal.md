...
5. 从“3 存储”中，指定是要将 Azure 存储还是将 Azure Data Lake Storage 作为默认存储  。 有关详细信息，请参阅下表。
     ...
     | **将 Azure Data Lake Storage 作为默认存储** | 对于“主要存储类型”，请选择“Azure Data Lake Storage Gen2”   。 然后参阅文章[快速入门：在 HDInsight 中设置群集](../storage/data-lake-storage/quickstart-create-connect-hdi-cluster.md)以获取说明。 |
...
10. 创建进程完成后，选择“部署成功”通知中的“转到资源”   。 群集窗口提供以下信息。
