...
ms.date: 12/18/2017
ms.author: v-yiso
ms.openlocfilehash: c4db2c32ab172d6f4ce9d5fe9d00ca431afb8e73
...
| [远程桌面](apache-hadoop-use-mapreduce-remote-desktop.md)（HDInsight 3.2 和 3.3） |通过**远程桌面**使用 Hadoop 命令 |Windows |Windows |
