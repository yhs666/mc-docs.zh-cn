...
ms.date: 01/14/2019
ms.author: v-yiso
ms.openlocfilehash: cf2700d8b2b632c686839f1f6eefacc051a616fa
...
- .NET SDK：
  ...
  - [使用用于 HDInsight 中的 Apache Hadoop 的 .NET SDK 运行 Apache Pig 作业](apache-hadoop-use-pig-dotnet-sdk.md)
...
- curl：
  ...
  - [使用 curl 通过 HDInsight 中的 Apache Hadoop 运行 Apache Pig 作业](apache-hadoop-use-pig-curl.md)
...
- **PowerShell**：
  ...
  - [使用 PowerShell 运行 Apache Pig 作业](apache-hadoop-use-pig-powershell.md)
