...
ms.date: 10/23/2017
ms.author: v-yiso
ms.openlocfilehash: 16f8a7fc5618b789f8704fad5ef39045a118ff2e
...
* **用于 IntelliJ 的 Azure 工具包中的 HDInsight 工具**。 此工具是用于 IntelliJ 的 Azure 工具包的一部分。 有关详细信息，请参阅[安装用于 IntelliJ 的 Azure 工具包](/azure-toolkit-for-intellij-installation)。
* **用于 IntelliJ 的 Azure 工具包**。 使用此工具包为 HDInsight 群集创建 Spark 应用程序。 有关详细信息，请遵循[使用用于 IntelliJ 的 Azure 工具包为 HDInsight 群集创建 Spark 应用程序](/hdinsight/hdinsight-apache-spark-intellij-tool-plugin)中的说明。
...
4. 选择 **src** > **main** > **scala** 打开项目中的代码。 本示例使用“SparkCore_wasbloTest”脚本。

5. 要访问“编辑配置”菜单，请选择右上角的图标。 通过此菜单可以创建或编辑远程调试的相关配置。
...
7. 输入“名称”、“Spark 群集”和“Main 类名”的信息。 然后选择“高级配置”。 
...
9. 现已使用提供的名称保存配置。 若要查看配置详细信息，请选择配置名称。 若要进行更改，请选择“编辑配置”。 

10. 完成配置设置后，可以针对远程群集运行项目，或执行远程调试。
...
本部分介绍如何使用 IntelliJ 调试功能动态更新变量值，以完成简单的修复。 在下面的代码示例中，由于已存在目标文件而引发异常。
