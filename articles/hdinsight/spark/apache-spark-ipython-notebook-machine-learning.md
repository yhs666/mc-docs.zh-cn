...
ms.date: 03/26/2018
ms.author: v-yiso
ms.openlocfilehash: be6d45bd06308d0862926fc21fcf52b1ae01223d
ms.sourcegitcommit: 41a236135b2eaf3d104aa1edaac00356f04807df
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/22/2018
ms.locfileid: "30075204"
---
...
10. 关闭 Notebook 以释放资源。 为此，请在 Notebook 的“文件”菜单中，单击“关闭并停止”。 这会关闭 Notebook。

## <a name="anaconda"></a>将 Anaconda scikit-learn 库用于 Spark 机器学习
HDInsight 上的 Apache Spark 群集包含 Anaconda 库， 还包含适用于机器学习的 **scikit-learn** 库。 该库还包含可用于直接从 Jupyter notebook 生成示例应用程序的各种数据集。 有关 scikit-learn 库的用法示例，请参阅 [http://scikit-learn.org/stable/auto_examples/index.html](http://scikit-learn.org/stable/auto_examples/index.html)。
