...
每个 Azure 区域都有特定数量的容错域。 如需域的列表及其所含容错域的数目，请参阅[可用性集](../virtual-machines/linux/regions-and-availability.md#availability-sets)文档。
...
如需创建主题和设置复制因子的示例，请参阅 [HDInsight 上的 Kafka 入门](hdinsight-apache-kafka-get-started.md)文档。
