...
ms.date: 10/23/2017
ms.author: v-yiso
ms.openlocfilehash: 0d7df47b2461212df58a46613c2e1e732453824e
...
我们还建议以另一种方式将 Spark 应用程序提交到群集。 为此，可在“运行/调试配置”IDE 中设置参数。 有关详细信息，请参阅[使用用于 IntelliJ 的 Azure 工具包通过 SSH 远程调试 HDInsight 群集上的 Spark 应用程序](./hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md)。
