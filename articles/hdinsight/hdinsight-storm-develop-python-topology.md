...
> [!IMPORTANT]
> 本文档中的信息已使用 Storm on HDInsight 3.5 进行测试。 Linux 是在 HDInsight 3.4 版或更高版本上使用的唯一操作系统。 有关详细信息，请参阅 [HDInsight 弃用日期](hdinsight-component-versioning.md#hdi-version-33-nearing-deprecation-date)。
