---
title: "将 Apache Storm 与 Power BI 配合使用 - Azure HDInsight | Azure"
...
>
> 基于 Linux 的群集上的 C# 拓扑必须使用 .NET 4.5，并使用 Mono 在 HDInsight 群集上运行。 大多数功能适用。 但应查看 [Mono 兼容性](http://www.mono-project.com/docs/about-mono/compatibility/) 文档，了解可能的不兼容性。
>
...
* Visual Studio（以下版本之一）
  ...
  * Visual Studio 2013 [Update 4](http://www.microsoft.com/download/details.aspx?id=45326) 或 [Visual Studio 2013 Community](http://go.microsoft.com/fwlink/?linkid=517284&clcid=0x409)
  * [Visual Studio 2015](https://www.visualstudio.com/downloads/download-visual-studio-vs.aspx)
  * Visual Studio 2017（任何版本）

* 用于 Visual Studio 的 HDInsight 工具：有关安装方面的信息，请参阅[开始使用用于 Visual Studio 的 HDInsight 工具](hdinsight-hadoop-visual-studio-tools-get-started.md)。
...
1. 在 [Azure 门户](https://portal.azure.cn)中，选择 SQL 数据库。 从 SQL 数据库边栏选项卡的“概要”部分，选择“显示数据库连接字符串”。 从显示的列表中，复制 **ADO.NET（SQL 身份验证）** 信息。
...
4. 输入信息以连接到 Azure SQL 数据库。 可以通过访问 [Azure 门户](https://portal.azure.cn)并选择 SQL 数据库来找到此信息。
