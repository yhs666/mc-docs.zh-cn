...
ms.date: 07/24/2017
ms.author: v-dazen
ms.openlocfilehash: b1b0ea6cd841e80897a325437784411d3b20ca07
...
HDInsight .NET SDK 提供 .NET 客户端库，可简化从 .NET 中使用 HDInsight 群集的操作。 Pig 可让你通过为一系列数据转换建模，创建 MapReduce 操作。 本文档介绍如何使用基本 C# 应用程序将 Pig 作业提交到 HDInsight 群集。
