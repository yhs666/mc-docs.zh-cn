...
ms.date: 11/27/2017
ms.author: v-yiso
ms.openlocfilehash: 39736496aac7ea986dc23e87c9d935a070bd8682
...
4. 选择包含目标 HBase 群集的虚拟网络。 例如，选择 **xxxx-vnet2**。 会列出名称以 **nic-zookeepermode-** 开头的三个设备。 这三个设备是 ZooKeeper VM。
