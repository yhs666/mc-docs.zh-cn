...
<a id="load-data-into-azure-sql-data-warehouse" class="xliff"></a>
...
## 从 Azure Blob 存储加载
<a id="load-from-azure-blob-storage" class="xliff"></a>
...
<a id="1-use-polybase-and-t-sql" class="xliff"></a>
加载过程摘要：
...
## 从 SQL Server 加载
<a id="load-from-sql-server" class="xliff"></a>
...
<a id="use-integration-services-ssis" class="xliff"></a>
...
<a id="use-azcopy-recommended-for--10-tb-data" class="xliff"></a>
...
<a id="use-importexport-recommended-for--10-tb-data" class="xliff"></a>
...
## 从 HDInsight 加载
<a id="load-from-hdinsight" class="xliff"></a>
