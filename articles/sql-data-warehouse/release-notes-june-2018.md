...
ms.openlocfilehash: 336301703247851123c9bb73ad22d4c43b17a048
ms.sourcegitcommit: 2f487fba38fd225111e07411cd9eb85e2e8e3153
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/17/2019
ms.locfileid: "65828835"
---
...
借助 CLS，你可以使用标准的 [GRANT](https://docs.azure.cn/sql-data-warehouse/column-level-security) T-SQL 语句根据用户的执行上下文或其组成员身份，控制对表列的访问。 访问限制逻辑位于数据库层本身，而不是脱离另一应用程序中的数据，同时简化了整个安全性实施。
...
通过引入[自动创建统计信息](/sql-data-warehouse/sql-data-warehouse-tables-statistics#automatic-creation-of-statistics)，Azure SQL 数据仓库将生成统计信息来优化查询执行。 2018 年 6 月版本新增了以下功能：无论何时执行 [CREATE STATISTICS](https://docs.microsoft.com/sql/t-sql/statements/create-statistics-transact-sql) 操作，通过将记录添加到 [sys.dm_pdw_exec_requests](https://docs.microsoft.com/sql/relational-databases/system-dynamic-management-views/sys-dm-pdw-exec-requests-transact-sql) 视图即可监视统计信息何时自动生成。
