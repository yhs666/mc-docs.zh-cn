...
ms.openlocfilehash: 66160ee4989a98ca32e16341ab338cfba50a6df6
ms.sourcegitcommit: 092d9ef3f2509ca2ebbd594e1da4048066af0ee3
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/22/2018
ms.locfileid: "36315683"
---
# <a name="whats-new-in-azure-sql-data-warehouse-may-2018"></a>Azure SQL 数据仓库（2018 年 5 月）中的新增功能
Azure SQL 数据仓库持续得到改进。 本文介绍 2018 年 5 月发行的版本中引入的新功能和所做的更改。 
...
[CONCAT_WS()](https://docs.microsoft.com/sql/t-sql/functions/concat-ws-transact-sql) 函数返回以端到端方式串联两个或更多个值后生成的字符串。 它使用第一个参数中指定的分隔符分隔串联值。 `CONCAT_WS` 函数用于生成逗号分隔值 (CSV) 输出。
...
### <a name="select-into-with-order-by"></a>包含 ORDER BY 的 SELECT INTO
...
### <a name="set-parseonly-on-query-status"></a>SET PARSEONLY ON 查询状态
