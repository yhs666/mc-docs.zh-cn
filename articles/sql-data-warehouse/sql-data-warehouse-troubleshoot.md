...
ms.date: 07/17/2017
ms.author: v-yeche
ms.openlocfilehash: 75383b1534d11fe8cefab045e5e6b705df81c377
ms.sourcegitcommit: 3727b139aef04c55efcccfa6a724978491b225a4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/05/2017
---
<a id="troubleshooting-azure-sql-data-warehouse" class="xliff"></a>

# 排查 Azure SQL 数据仓库问题
本主题列出了客户较常见的一些故障排除问题。

<a id="connecting" class="xliff"></a>
...
<a id="system-management" class="xliff"></a>
...
|在 Azure 门户中，透明数据加密 (TDE) 进度栏不更新|可以通过 [powershell](https://docs.microsoft.com/zh-cn/powershell/module/azurerm.sql/get-azurermsqldatabasetransparentdataencryption) 查看 TDE 的状态。|

<a id="polybase" class="xliff"></a>
...
<a id="differences-from-sql-database" class="xliff"></a>
