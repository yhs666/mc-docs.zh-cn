...
ms.date: 07/17/2017
ms.author: v-yeche
ms.openlocfilehash: 8ebb7a8e93cdfbae30518cae5f3a71a1e3f251e6
...
---
# SQL 数据仓库备份
<a id="sql-data-warehouse-backups" class="xliff"></a>
...
## 什么是数据仓库备份？
<a id="what-is-a-data-warehouse-backup" class="xliff"></a>
...
## 数据冗余
<a id="data-redundancy" class="xliff"></a>
...
## Azure 存储 Blob 快照
<a id="azure-storage-blob-snapshots" class="xliff"></a>
...
## 异地冗余备份
<a id="geo-redundant-backups" class="xliff"></a>
...
## 数据仓库备份计划和保留期
<a id="data-warehouse-backup-schedule-and-retention-period" class="xliff"></a>
...
### 暂停数据仓库时，备份保留会发生什么情况？
<a id="what-happens-to-my-backup-retention-while-my-data-warehouse-is-paused" class="xliff"></a>
...
### 已删除的数据仓库的保留期有多长？
<a id="how-long-is-the-retention-period-for-a-dropped-data-warehouse" class="xliff"></a>
...
## 数据仓库备份费用
<a id="data-warehouse-backup-costs" class="xliff"></a>
...
## 使用数据库备份
<a id="using-database-backups" class="xliff"></a>
