...
ms.author: v-jay
ms.reviewer: craigg
ms.openlocfilehash: 0f1073efd22a9c3cf4552898e6a1f933a8ae8b74
ms.sourcegitcommit: bfd0b25b0c51050e51531fedb4fca8c023b1bf5c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52673375"
---
...
1. 查找用于连接 Azure SQL 数据仓库的完全限定的服务器名和数据库名。
   ...
   [如何从门户查找服务器名和数据库名？](/sql-data-warehouse/sql-data-warehouse-connect-overview)
...
3. 在服务器级别防火墙中添加 "52.0.2.4" IP 地址以允许传入从 Fivetran 到 Azure SQL 数据仓库的连接。
   ...
   [如何添加服务器级防火墙？](/sql-data-warehouse/create-data-warehouse-portal#create-a-server-level-firewall-rule)
...
有关详细信息，请查看有关[内存和并发限制](/azure/sql-data-warehouse/memory-and-concurrency-limits#data-warehouse-limits)和[资源类](/sql-data-warehouse/sql-data-warehouse-memory-optimizations-for-columnstore-compression#ways-to-allocate-more-memory)的文档
...
2. 端口
3. 数据库
4. 用户（用户名应为 `fivetran@<server_name>`，其中 `<server_name>` 是 azure 主机 uri 的一部分：`<server_name>.database.chinacloudapi.cn`）
5. 密码