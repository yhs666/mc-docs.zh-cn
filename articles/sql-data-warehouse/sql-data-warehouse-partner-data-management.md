...
| 合作伙伴 | 说明 | 链接 | 视频 |
| ------- | ----------- | ----- | ------ |
| ![Coffing Data Warehousing][1] |**Coffing Data Warehousing**<br>Coffing Data Warehousing 提供 Nexus Chameleon，这是专门用于查询系统的工具，已有 10 多年的历史。Nexus 可用作 SQL 数据仓库的查询工具。使用 Nexus 可以查询本地和云计算机，并联接不同平台的数据。点击式报告！ |[应用商店][coffing_marketplace]<br>[网站][coffing_website]<br>[新闻稿][coffing_press]<br>[Twitter][coffing_twitter]<br>[YouTube][coffing_youtube] | --- |
| ![Inbrein][2] |**MicroERD**<br>Inbrein MicroERD 提供创建准确的数据模型、减少数据冗余、提升产能及遵守标准所必需的工具。根据广泛的用户体验所开发的 UI，可让模型塑造者轻松又方便地处理 DB 模型。通过及时的功能改进和更新，你可以持续享有 MicroERD 最新改善的功能。 |[网站][inbrein_website]<br>[数据表][inbrein_datasheet]<br>[Twitter][inbrein_twitter]<br>[YouTube][inbrein_youtube] | --- |
| ![Infolibrarian][3] |**Infolibrarian**<br>InfoLibrarian 能够归类、存储和管理元数据，帮助你解决数据管理的主要难题。此外还提供元数据管理、数据控制和资产管理软件解决方案，让用户管理和发布各种不同工具和技术的元数据。 |[应用商店][infolibrarian_marketplace]<br>[网站][infolibrarian_website]<br>[Twitter][infolibrarian_twitter] | --- |
| ![Redpoint Global][4] |**RedPoint Interaction**<br>RedPoint Interaction 允许你以持续对话的方式跨每个通信通道和接触点与客户进行交流。通过单个操作控制点，对全渠道营销的完整生命周期进行轻松管理 |[应用商店][redpoint_it_marketplace]<br>[网站][redpoint_it_website]<br>[新闻稿][redpoint_press]<br>[数据表][redpoint_it_datasheet]<br>[Twitter][redpoint_twitter]<br>[YouTube][redpoint_youtube] | --- |
| ![Redpoint Global][4] |**RedPoint Data Management**<br>RedPoint Data Management 可让营销人员应用其所有数据促进跨渠道客户的参与，同时运行结构化和非结构化的数据管理。用户可以利用 Azure SQL 数据仓库和 RedPoint，让其所有的结构化或非结构化数据发挥最大的价值，经由高度个人化和情境式交互，吸引现今泛通路的客户。拖放式界面使设计和运行数据管理过程变得轻松。 |[应用商店][redpoint_dm_marketplace]<br>[网站][redpoint_dm_website]<br>[新闻稿][redpoint_press]<br>[数据表][redpoint_dm_datasheet]<br>[Twitter][redpoint_twitter]<br>[YouTube][redpoint_youtube] | --- |
| ![Sentry One][5] |**DW Sentry**<br>使用智能数据移动仪表板和事件日历，用户始终知道影响工作负荷的具体因素。旨在方便用户了解其所运行的查询和作业，以便加载、备份或还原 其数据，使用户不再担心是否会造成 Azure 资源的过度使用。 |[应用商店][]<br>[网站][sql_sentry_website]<br>[新闻稿][sql_sentry_press]<br>[Twitter][sql_sentry_twitter]<br>[YouTube][sql_sentry_youtube] | --- |

## 后续步骤
<!-- Not Available for sql-data-warehouse-partner-business-intelligence -->
<!-- Not Available for sql-data-warehouse-partner-data-integration -->
...
[redpoint_dm_marketplace]: https://azure.microsoft.com/zh-cn/marketplace/partners/redpoint-global/redpoint-rpdm/
[sql_sentry_marketplace]: https://azure.microsoft.com/zh-cn/marketplace/partners/sqlsentry/sqlsentryplatform/
...
<!-- Update_Description: new articles to describe Microsoft's 3rd partner of SQL data warehouse -->