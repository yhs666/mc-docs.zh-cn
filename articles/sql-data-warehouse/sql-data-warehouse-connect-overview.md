...
---
# 连接到 Azure SQL 数据仓库
<a id="connect-to-azure-sql-data-warehouse" class="xliff"></a>
本文介绍首次连接到 SQL 数据仓库的操作方法。

## 查找服务器名称
<a id="find-your-server-name" class="xliff"></a>
...
## 支持的驱动程序和连接字符串
<a id="supported-drivers-and-connection-strings" class="xliff"></a>
...
### ADO.NET 连接字符串示例
<a id="adonet-connection-string-example" class="xliff"></a>
```C#
...
### ODBC 连接字符串示例
<a id="odbc-connection-string-example" class="xliff"></a>
```C#
...
### PHP 连接字符串示例
<a id="php-connection-string-example" class="xliff"></a>
```PHP
...
### JDBC 连接字符串示例
<a id="jdbc-connection-string-example" class="xliff"></a>
```Java
...
## 连接设置
<a id="connection-settings" class="xliff"></a>
