...
<a id="create-a-sql-data-warehouse-database-by-using-transact-sql-tsql" class="xliff"></a>
...
<a id="create-a-database-with-visual-studio" class="xliff"></a>
...
## 使用 sqlcmd 创建数据库
<a id="create-a-database-with-sqlcmd" class="xliff"></a>
