...
ms.date: 01/15/2018
ms.author: v-yeche
ms.openlocfilehash: cb8d0b68019f9bd688a58ba83d694e97b8f48f65
...
在使用 SQL 数据仓库的过程中变得更老练以后，如果想要优化性能，则需了解有关表设计的详细信息。  若要了解详细信息，请参阅有关[表数据类型][Data Types]、[分布表][Distribute]、[为表编制索引][Index]、[将表分区][Partition]的文章。
