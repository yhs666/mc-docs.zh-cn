...
ms.date: 07/17/2017
ms.author: v-yeche
ms.openlocfilehash: 803e4bc0bc9a9043a45e5b5dcfadede9e17355fe
...
- 执行脚本的用户应为 [mediumrc 角色][mediumrc role] 或更高级角色。 若要将用户添加到此角色中，请执行下列语句：````EXEC sp_addrolemember 'xlargerc', 'MyUser'````
...
如果有任何关于数据仓库的问题，请[创建支持票证][create a support ticket]，并参阅“迁移到高级存储”寻找可能的原因。
