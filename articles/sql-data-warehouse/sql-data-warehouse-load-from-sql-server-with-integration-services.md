...
<a id="load-data-from-sql-server-into-azure-sql-data-warehouse-ssis" class="xliff"></a>
...
## 使用 SSIS 加载数据的选项
<a id="options-for-loading-data-with-ssis" class="xliff"></a>
...
<a id="step-1-create-a-new-integration-services-project" class="xliff"></a>
1. 启动 Visual Studio。
2. 在“文件”菜单中，选择“新建 | 项目”。
...
## 步骤 2：创建基本数据流
<a id="step-2-create-the-basic-data-flow" class="xliff"></a>
...
## 步骤 3：配置源适配器
<a id="step-3-configure-the-source-adapter" class="xliff"></a>
...
## 步骤 4 ：将源适配器连接到目标适配器
<a id="step-4-connect-the-source-adapter-to-the-destination-adapter" class="xliff"></a>
1. 选择设计图面上的源适配器。
...
## 步骤 5：配置目标适配器
<a id="step-5-configure-the-destination-adapter" class="xliff"></a>
...
## 步骤 6：运行包以加载数据。
<a id="step-6-run-the-package-to-load-the-data" class="xliff"></a>
