...
ms.date: 07/08/2019
ms.openlocfilehash: be2ec696747a82ab60ae453d449b0edd2224c443
ms.sourcegitcommit: 5191c30e72cbbfc65a27af7b6251f7e076ba9c88
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/05/2019
ms.locfileid: "67570281"
---
...
该服务目前支持各种迁移方案。 有关每个可用迁移方案的状态的完整列表，请参阅文章 [Azure 数据库迁移服务支持的迁移方案的状态](/dms/resource-scenario-status)。 其他迁移方案处于预览状态，需要通过 DMS 预览站点提交提名。
...
* 确保 Azure 虚拟网络 (VNet) 网络安全组规则未阻止以下通信端口：443、53、9354、445、12000。 有关 Azure VNet NSG 流量筛选的更多详细信息，请参阅[使用网络安全组筛选网络流量](/virtual-network/virtual-networks-nsg)一文。
