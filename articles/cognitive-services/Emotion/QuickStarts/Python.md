...
本演练中的信息和代码示例有助于用户快速开始结合使用[情感 API Recognize 方法](https://dev.cognitive.azure.cn/docs/services/5639d931ca73072154c1ce89/operations/563b31ea778daf121cc3a5fa)和 Python，以识别图像中一人或多人的情感。
...
```python
emotion_recognition_url = "https://api.cognitive.azure.cn/emotion/v1.0/recognize"
```

本演练使用在磁盘上存储的图像。 还可以使用可通过公开访问 URL 获取的图像。 有关详细信息，请参阅 [REST API 文档](https://dev.cognitive.azure.cn/docs/services/5639d931ca73072154c1ce89/operations/563b31ea778daf121cc3a5fa)。
...
首先，从[情感 API](https://www.azure.cn/home/features/cognitive-services/emotion/) 网站下载一些示例图像。
