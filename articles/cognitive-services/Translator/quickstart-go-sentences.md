...
u, _ := url.Parse("https://api.translator.azure.cn/breaksentence?api-version=3.0")
q := u.Query()
q.Add("languages", "en")
u.RawQuery = q.Encode()
```
