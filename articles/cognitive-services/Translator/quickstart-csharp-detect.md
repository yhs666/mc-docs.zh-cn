...
description: 在本快速入门中，你将使用文本翻译 API 和 C# 识别源文本的语言。
...
ms.date: 11/26/2018
ms.author: v-junlch
ms.openlocfilehash: e929d755b137085a982aafa3edeafda6cfc13360
ms.sourcegitcommit: bfd0b25b0c51050e51531fedb4fca8c023b1bf5c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52673453"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-c"></a>快速入门：使用文本翻译 REST API (C#) 识别文本中的语言
