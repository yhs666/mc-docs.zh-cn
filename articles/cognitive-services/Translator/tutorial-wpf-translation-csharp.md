...
ms.date: 11/27/2018
ms.author: v-junlch
ms.openlocfilehash: 7249c6eca03ccbc93266ab7f703de51e92342ef3
ms.sourcegitcommit: bfd0b25b0c51050e51531fedb4fca8c023b1bf5c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52673279"
---
...
|||
|-|-|
|[文本分析](https://www.azure.cn/home/features/cognitive-services/)|用于根据需要自动检测要翻译的文本的源语言|
|[必应拼写检查](https://www.azure.cn/home/features/cognitive-services/)|对于英语源文本，用于更正拼写错误，使翻译更准确
...
文本分析和必应拼写检查服务均提供试用版，你可以在[试用认知服务](https://www.azure.cn/pricing/1rmb-trial/)上注册。 你还可以通过 Azure 仪表板为任一服务创建订阅。 文本分析具有免费层。

本教程的源代码如下所示。 订阅密钥必须作为 `MainWindow.xaml.cs` 中的 `TEXT_TRANSLATION_API_SUBSCRIPTION_KEY` 等变量复制到源代码中。

> [!IMPORTANT]
> 文本分析服务在多个地区提供。 本教程源代码中的 URI 位于 `chinanorth` 区域，该区域是用于试用版的区域。 如果你在其他地区有订阅，请相应地更新此 URI。
...
namespace MSTranslatorTextDemo
{
    ...
    {
        // Translator text subscription key from Azure dashboard
        ...
        const string TEXT_ANALYTICS_API_ENDPOINT = "https://api.cognitive.azure.cn/text/analytics/v2.0/";
        const string BING_SPELL_CHECK_API_ENDPOINT = "https://api.cognitive.azure.cn/bing/v7.0/spellcheck/";
...
> [Microsoft 文本翻译 API 参考](/cognitive-services/Translator/reference/v3-0-reference)
