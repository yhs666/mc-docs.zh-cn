...
ms.date: 06/10/2019
ms.author: v-junlch
ms.openlocfilehash: 6e3b401702ffdd4ab94617aeaaae128b6f7e8b66
ms.sourcegitcommit: 259c97c9322da7add9de9f955eac275d743c9424
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/11/2019
ms.locfileid: "66830141"
---
...
使用 `credentials` 和 `text_analytics_url` 作为参数创建新的 `TextAnalyticsClient` 对象。 请使用适合你的文本分析订阅的正确 Azure 区域（例如 `chinaeast2`）。

```
text_analytics_url = "https://chinaeast2.api.cognitive.azure.cn/"
