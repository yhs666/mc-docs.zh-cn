...
| 属性 | 说明 | 必需/可选 |
|-----------|-------------|---------------------|
| 音节 | 指示文本的基线音节。 可将音节表述为：<ul><li>以某个数字后接“Hz”（赫兹）表示的绝对值。 例如 600Hz。</li><li>以前面带有“+”或“-”的数字，后接“Hz”或“st”（用于指定音节的变化量）表示的相对值。 例如：+80Hz 或 -2st。 “st”表示变化单位为半音，即，标准全音阶中的半调（半步）。</li><li>常量值：<ul><li>x-low</li><li>低</li><li>中</li><li>高</li><li>x-high</li><li>默认值</li></ul></li></ul>上获取。 | 可选 |
