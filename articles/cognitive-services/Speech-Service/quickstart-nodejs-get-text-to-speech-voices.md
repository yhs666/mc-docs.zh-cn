...
此示例假定语音服务订阅位于“中国东部”区域。 如果使用其他区域，请更新 `uri` 的值。 如需完整的列表，请参阅[区域](regions.md#rest-apis)。
...
此处我们将要生成请求并保存返回的语音列表。 此示例假设使用“中国东部”终结点。 如果已将资源注册到其他区域，请务必更新 `uri`。 有关详细信息，请参阅[语音服务区域](regions.md#text-to-speech)。
