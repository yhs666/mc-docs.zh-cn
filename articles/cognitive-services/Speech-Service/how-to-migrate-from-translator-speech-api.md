...
ms.date: 04/01/2019
ms.author: v-biyu
ms.openlocfilehash: 3f5ee418f56a6c24140caa151e959606926700ed
...
| 语言 API                                     | :heavy_check_mark:                                              | :heavy_minus_sign:                 |                                                                                                                                                                     |
...
| 自定义翻译模型                         | :heavy_minus_sign:                                              | :heavy_check_mark:                 | 通过订阅 Microsoft 文本翻译 API，可使用自定义翻译工具，从而利用自己的数据提高翻译准确度。                                                 |
