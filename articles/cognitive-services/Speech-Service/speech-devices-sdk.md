...
ms.date: 07/05/2019
ms.author: v-lingwu
ms.openlocfilehash: 8b72820e9f7f1f7abb9b139ef558e3883ff0e5b5
ms.sourcegitcommit: 13642a99cc524a416b40635f48676bbf5cdcdf3d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/28/2019
ms.locfileid: "70104121"
---
...
该语音设备 SDK 支持多种启用语音的方案，例如免下车点单系统、店内或家用助理和智能扬声器。 可以使用文本回复用户、用默认或自定义语音回答用户、提供搜索结果以及[翻译](speech-translation.md)为其他语言等。 我们期待看到你的成果！
