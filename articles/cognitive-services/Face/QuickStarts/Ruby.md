---
title: 人脸 API Ruby 快速入门 | Microsoft Docs
description: 获取信息和代码示例，帮助自己快速开始使用认知服务中的人脸 API 和 Ruby。
...
ms.date: 10/13/2017
ms.author: v-junlch
ms.openlocfilehash: 7841055ed49ce3aecef8c24acbd47dfd8f2b6e2c
ms.sourcegitcommit: 9b2b3a5aede3a66aaa5453e027f1e7a56a022d49
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/13/2017
ms.locfileid: "23407583"
---
# <a name="face-api-ruby-quick-starts"></a>人脸 API Ruby 快速入门
本文提供信息和代码示例来帮助读者快速开始使用人脸 API 和 Ruby 来完成以下任务： 
- [检测图像中的人脸](#Detect) 
- [识别图像中的人脸](#Identify)

在[此处](../../Computer-vision/Vision-API-How-to-Topics/HowToSubscribe.md)详细了解如何获取免费订阅密钥。

## 使用人脸 API 通过 Ruby 检测图像中的人脸 <a name="Detect"> </a>
...
#### <a name="face-detect-ruby-example-request"></a>人脸检测 Ruby 示例请求
...
## 使用人脸 API 通过 Ruby 识别图像中的人脸 <a name="Identify"> </a>
...
#### <a name="face---identify-ruby-example-request"></a>“人脸 - 识别”Ruby 示例请求
