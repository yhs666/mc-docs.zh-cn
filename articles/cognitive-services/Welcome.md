...
所有 API 都有一个免费试用计划，该计划具有使用量和吞吐量限制。  在 Azure 门户中部署服务时，可以通过使用付费产品/服务和选择适当的定价层选项来增加这些限制。 [详细了解产品/服务和定价](https://www.azure.cn/pricing/details/cognitive-services/ "o产品/服务和定价)。 你将需要使用信用卡和电话号码设置一个 Azure 订阅者帐户。
