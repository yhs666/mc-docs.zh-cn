...
ms.date: 09/23/2019
ms.author: v-lingwu
ms.openlocfilehash: bf1546721617c7983d29a736c21f8d8bfd14e513
ms.sourcegitcommit: 2f2ced6cfaca64989ad6114a6b5bc76700870c1a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/27/2019
ms.locfileid: "71330437"
---
...
例如，对于在 [https://luis.azure.cn](https://luis.azure.cn) 上创建的应用，如果你在 **westus** 和 **eastus** 两个区域中创建 LUIS 资源并将其作为资源添加到该应用，则该应用将发布到两个区域中。 有关 LUIS 区域的详细信息，请参阅[区域](luis-reference-regions.md)。
