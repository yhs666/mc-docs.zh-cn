...
ms.date: 06/16/2019
ms.author: diberry
ms.openlocfilehash: a9e543701aa48795a8fed2bf6d02cc0882ec7b76
ms.sourcegitcommit: 68f7c41974143a8f7bd9b7a54acf41c09893e587
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/19/2019
ms.locfileid: "68332677"
---
...
本教程将机器人和语言理解信息添加到 [Application Insights](/azure-monitor/) 遥测数据存储。 有了该数据后，可使用 Kusto 语言或 Power BI 对其进行查询，以便对话语的意向和实体进行实时分析、聚合和报告。 此分析有助于确定是否应添加或编辑 LUIS 应用的意向和实体。
...
1. 在浏览器的 [Azure 门户](https://portal.azure.cn)中，找到机器人的 **Application Insights** 资源。 其名称将包含机器人名称的大部分，结尾是随机字符，例如 `luis-nodejs-bot-johnsmithxqowom`。 
...
1. 在 [Azure 门户](https://portal.azure.cn)中，打开机器人的 Application Insights 资源。 
...
详细了解 [Kusto 查询语言](/azure-monitor/log-query/get-started-queries)或[将数据导出到 Power BI](https://docs.microsoft.com/azure/application-insights/app-insights-export-power-bi)。 
