...
使用以下 [Azure CLI 命令创建认知服务密钥](https://docs.azure.cn/zh-cn/cli/cognitiveservices/account?view=azure-cli-latest#az-cognitiveservices-account-create)：
...
将 `<REPLACE-WITH-YOUR-KEY>` 替换为认知服务密钥的区域。 密钥位于 [Azure 门户](https://portal.azure.cn)中该资源的“密钥”页上。
