---
title: Azure Policy json 示例 - 如果未对区域启用网络观察程序则进行审核 | Microsoft Docs
description: 如果未对指定区域启用网络观察程序，则此 json 示例策略会进行审核。
...
ms.author: v-nany
ms.custom: mvc
ms.openlocfilehash: 2603da166e8ebd57f99c90e1b8b1f6b0df5a9756
