---
title: 选择要针对 Stretch Database 进行迁移的行 - Azure | Azure
...
1. 反向迁移，并取回已迁移的数据。启动此操作后将无法取消此操作。另外，Azure 上会产生出站数据传输（传出）的费用。有关详细信息，请参阅 [Azure 如何定价](https://www.azure.cn/pricing/details/data-transfer/)。
...
2. 等待迁移完成。可以在 SQL Server Management Studio 的 **延伸数据库监视器**中查看状态，也可以查询 **sys.dm\_db\_rda\_migration\_status** 视图。有关详细信息，请参阅[数据迁移的监视和故障排除](./sql-server-stretch-database-monitor.md) 或 [sys.dm\_db\_rda\_migration\_status](https://msdn.microsoft.com/zh-cn/library/dn935017.aspx)。
