...
ms.date: 11/26/2018
ms.author: v-yeche
ms.openlocfilehash: 0902caa10e83ef73123d6196ea3b714f7b7c81c7
ms.sourcegitcommit: 59db70ef3ed61538666fd1071dcf8d03864f10a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52676786"
---
...
> [!CAUTION]
> HTTP 应用程序路由加载项旨在可以快速创建入口控制器并访问应用程序。 建议不要将此加载项用于生产。 对于包含多个副本和 TLS 支持的生产就绪入口部署，请参阅[创建 HTTPS 入口控制器](/aks/ingress-tls)。
...
Result
-----------------------------------------------------
9f9c1fe7-21a1-416d-99cd-3543bb92e4c3.chinaeast.aksapp.io
```
...
<!-- LINKS - external -->
[dns-pricing]: https://www.azure.cn/pricing/details/dns/
