...
ms.author: v-yeche
ms.custom: mvc
ms.openlocfilehash: 0b115f79f2e790f6c114cb267996dac431560cb0
...
如果已按照教程执行，则在 AKS 中已有可正常工作的 Kubernetes 群集，并且已部署了 Azure 投票应用。 在本教程第 5 部分（共 7 部分）中，会在应用中扩大 Pod 并尝试 Pod 自动缩放。 还会了解如何缩放 Azure VM 节点数以更改群集用于托管工作负荷的容量。 你将学习如何执行以下操作：
...
[az-aks-scale]: https://docs.azure.cn/zh-cn/cli/aks?view=azure-cli-latest#az-aks-scale
