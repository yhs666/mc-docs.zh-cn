...
ms.author: v-yeche
ms.custom: mvc
ms.openlocfilehash: 3e910dc5088b411c7bb351d693791418074f0417
...
Kubernetes 为容器化应用程序提供一个分布式平台。 使用 AKS 可以快速预配生产就绪的 Kubernetes 群集。 在本教程的第 3 部分（共 7 部分）中，在 AKS 中部署了 Kubernetes 群集。 你将学习如何执行以下操作：
