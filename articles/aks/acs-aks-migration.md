...
有关详细信息，请参阅 [Azure 订阅和服务限制](/azure-subscription-service-limits)。 若要查看当前配额，请在 Azure 门户中转到[订阅边栏选项卡](https://portal.azure.cn/#blade/Microsoft_Azure_Billing/SubscriptionsBlade)，选择自己的订阅，然后选择“用量 + 配额”。 

<!--Correct on https://portal.azure.cn/#blade, contains no empty characters-->
