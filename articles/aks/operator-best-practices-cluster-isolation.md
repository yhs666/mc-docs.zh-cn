...
ms.date: 10/28/2019
ms.author: v-yeche
ms.openlocfilehash: 871328d95c7074d03c1159e692871b6ef398584d
ms.sourcegitcommit: 1d4dc20d24feb74d11d8295e121d6752c2db956e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/30/2019
ms.locfileid: "73068889"
---
...
AKS 或其他位置中的 Kubernetes 环境并不完全安全，因为可能存在恶意的多租户使用情况。 在多租户环境中，多个租户使用公共的共享基础设施。 因此，如果不能信任所有租户，则需要进行额外的规划，以避免一个租户影响另一个租户的安全和服务。 增加面向节点的安全功能（如 *Pod 安全策略*或更细粒度的基于角色的访问控制 (RBAC)）可增加攻击的难度。 但是，如果想真正实现可抵御恶意多租户工作负荷的安全性，虚拟机监控程序是唯一信任的安全级别。 Kubernetes 的安全域成为整个群集，而不是单个节点。 对于这些类型的恶意多租户工作负荷，应使用物理隔离的群集。
