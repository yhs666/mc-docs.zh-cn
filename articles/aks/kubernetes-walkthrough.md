...
ms.openlocfilehash: f608608f174acb8e334c9fcffbf779c555a02b42
ms.sourcegitcommit: 59db70ef3ed61538666fd1071dcf8d03864f10a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52676422"
---
...
以下示例在 *chinaeast* 位置创建名为 *myAKSCluster* 的资源组。

```azurecli
az group create --name myAKSCluster --location chinaeast
```
...
<!--The parent file of includes file of cloud-shell-try-it.md-->
<!--ms.date:11/26/2018-->