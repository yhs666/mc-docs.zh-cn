...
ms.date: 02/14/2017
ms.author: v-junlch
ms.openlocfilehash: 1069bc035ef8c1392c04b5788d7995a41685b493
...
---
# 实施大型部署
<a id="deploying-large-deployments" class="xliff"></a>
如果你的部署太大，从而无法包含在默认 approot 文件夹中，你可以使用本地存储资源作为 JDK 和应用程序服务器的部署根文件夹。

## 使用本地存储资源作为大型部署的部署根文件夹
<a id="to-use-a-local-storage-resource-as-the-deployment-root-folder-for-large-deployments" class="xliff"></a>
...
3. 确保已选中“回收角色实例时清除内容”；这有助于在回收角色实例时，防止部署的启动逻辑与资源中的现有文件发生冲突。
