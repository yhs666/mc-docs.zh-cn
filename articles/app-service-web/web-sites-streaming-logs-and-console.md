...
![][BrowseSitesScreenshot] 诊断基于每个应用启用。 首先浏览到要启用此功能的网站。  
...
![][ConsoleScreenshot] 在“设置”菜单中，向下滚动到“开发工具”部分，并单击“(1) 控制台”，**(2) 控制台** UI 会在右侧打开。
