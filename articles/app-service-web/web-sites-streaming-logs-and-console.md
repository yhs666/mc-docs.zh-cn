...
---
# 流式传输日志和控制台
<a id="streaming-logs-and-the-console" class="xliff"></a>
## 流式传输日志
<a id="streaming-logs" class="xliff"></a>
...
### 如何在你的代码中编写跟踪
<a id="how-to-write-traces-in-your-code" class="xliff"></a>
...
### 如何启用和查看流式传输日志
<a id="how-to-enable-and-view-the-streaming-logs" class="xliff"></a>
