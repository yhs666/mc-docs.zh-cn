...
ms.author: v-yiso
ms.date: 09/04/2017
ms.openlocfilehash: c5f924621125aa0eec34a5296b171572f40c4833
ms.sourcegitcommit: d75065296d301f0851f93d6175a508bdd9fd7afc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52651904"
---
...
本部分创建 Maven 插件在将 Web 应用部署到 Azure 时使用的 Azure 服务主体。
...
本部分使用 Azure 服务主体中的值配置 Maven 在将 Web 应用部署到 Azure 时要使用的身份验证。
...
配置了本文前面部分中的所有设置后，就可将 Web 应用部署到 Azure。 为此，请使用以下步骤：
