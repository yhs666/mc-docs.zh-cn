...
ms.author: v-dazen
ms.custom: mvc
ms.openlocfilehash: 4cf5e7000902601230004309e1b54a644b89b5a5
...
| [az cosmosdb create](https://docs.microsoft.com/cli/azure/cosmosdb#create) | 创建 Cosmos DB 帐户。 这是数据存储位置。 |
