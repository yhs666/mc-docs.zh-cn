...
ms.date: 07/03/2017
ms.author: v-dazen
ms.openlocfilehash: 48aeb1ec96dd9353d267cd436b8afafc4ff312ae
...
5. 在仍处于打开状态的“备份配置”边栏选项卡中，可以配置“备份数据库”，选择要包含在备份中的数据库（SQL 数据库或 MySQL），然后单击“确定”。  
...
使用 [ftp](web-sites-deploy.md#ftp) 或任何其他方法，将 `_backup.filter` 文件上传到站点的 `D:\home\site\wwwroot\` 目录。 如果需要，可使用 Kudu `DebugConsole` 直接创建此文件，并在其中插入内容。
