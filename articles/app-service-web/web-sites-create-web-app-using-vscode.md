...
## <a name="create-a-web-app-in-the-azure-portal-preview"></a>在 Azure 门户预览版中创建 Web 应用
以下步骤将指导用户在 Azure 门户预览版中创建 Web 应用。
...
9. 返回到 [Azure 门户预览版](https://portal.azure.cn)，单击“设置”>“属性”。 要部署到的远程 Git 存储库的 URL 将显示在“GIT URL”下。
...
* 在 Azure 门户预览版中，找到 Web 应用的 Web 应用边栏选项卡，然后单击“浏览”以在默认游览器中 
* 查看应用。
