...
ms.date: 06/20/2017
ms.author: v-dazen
ms.openlocfilehash: ca4a0885a45d2ea5493d21fb40044edc9915980c
...
<a id="azure-sdk-for-net-28-281-and-282" class="xliff"></a>
## 概述
...
<a id="azure-sdk-for-net-28" class="xliff"></a>
### 下载 Azure SDK for .NET 2.8
<a id="download-azure-sdk-for-net-28" class="xliff"></a>
...
### .NET 4.5.2 支持
<a id="net-452-support" class="xliff"></a>
#### 已知问题
...
### Azure 数据工厂
<a id="azure-data-factory" class="xliff"></a>
#### 已知问题
<a id="known-issues" class="xliff"></a>
...
### Web 工具扩展
<a id="web-tools-extensions" class="xliff"></a>
#### 已知问题
<a id="known-issues" class="xliff"></a>
以下版本将解决以下已知问题。
...
### Azure HDInsight 工具
<a id="azure-hdinsight-tools" class="xliff"></a>
#### 新的更新
...
<a id="azure-sdk-for-net-281" class="xliff"></a>
### Visual Studio 2013 和 Visual Studio 2015 的已知问题
<a id="known-issues-for-visual-studio-2013-and-visual-studio-2015" class="xliff"></a>
1. 以槽为目标的触发 Web 作业发布将显示错误，并且不会设置计划，但会将 Web 作业推送到 Azure。 然后，需要计划作业的客户可以使用 Azure 门户设置 Web 作业的计划。 
...
<a id="azure-sdk-for-net-282" class="xliff"></a>
