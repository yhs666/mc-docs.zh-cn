...
ms.date: 07/10/2017
ms.author: v-dazen
ms.openlocfilehash: 0731ab5f1d34da4122cb011dc02e0db2c43f3ce4
...
<a id="enterprise-class-wordpress-on-azure" class="xliff"></a>
...
## 架构与规划
<a id="architecture-and-planning" class="xliff"></a>
...
### 基本部署
<a id="basic-deployment" class="xliff"></a>
...
### 多区域部署
<a id="multi-region-deployment" class="xliff"></a>
...
### 使用媒体存储和缓存的多区域部署
<a id="multi-region-deployment-with-media-storage-and-caching" class="xliff"></a>
...
#### 其他要求
<a id="additional-requirements" class="xliff"></a>
| 为此，请执行以下操作... | 使用此方法... |
| --- | --- |
...
#### 可用性和灾难恢复
<a id="availability-and-disaster-recovery" class="xliff"></a>
| 为此，请执行以下操作... | 请使用以下方法... |
| --- | --- |
...
## 分步说明
<a id="step-by-step-instructions" class="xliff"></a>
### 创建 WordPress 站点
<a id="create-a-wordpress-site" class="xliff"></a>
...
<a id="migrate-an-existing-wordpress-site-to-azure" class="xliff"></a>
...
#### 导出和导入方法
<a id="the-export-and-import-method" class="xliff"></a>
...
#### 备份和还原方法
<a id="the-backup-and-restore-method" class="xliff"></a>
...
### 配置网站
<a id="configure-your-site" class="xliff"></a>
