---
title: "Azure CLI 脚本示例 - 从 GitHub 连续部署 Web 应用 | Azure"
...
> [!NOTE]
> 若要设置连续部署，请参阅[连续部署到 Azure 应用服务](app-service-continuous-deployment.md)。 在 Azure 中国区，需使用 KUDU 进行此设置。
>
>
...
| [az appservice web source-control config](https://docs.microsoft.com/cli/azure/webapp/deployment/source#config) | 将 Web 应用与 Git 或 Mercurial 存储库相关联。 |
