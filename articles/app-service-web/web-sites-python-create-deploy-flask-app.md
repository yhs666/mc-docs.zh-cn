...
ms.openlocfilehash: 20c182d0a6872e39324c50694c76a321b6cee0b2
...
本教程介绍了如何开始在 [Azure App Service Web 应用](/azure/app-service-web/app-service-changes-existing-services)中运行 Python。  Web Apps 提供有限的免费托管和快速部署功能，现在，你可以使用 Python！  随着您的应用增长，可以切换到付费托管，并且还可以与所有其他 Azure 服务集成。
...
## <a name="web-app-create-on-the-azure-portal-preview"></a>在 Azure 门户预览版中创建 Web 应用
...
请确保使用的 Python 版本与 Web 应用所选的 Python 版本相同（在 runtime.txt 中或 Azure 门户预览版中 Web 应用的“应用程序设置”边栏选项卡）。
