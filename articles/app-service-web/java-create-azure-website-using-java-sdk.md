...
> **注意：**用于 Eclipse 的 Azure 工具包支持部署到存储帐户和云服务，但当前不支持部署到 Web 应用。 可按照[在 Eclipse 中为 Azure 创建 Hello World 应用程序](/azure/azure-toolkit-for-eclipse-creating-a-hello-world-application/)中所述，使用 Azure 部署项目部署到存储帐户和云服务，但不能部署到 Web 应用。 使用其他方法（例如 FTP 或 GitHub）将文件传输到 Web 应用。
> 
...
若要从 [Azure 门户预览][Azure Portal Preview]的 Web 应用边栏选项卡中获取 FTP 连接信息：
