...
ms.date: 03/01/2017
ms.author: v-dazen
ms.openlocfilehash: 197c109da5138bdf4b27a9252260dad6023550de
...
<a id="configuring-a-custom-domain-name-for-a-web-app-in-azure-app-service-using-traffic-manager" class="xliff"></a>
...
## 了解 DNS 记录
<a id="understanding-dns-records" class="xliff"></a>
[!INCLUDE [understandingdns](../../includes/custom-dns-web-site-understanding-dns-traffic-manager.md)]

<a name="bkmk_configsharedmode"></a>

## 将 Web 应用配置为标准模式
<a id="configure-your-web-apps-for-standard-mode" class="xliff"></a>
[!INCLUDE [modes](../../includes/custom-dns-web-site-modes-traffic-manager.md)]

<a name="bkmk_configurecname"></a>

## 为自定义域添加 DNS 记录
<a id="add-a-dns-record-for-your-custom-domain" class="xliff"></a>
...
## 启用流量管理器
<a id="enable-traffic-manager" class="xliff"></a>
