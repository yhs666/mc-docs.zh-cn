...
* 若要了解适用于 Azure Web 应用的基于 Azure Resource Manager 的 PowerShell cmdlet 的完整列表，请参阅 [Web 应用 Azure Resource Manager PowerShell Cmdlet 的 Azure Cmdlet 参考](https://msdn.microsoft.com/library/mt619237.aspx)。
* * 若要了解如何使用 CLI 管理应用服务，请参阅[使用适用于 Azure Web 应用的基于 Azure Resource Manager 的 XPlat CLI](app-service-web-app-azure-resource-manager-xplat-cli.md)