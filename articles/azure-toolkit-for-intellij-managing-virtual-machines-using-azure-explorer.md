...
ms.date: 08/25/2017
ms.author: v-junlch
ms.openlocfilehash: 6fb386801946b92522ed4bb9920f648fdb03ba94
...
8. 在“关联的资源”窗口中，输入以下信息：
   ...
   - 公共 IP 地址：为虚拟机指定面向外部的 IP 地址。 可选择创建新 IP 地址，也可以选择“(无)”（如果虚拟机不会有公共 IP 地址）。 
...
## <a name="restart-a-virtual-machine-in-intellij"></a>在 IntelliJ 中重启虚拟机

若要在 IntelliJ 中使用 Azure 资源管理器重启虚拟机，请执行以下操作：

1. 在“Azure 资源管理器”视图中，右键单击虚拟机，然后选择“重启”。
