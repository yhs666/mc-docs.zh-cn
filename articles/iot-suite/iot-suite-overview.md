...
ms.openlocfilehash: 7cac989fd80d8aac2be40fc2a2da70671d41a1e1
...
---
# Azure IoT 套件概述
<a id="overview-of-azure-iot-suite" class="xliff"></a>
...
<a id="azure-iot-services-in-azure-iot-suite" class="xliff"></a>
预配置解决方案通常使用下列服务：
...
* Azure Web 应用和 [Microsoft Power BI][lnk-power-bi] 提供数据可视化功能。 借助 Power BI 的灵活性，你可以快速生成自己的交互式仪表板（使用 IoT 套件数据）。

有关典型 IoT 解决方案体系结构的概述，请参阅 [Azure 和物联网 (IoT)][iot-suite-what-is-azure-iot]。

## 预配置解决方案
<a id="preconfigured-solutions" class="xliff"></a>
