...
1. 可以在 mbed 编译器窗口中看到导入此项目也会导入各种库。 一些库由 Azure IoT 团队提供并维护（[azureiot_common](https://developer.mbed.org/users/AzureIoTClient/code/azureiot_common/)、[iothub_client](https://developer.mbed.org/users/AzureIoTClient/code/iothub_client/)、[iothub_amqp_transport](https://developer.mbed.org/users/AzureIoTClient/code/iothub_amqp_transport/)、[azure_uamqp](https://developer.mbed.org/users/AzureIoTClient/code/azure_uamqp/)），而其他库是 mbed 库目录中可用的第三方库。

    ![查看 mbed 项目][8]

1. 在“程序工作区”中，右键单击 **iothub\_amqp\_transport** 库，单击“删除”，然后单击“确定”进行确认。

1. 在“程序工作区”中，右键单击 **azure\_amqp\_c** 库，单击“删除”，然后单击“确定”进行确认。

1. 右键单击“程序工作区”中的 **remote_monitoring** 项目，选择“导入库”，然后选择“从 URL”。
