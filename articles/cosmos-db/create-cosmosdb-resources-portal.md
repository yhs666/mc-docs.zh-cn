...
ms.date: 07/29/2019
ms.openlocfilehash: 0d5fef68ffacb10c3ae96f0234fb10d7874c9c60
ms.sourcegitcommit: 5a4a826eea3914911fd93592e0f835efc9173133
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/31/2019
ms.locfileid: "68672319"
---
...
Azure Cosmos DB 是世纪互联提供的多区域分布式多模型数据库服务。 可以使用 Azure Cosmos DB 快速创建和查询键/值数据库、文档数据库和图形数据库，所有这些资源都可受益于 Azure Cosmos DB 核心的多区域 $2 和水平缩放功能。 
...
<a name="create-collection-database"></a>
...
<!--Update_Description: new articles on create cosmos db resource portal -->
<!--ms.date: 07/29/2019-->