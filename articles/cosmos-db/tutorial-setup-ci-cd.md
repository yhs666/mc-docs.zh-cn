...
ms.date: 09/30/2018
ms.author: v-yeche
ms.openlocfilehash: 798841dbd9fd759a99623adbc6cb45af270fd32f
ms.sourcegitcommit: 7aa5ec1a312fd37754bf17a692605212f6b716cd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/26/2018
ms.locfileid: "47201470"
---
...
> [!NOTE]
> 若要将扩展安装到 VSTS 组织，你必须是帐户所有者或项目集合管理员。 如果你没有权限，但却是帐户成员，可以改为请求扩展。 [了解详细信息。](https://docs.microsoft.com/zh-cn/vsts/marketplace/faq-extensions?view=vsts#install-request-assign-and-access-extensions) 

![选择要在其中安装扩展的 VSTS 组织](./media/tutorial-setup-ci-cd/addExtension_2.png)

## <a name="create-a-build-definition"></a>创建生成定义

安装扩展以后，想将其添加到[生成定义](https://docs.microsoft.com/zh-cn/vsts/pipelines/get-started-designer?view=vsts&tabs=new-nav)。 可以修改现有的生成定义，也可以创建一个新的。 如果已经有现有的生成定义，则可跳转到[向生成定义添加模拟器生成任务](#addEmulatorBuildTaskToBuildDefinition)。
...
## <a name="add-the-task-to-a-build-definition"></a>将任务添加到生成定义
...
在本教程中，我们将使用 [Visual Studio 测试任务](https://github.com/Microsoft/vsts-tasks/blob/master/Tasks/VsTestV2/README.md)运行通过 **.runsettings** 文件配置的单元测试。 若要详细了解单元测试设置，请访问此[文档](https://docs.microsoft.com/zh-cn/visualstudio/test/configure-unit-tests-by-using-a-dot-runsettings-file?view=vs-2017)。
...
<!-- Update_Description: new articles on tutorial setup ci cd -->
<!--ms.date: 09/30/2018-->