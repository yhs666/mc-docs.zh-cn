...
ms.date: 07/17/2017
ms.author: v-yeche
ms.openlocfilehash: 918c75b33d28722d31bff220b4fadfa7970d8f41
ms.sourcegitcommit: b15d77b0f003bef2dfb9206da97d2fe0af60365a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/07/2017
---
# 利用生存时间使 Azure Cosmos DB 集合中的数据自动过期
<a id="expire-data-in-azure-cosmos-db-collections-automatically-with-time-to-live" class="xliff"></a>
...
## TTL 行为
<a id="ttl-behavior" class="xliff"></a>
...
只要文档已过期（`ttl` + `_ts` >= 当前服务器时间），则文档就会标记为“已过期”。 此时间过后，将不允许对这些文档执行任何操作，这些文档也将从执行的任何查询结果中排除。 这些文档在系统中被物理删除，并且稍后找机会在后台删除。 这不占用集合预算的任何[请求单位 (RU)](request-units.md)。
...
## 配置 TTL
<a id="configuring-ttl" class="xliff"></a>
默认情况下，在所有 Cosmos DB 集合和所有文档上禁用生存时间。

## 启用 TTL
<a id="enabling-ttl" class="xliff"></a>
...
## 在集合上配置默认 TTL
<a id="configuring-default-ttl-on-a-collection" class="xliff"></a>
...
## 在文档上设置 TTL
<a id="setting-ttl-on-a-document" class="xliff"></a>
...
## 在现有文档上扩展 TTL
<a id="extending-ttl-on-an-existing-document" class="xliff"></a>
...
## 从文档中移除 TTL
<a id="removing-ttl-from-a-document" class="xliff"></a>
...
## 禁用 TTL
<a id="disabling-ttl" class="xliff"></a>
