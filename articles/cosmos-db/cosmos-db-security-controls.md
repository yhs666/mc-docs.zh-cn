...
description: 用于评估 Azure Cosmos DB 的安全控制的清单
services: cosmos-db
documentationcenter: ''
author: rockboyfor
manager: digimobile
...
ms.date: 09/30/2019
ms.author: v-yeche
ms.openlocfilehash: 91d4e4aed0317e726da1a8be004887221e01bffc
ms.sourcegitcommit: 0d07175c0b83219a3dbae4d413f8e012b6e604ed
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/26/2019
ms.locfileid: "71306874"
---
...
| 安全控制 | 是/否 | 注释 |
|---|---|--|
| 服务器端静态加密：Azure 托管的密钥 | 是 | 所有 Cosmos 数据库和备份默认已加密。请参阅 [Azure Cosmos DB 中的数据加密](database-encryption-at-rest.md)。 不支持使用客户管理的密钥进行服务器端加密。 |
...
<!-- Update_Description: new article about cosmos db security controls -->
<!--ms.date: 09/30/2019-->