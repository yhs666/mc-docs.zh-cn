...
ms.date: 12/03/2018
ms.author: v-yeche
ms.openlocfilehash: 30ec7027750347f49e14694d1b2d6297cbed32a7
...
下面的这个示例创建新的 Cosmos DB 帐户，并在“中国东部”和“中国北部”区域启用多主机，同时将默认一致性策略设置为“有限过期”，将最大过期时间间隔设置为 10 秒钟，将可以忍受的最大过期请求数设置为 200。
