...
## 指定 Azure Cosmos DB 中的请求单位容量
<a id="specifying-request-unit-capacity-in-azure-cosmos-db" class="xliff"></a>
...
### 使用 Azure Cosmos DB 请求费用响应标头
<a id="use-the-azure-cosmos-db-request-charge-response-header" class="xliff"></a>
