...
ms.openlocfilehash: fd611854fe9f8bf970907dc7a17b9f24f65acd31
...
<a id="build-a-python-flask-web-application-using-azure-cosmos-db" class="xliff"></a>
...
本教程演示了如何使用 Azure Cosmos DB 通过 Azure 上托管的 Python Web 应用程序存储和访问数据，并假定你之前有过一些使用 Python 和 Azure 网站的经验。
...
<a id="step-1-create-an-azure-cosmos-db-database-account" class="xliff"></a>
...
2. 将以下代码添加到 config.py，需要在下一步更改 **DOCUMENTDB\_HOST** 和 **DOCUMENTDB\_KEY** 的值。
    ...
    ```
3. 在 [Azure 门户](https://portal.azure.cn/)中，单击“浏览”、“Azure Cosmos DB 帐户”导航到“密钥”边栏选项卡，双击要使用的帐户名，然后单击“概要”区域中的“密钥”按钮。 在“密钥”边栏选项卡中，复制“URI”值并将其粘贴到 **config.py** 文件中，作为 **DOCUMENTDB\_HOST** 属性的值。 
