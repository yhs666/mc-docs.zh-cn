...
ms.date: 06/17/2019
ms.author: v-yeche
ms.openlocfilehash: 1f789510fab98d41b7dbbfbfc65a7f66d79917a3
ms.sourcegitcommit: 43eb6282d454a14a9eca1dfed11ed34adb963bd1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/17/2019
ms.locfileid: "67151488"
---
<!--Verify sucessfully-->
...
3. 如果图形数据库帐户是在 2017 年 12 月 20 日或之后创建的，请将主机名中的 `graphs.azure.cn` 更改为 `gremlin.cosmosdb.azure.cn`。
