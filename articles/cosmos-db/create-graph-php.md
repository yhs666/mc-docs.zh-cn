...
ms.date: 03/18/2019
ms.author: v-yeche
ms.openlocfilehash: a29305ee04881eceda05c0701b0d2a19a88604d6
ms.sourcegitcommit: b8fb6890caed87831b28c82738d6cecfe50674fd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/29/2019
ms.locfileid: "58625259"
---
<!--Verify sucessfully-->
...
3. 如果图形数据库帐户是在 2017 年 12 月 20 日或之后创建的，请将主机名中的 `graphs.azure.com` 更改为 `gremlin.cosmosdb.azure.cn`。
...
<!--Update_Description: new articles on create graph php -->
<!--ms.date: 03/18/2019-->