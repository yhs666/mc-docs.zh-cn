---
title: "Azure Cosmos DB：使用 Java 和 DocumentDB API 生成应用 | Azure"
...
ms.openlocfilehash: e00918882e3785e82cff6931c82aa640bf7b1de3
ms.contentlocale: zh-cn
ms.lasthandoff: 05/19/2017


---
# <a name="azure-cosmos-db-build-a-documentdb-api-app-with-java-and-the-azure-portal-preview"></a>Azure Cosmos DB：使用 Java 和 Azure 门户预览生成 DocumentDB API 应用

Azure Cosmos DB 由 Microsoft 提供，是全球分布的多模型数据库服务。 可快速创建和查询文档、键/值和图形数据库，所有这些都受益于 Azure Cosmos DB 核心的全球分布和水平缩放功能。 

本快速入门教程演示如何使用 Azure 门户预览创建 Azure Cosmos DB 帐户、文档数据库和集合。 然后将生成并运行基于 [DocumentDB Java API](../documentdb/documentdb-sdk-java.md) 构建的控制台应用。
