...
ms.date: 06/17/2019
ms.openlocfilehash: c7fb50324a26e765e85618fbae98ba51f666a013
ms.sourcegitcommit: 43eb6282d454a14a9eca1dfed11ed34adb963bd1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/17/2019
ms.locfileid: "67151464"
---
...
1. 返回 Azure 门户，复制连接字符串信息，并将其粘贴到 *web.config* 中。
    ...
    1. 在“读写密钥”下，使用右侧的复制按钮复制“URI”值，并将其粘贴到 *web.config* 中的 `endpoint` 密钥。   例如： 
        ...
        `<add key="endpoint" value="https://mysqlapicosmosdb.documents.azure.cn:443/" />`
