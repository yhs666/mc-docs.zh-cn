...
ms.date: 11/05/2018
ms.author: v-yeche
ms.openlocfilehash: b4dd1d621643ba76eaeac0aee096b6bb28895a34
ms.sourcegitcommit: c1020b13c8810d50b64e1f27718e9f25b5f9f043
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/29/2018
ms.locfileid: "50204836"
---
<a name="_Toc395783175"></a>
# <a name="build-a-nodejs-web-app-using-javascript-sdk-to-manage-azure-cosmos-db-sql-api-data"></a>使用 JavaScript SDK 生成 Node.js Web 应用，以管理 Azure Cosmos DB SQL API 数据
...
## <a name="step-3-install-the-required-modules"></a>步骤 3：安装所需的模块
...
1. **views** 目录中的 **layout.jade** 文件用作其他 **.jade** 文件的多区域模板。 在此步骤中，将对其进行修改以使用 [Twitter Bootstrap](https://github.com/twbs/bootstrap)（一个可以轻松设计美观网站的工具包）。  
