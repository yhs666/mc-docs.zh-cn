...
ms.date: 03/05/2018
ms.author: v-yeche
ms.openlocfilehash: 32692b17975cdf1cba85d2db820e24af6dd8bf31
...
2. 为帐户类型选择相应“默认体验”（“DocumentDB”<!--either--><!--or **MongoDB**-->），粘贴“连接字符串”，然后单击“确定”以连接 Azure Cosmos DB 帐户。 有关检索连接字符串的信息，请参阅[获取连接字符串](/cosmos-db/manage-account#get-the--connection-string)。
