---
title: "Azure Cosmos DB 教程：在 Apache TinkerPop Gremlin 控制台中创建、查询和遍历 | Azure"
...
ms.date: 07/17/2017
ms.author: v-yeche
ms.openlocfilehash: 0f77c9f9f150f5e693204c985bc6a7e039461277
ms.sourcegitcommit: b15d77b0f003bef2dfb9206da97d2fe0af60365a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/07/2017
---
# Azure Cosmos DB：在 Gremlin 控制台中创建、查询和遍历图形
...
现在尝试一个简单的 count() 命令。 在提示符下，将以下内容键入到控制台：
```
:> g.V().count()
```
...
>
> 这是需要键入的命令的一部分。 通过 Azure Cosmos DB 使用 Gremlin 控制台时，这一部分非常重要。  
>
