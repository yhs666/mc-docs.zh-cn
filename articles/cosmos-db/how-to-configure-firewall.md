...
ms.date: 12/03/2018
ms.author: v-yeche
ms.openlocfilehash: 289036e45c3903b2c018c485e15f92989e177168
ms.sourcegitcommit: 59db70ef3ed61538666fd1071dcf8d03864f10a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52676568"
---
...
##  <a name="configuring-ip-firewall-using-azure-portal"></a>使用 Azure 门户配置 IP 防火墙
...
在 Azure 中，云服务是一种使用 Azure Cosmos DB 托管中间层服务逻辑的常用方法。 要从云服务启用对 Azure Cosmos 帐户的访问，必须通过[配置 IP 访问控制策略](#configure-ip-policy)，将云服务的公共 IP 地址添加到与 Azure Cosmos 帐户关联的 IP 地址的允许列表中。 这可确保云服务的所有角色实例都有权访问 Azure Cosmos 帐户。 如以下屏幕截图所示，可以在 Azure 门户中检索云服务的 IP 地址：
...
[虚拟机](https://www.azure.cn/home/features/virtual-machines/)或[虚拟机规模集](../virtual-machine-scale-sets/virtual-machine-scale-sets-overview.md)还可以用于托管使用 Azure Cosmos DB 的中间层服务。 要将 Cosmos 帐户配置为允许从虚拟机访问，必须通过[配置 IP 访问控制策略](#configure-ip-policy)，将虚拟机和/或虚拟机规模集的公共 IP 地址配置为 Azure Cosmos 帐户允许的 IP 地址之一。 如以下屏幕截图所示，可以在 Azure 门户中检索虚拟机的 IP 地址：
...
## <a name="configure-ip-firewall-using-resource-manager-template"></a>使用资源管理器模板配置 IP 防火墙
...
## <a name="configuring-ip-access-control-policy-using-azure-cli"></a>使用 Azure CLI 配置 IP 访问控制策略
...
## <a name="how-to-troubleshoot-ip-access-control-policy-issues"></a>如何排查 IP 访问控制策略问题
...
对 Azure Cosmos 帐户启用诊断日志记录，这些日志显示每个请求和响应。 与防火墙相关的消息使用 403 返回代码以内部方式记录。 通过筛选这些消息，可以查看已阻止请求的源 IP。
