---
title: "图形 API 的 Azure Cosmos DB 全局分发教程 | Azure"
...
ms.date: 07/17/2017
ms.author: v-yeche
ms.openlocfilehash: 1c0b0d863686891070474fcd3c6e43d0ee41759c
ms.sourcegitcommit: b15d77b0f003bef2dfb9206da97d2fe0af60365a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/07/2017
---
# 如何使用图形 API 设置 Azure Cosmos DB 全局分发
<a id="how-to-setup-azure-cosmos-db-global-distribution-using-the-graph-api" class="xliff"></a>

本文介绍了如何使用 Azure 门户设置 Azure Cosmos DB 全局分发，然后使用图形 API（预览版）进行连接。

本文涵盖以下任务： 

> [!div class="checklist"]
> * 使用 Azure 门户配置全局分发
> * 使用[图形 API](graph-introduction.md)（预览版）配置全局分发

[!INCLUDE [cosmos-db-tutorial-global-distribution-portal](../../includes/cosmos-db-tutorial-global-distribution-portal.md)]

## 通过 .NET SDK 使用图形 API 连接到首选区域
<a id="connecting-to-a-preferred-region-using-the-graph-api-using-the-net-sdk" class="xliff"></a>

图形 API 在 DocumentDB SDK 上作为扩展库公开。

为了利用[全局分发](distribute-data-globally.md)，客户端应用程序可以指定要用于执行文档操作的区域优先顺序列表。 可通过设置连接策略来实现此目的。 SDK 根据 Azure Cosmos DB 帐户配置、当前区域可用性和指定的优先顺序列表，选择最佳的终结点来执行写入和读取操作。
...
### 使用 SDK
<a id="using-the-sdk" class="xliff"></a>
