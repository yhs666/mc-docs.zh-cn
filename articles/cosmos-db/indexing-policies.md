...
ms.date: 09/03/2018
ms.author: v-yeche
ms.openlocfilehash: 59c5f886a8ec4c61f31e752cb544d0940ed3955e
ms.sourcegitcommit: aee279ed9192773de55e52e628bb9e0e9055120e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/29/2018
ms.locfileid: "43164775"
---
...
### <a name="customize-the-indexing-policy-in-the-portal"></a>自定义门户中的索引策略
...
* **范围**支持高效的等式查询、范围查询（使用 >、<、>=、<=、!=）和 ORDER BY 查询。 默认情况下，ORDER BY 查询还需要最大索引精度 (-1)。 数据类型可以是字符串或数字。
...
## <a name="modify-the-indexing-policy-of-a-collection"></a>修改集合的索引策略
...
若要检查存储配额和集合使用情况，请针对集合资源运行 HEAD 或 GET 请求。 然后检查 x-ms-request-quota 和 x-ms-request-usage 标头。 在 .NET SDK 中，[ResourceResponse<T\>](http://msdn.microsoft.com/library/dn799209.aspx) 中的 [DocumentSizeQuota](http://msdn.microsoft.com/library/dn850325.aspx) 和 [DocumentSizeUsage](http://msdn.microsoft.com/library/azure/dn850324.aspx) 属性包含这些相应的值。
...
若要度量每个写入操作（创建、更新或删除）执行索引的开销，请检查 x-ms-request-charge 标头（或 .NET SDK 中 [ResourceResponse<T\>](http://msdn.microsoft.com/library/dn799209.aspx) 的等效 [RequestCharge](http://msdn.microsoft.com/library/dn799099.aspx) 属性）来度量这些操作占用的请求单位数。
...
* [SQL API .NET 索引管理代码示例](https://github.com/Azure/azure-documentdb-net/blob/master/samples/code-samples/IndexManagement/Program.cs)
* [SQL API REST 集合操作](https://msdn.microsoft.com/library/azure/dn782195.aspx)
* [使用 SQL 进行查询](sql-api-sql-query.md)
