...
ms.openlocfilehash: b165cb13043ea8720714746fc015636b4940aa47
...
> [!WARNING]
> 为了避免在任何作业期间创建一个新集合，可以将结果打印到 stdout，将输出保存到 WASB 容器，或指定一个现有集合。 指定现有集合时，会在集合内创建新文档，如果 *ID*中有冲突，只会影响现有文档。 
