...
ms.openlocfilehash: be4a4759d5fec12e22af3e4b403d32412ff04185
...
* Cosmos DB 帐户、数据库以及其中包含文档的集合。 有关详细信息，请参阅 [Cosmos DB 入门][getting-started]。 使用 [Cosmos DB 导入工具][import-data]将示例数据导入到 Cosmos DB 帐户。
...
本教程使用 Azure 门户中的脚本操作自定义 HDInsight 群集。 本教程将使用 Azure 门户创建 HDInsight 群集。 有关如何使用 PowerShell cmdlet 或 HDInsight .NET SDK 的说明，请查看[使用脚本操作自定义 HDInsight 群集][hdinsight-custom-provision]一文。
