...
ms.date: 09/30/2019
ms.author: v-yeche
ms.openlocfilehash: 569a7be4afedb579e7906b58f4ae622fe6e29810
ms.sourcegitcommit: 0d07175c0b83219a3dbae4d413f8e012b6e604ed
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/26/2019
ms.locfileid: "71306882"
---
...
资源标记之上的对象模型层次结构：
- **Cosmos DB 帐户** - 具有与之关联的 DNS 的顶级实体，例如 `contoso.gremlin.cosmos.azure.cn`
  - **Cosmos DB 数据库**
    - **User**
      - 权限 
...
GremlinServer server = new GremlinServer(
  "contoso.gremlin.cosmosdb.azure.cn",
  port: 443,
  enableSsl: true,
...
<!-- Update_Description: new article about how to use resource tokens gremlin -->
<!--ms.date: 09/30/2019-->