...
ms.date: 12/03/2018
ms.author: v-yeche
ms.openlocfilehash: 3ffe7cd8e624e958dc989bfd54254b3d9ea18b0d
ms.sourcegitcommit: 59db70ef3ed61538666fd1071dcf8d03864f10a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52676737"
---
...
- **最后写入者胜出 (LWW)** ：此解决策略默认情况下使用系统定义的时间戳属性（基于时间同步时钟协议）。 另外，在使用 SQL API 时，Cosmos DB 允许指定其他任何自定义数字属性（也称为“冲突解决路径”）用于解决冲突。  
  ...
  > [!NOTE]
  > 最后写入者胜出是默认的冲突解决策略，适用于 SQL 和 MongoDB API 帐户。
  
  <!-- Not Available on  Table, Cassandra and Gremlin API-->
...
<!-- Update_Description: new articles on cosmos db conflict resolution policies -->
<!--ms.date: 12/03/2018-->