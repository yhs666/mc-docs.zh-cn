...
author: rockboyfor
ms.author: v-yeche
ms.openlocfilehash: 5a38a63d8469f32bb02473d26ee2e91c937f88d5
ms.sourcegitcommit: 10458f9a72d4648fd5c9953136bb9581bb216015
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/31/2019
ms.locfileid: "66424271"
---
...
> [!NOTE]
> Azure Cosmos DB 中的内置 Apache Spark 支持目前以受限预览版提供。 若要注册预览版，请导航到[“注册预览版”页](https://portal.azure.cn/?feature.customportal=false#create/Microsoft.DocumentDB)。 
...
### <a name="multiple-region-distributed-low-latency-operational-analytics-and-ai"></a>多区域分布式低延迟运营分析和 AI

通过针对多区域分布式 Azure Cosmos 数据库使用 Apache Spark，现在可以在中国各地快速获取实时见解。 Azure Cosmos DB 使用三项关键技术来实现支持弹性缩放的**多区域分布式低延迟运营分析**：

* 由于 Azure Cosmos 数据库是多区域分布的，因此将在数据生成者（例如用户）所在位置本地引入所有数据。 无论数据生成者和使用者位于全球的哪个位置，都会针对最靠近他们的本地副本提供查询服务。 
...
将 Apache Spark 集成到 Azure Cosmos DB 可以弥合事务与分析功能的隔离状态，而这种隔离是客户在生成多区域规模的云原生应用程序时面临的主要痛点之一。 
