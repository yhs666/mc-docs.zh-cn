...
ms.author: v-yeche
ms.custom: mvc
ms.openlocfilehash: 3cbaf0ddc3d1ec43a4451f45358adbe492ffe31e
...
[!INCLUDE [quickstarts-free-trial-note](../../includes/quickstarts-free-trial-note.md)]或者，无需 Azure 订阅即可[免费试用 Azure Cosmos DB](https://www.azure.cn/try/cosmosdb/)，也无需缴纳费用或承诺金。
...
现在，让我们转到如何使用代码上来。 从 GitHub 克隆 Cassandra 应用，设置连接字符串，并运行应用。 你会看到以编程方式处理数据是多么容易。 
...
1. 在 [Azure 门户](http://portal.azure.cn/)中，单击“连接字符串”。 
    ...
    ![在 Azure 门户的“连接字符串”页面中查看并复制用户名](./media/tutorial-develop-cassandra-java/keys.png)

2. 使用屏幕右侧的 ![“复制”按钮](./media/tutorial-develop-cassandra-java/copy.png) 复制“联系点”值。
