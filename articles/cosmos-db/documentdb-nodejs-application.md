---
title: "了解 Node.js - Azure Cosmos DB Node.js 教程 | Azure"
...
ms.date: 07/17/2017
ms.author: v-yeche
ms.openlocfilehash: bb7aa0ec5f4a94df6f1f66c85c7807af64e61b63
...
没有时间完成本教程且只想获取完整的解决方案？ 没有问题，你可以从 [GitHub][GitHub]获得完整的示例解决方案。 只需读取[自述](https://github.com/Azure-Samples/documentdb-node-todo-app/blob/master/README.md)文件，了解如何运行该应用。
