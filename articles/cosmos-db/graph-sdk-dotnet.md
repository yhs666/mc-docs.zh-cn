---
title: "Azure CosmosDB 图形 API .NET SDK 和资源 | Azure"
description: "了解有关 Azure CosmosDB 图形 API 的全部信息，包括发布日期、停用日期和各版本之间进行的更改。"
services: cosmosdb
...
ms.openlocfilehash: d685b2a25291c3cccea6bfc14af7f0255b6e1fed
...
|**快速入门**|[Azure Cosmos DB：使用 .NET 和图形 API 创建图形应用](create-graph-dotnet.md)|
...
若要了解有关 Azure Cosmos DB 图形 API 的详细信息，请参阅 [Azure Cosmos DB：图形 API 简介](graph-introduction.md)。
