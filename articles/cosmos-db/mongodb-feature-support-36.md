...
author: rockboyfor
ms.author: v-yeche
ms.openlocfilehash: 6706c070a3b22302e85e39dac414a6a8efad964f
ms.sourcegitcommit: 73f07c008336204bd69b1e0ee188286d0962c1d7
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/25/2019
ms.locfileid: "72914841"
---
...
默认情况下，对于新帐户，Azure Cosmos DB 的 API for MongoDB 与 MongoDB 服务器版本 **3.6** 兼容。 支持的运算符以及限制或例外已列在下面。 任何理解这些协议的客户端驱动程序应该都能够连接到 Azure Cosmos DB 的用于 MongoDB 的 API。
...
<!--Update_Description: new articles on mongodb feature support 3.6 version  -->
<!--New.date: 10/28/2019-->