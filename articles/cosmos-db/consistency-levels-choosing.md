---
title: 为使用 Azure Cosmos DB 的应用程序选择适当的一致性级别 | Azure
...
ms.date: 12/03/2018
ms.author: v-yeche
ms.openlocfilehash: fa7102415c80df45051e352248000a789246cfd3
ms.sourcegitcommit: 59db70ef3ed61538666fd1071dcf8d03864f10a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52676494"
---
...
<!-- Not Available on Table API--> 如果应用程序是使用 Cosmos DB SQL API 生成的，请注意以下几点
...
<!-- Not Available on Cassandra, and Gremlin API-->
<!-- Not Available on [Consistency levels and Cosmos DB APIs](consistency-levels-across-apis.md#cassandra-mapping)-->
...
<!-- Update_Description: new articles on cosmos db consistence levels choosing -->
<!--ms.date: 12/03/2018-->