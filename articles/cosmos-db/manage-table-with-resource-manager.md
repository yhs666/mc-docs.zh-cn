...
ms.date: 05/13/2019
ms.author: v-yeche
ms.openlocfilehash: 9e2eeda5567a9a92ae0b77ac516eb81bc00fdace
ms.sourcegitcommit: 71172ca8af82d93d3da548222fbc82ed596d6256
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/15/2019
ms.locfileid: "65668994"
---
<!--Verify successfully-->
# <a name="create-azure-cosmos-db-table-api-resources-from-a-resource-manager-template"></a>从资源管理器模板创建 Azure Cosmos DB 表 API 资源

了解如何使用 Azure 资源管理器模板创建 Azure Cosmos DB 表 API 资源。 以下示例通过 [Azure 快速入门模板](https://aka.ms/table-arm-qs)创建 Azure Cosmos DB 表 API。 此模板将创建一个适用于表 API 的 Azure Cosmos 帐户，所使用的一个表的吞吐量为 400 RU/秒。
...
<!--Update_Description: new articles on manage table with resource manager -->
<!--ms.date: 05/20/2019-->