...
下面的示例演示了如何使用 [SQL API .NET SDK](sql-api-sdk-dotnet.md) 和 [RequestOptions.IndexingDirective](https://docs.azure.cn/zh-cn/dotnet/api/microsoft.azure.documents.client.requestoptions.indexingdirective?view=azure-dotnet) 属性来显式包括项。
