...
ms.date: 09/09/2019
ms.author: v-yeche
ms.openlocfilehash: 7b29884a2e83ebd1c9a20b84a8a6de5eb1dda75b
ms.sourcegitcommit: 66192c23d7e5bf83d32311ae8fbb83e876e73534
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/04/2019
ms.locfileid: "70254500"
---
...
对某个数据库预配的吞吐量可由该数据库内的容器共享。 最多 25 个容器可以共享对数据库预配的吞吐量。 超过 25 个容器时，在该数据库中创建的每个新容器可与该数据库中已有的其他集合共享一部分数据库吞吐量。 可共享的吞吐量取决于数据库中预配的容器数。 

如果工作负荷涉及到删除数据库中的所有集合并重新创建集合，则我们建议删除空数据库，再重新创建新的数据库，然后创建集合。
