...
ms.date: 04/15/2019
ms.author: v-yeche
ms.openlocfilehash: 9d2ec9a97cdd20eca2bf42598c520ebc1ac2b333
ms.sourcegitcommit: f85e05861148b480d6c9ea95ce84a17145872442
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/16/2019
ms.locfileid: "59615242"
---
...
可以通过 SDK 以编程方式检索容器或数据库的最小吞吐量，也可以在 Azure 门户中查看值。 使用 .NET SDK 时，可以通过 [DocumentClient.ReplaceOfferAsync](https://docs.azure.cn/zh-cn/dotnet/api/microsoft.azure.documents.client.documentclient.replaceofferasync?view=azure-dotnet) 方法缩放预配的吞吐量值。 使用 Java SDK 时，可以通过 [RequestOptions.setOfferThroughput](sql-api-java-samples.md#offer-examples) 方法缩放预配的吞吐量值。 
...
可以随时缩放容器或数据库的预配吞吐量。 可以在空闲 4 小时后运行纵向缩减操作。 根据定义，空闲期间是指在容器或数据库上没有套餐更换操作（包括纵向扩展和纵向缩减）的时间段。 
