...
1. 在 Visual Studio 的“文件”  菜单中，选择“新建”  ，然后选择“项目”  。 会显示“新建项目”对话框  。
...
2. 此时显示“管理 NuGet 包”对话框  。 在 NuGet 的“浏览”框中，键入 **Microsoft.Azure.Cosmos**。  从结果中安装 **Microsoft.Azure.Cosmos** 包。 它会下载并安装 Azure Cosmos DB 包及其依赖项。 在“接受许可证”窗口中选择“我接受”，以完成安装。  
