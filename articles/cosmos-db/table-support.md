---
title: "Azure Cosmos DB 中的 Azure 表存储支持 | Azure"
...
ms.date: 11/27/2017
ms.author: v-yeche
ms.openlocfilehash: da8a4c5f94d7a7161b6414745eda26ce05634713
...
- [Microsoft.Azure.CosmosDB.Table](https://aka.ms/tableapinuget) .NET SDK。 此库与公共 [Microsoft Azure 存储 SDK](https://www.nuget.org/packages/WindowsAzure.Storage) 具有相同的类和方法签名，但还具有使用表 API 连接到 Azure Cosmos DB 帐户的功能。 
...
- [Java SDK](table-sdk-java.md)。 此 Microsoft Azure 存储 SDK 能够使用表 API 连接到 Azure Cosmos DB 帐户。
- [Node.js SDK](table-sdk-nodejs.md)。 此 Microsoft Azure 存储 SDK 能够使用表 API 连接到 Azure Cosmos DB 帐户。
