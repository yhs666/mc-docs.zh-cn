...
ms.openlocfilehash: 5ffa2069dae3e4f1a169820753f28086f981530c
...
| [az cosmosdb list-keys](https://docs.microsoft.com/cli/azure/sql/server#create) | 创建用于托管 SQL 数据库的逻辑服务器。 |
