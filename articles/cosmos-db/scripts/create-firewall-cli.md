...
ms.date: 07/17/2017
ms.author: v-yeche
ms.openlocfilehash: 9d9ed9d61c2e031431cf70abf2d5c386b3fcb603
ms.sourcegitcommit: b15d77b0f003bef2dfb9206da97d2fe0af60365a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/07/2017
---
# Azure Cosmos DB：使用 Azure CLI 创建防火墙
...
| [az cosmosdb create](https://docs.microsoft.com/zh-cn/cli/azure/cosmosdb/name#create) | 创建 Azure CosmosDB 帐户。 |
| [az cosmosdb update](https://docs.microsoft.com/zh-cn/cli/azure/sql/server#create) | 更新 Azure CosmosDB 帐户，将防火墙设置加入其中。 |
