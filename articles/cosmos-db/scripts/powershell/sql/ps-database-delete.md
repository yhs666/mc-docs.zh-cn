...
ms.date: 05/20/2019
ms.author: v-yeche
ms.openlocfilehash: 3f60335fad3a53b65036513731131420459cb0a1
ms.sourcegitcommit: 71172ca8af82d93d3da548222fbc82ed596d6256
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/15/2019
ms.locfileid: "65669032"
---
# <a name="delete-a-database-in-an-azure-cosmos-account-in-an-azure-cosmos-account-using-powershell"></a>使用 PowerShell 删除 Azure Cosmos 帐户中的数据库
...
<!--Update_Description: new articles on ps database delete-->
<!--ms.date: 05/20/2019-->