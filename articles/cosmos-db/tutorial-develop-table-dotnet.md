...
ms.custom: seodec18
ms.reviewer: sngun
ms.openlocfilehash: a2fdaab838d0142c281a365d09c543088c1d6f78
ms.sourcegitcommit: 66e360fe2577c9b7ddd96ff78e0ede36c3593b99
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/15/2019
ms.locfileid: "57988347"
---
<!--Verify sucessfully-->
...
- 具有多宿主的统包[多区域分发](distribute-data-globally.md)与[自动和手动故障转移](high-availability.md)
...
以下代码片段演示如何使用 Azure 存储 SDK 插入实体。 Azure Cosmos DB 的设计旨在保证针对中国的任何规模实现低延迟。
