...
ms.date: 07/17/2017
ms.author: v-yeche
ms.openlocfilehash: 9e80e76b77c5f5af6a5e458aa92f0070ccb33341
ms.sourcegitcommit: b15d77b0f003bef2dfb9206da97d2fe0af60365a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/07/2017
---
# Azure Cosmos DB：使用图形 API 生成 Node.js 应用程序
...
1. 在 [Azure 门户](http://portal.azure.cn/)的 Azure Cosmos DB 帐户的左侧导航菜单中，单击“密钥”，然后单击“读写密钥”。 使用右侧的复制按钮将 URI 和主密钥复制到下一步的 `app.js` 文件中。
