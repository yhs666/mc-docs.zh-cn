...
ms.date: 12/25/2017
ms.author: v-yeche
ms.openlocfilehash: d3c2d6ba7e3eecba1365ebdae28c6d3ea5e1317e
...
* 多区域分布。 移动应用的用户特点是经常在全球不同的地点漫游。 Azure Cosmos DB 是[全局分布式数据库](distribute-data-globally.md)。 单击地图即可让用户访问数据。
<!-- Notice: 全球 to 多个区域 -->
