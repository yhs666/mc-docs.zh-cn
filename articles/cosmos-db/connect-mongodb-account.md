...
ms.date: 12/31/2018
ms.author: v-yeche
ms.openlocfilehash: 58a12a70266f8395b4c0a0724d4ed421fe285261
...
- 一个 Azure Cosmos DB 帐户。 有关说明，请参阅[使用 .NET 和 Azure 门户生成 Azure Cosmos DB API for MongoDB Web 应用](create-mongodb-dotnet.md)。
