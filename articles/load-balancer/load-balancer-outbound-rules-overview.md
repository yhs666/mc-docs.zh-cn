...
origin.date: 10/8/2018
ms.date: 11/05/2018
ms.author: v-jay
ms.openlocfilehash: 085695853f51f66ec51ef3e0eaab65994fa2e050
ms.sourcegitcommit: 9be84d4dc546d66a0d9d1d2be67dd79c84b2c210
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/31/2018
ms.locfileid: "50408860"
---
...
此外，可以直接对出站规则使用[公共 IP 前缀](/load-balancer/load-balancer-outbound-rules-overview)。  这样可以简化缩放，并更轻松地将源自 Azure 部署的流加入白名单。 可以在负载均衡器资源中配置直接引用公共 IP 地址前缀的前端 IP 配置。  这样，负载均衡器将以独占方式控制公共 IP 前缀，而出站规则将自动使用公共 IP 前缀中包含的所有公共 IP 地址来建立出站连接。  公共 IP 前缀范围内的每个 IP 地址提供 64,000 个临时端口，供负载均衡器用作 SNAT 端口。   
