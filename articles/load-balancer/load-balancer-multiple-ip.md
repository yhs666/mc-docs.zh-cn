...
ms.date: 05/08/2017
ms.author: v-yeche
ms.openlocfilehash: dff82042702c0a23558fdaf938521ac76e2899a0
...
<a id="load-balancing-on-multiple-ip-configurations-using-the-azure-portal" class="xliff"></a>
...
<a id="step-1-configure-the-secondary-nics-for-each-vm" class="xliff"></a>
...
### 步骤 2：创建负载均衡器
<a id="step-2-create-a-load-balancer" class="xliff"></a>
...
### 步骤 3：配置前端 IP 池
<a id="step-3-configure-the-frontend-ip-pool" class="xliff"></a>
...
### 步骤 4：配置后端池
<a id="step-4-configure-the-backend-pool" class="xliff"></a>   
...
### 步骤 5：为负载均衡器配置运行状况探测
<a id="step-5-configure-a-health-probe-for-your-load-balancer" class="xliff"></a>
按如下所述为负载均衡器配置运行状况探测：
    1. 在门户中单击“更多服务”> 在筛选框中键入“负载均衡器”，然后单击“负载均衡器”。  
    2. 选择要将后端池添加到的负载均衡器。
...
### 步骤 6：配置负载均衡规则
<a id="step-6-configure-load-balancing-rules" class="xliff"></a>
...
### 步骤 7：配置 DNS 记录
<a id="step-7-configure-dns-records" class="xliff"></a>
