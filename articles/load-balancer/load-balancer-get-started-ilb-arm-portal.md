...
ms.date: 03/03/2017
ms.author: v-yeche
ms.openlocfilehash: 432e3f6b1719bed1411abbe32b27ecdce26b2389
...
1. 打开浏览器，导航到 [Azure 门户](http://portal.azure.cn)，然后使用 Azure 帐户登录。
...
7. 在“IP 地址分配”下，单击“动态”或“静态”，具体取决于是否希望负载均衡器使用固定（静态）IP 地址。
...
7. 在“后端端口”下，指定要在后端池中使用的端口（通常情况下，负载均衡器端口与后端端口相同）。
8. 在“后端池” 下，选择前面创建的后端池。
9. 在“会话持久性” 下，选择要保留会话的方式。
10. 在“空闲超时(分钟)”下，指定空闲超时时间。
