...
ms.author: v-yiso
ms.date: 03/26/2018
ms.openlocfilehash: 2efb18b05029889027e072b24d7ef3fb6aa0d284
ms.sourcegitcommit: 41a236135b2eaf3d104aa1edaac00356f04807df
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/22/2018
ms.locfileid: "30072504"
---
# <a name="get-started-with-the-bing-search-connector"></a>必应搜索连接器入门
连接到必应搜索，搜索资讯、视频等。 通过必应搜索，可以： 
...
在[连接器详细信息](/connectors/bingsearch/)中查看在 Swagger 中定义的触发器和操作，并查看限制。
