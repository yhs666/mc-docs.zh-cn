---
title: 使用 SSH 连接到 SFTP 服务器 - Azure 逻辑应用
...
ms.date: 11/11/2019
tags: connectors
ms.openlocfilehash: 02a513d68533d9010c58d3b089aa050ea61ff219
ms.sourcegitcommit: fc8a6e0f8eff2ef7b645ae8dc2ac02fdf498086f
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/04/2019
ms.locfileid: "74797609"
---
...
* 默认情况下，SFTP-SSH 操作可以读取或写入 1 GB 或更小  的文件，但是每次只能采用 *15 MB* 的块区。 为了处理大于 15 MB 的文件，SFTP-SSH 操作支持[消息分块](../logic-apps/logic-apps-handle-large-messages.md)，但只能处理 15 MB 文件的“复制文件”操作除外。 “获取文件内容”  操作隐式使用消息分块。
...
* 默认情况下，SFTP-SSH 操作可以读取或写入 1 GB 或更小  的文件，但是每次只能采用 *15 MB* 的块区。 SFTP-SSH 操作可以使用[消息分块](../logic-apps/logic-apps-handle-large-messages.md)来处理大于 15 MB 的文件。 但是，“复制文件”操作只支持 15 MB 的文件，因为该操作不支持消息分块。 SFTP-SSH 触发器不支持分块。
