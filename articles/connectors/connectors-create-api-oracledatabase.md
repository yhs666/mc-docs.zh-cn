---
title: 在 Azure 逻辑应用中添加 Oracle 数据库连接器
...
ms.author: v-yiso
ms.date: 03/26/2018
ms.openlocfilehash: 402498edcb089c589114fe2dbc5df26ccb79c67f
...
[创建逻辑应用](../logic-apps/quickstart-create-first-logic-app-workflow.md)，并在我们的 [API 列表](apis-list.md)中了解逻辑应用中的可用连接器。
