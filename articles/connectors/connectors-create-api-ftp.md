...
ms.date: 06/24/2019
tags: connectors
ms.openlocfilehash: 7d80eb3dbc71e74a8353c126ec93b29974c6c0d4
ms.sourcegitcommit: e77582e79df32272e64c6765fdb3613241671c20
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/14/2019
ms.locfileid: "67135862"
---
...
* FTP 操作仅支持 50 MB 或更小  的文件，除非你使用[消息分块](../logic-apps/logic-apps-handle-large-messages.md)，这可以超过此限制。 目前，FTP 触发器不支持分块。
...
请求文件内容时，触发器无法获取大于 50 MB 的文件。 若要获取大于 50 MB 的文件，请遵循以下模式： 
