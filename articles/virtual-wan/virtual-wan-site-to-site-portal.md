---
title: 使用 Azure 虚拟 WAN 与 Azure 建立站点到站点连接 | Azure
...
<a name="site"></a>
## <a name="2-create-a-site"></a>2.创建站点

创建任意数目的与物理位置对应的站点。 例如，如果你在北京、上海和天津各有一个分支机构，请创建三个独立的站点。 这些站点包含本地 VPN 设备终结点。 目前，只能为站点指定一个专用地址空间。
...
<a name="associate"></a>
## <a name="4-associate-the-sites-with-the-hub"></a>4.将站点与中心相关联
...
<a name="vnet"></a>
## <a name="5-create-a-virtual-network"></a>5.创建虚拟网络
...
<a name="device"></a>
## <a name="7-download-vpn-configuration"></a>7.下载 VPN 配置
...
<a name="viewwan"></a>
## <a name="8-view-your-virtual-wan"></a>8.查看虚拟 WAN
...
<a name="viewhealth"></a>
## <a name="9-view-your-resource-health"></a>9.查看资源运行状况

1. 导航到 WAN。
2. 在“WAN”页上的“支持 + 故障排除”部分，单击“运行状况”并查看资源。  

<a name="connectmon"></a>
## <a name="10-monitor-a-connection"></a>10.监视连接
...
<a name="cleanup"></a>
## <a name="11-clean-up-resources"></a>11.清理资源
