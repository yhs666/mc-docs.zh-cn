...
ms.date: 06/03/2019
ms.author: v-junlch
ms.openlocfilehash: 8984e102085bc4178398d2c9e99de7a3d4273e7d
ms.sourcegitcommit: 9e839c50ac69907e54ddc7ea13ae673d294da77a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/04/2019
ms.locfileid: "66491479"
---
...
Durable Functions 的计费与 Azure Functions 一样。 有关详细信息，请参阅 [Azure Functions 定价](https://www.azure.cn/pricing/details/azure-functions/)。
...
Durable Functions 是 [Azure Functions](../functions-overview.md) 的高级扩展，因此并不适用于所有应用程序。 若要详细了解 Durable Functions，请参阅 [Durable Functions 模式和技术概念](durable-functions-concepts.md)。 
