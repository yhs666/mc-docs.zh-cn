...
ms.date: 09/29/2019
ms.author: v-junlch
ms.openlocfilehash: 721ab6819072aee192e1808b616eafc89b8e3b0d
ms.sourcegitcommit: 73a8bff422741faeb19093467e0a2a608cb896e1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/29/2019
ms.locfileid: "71673552"
---
...
从 Durable Functions v2.0.0-alpha 开始，我们引入了一个新的[实体函数](durable-functions-entities.md)概念。
...
基于最初的用户反馈，我们后来添加了对 Durable Functions v2.0.0-beta1 中实体的基于类的编程模型的支持。

若要了解更多信息，请参阅[实体函数](durable-functions-entities.md)一文。

## <a name="durable-http"></a>持久 HTTP

从 Durable Functions v2.0.0-beta2 开始，我们引入了新的[持久 HTTP](durable-functions-http-features.md) 功能，允许你：

* 直接从业务流程函数调用 HTTP API（有一些记录的限制）
* 实现自动客户端 HTTP 202 状态轮询
* 对 [Azure 托管标识](/active-directory/managed-identities-azure-resources/overview)的内置支持
