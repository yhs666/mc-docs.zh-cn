...
ms.date: 12/25/2018
ms.author: v-junlch
ms.openlocfilehash: 29dfcfc33eadd0b927cbf9b08a28f704163a4624
ms.sourcegitcommit: d15400cf780fd494d491b2fe1c56e312d3a95969
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/28/2018
ms.locfileid: "53806666"
---
...
不能直接将多个参数传递给活动函数。 在这种情况下，建议传入对象数组或者在 .NET 中使用 [ValueTuples](https://docs.microsoft.com/en-us/dotnet/csharp/tuples) 对象。

以下示例使用了 [C# 7](https://docs.microsoft.com/en-us/dotnet/csharp/whats-new/csharp-7#tuples) 添加的 [ValueTuples](https://docs.microsoft.com/en-us/dotnet/csharp/tuples) 的新功能：
