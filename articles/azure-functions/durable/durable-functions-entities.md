...
ms.date: 10/28/2019
ms.author: v-junlch
ms.openlocfilehash: 3ddd61bac488b9119184fdb8ad4f353cf38ca664
ms.sourcegitcommit: 7d2ea8a08ee329913015bc5d2f375fc2620578ba
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/29/2019
ms.locfileid: "73034431"
---
# <a name="entity-functions-preview"></a>实体函数（预览版）

实体函数定义读取和更新较小状态片段（称为“持久实体”）的操作。  与业务流程协调程序函数类似，实体函数是具有特殊触发器类型“实体触发器”的函数。  与业务流程协调程序函数不同，实体函数会显式管理实体状态，而不是通过控制流隐式表示状态。
...
* 一个**实体名称**：用于标识实体类型的名称（例如“Counter”）。 此名称必须与实现该实体的实体函数的名称相匹配。 此名称不区分大小写。
