...
ms.date: 04/18/2018
ms.author: v-junlch
ms.openlocfilehash: eaaec3f92b8300c78afa48d6bd42460fd412b24b
ms.sourcegitcommit: f97c9253d16fac8be0266c9473c730ebd528e542
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/19/2018
ms.locfileid: "31585464"
---
...
1. 在 [Azure 门户](https://portal.azure.cn)中，导航到函数应用，并在“已配置功能”下选择“函数应用设置”。 
...
1. 在 [Azure 门户](https://portal.azure.cn)中，导航到“函数应用”，并在“已配置功能”下选择“应用程序设置”。
...
## <a name="target-a-version-using-azure-cli"></a>使用 Azure CLI 指定版本
 ...
 还可以设置来自 Azure CLI 的 `FUNCTIONS_EXTENSION_VERSION`。 使用 Azure CLI 更新，通过 [az functionapp config appsettings set](https://docs.microsoft.com/cli/azure/functionapp/config/appsettings#set) 命令在函数应用中更新应用程序设置。
