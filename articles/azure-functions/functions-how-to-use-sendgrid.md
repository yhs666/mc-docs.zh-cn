...
ms.date: 04/18/2018
ms.author: v-junlch
ms.openlocfilehash: 69eeec56304b4580b4d34f0fe3f7032f3ce4b98e
...
1. 登录到 Azure 门户并[创建 Azure Function APP](/azure-functions/functions-create-first-azure-function) 或打开一个现有 Function App。 
