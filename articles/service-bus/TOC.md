# 概述
## [消息传送](/azure/service-bus-messaging)
## [中继](/azure/service-bus-relay)
# 引用
## [PowerShell Resource Manager Cmdlet](https://docs.microsoft.com/powershell/resourcemanager)
## [服务总线托管参考 API](/dotnet/api/) 
## [服务总线 REST API 参考](https://docs.microsoft.com/rest/api/servicebus) 
# 资源
