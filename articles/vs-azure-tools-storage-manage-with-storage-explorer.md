...
ms.date: 12/28/2017
ms.author: v-junlch
ms.openlocfilehash: 14401b2bac87a9f750284cc519ad5aca4ea3d93c
...
2. 如果尚未安装 Azure 存储模拟器，系统会提示按照信息栏中的说明进行安装。 如果该信息栏已显示，请选择“下载最新版本”，并安装模拟器。
...
要共享外部存储帐户，首先必须由该帐户的所有者获取该帐户的凭据（帐户名称和密钥），并将该信息共享给想要附加到该（外部）帐户的人员。 可以执行以下操作，通过 Azure 门户获取存储帐户凭据：
...
3. 选择“连接字符串”旁边的“复制”，将其复制到剪贴板，并选择“关闭”。
