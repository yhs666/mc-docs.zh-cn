...
ms.date: 02/22/2017
ms.author: v-junlch
ms.openlocfilehash: 9f39f5b1b650107f6fdfbcb0548bf94d1e3b9060
...
使用 **Power BI Embedded**，可以在自己的应用中嵌入报表。 在应用中嵌入 Power BI 报表时，可以通过导入数据的副本或通过使用 DirectQuery 直接连接到数据源将该报表连接到基础数据。
