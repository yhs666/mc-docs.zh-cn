...
```powershell
$AzureNetworkWatcherExtension = Get-AzureRmVMExtensionImage -Location chinanorth -PublisherName Microsoft.Azure.NetworkWatcher -Type NetworkWatcherAgentWindows -Version 1.4.585.2
