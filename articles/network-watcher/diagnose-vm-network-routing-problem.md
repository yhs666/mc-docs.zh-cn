---
title: 诊断虚拟机网络路由问题 - 教程 - Azure 门户 | Azure
...
本教程介绍了如何创建 VM 并根据该 VM 诊断网络路由问题， 同时还介绍了 Azure 可以创建多个默认路由，并且还测试了到两个不同目标的路由。 详细了解 [Azure 中的路由](../virtual-network/virtual-networks-udr-overview.md?toc=%2fnetwork-watcher%2ftoc.json)以及如何[创建自定义路由](../virtual-network/manage-route-table.md?toc=%2fnetwork-watcher%2ftoc.json#create-a-route)。
