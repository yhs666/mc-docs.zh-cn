---
title: "使用 Azure 网络观察程序检查连接性 - Azure 门户 | Azure"
description: "本页说明了如何使用 Azure 门户通过网络观察程序使用连接监视"
...
导航到网络观察程序并单击“连接监视（预览版）”。 选择虚拟机以检查其连接性。 在“目标”部分，选择“选择虚拟机”，并选择正确的虚拟机和端口来进行测试。
