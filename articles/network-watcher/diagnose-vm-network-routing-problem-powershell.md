...
若要进一步分析路由情况，请使用 [Get-AzureRmEffectiveRouteTable](https://docs.microsoft.com/powershell/module/azurerm.network/get-azurermeffectiveroutetable) 命令查看网络接口的有效路由。
