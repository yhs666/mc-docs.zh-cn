...
<a id="how-azure-subscriptions-are-associated-with-azure-active-directory" class="xliff"></a>
本文介绍有关登录 Azure 及相关问题（例如，Azure 订阅与 Azure Active Directory (Azure AD) 之间的关系）的信息。

## 可用于登录的帐户
<a id="accounts-that-you-can-use-to-sign-in" class="xliff"></a>
...
<a id="how-an-azure-subscription-is-related-to-azure-ad" class="xliff"></a>
...
## 如何管理订阅和目录
<a id="how-to-manage-a-subscription-and-a-directory" class="xliff"></a>
...
## 我为何无法使用当前的用户帐户管理目录？
<a id="why-cant-i-manage-the-directory-with-my-current-user-account" class="xliff"></a>
...
<a id="using-your-work-or-school-account-to-manage-an-azure-subscription-that-was-created-by-using-a-microsoft-account" class="xliff"></a>
...
<a id="signing-in-when-you-used-your-work-email-for-your-microsoft-account" class="xliff"></a>
...
<a id="manage-the-directory-for-your-office-365-subscription-in-azure" class="xliff"></a>
假设在注册 Azure 之前注册了 Office 365。 现在你要在 Azure 经典管理门户中管理 Office 365 订阅的目录。 可以通过两种方式进行管理，具体取决于是否注册了 Azure。

### 我没有订阅 Azure
<a id="i-do-not-have-a-subscription-for-azure" class="xliff"></a>
...
<a id="i-do-have-a-subscription-for-azure-using-my-microsoft-account" class="xliff"></a>
