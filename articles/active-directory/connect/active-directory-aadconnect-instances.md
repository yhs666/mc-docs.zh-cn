...
ms.date: 07/31/2017
ms.author: v-junlch
ms.openlocfilehash: da586fceeba4c412c43c18bb6a598c22c2e682fe
...
DirSync 的早期版本已支持该云。 从 Azure AD Connect 的 1.1.180 版本起，会支持该云的新一代版本。 这一代使用的是基于仅限美国的终结点，并具有不同的 URL 列表，可在代理服务器中打开。
...
Azure AD Connect 不能自动检测到 Azure AD 租户位于政府版云中。 安装 Azure AD Connect 时，需要改为执行以下操作。
