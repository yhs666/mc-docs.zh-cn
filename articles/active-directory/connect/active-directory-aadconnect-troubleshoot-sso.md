...
ms.date: 06/23/2017
ms.author: v-junlch
ms.openlocfilehash: 759051d94451dbbf60c5b61ece93a31597773f11
ms.sourcegitcommit: a93ff901be297d731c91d77cd7d5c67da432f5d4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/29/2017
---
# 排除 Azure Active Directory 无缝单一登录故障
<a id="troubleshoot-azure-active-directory-seamless-single-sign-on" class="xliff"></a>
...
## 故障排除清单
<a id="troubleshooting-checklist" class="xliff"></a>
...
## 手动重置 Azure AD 无缝 SSO
<a id="manual-reset-of-azure-ad-seamless-sso" class="xliff"></a>

如果故障排除不起作用，请使用以下步骤在租户中手动重置该功能：

### 步骤 1：导入无缝 SSO PowerShell 模块
<a id="step-1-import-the-seamless-sso-powershell-module" class="xliff"></a>
...
<a id="step-2-get-the-list-of-ad-forests-on-which-seamless-sso-has-been-enabled" class="xliff"></a>
...
### 步骤 3：为已设置无缝 SSO 的每个 AD 林禁用该功能
<a id="step-3-disable-seamless-sso-for-each-ad-forest-that-it-was-set-it-up-on" class="xliff"></a>
...
### 步骤 4：为每个 AD 林启用无缝 SSO
<a id="step-4-enable-seamless-sso-for-each-ad-forest" class="xliff"></a>

1. 调用 `Enable-AzureADSSOForest`。 出现提示时，输入目标 AD 林的域管理员凭据。
2. 针对想要设置此功能的每个 AD 林重复上述步骤。

### 步骤 5。 在租户上启用该功能
<a id="step-5-enable-the-feature-on-your-tenant" class="xliff"></a>
