...
1. 在 Azure AD Connect 工具中检查是否已在租户中启用无缝 SSO 功能。 如果无法启用该功能（例如，由于端口被阻止），请确保事先满足所有[先决条件](active-directory-aadconnect-sso.md#pre-requisites)。 如果启用该功能时仍出现问题，请联系 Microsoft 支持部门。
