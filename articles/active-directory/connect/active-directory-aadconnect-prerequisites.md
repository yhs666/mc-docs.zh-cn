...
有关[默认代理元素](https://msdn.microsoft.com/zh-cn/library/kd3cf2ex.aspx)的详细信息，请参阅 MSDN。在出现连接问题时，如需详细信息，请参阅[排查连接问题](./active-directory-aadconnect-troubleshoot-connectivity.md)。
