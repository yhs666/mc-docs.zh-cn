...
- 修复了在更新基于 OU 的筛选配置时，导致需要删除“Out to AD - User ImmutableId”现成同步规则的问题。 此同步规则是[将 ms-DS-ConsistencyGuid 用作源定位点](active-directory-aadconnect-design-concepts.md#using-ms-ds-consistencyguid-as-sourceanchor)功能所必需的。
