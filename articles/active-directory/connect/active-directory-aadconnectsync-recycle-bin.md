...
ms.date: 07/31/2017
ms.author: v-junlch
ms.openlocfilehash: 19aeb9a6f1f542865124173e273e39477add29b6
...
- 如果你意外删除了某个本地 AD 用户对象，相应的 Azure AD 用户对象会在下一同步周期被删除。 默认情况下，Azure AD 会将删除的 Azure AD 用户对象以软删除状态保留 30 天。
