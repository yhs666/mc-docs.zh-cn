...
ms.date: 02/08/2017
ms.author: v-junlch
ms.openlocfilehash: 94dbe12d1fb45a8b8c6f83f11dc6538a355e7227
...
此选项可让你启用和禁用服务器上的暂存模式。 暂存模式及其使用方式的详细信息可在[操作](active-directory-aadconnectsync-operations.md#staging-mode)中找到。
