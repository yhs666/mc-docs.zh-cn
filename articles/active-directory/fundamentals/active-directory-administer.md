...
1. 使用作为订阅的“帐户管理员”的帐户登录到 [Azure 帐户中心](https://account.windowsazure.cn/Subscriptions)以转让订阅所有权。
...
若要管理一个或多个 Azure 云服务订阅，可以使用 [Azure 门户](https://portal.azure.cn/)管理组织的目录数据。 还可以使用 [Azure Active Directory PowerShell cmdlet](https://docs.microsoft.com/powershell/azure/active-directory) 来帮助管理 Azure AD 中存储的数据。
