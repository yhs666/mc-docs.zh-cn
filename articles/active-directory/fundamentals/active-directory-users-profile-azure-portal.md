...
3. 选择“编辑”以有选择地添加或更新每个可用部分中包括的信息。
    ...
    - **标识。** 添加或更新用户的其他标识值，例如结婚后的姓氏。 可以独立于姓氏和名称的值来设置此名称。 例如，可以使用它来包括首字母缩写、公司名称，或者更改所显示名称的顺序。 又比如，如果两个用户的姓名均为“Chris Green”，则可使用标识字符串将其姓名设置为“Chris B. Green”和“Chris R. Green (Contoso)”。
