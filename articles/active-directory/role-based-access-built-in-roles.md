...
### API 管理服务操作员角色 <a name="api-management-service-operator-role"></a>
可管理 API 管理服务
...
### API 管理服务读者角色 <a name="api-management-service-reader-role"></a>
可管理 API 管理服务
...
### DevTest 实验室用户 <a name="devtest-labs-user"></a>
