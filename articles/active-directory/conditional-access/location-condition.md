...
ms.openlocfilehash: 14d020a9f526f50e210b2c3524ff7f902f0db5f9
ms.sourcegitcommit: 44548f2ebec1246f6ac799f5b2640ad1b5d7c8a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/13/2019
ms.locfileid: "68972945"
---
...
使用位置条件，可以基于用户的网络位置来控制对云应用的访问。 位置条件的常见用例如下：
...
- **标记为可信位置** - 可为命名位置设置标志，以指示它是可信的位置。 通常，可信位置是由 IT 部门控制的网络区域。 除条件访问以外，Azure 标识保护和 Azure AD 安全报告也使用可信命名位置来减少误报。
