...
ms.openlocfilehash: b34713509c1f5722f9e50c07c032ad802e9ef2f0
ms.sourcegitcommit: 44548f2ebec1246f6ac799f5b2640ad1b5d7c8a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/13/2019
ms.locfileid: "68973200"
---
# <a name="what-is-a-policy-migration-in-azure-active-directory-conditional-access"></a>Azure Active Directory 条件访问中的策略迁移是什么？ 

[条件访问](overview.md)是 Azure Active Directory (Azure AD) 中的一项功能，用于控制已获授权的用户访问云应用的方式。 尽管此功能的用途仍未变化，但新版 Azure 门户在条件访问的工作原理方面引入了重大改进。
...
在 [Azure 门户](https://portal.azure.cn)中，[条件访问 - 策略](https://portal.azure.cn/#blade/Microsoft_AAD_IAM/ConditionalAccessBlade/Policies)页是条件访问策略的入口点。 但是，你的环境也可能包含尚未使用此页创建的条件访问策略。 这些策略称为“经典策略”。  经典策略是在以下位置创建的条件访问策略：

- Azure 经典门户
- Intune 经典门户
- Intune 应用保护门户

在“条件访问”页上，可以通过单击“管理”部分中的“[**经典策略(预览)** ](https://portal.azure.cn/#blade/Microsoft_AAD_IAM/ConditionalAccessBlade/ClassicPolicies)”来访问经典策略。   
...
使用 Azure 门户中的“条件访问”，可以在一个中心位置管理所有策略。 由于条件访问的实现方式已发生变化，在迁移经典策略之前，应熟悉基本的概念。

请参阅：

- [Azure Active Directory 中的条件访问是什么](overview.md)，了解基本概念和术语。
