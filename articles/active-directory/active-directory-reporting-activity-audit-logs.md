...
若要获取所有审核活动的列表，可以使用图形 API https://graph.chinacloudapi.cn/$tenantdomain/activities/auditActivityTypes?api-version=beta，其中，$tenantdomain 为域名。
...
### <a name="users-audit-logs"></a>用户审核日志

使用用户审核报表，可以获得如下问题的答案：
...
![审核日志](./media/active-directory-reporting-activity-audit-logs/06202018-1.png "审核日志")
...
如果只想查看与应用程序相关的审核数据，可以在“企业应用程序”边栏选项卡的“活动”部分中的“审核日志”下方查找筛选视图。 

![审核日志](./media/active-directory-reporting-activity-audit-logs/134.png "审核日志")

![审核日志](./media/active-directory-reporting-activity-audit-logs/06202018-2.png "审核日志")
