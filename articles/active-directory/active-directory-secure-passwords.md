...
ms.date: 07/30/2018
ms.author: v-junlch
ms.openlocfilehash: 431df2a384fbeea4945cceeab2cd358de66564f1
ms.sourcegitcommit: 98c7d04c66f18b26faae45f2406a2fa6aac39415
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/03/2018
ms.locfileid: "39487009"
---
...
本文介绍用户或管理员在保护 Azure Active Directory (Azure AD) 或 Microsoft 帐户时可遵循的一些最佳做法。
 ...
 > [!NOTE]
 > **是否因登录时遇到问题而浏览至此？** 如果是这样，[可按以下方式更改和重置密码](user-help/active-directory-passwords-update-your-own-password.md)。
 >
