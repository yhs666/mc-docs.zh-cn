...
ms.openlocfilehash: db1c9204a01f63475ee4155e87da706192637235
ms.sourcegitcommit: 44548f2ebec1246f6ac799f5b2640ad1b5d7c8a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/13/2019
ms.locfileid: "68972897"
---
...
| 方案 | 计算 | 所需许可证数 |
| --- | --- | --- |
| 管理员创建具有 500 个用户的组 A 的访问评审。<br/>分配 3 个组所有者作为评审者。 | 1 个管理员 + 3 个组所有者 | 4 |
| 管理员创建具有 500 个用户的组 A 的访问评审。<br/>将其设为自我评审。 | 1 个管理员 + 500 个用户作为自我评审者 | 501 |
| 管理员创建具有 5 个用户和 25 个来宾用户的组 A 的访问评审。<br/>将其设为自我评审。 | 1 个管理员 + 5 个用户作为自我评审者<br/>（按所需的 1:5 比例包含来宾用户） | 6 |
| 管理员创建具有 5 个用户和 28 个来宾用户的组 A 的访问评审。<br/>将其设为自我评审。 | 1 个管理员 + 5 个用户作为自我评审者 + 1 个用户，以便按所需的 1:5 比例包含来宾用户 | 7 |
