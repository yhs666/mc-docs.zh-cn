---
title: 使用访问评审管理从条件访问策略中排除的用户 - Azure Active Directory | Microsoft Docs
...
ms.openlocfilehash: 5a838a80a48c89cf2ac65c640bb8adcc0a50971e
ms.sourcegitcommit: 44548f2ebec1246f6ac799f5b2640ad1b5d7c8a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/13/2019
ms.locfileid: "68972869"
---
...
但在某些情况下，用户可能有合法的理由需要从这些受禁的国家/地区登录。 例如，用户可能因公或因私外出旅行。 在此示例中，阻止这些国家/地区的条件访问策略可以针对排除在策略之外的用户创建一个专用的云安全组。 
...
## <a name="example-1-access-review-for-users-accessing-from-blocked-countriesregions"></a>示例 1：对从受阻止国家/地区访问的用户进行访问评审
