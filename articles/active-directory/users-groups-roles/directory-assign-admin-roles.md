...
ms.reviewer: vincesm
ms.custom: it-pro
ms.openlocfilehash: 30de5560405e145e679c5198a0ea15fdde880b3e
ms.sourcegitcommit: 98c7d04c66f18b26faae45f2406a2fa6aac39415
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/03/2018
ms.locfileid: "39487544"
---
...
- **[Power BI 服务管理员](#power-bi-service-administrator)**：具有此角色的用户在 Power BI（如果存在此服务）中拥有全局权限，并可管理支持票证和监视服务运行状况。 有关详细信息，请参阅[了解 Power BI 管理员角色](https://docs.microsoft.com/en-us/power-bi/service-admin-role)。
...
1. 使用租户目录的全局管理员或特权角色管理员的帐户登录到 [Azure 门户](https://portal.azure.cn)。
...
可以创建和管理应用注册和企业应用的所有方面。
  ...
  > [!NOTE]
  > 此角色从[用户角色](/active-directory/users-default-permissions)继承其他权限。
  >
  >
