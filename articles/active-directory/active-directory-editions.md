...
ms.date: 06/12/2017
ms.author: v-junlch
ms.openlocfilehash: 2dcc36fc062c7ccc6ed22c296679e3e6e16173b1
...
<a id="azure-active-directory-editions" class="xliff"></a>
...
## 比较正式推出的功能
<a id="comparing-generally-available-features" class="xliff"></a>
> [!NOTE]
...
## 常用功能
<a id="common-features" class="xliff"></a>
#### 目录对象
<a id="directory-objects" class="xliff"></a>
**类型：** 常用功能
...
<a id="usergroup-management-addupdatedelete-user-based-provisioning-device-registration" class="xliff"></a>
**类型：** 常用功能
...
#### 云用户的自助密码更改
<a id="self-service-password-change-for-cloud-users" class="xliff"></a>
**类型：** 常用功能
...
<a id="connect--sync-engine-that-extends-on-premises-directories-to-azure-active-directory" class="xliff"></a>
**类型：** 常用功能
...
#### 安全/使用情况报告
<a id="securityusage-reports" class="xliff"></a>
**类型：** 常用功能
...
#### 云用户的自助密码重置
<a id="self-service-password-reset-for-cloud-users" class="xliff"></a>
**类型：** 基本功能
...
#### 公司品牌（登录页/访问面板自定义）
<a id="company-branding-logon-pagesaccess-panel-customization" class="xliff"></a>
**类型：** 基本功能
...
#### 应用程序代理
<a id="application-proxy" class="xliff"></a>
**类型：** 基本功能
...
## Premium 功能
<a id="premium-features" class="xliff"></a>
...
<a id="self-service-password-resetchangeunlock-with-on-premises-write-back" class="xliff"></a>
**类型：** 高级功能
...
#### 多重身份验证（云和本地（MFA 服务器））
<a id="multi-factor-authentication-cloud-and-on-premises-mfa-server" class="xliff"></a>
**类型：** 高级功能
...
#### Cloud App Discovery
<a id="cloud-app-discovery" class="xliff"></a>
**类型：** 高级功能
...
<a id="azure-ad-connect-health" class="xliff"></a>
**类型：** 高级功能
...
#### 组帐户的自动密码滚动更新
<a id="automatic-password-rollover-for-group-accounts" class="xliff"></a>
**类型：** 高级功能
...
#### 标识保护
<a id="identity-protection" class="xliff"></a>
**类型：** 高级功能
...
## Azure Active Directory Join - 仅适用于 Windows 10 的相关功能
<a id="azure-active-directory-join---windows-10-only--related-features" class="xliff"></a>
#### 让设备加入 Azure AD、Desktop SSO、Microsoft Passport for Azure AD 和 Administrator Bitlocker 恢复
<a id="join-a-device-to-azure-ad-desktop-sso-microsoft-passport-for-azure-ad-administrator-bitlocker-recovery" class="xliff"></a>
...
#### 企业状态漫游
<a id="enterprise-state-roaming" class="xliff"></a>
**类型：** Azure Active Directory Join - 仅适用于 Windows 10 的相关功能
