...
<a id="azure-active-directory-developer-glossary" class="xliff"></a>
本文包含一些核心 Azure Active Directory (AD) 开发人员概念的定义，帮助你了解 Azure AD 的应用程序开发。

## 访问令牌
<a id="access-token" class="xliff"></a>
...
## 应用程序清单
<a id="application-manifest" class="xliff"></a>
...
## 应用程序对象
<a id="application-object" class="xliff"></a>
...
## 应用程序注册
<a id="application-registration" class="xliff"></a>
...
## 授权代码
<a id="authorization-code" class="xliff"></a>
...
## 授权终结点
<a id="authorization-endpoint" class="xliff"></a>
...
## 授权
<a id="authorization-grant" class="xliff"></a>
...
## 授权服务器
<a id="authorization-server" class="xliff"></a>
...
## 客户端应用程序
<a id="client-application" class="xliff"></a>
...
## 多租户应用程序
<a id="multi-tenant-application" class="xliff"></a>
...
## 本机客户端
<a id="native-client" class="xliff"></a>
...
## 资源所有者
<a id="resource-owner" class="xliff"></a>
...
## 资源服务器
<a id="resource-server" class="xliff"></a>
...
## 安全令牌
<a id="security-token" class="xliff"></a>
...
## 应用程序对象
<a id="service-principal-object" class="xliff"></a>
...
## 令牌终结点
<a id="token-endpoint" class="xliff"></a>
...
## 基于用户代理的客户端
<a id="user-agent-based-client" class="xliff"></a>
...
## 用户主体
<a id="user-principal" class="xliff"></a>
