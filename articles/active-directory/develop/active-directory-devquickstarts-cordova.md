...
ms.author: v-junlch
ms.custom: aaddev
ms.openlocfilehash: c63164091690432b5406f25a52aea78e5aea59b6
ms.sourcegitcommit: da6168fdb4abc6e5e4dd699486b406b16cd45801
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/05/2018
ms.locfileid: "37800445"
---
...
- 生成并运行用于 iOS 的应用：
  ...
  - 安装 Xcode 6.x 或更高版本。 从 [Apple 开发人员站点](http://developer.apple.com/downloads)或 [Mac 应用商店](http://itunes.apple.com/cn/app/xcode/id497799835?mt=12)进行下载。
...
Azure AD 仅向已知应用程序颁发令牌。 在从应用使用 Azure AD 之前，需要在租户中为该应用创建一个条目。 在租户中注册新应用程序：
