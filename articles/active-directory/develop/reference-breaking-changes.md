...
ms.reviewer: hirsin
ms.custom: aaddev
ms.openlocfilehash: ec62c8fc43bee80941c7c6395ce0c426de6cceed
ms.sourcegitcommit: d75065296d301f0851f93d6175a508bdd9fd7afc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52652885"
---
...
**生效日期**：2018 年 10 月 10 日**受影响的终结点**：v1.0 

从 2018 年 10 月 10 日起，Azure AD 不再允许对应用使用以前用过的身份验证代码。 此项安全变更有助于使 Azure AD 与 OAuth 规范保持一致，将在 v1 终结点上强制实施。
...
> [!NOTE]
> 为了尽可能少地破坏应用程序，依赖此功能的现有应用程序将被赋予此要求的例外。  任何一天依赖此模式登录超过 10 次的应用程序都被视为依赖此功能。  

## <a name="may-2018"></a>2018 年 5 月

### <a name="id-tokens-cannot-be-used-for-the-obo-flow"></a>ID 令牌不能用于 OBO 流

**日期**：2018 年 5 月 1 日**受影响的终结点**：v1.0**受影响的协议**：隐式流和 [OBO 流](v1-oauth2-on-behalf-of-flow.md)
