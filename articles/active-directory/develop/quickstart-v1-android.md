...
ms.openlocfilehash: 210d3b014308ce2b93d633d3bdbd435a84ae44ae
ms.sourcegitcommit: a88cc623ed0f37731cb7cd378febf3de57cf5b45
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/08/2019
ms.locfileid: "73830953"
---
...
对于新的 android 应用程序，我们建议你使用 Microsoft 标识平台 (v2.0) 和 MSAL 来获取令牌并访问受保护的 Web API。 请参阅[快速入门：从 Android 应用登录用户并调用 Microsoft Graph API](quickstart-v2-android.md) 以开始使用。
