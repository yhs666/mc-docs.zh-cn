...
ms.author: v-junlch
ms.custom: aaddev
ms.openlocfilehash: c1399dbc49e6b7e9f9f9d1e05d4024d3e712748a
...
如果应用是通过 Azure AD 保护的 API，需要 HTTP 请求中的访问令牌，则应验证和检查接收到的令牌。 在使用访问令牌访问资源之前，应用程序应执行访问令牌的验证。 有关验证的详细信息，请参阅 [验证令牌](#validating-tokens)。  
