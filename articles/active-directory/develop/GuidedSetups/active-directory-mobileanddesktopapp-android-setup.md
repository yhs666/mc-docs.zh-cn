---
title: "Azure AD v2 Android 入门 - 设置 | Microsoft Docs"
...
ms.author: v-junlch
ms.custom: aaddev
ms.openlocfilehash: f15411d5efc0a98286edc7981f1eee986dd8b4c7
...
> 想要改为下载此示例的 Android Studio 项目？ [下载项目](https://github.com/Azure-Samples/active-directory-android-native-v2/archive/master.zip)并跳到[配置](#create-an-application-express "配置步骤")，在执行前配置代码示例...。
