...
ms.custom: aaddev
ms.openlocfilehash: 697951b53939d4f46b8c3581b5e7d46122ed815f
ms.sourcegitcommit: 562cde32fc2271238f3d1ef5d2cc5ed037bdec2d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/04/2018
ms.locfileid: "43531625"
---
...
- 还需要一个可在其中创建用户和注册应用的 Azure AD 租户。 如果没有租户，请[了解如何获取租户](quickstart-create-new-tenant.md)。
