...
ms.openlocfilehash: fd0898fe273f31b409148eea4b1839721a3b22d8
ms.sourcegitcommit: 1ebc1e0b99272e62090448d1cd2af385b74ef4b3
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/10/2019
ms.locfileid: "65517624"
---
...
本指南创建的示例 UWP 应用程序查询从 Microsoft 标识平台终结点接受令牌的 Microsoft 图形 API 或 Web API。 在此方案中，令牌通过授权标头添加到 HTTP 请求。 Microsoft 身份验证库 (MSAL) 处理令牌获取和续订。
...
准备好测试后，选择“调用 Microsoft Graph API”。 然后使用 Azure AD 组织帐户进行登录。 如果是首次测试，会看到要求用户登录的窗口：
...
Microsoft 图形 API 需要 *user.read* 作用域来读取用户的个人资料。 Microsoft Graph 的其他 API 以及后端服务器的自定义 API 可能需要其他作用域。 Microsoft 图形 API 需要 *Calendars.Read* 作用域来列出用户的日历。
