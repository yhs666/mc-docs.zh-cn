...
ms.date: 09/03/2018
ms.author: v-junlch
ms.openlocfilehash: 30dfb0d9a5c4d708150ca93e7d4db0dc85d6c8e1
ms.sourcegitcommit: 562cde32fc2271238f3d1ef5d2cc5ed037bdec2d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/04/2018
ms.locfileid: "43531637"
---
<!--start-intro-->
...
<!--start-collapse-->
> [!NOTE]
> 此页以 SVG 格式添加登录按钮，背景为黑色：<br/>![使用 Microsoft 登录](./media/quickstart-v1-aspnet-webapp/aspnetsigninbuttonsample.png)<br/> 对于多个登录按钮，请转到[本页](/active-directory/develop/active-directory-branding-guidelines "品牌准则")。
<!--end-collapse-->
...
有关此设置和多租户应用程序概念的详细信息，请参阅[本文](howto-convert-app-to-be-multi-tenant.md "多租户概述")。
...
登录后，用户会重定向到网站主页，该网站是门户上的应用程序注册信息中指定的 HTTPS URL。 此页现在显示“Hello {用户}”、注销链接，以及查看用户声明的链接（即指向之前创建的 Authorize 控制器的链接）。
...
此外还可看到一个表格，其中包含身份验证请求中的所有用户声明。 有关 ID 令牌和说明中所有声明的列表，请参阅此[文章](/active-directory/develop/active-directory-token-and-claims "ID 令牌中所有声明的列表")。
