...
ms.author: v-junlch
ms.custom: aaddev
ms.openlocfilehash: 755a15786932807cded72b14a8e0d7a05cc6c9a5
...
通过 Azure Active Directory 身份验证库 (ADAL)，客户端应用程序开发人员能够轻松利用云或本地 Active Directory (AD) 对用户进行身份验证，并获取访问令牌，以保护 API 调用。 ADAL 通过以下功能使开发者更轻松地进行身份验证：
 - 支持异步方法调用
 - 存储访问令牌和刷新令牌的可配置令牌缓存
 - 当访问令牌过期且刷新令牌可用时，自动刷新令牌
 - 等
 
ADAL 可以应对大部分复杂情况，帮助开发者集中处理业务逻辑并轻松保护资源，而无需成为安全方面的专家。
...
| 平台 | 库 | 下载 | 源代码 | 示例 | 引用
| --- | --- | --- | --- | --- | --- |
| .NET 客户端、Windows 应用商店、UWP、Xamarin iOS 和 Android |适用于 .NET 的 MSAL（预览） |[NuGet](https://www.nuget.org/packages/Microsoft.Identity.Client/1.1.0-preview) |[GitHub](https://github.com/AzureAD/microsoft-authentication-library-for-dotnet) | 桌面应用 |[引用](https://docs.microsoft.com/dotnet/api/?view=identityclient-1.1.0-preview) | 
| JavaScript |适用于 JavaScript 的 MSAL（预览） |[GitHub](https://github.com/AzureAD/microsoft-authentication-library-for-js) |[GitHub](https://github.com/AzureAD/microsoft-authentication-library-for-js) | 单页应用 | [引用](https://htmlpreview.github.io/?https://raw.githubusercontent.com/AzureAD/microsoft-authentication-library-for-js/blob/dev/docs/classes/_useragentapplication_.msal.useragentapplication.html) | 
| iOS |适用于 iOS 的 MSAL（预览） |[GitHub](https://github.com/AzureAD/microsoft-authentication-library-for-objc) |[GitHub](https://github.com/AzureAD/microsoft-authentication-library-for-objc) | iOS 应用 | [引用](https://azuread.github.io/docs/objc/) |
| Android |适用于 Android 的 MSAL（预览） |[GitHub](https://github.com/AzureAD/microsoft-authentication-library-for-android) |[GitHub](https://github.com/AzureAD/microsoft-authentication-library-for-android) | Android 应用 | [引用](http://javadoc.io/doc/com.microsoft.identity.client/msal/0.1.1) |
