...
ms.author: v-junlch
ms.custom: aaddev
ms.openlocfilehash: ffbd4433d042b3195970a01beabe6763ed2ed4b5
...
| iOS、macOS |ADAL |[CocoaPods](http://cocoadocs.org/docsets/ADAL/) |[GitHub](https://github.com/AzureAD/azure-activedirectory-library-for-objc) |[iOS 应用](/active-directory/develop/active-directory-devquickstarts-ios/) | [引用](http://cocoadocs.org/docsets/ADAL/)|
...
### <a name="authenticating-users-of-a-client-application-to-a-remote-resource"></a>对客户端应用程序的用户进行身份验证以访问远程资源
...
### <a name="authenticating-a-server-application-to-a-remote-resource"></a>对服务器应用程序进行身份验证以访问远程资源
...
### <a name="authenticating-a-server-application-on-behalf-of-a-user-to-access-a-remote-resource"></a>代表用户对服务器应用程序进行身份验证以访问远程资源
