...
Azure Active Directory (Azure AD) 使用 SAML 2.0 协议，使应用程序能够为其用户提供单一登录体验。Azure AD 的[单一登录](./active-directory-single-sign-on-protocol-reference.md)和[单一注销](./active-directory-single-sign-out-protocol-reference.md) SAML 配置文件说明了标识提供者服务中如何使用 SAML 断言、协议和绑定。
