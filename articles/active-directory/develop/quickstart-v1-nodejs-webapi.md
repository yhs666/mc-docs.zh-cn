...
ms.author: v-junlch
ms.custom: aaddev
ms.openlocfilehash: 837e8fa5d4bee3767bd30532256c04b0565bb15a
ms.sourcegitcommit: 562cde32fc2271238f3d1ef5d2cc5ed037bdec2d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/04/2018
ms.locfileid: "43531682"
---
...
若要开始配置应用程序，可以通过 Azure CLI 获取几个特定于帐户的值。 

```azurecli
az ad app create --display-name node-aad-demo --homepage http://localhost --identifier-uris http://node-aad-demo
```

`create` 命令的[参数](/cli/ad/app?view=azure-cli-latest#az-ad-app-create)包括：
