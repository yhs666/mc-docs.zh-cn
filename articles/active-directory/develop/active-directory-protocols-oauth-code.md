...
ms.author: v-junlch
ms.custom: aaddev
ms.openlocfilehash: a30bea957a631b2a350690081fa3585f9b4fa6ce
ms.sourcegitcommit: 0b63440e7722942ee1cdabf5245ca78759012500
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/07/2018
ms.locfileid: "33815364"
---
...
| client_secret |对于 Web 应用是必需的，不允许用于公共客户端 |在应用注册门户中为应用创建的应用程序机密。  它不能在本机应用（公共客户端）中使用，因为设备无法可靠地存储 client_secrets。  Web 应用和 Web API（所有机密客户端）都需要它，能够将 `client_secret` 安全地存储在服务器端。 |
