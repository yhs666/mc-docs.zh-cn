...
ms.custom: aaddev
ms.openlocfilehash: 11359fa8846ef685e9b427c568084e12cf678598
ms.sourcegitcommit: 562cde32fc2271238f3d1ef5d2cc5ed037bdec2d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/04/2018
ms.locfileid: "43531594"
---
...
5. 创建一个新的 **Web 应用程序和/或 Web API**。
    ...
    - **登录 URL** 是用户可以在其中登录并使用你的应用的 URL。 为此值输入 `https://localhost:44321/` 。

6. 从应用程序的“设置” -> “属性”页中，更新应用 ID URI。 输入租户特定的标识符。 例如，输入 `https://contoso.partner.onmschina.cn/TodoListService`。
...
2. 在 Azure AD 租户中创建一个新的**本机**应用程序。
    - **名称**向用户描述应用程序。
