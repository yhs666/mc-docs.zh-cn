...
ms.openlocfilehash: 91450ee3625dbf123e42c5f0f9574753b34859a3
ms.sourcegitcommit: 1ebc1e0b99272e62090448d1cd2af385b74ef4b3
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/10/2019
ms.locfileid: "65517557"
---
...
```html
<script src="https://secure.aadcdn.parter.microsoftonline-p.cn/lib/1.0.0-preview.4/js/msal.min.js"></script>
```
> [!TIP]
...
> |`authority`    | （可选）如上面的配置部分所述，它是用于支持帐户类型的颁发机构 URL。 默认颁发机构为 `https://login.partner.microsoftonline.cn/common`。 |
