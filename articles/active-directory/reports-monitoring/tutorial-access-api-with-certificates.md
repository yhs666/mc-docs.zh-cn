...
ms.openlocfilehash: be2908f30e504abafbe68d8ec82d8ee633460ffa
ms.sourcegitcommit: aee279ed9192773de55e52e628bb9e0e9055120e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/29/2018
ms.locfileid: "43171508"
---
...
1. 首先，确保已完成[访问 Azure Active Directory 报告 API 的先决条件](howto-configure-prerequisites-for-reporting-api.md)。 

2. 下载并安装 Azure AD Powershell V2。 
...
1. 首先，转到“应用程序注册”页。 为此，请导航到 [Azure 门户](https://portal.azure.cn)，单击“Azure Active Directory”，然后单击“应用注册”并从列表中选择应用程序。 

2. 然后，按照[使用 Azure AD 注册证书](/active-directory/develop/active-directory-certificate-credentials#register-your-certificate-with-azure-ad)中的步骤注册应用程序。 
