...
ms.component: hybrid
ms.author: v-junlch
ms.openlocfilehash: 474b9da612d6802c12f5bc444de191c5fe929fb6
ms.sourcegitcommit: 5f2849d5751cb634f1cdc04d581c32296e33ef1b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/07/2018
ms.locfileid: "53028766"
---
...
- [添加并验证要在 Azure AD 中使用的域](../add-custom-domain.md)。 例如，如果计划让用户使用 contoso.com，请确保此域已经过验证，并且不是直接使用 contoso.partner.onmschina.cn 默认域。
...
- 如果全局管理员已启用 MFA，URL **https://secure.aadcdn.parter.microsoftonline-p.cn** 必须在受信任的站点列表中。 在显示 MFA 质询提示之前，系统会先提示将此站点添加到受信任的站点列表中（如果尚未添加）。 可以使用 Internet Explorer 将它添加到受信任的站点。
...
- 如果使用独立的 SQL Server，则这些要求适用：
  - Azure AD Connect 支持从 SQL Server 2008（包含最新的 Service Pack）到 SQL Server 2017 的所有版本 Microsoft SQL Server。 **不支持**将 Azure SQL 数据库用作数据库。
