...
ms.date: 3/5/2018
ms.author: v-nany
ms.openlocfilehash: 1dced4ef57b423ab6075d293ee0f8d168ecdf64d
...
## <a name="use-elevateaccess-for-tenant-access-with-azure-portal"></a>通过 Azure 门户使用 elevateAccess 进行租户访问

1. 转到 [Azure Active Directory 门户](https://portal.azure.cn/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/Overview)并使用凭据登录。
...
> [!TIP] 
> 印象中这是 Azure Active Directory 的全局属性，但是，它对于当前已登录用户基于每个用户工作。 
