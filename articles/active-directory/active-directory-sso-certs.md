...
ms.date: 06/21/2017
ms.author: v-junlch
ms.openlocfilehash: e48467507bcb1b72ebdaa659ccd2e6c70bbb4df4
...
<a id="managing-certificates-for-federated-single-sign-on-in-azure-active-directory" class="xliff"></a>
...
## 如何自定义联合证书的过期日期
<a id="how-to-customize-the-expiration-date-for-your-federation-certificate" class="xliff"></a>
...
## 如何续订即将过期的证书
<a id="how-to-renew-a-certificate-that-will-soon-expire" class="xliff"></a>
