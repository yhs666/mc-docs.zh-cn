...
ms.reviewer: vincesm
ms.custom: it-pro
ms.openlocfilehash: 91f5f4650f664fcbe292e0ba1232b74bfde5034a
ms.sourcegitcommit: da6168fdb4abc6e5e4dd699486b406b16cd45801
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/05/2018
ms.locfileid: "37800442"
---
...
- **设备管理员**：此角色只能作为[设备设置](https://aad.portal.azure.cn/#blade/Microsoft_AAD_IAM/DevicesMenuBlade/DeviceSettings/menuId/)中的附加本地管理员进行分配。 拥有此角色的用户成为所有已加入 Azure Active Directory 的 Windows 10 设备上的本地计算机管理员。 他们无权管理 Azure Active Directory 中的设备对象。

- **目录读取者**：这是一个遗留的角色，分配给不支持[同意框架](develop/active-directory-integrating-applications.md)的应用程序。 不应将它分配给任何用户。

- **目录同步帐户**：请勿使用。 此角色自动分配给 Azure AD Connect 服务，不可用于其他任何用途。

- **目录写入者**：这是一个遗留的角色，分配给不支持[同意框架](develop/active-directory-integrating-applications.md)的应用程序。 不应将它分配给任何用户。
...
- **Power BI 服务管理员**：具有此角色的用户在 Power BI（如果存在此服务）中拥有全局权限，并可以管理支持票证和监视服务运行状况。 有关详细信息，请参阅 [About Office 365 admin roles](https://support.office.com/article/About-Office-365-admin-roles-da585eea-f576-4f55-a1e0-87090b6aaa9d?ui=en-US&rs=en-001&ad=US)（关于 Office 365 管理员角色）。
...
1. 使用租户目录全局管理员的帐户登录到 [Azure 门户](https://portal.azure.cn)。
...
4. 在“用户”边栏选项卡中，选择“目录角色”&gt;“添加角色”。
 
5. 选择“全局管理员”角色，然后单击“选择”。
