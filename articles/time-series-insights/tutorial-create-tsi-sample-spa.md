...
manager: cshankar
ms.custom: seodec18
ms.openlocfilehash: 21361fc6575a7635eaa015a358e2f478bcf3e325
ms.sourcegitcommit: c0f7c439184efa26597e97e5431500a2a43c81a5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/28/2019
ms.locfileid: "67456489"
---
...
1. 在“创建”窗格中，填写必需的参数。 
   ...
   **登录 URL** | 输入应用程序登录页（主页）的 URL。 由于应用程序会在以后托管在 Azure 应用服务中，因此必须使用 https:\//chinacloudsites.cn 域中的 URL。 在本示例中，名称基于注册名称。
