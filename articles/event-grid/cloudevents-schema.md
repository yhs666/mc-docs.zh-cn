...
ms.date: 06/03/2019
ms.author: v-yiso
ms.openlocfilehash: 732248f71dba4d66413ab89a0fc906461cfca34b
ms.sourcegitcommit: 5a57f99d978b78c1986c251724b1b04178c12d8c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/24/2019
ms.locfileid: "66195186"
---
...
| CloudEvents        | 类型     | 示例 JSON 值             | 说明                                                        | 事件网格映射
|--------------------|----------|--------------------------------|--------------------------------------------------------------------|-------------------------
...
CloudEvents 的当前版本不支持对事件进行批处理。 针对 CloudEvent 架构配置的事件订阅会单独接收每个事件。 目前，在以 CloudEvents 架构传递事件时，无法为 Azure Functions 应用使用事件网格触发器。 使用 HTTP 触发器。 
