...
ms.custom: it-pro
ms.openlocfilehash: 71e4b6530cc7f39f8b24c611ebcc692f19a52b85
ms.sourcegitcommit: 9642fa6b5991ee593a326b0e5c4f4f4910f50742
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/28/2019
ms.locfileid: "64854595"
---
...
| [监视读取者](#monitoring-reader) | 可以读取所有监视数据（指标、日志等）。 另请参阅 [Azure Monitor 的角色、权限和安全入门](../azure-monitor/platform/roles-permissions-security.md#built-in-monitoring-roles)。 |
...
| [存储队列数据消息处理者](#storage-queue-data-message-processor) | 授予对 Azure 存储队列消息的扫视、接收和删除权限 |
