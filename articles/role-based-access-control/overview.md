...
ms.openlocfilehash: 7dfcf922d5ec6e790532a190d071666140ae0a4e
ms.sourcegitcommit: 6f42cd6478fde788b795b851033981a586a6db24
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/13/2018
ms.locfileid: "34559504"
---
...
使用 RBAC，可以在团队中对职责进行分配，仅向用户授予执行作业所需的访问权限。 不是在 Azure 订阅或资源中给每个人无限制的权限，只能允许某些操作。 例如，使用 RBAC 允许一个员工管理订阅中的虚拟机，而另一个员工可以管理同一订阅中的 SQL 数据库。
...
![Azure Active Directory 元素之间的关系 - 关系图](./media/overview/rbac_aad.png)
...
[RBAC 内置角色](built-in-roles.md)列出了 Azure 中可用的角色。 它指定每个内置角色向用户授予的操作和范围。 若要定义自己的角色以便进一步控制，请参阅如何生成 [Azure RBAC 中的自定义角色](custom-roles.md)。
...
[经典订阅管理员和共同管理员](../billing/billing-add-change-azure-subscription-administrator.md)具有对 Azure 订阅的完全访问权限。 他们可以将 [Azure 门户](https://portal.azure.cn)和 Azure 资源管理器 API 配合使用或使用经典部署模型 API。 在 RBAC 模型中，经典管理员具有订阅范围内的所有者角色。
...
- [Azure 门户中基于角色的访问控制](role-assignments-portal.md)入门。
