...
ms.openlocfilehash: b8b819217f53a70f81642d6b8e7fb119476a7692
ms.sourcegitcommit: e9c62212a0d1df1f41c7f40eb58665f4f1eaffb3
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/09/2019
ms.locfileid: "68886365"
---
...
1. 获取用户、组或应用程序的唯一标识符。 例如，可以使用 [az ad user list](/cli/ad/user#az-ad-user-list) 命令列出 Azure AD 用户。
