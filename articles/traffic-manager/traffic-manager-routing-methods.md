...
ms.date: 05/02/2017
ms.author: v-dazen
ms.openlocfilehash: 9b95cbbb11c6a06af691206bb72f1e7dd8d4da4b
...
---
# 流量管理器路由方法
<a id="traffic-manager-routing-methods" class="xliff"></a>
...
## “优先级”流量路由方法
<a id="priority-traffic-routing-method" class="xliff"></a>
...
### 配置终结点
<a id="configuring-endpoints" class="xliff"></a>
...
## “加权”流量路由方法
<a id="weighted-traffic-routing-method" class="xliff"></a>
...
## “性能”流量路由方法
<a id="performance-traffic-routing-method" class="xliff"></a>
