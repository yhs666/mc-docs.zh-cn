...
ms.date: 05/02/2017
ms.author: v-dazen
ms.openlocfilehash: 7253dfc1f1ba9a1d64152c69baa329cb344a119d
...
## 添加流量管理器终结点
<a id="add-traffic-manager-endpoints" class="xliff"></a>
...
## 删除流量管理器配置文件
<a id="delete-the-traffic-manager-profile" class="xliff"></a>
