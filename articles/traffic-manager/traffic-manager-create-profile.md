...
ms.date: 11/06/2017
ms.author: v-yeche
ms.openlocfilehash: a281b566c49528dd489ae5728a421a05be0f7478
...
在本文中，两个以前创建的 Azure Web 应用终结点会关联到这个新创建的流量管理器配置文件。 若要详细了解如何创建 Azure Web 应用终结点，请访问[“Azure Web 应用文档”页](/app-service/)。 可以添加任何具有 DNS 名称且可通过公共 Internet 访问的终结点，例如，我们使用 Azure Web 应用终结点。
