---
title: "适用于 DocumentDB 的 DocumentDB API 的 Node.js 教程 | Microsoft Docs"
...
ms.date: 05/31/2017
ms.author: v-junlch
ms.openlocfilehash: 5d70e4c5ec6a2c99e7011205c5a95ee0fe62066a
...
让我们创建一个 DocumentDB 帐户。 如果已经有想要使用的帐户，可以跳到 [安装 Node.js 应用程序](#SetupNode)。 如果使用 DocumentDB 模拟器，请遵循 [DocumentDB 模拟器](documentdb-nosql-local-emulator.md)中的步骤设置该模拟器，然后直接跳到[设置 Node.js 应用程序](#SetupNode)。
...
> [!WARNING]
> **CreateDocumentCollectionAsync** 将创建新的集合，它牵涉定价。 有关详细信息，请访问 [定价页](https://www.azure.cn/pricing/details/documentdb/)。
> 
> 
...
DocumentDB 支持对存储在每个集合中的 JSON 文档进行[各种查询](documentdb-sql-query.md)。 下面的示例代码演示你可针对集合中文档运行的查询。
...
- 想要更复杂的 Node.js 示例？ 请参阅 [Build a Node.js web application using DocumentDB](documentdb-nodejs-application.md)（构建使用 DocumentDB 的 Node.js Web 应用程序）。
