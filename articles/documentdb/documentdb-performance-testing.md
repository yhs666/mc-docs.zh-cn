---
title: "Azure Cosmos DB 规模和性能测试 | Microsoft Docs"
...
性能和规模测试是应用程序开发过程中的关键步骤。 对许多应用程序而言，数据库层对整体性能和可缩放性具有相当重大的影响，因此是性能测试的关键组件。 [Azure Cosmos DB](https://www.azure.cn/home/features/documentdb/) 是为了实现弹性缩放和性能可预测而构建的，因此非常适合需要高性能数据库层的应用程序。 
...
> [!NOTE]
> 为集合预配高吞吐量之前，请参阅[定价页](https://www.azure.cn/pricing/details/documentdb/)以估算每个集合的成本。 Cosmos DB 根据存储和吞吐量单独按小时计费，因此可以通过在测试后删除或降低 DocumentDB 集合的吞吐量来节省成本。
> 
> 
