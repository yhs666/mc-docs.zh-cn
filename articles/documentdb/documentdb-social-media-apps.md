...
通过 DocumentDB，只需单击数次即可通过透明方式[全局复制数据](./documentdb-portal-global-replication.md)，并从[客户端代码](./documentdb-portal-global-replication.md)中自动选择可用区域。 这也意味着可以拥有[多个故障转移区域](documentdb-regional-failovers.md)。 
