...
ms.date: 05/31/2017
ms.author: v-junlch
ms.openlocfilehash: 6fbd8f781b83f1dbbac73cb216eefef3ca89f9e4
...
---
# 如何管理 DocumentDB 帐户
<a id="how-to-manage-a-documentdb-account" class="xliff"></a>
...
<a id="to-specify-the-default-consistency-for-a-documentdb-account" class="xliff"></a>
1. 在 [Azure 门户](https://portal.azure.cn/)中，访问 DocumentDB 帐户。
...
2. 为你的 DocumentDB 帐户重新生成主访问密钥。 在 [Azure Portal](https://portal.azure.cn/)中，访问 DocumentDB 帐户。
...
如果要在 [DocumentDB 数据库迁移工具](documentdb-import-data.md)中使用连接字符串，请将数据库名称追加到连接字符串的末尾。 `AccountEndpoint=< >;AccountKey=< >;Database=< >`。
