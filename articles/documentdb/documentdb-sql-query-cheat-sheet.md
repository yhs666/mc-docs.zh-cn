...
**Azure Cosmos DB SQL 查询速查表**通过在易于打印的 PDF 参考表中显示常见的数据库查询、关键字、内置函数和运算符，有助于快速编写用于 Azure Cosmos DB 数据的查询。 
...
- 有关参考文档的信息，请参阅 [Cosmos DB SQL 查询语言](https://msdn.microsoft.com/library/azure/dn782250.aspx)。
