...
如需详细了解如何配置索引策略，可参阅 [Cosmos DB Indexing Policies](documentdb-indexing-policies.md)（Cosmos DB 索引策略）。
...
- 详细了解 [Azure Cosmos DB 索引策略](documentdb-indexing-policies.md)
