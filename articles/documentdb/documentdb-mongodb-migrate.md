---
title: "将 mongoimport 和 mongorestore 与 Azure Cosmos DB 的 API for MongoDB 配合使用 | Microsoft Docs"
...
- 增加吞吐量：数据迁移的持续时间取决于为集合设置的吞吐量。 请确保对于较大的数据迁移增加吞吐量。 完成迁移后，减少吞吐量以节约成本。 有关在 [Azure 门户](https://portal.azure.cn)中增加吞吐量的详细信息，请参阅 [Azure Cosmos DB 中的性能级别和定价层](documentdb-performance-levels.md)。
