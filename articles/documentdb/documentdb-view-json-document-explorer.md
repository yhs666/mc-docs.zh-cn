---
title: Azure DocumentDB 门户工具：文档资源管理器 | Azure
...
本文概述了 [Azure DocumentDB](https://www.azure.cn/home/features/documentdb/) 文档资源管理器，这是一个 Azure 门户预览工具，允许用户使用 DocumentDB 查看、编辑、创建、上传和筛选 JSON 文档。
