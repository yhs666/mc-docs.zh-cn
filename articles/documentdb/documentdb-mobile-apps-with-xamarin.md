---
title: "使用 Xamarin 和 Azure Cosmos DB 生成移动应用程序 | Microsoft Docs"
...
- 全球分布。 移动应用的用户特点是经常在全球不同的地点漫游。 Azure Cosmos DB 是[全局分布式数据库](documentdb-distribute-data-globally.md)。 单击地图即可让用户访问你的数据。
...
![Azure Cosmos DB 用户和权限代理](./media/documentdb-mobile-apps-with-xamarin/documentdb-resource-token-broker.png)
...
![Azure Cosmos DB 可按需缩放吞吐量](./media/documentdb-mobile-apps-with-xamarin/documentdb-scale.png)
...
![Azure Cosmos DB 可跨地理区域缩放](./media/documentdb-mobile-apps-with-xamarin/documentdb-replicate-globally.png)
