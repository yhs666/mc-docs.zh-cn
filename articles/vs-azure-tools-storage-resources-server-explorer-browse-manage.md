...
ms.date: 09/25/2017
ms.author: v-junlch
ms.openlocfilehash: 6d732628abb876afdacb5ca04cdf682b61ec0b70
...
> [!NOTE]
> 从服务器资源管理器中删除存储帐户不会影响到存储帐户或其所包含的任何数据。 它只是将引用从服务器资源管理器中删除。 若要永久删除存储帐户，请使用 [Azure 经典管理门户](https://manage.windowsazure.cn)。
> 
> 
