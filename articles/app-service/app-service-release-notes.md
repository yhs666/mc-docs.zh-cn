...
ms.date: 03/17/2017
ms.author: v-dazen
ms.openlocfilehash: 7f14807256d4a5f9f55a3349b4c5dff8356641b4
...
* 与 Web 工具扩展相关的新功能\方案。 
  ...
  * Azure API 应用服务器资源管理器节点提供 Azure 门户中 API 应用深层链接的链接，以及其他功能（例如日志流式处理和远程调试）。
    ...
    有关 Azure SDK .NET 2.5.1 中存在的已知问题以及目前存在的限制，请参阅下面的[此](app-service-release-notes.md#known_issues_2_5_1)部分。
* Visual Studio 中与 HDInsight 工具相关的新功能\方案已在此版本中启用。 
