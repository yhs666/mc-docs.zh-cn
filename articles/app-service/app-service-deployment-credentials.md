...
ms.date: 10/30/2017
ms.author: v-yiso
ms.openlocfilehash: 84782b449882d137738290e29b5479394db50eae
...
1. 在 [Azure 门户](https://portal.azure.cn)中，单击“应用服务”> &lt;any_app> > “部署凭据”。
    ...
    > [!NOTE]
    > 在门户中必须至少有一个应用，才能访问部署凭据边栏选项卡。 但使用 [Azure CLI](https://docs.microsoft.com/cli/azure/webapp/deployment/user#set) 时，可以在没有应用的情况下配置用户级凭据。
