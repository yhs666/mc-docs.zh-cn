---
title: 应用服务环境 v1 简介 - Azure
description: 了解有关可提供安全、加入 VNet 的专用缩放单元用于运行所有应用的应用服务环境 v1 功能。
...
ms.author: v-tawe
ms.custom: seodec18
ms.openlocfilehash: 04743e5c731cfcd1d946f7064a0642e88a629889
ms.sourcegitcommit: 6a62dd239c60596006a74ab2333c50c4db5b62be
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/20/2019
ms.locfileid: "71156414"
---
...
<!-- LINKS -->
[PremiumTier]: https://www.azure.cn/pricing/details/app-service
[MoreInfoOnVirtualNetworks]: https://docs.azure.cn/virtual-network/virtual-networks-faq
[AppServicePlan]: ../overview-hosting-plans.md
[HowToCreateAnAppServiceEnvironment]: app-service-web-how-to-create-an-app-service-environment.md
[LogicApps]: https://docs.azure.cn/logic-apps/logic-apps-overview
<!-- [AzureConDeepDive]: https://azure.microsoft.com/documentation/videos/azurecon-2015-deploying-highly-scalable-and-secure-web-and-mobile-apps/ -->
[GeodistributedAppFootprint]:  app-service-app-service-environment-geo-distributed-scale.md [NetworkSecurityGroups]: https://docs.azure.cn/virtual-network/virtual-network-vnet-plan-design-arm [SiteToSite]: https://docs.azure.cn/vpn-gateway/vpn-gateway-multi-site [ExpressRoute]: https://www.azure.cn/home/features/expressroute [HowToConfigureanAppServiceEnvironment]:  app-service-web-configure-an-app-service-environment.md [ControllingInboundTraffic]:  app-service-app-service-environment-control-inbound-traffic.md [SecurelyConnectingToBackends]:  app-service-app-service-environment-securely-connecting-to-backend-resources.md [NetworkArchitectureOverview]:  app-service-app-service-environment-network-architecture-overview.md [NetworkConfigDetailsForExpressRoute]:  app-service-app-service-environment-network-configuration-expressroute.md [AppServicePricing]: https://www.azure.cn/pricing/details/app-service
