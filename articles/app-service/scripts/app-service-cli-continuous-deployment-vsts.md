---
title: Azure CLI 脚本示例 - 从 Azure DevOps Services 使用持续部署创建 Web 应用
description: Azure CLI 脚本示例 - 从 Azure DevOps Services 使用持续部署创建 Web 应用
...
此示例脚本使用其相关资源，在应用服务中创建 Web 应用，并从 Azure DevOps 存储库设置持续部署。 在此示例中，需要以下项：
