...
ms.date: 07/02/2018
ms.author: v-yiso
ms.openlocfilehash: 30f8f3870526d40244d4e162514cc43fce575d32
ms.sourcegitcommit: 092d9ef3f2509ca2ebbd594e1da4048066af0ee3
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/22/2018
ms.locfileid: "36315404"
---
...
根据应用服务计划的[定价层](www.azure.cn/pricing/details/app-service/plans/)，可能还会看到“部署到过渡环境”页。 选择是否要[启用部署槽位](web-sites-staged-publishing.md)，然后单击“继续”。
...
根据应用服务计划的[定价层](/pricing/details/app-service/plans/)，可能还会看到“部署到过渡环境”页。 选择是否要[启用部署槽位](web-sites-staged-publishing.md)，然后单击“继续”。 
