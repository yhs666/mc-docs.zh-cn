...
![在 Azure 中运行的示例应用](media/quickstart-nodejs/hello-world-in-browser.png)
...
![在本地运行的示例应用](media/quickstart-nodejs/localhost-hello-world-in-browser.png)
...
![空 Web 应用页](media/quickstart-nodejs/app-service-web-service-created.png)
...
![已更新的在 Azure 中运行的示例应用](media/quickstart-nodejs/hello-azure-in-browser.png)
...
![Azure 门户中的“应用服务”页](media/quickstart-nodejs/nodejs-docs-hello-world-app-service-detail.png)
