...
如果未能启动应用程序或希望检查应用中的日志记录，请查看 LogFiles 目录中的 Docker 日志。 可以通过 SCM 站点或通过 FTP 访问此目录。
...
请访问以下链接以开始使用 Linux 应用服务。 可以在 [我们的论坛](https://social.msdn.microsoft.com/forums/azure/home?forum=windowsazurewebsitespreview)上发布问题和关注点。
