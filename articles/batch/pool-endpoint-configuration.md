...
ms.date: 03/07/2018
ms.author: v-junlch
ms.openlocfilehash: 122c0584695ef64b74ffca4063f8e301b6098ae4
ms.sourcegitcommit: 9b5cc262f13a0fc9e0fd9495e3fbb6f394ba1812
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/08/2018
ms.locfileid: "29798093"
---
...
每个 NAT 池配置包括一个或多个[网络安全组 (NSG) 规则](https://docs.microsoft.com/rest/api/batchservice/pool/add#networksecuritygrouprule)。 每个 NSG 规则允许或拒绝特定的网络流量流向终结点。 可以选择允许或拒绝所有流量、由[默认标记](../virtual-network/virtual-networks-nsg.md#default-tags)（例如“Internet”）标识的流量，或者来自特定 IP 地址或子网的流量。
