...
ms.date: 11/26/2018
ms.author: v-lingwu
ms.openlocfilehash: 8f455252553385bef2ad10f901335b8f7037cf18
...
- Azure 存储服务加密适用于 [Azure Blob 存储](../storage/storage-introduction.md)。 有关其他 Azure 存储类型的详细信息，请参阅[文件](../storage/storage-dotnet-how-to-use-files.md)、[表](../storage/storage-dotnet-how-to-use-files.md)和[队列](../storage/storage-dotnet-how-to-use-queues.md)。
