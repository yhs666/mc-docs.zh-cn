...
ms.author: v-yiso
ms.date: 09/18/2017
ms.openlocfilehash: 2121fa9256deafd176d31ca148e9a8db4c14bb4a
...
如果已创建服务总线消息命名空间，请跳转到[使用 Azure 门户创建队列](#2-create-a-queue-using-the-azure-portal)部分。
...
为了将消息发送到队列中，我们会使用 Visual Studio 编写一个 C# 控制台应用程序。
