...
8. 现在必须配置新 Web 应用的 Azure 资源。请按照[配置新 Web 应用的 Azure 资源](../app-service-web/app-service-web-get-started-dotnet.md)一节中的所有步骤操作。然后，返回到本教程并继续执行下一步。
...
下一步是将 **ProductsPortal** 前端转换为 Azure Web 应用。首先，部署 **ProductsPortal** 项目，请按照[将 Web 项目部署到 Azure Web 应用](../app-service-web/app-service-web-get-started-dotnet.md)一节中的所有步骤操作。部署完成后，返回到本教程并继续执行下一步。
