...
ms.author: v-yiso
ms.date: 09/18/2017
ms.openlocfilehash: a8543ed7e651f2a309e51156b72e9e8e23becad6
...
客户端后续负责跟踪令牌过期时间。 令牌过期时，服务总线立即删除相应实体连接上的所有链接。 若要避免这种情况，客户端随时可以通过具有相同 put-token 手势的虚拟 $cbs 管理节点，使用新的令牌来替换节点的令牌，且不干扰在不同链接上流动的有效负载流量。
