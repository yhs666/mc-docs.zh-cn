...
ms.author: v-junlch
ms.date: 10/27/2016
ms.openlocfilehash: f8578a6566d3745202a2b74509e0d38813f342c9
...
5. 注册开发者后，将在顶部菜单上看到“管理控制台”。 单击“开发者服务管理”。
...
11. 在配置页的“应用程序包”字段中添加将在 Android 项目中使用的包名，然后单击“保存设置”。  
...
3. 为通知中心提供名称，选择要在其中创建此通知中心的区域和命名空间，然后单击“创建新的通知中心”。  
...
2. 输入应用程序名称，并确保将要求的最低 SDK 版本设为 API 16: Android 4.1。

    ![][24]

3. 单击“下一步”，然后继续执行向导，直到显示“创建活动”窗口。 确保选中“空白活动”，最后选择“完成”以创建新的 Android 应用程序。
...
10. 将以下代码添加到该类中：
    ...
    使用前面从百度云项目中检索到的内容设置 API_KEY 的值，使用 Azure 经典管理门户中的通知中心名称设置 NotificationHubName，并使用 Azure 经典管理门户中的 DefaultListenSharedAccessSignature 设置 NotificationHubConnectionString。
...
4. 在 `Program` 类中添加以下方法，并将 DefaultFullSharedAccessSignatureSASConnectionString 和 NotificationHubName 替换为自己的值。
