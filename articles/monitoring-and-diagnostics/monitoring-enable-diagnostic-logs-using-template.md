...
ms.date: 03/19/2018
ms.author: v-yiso
ms.openlocfilehash: 35c61a6f121071928a2480ced13352ea736debcf
...
* **非计算**资源（例如，网络安全组、自动化）使用[此文中描述的诊断设置](monitoring-overview-of-diagnostic-logs.md#resource-diagnostic-settings)。
...
整个过程（包括示例）详见[此文档](../virtual-machines/windows/extensions-diagnostics-template.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json)。
