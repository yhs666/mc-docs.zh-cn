---
title: "了解 Azure Monitor 中的全新警报（预览）体验"
...
ms.author: v-yiso
ms.custom: 
ms.openlocfilehash: a369905a5b876f922f5e0473d033b0509ab11815
...
- **目标资源** - 目标可以是任何 Azure 资源。 目标资源定义适用于警报的范围和信号。 示例目标：虚拟机、存储帐户、虚拟机规模集或解决方案。

- **条件** - 条件是应用于目标资源的信号和逻辑的组合。 示例：百分比 CPU > 70%、服务器响应时间 > 4 毫秒、日志查询的结果计数 > 100，等等。 

- **信号** - 信号由目标资源发出，可以有多种类型。 此预览版支持将指标、活动日志和日志作为信号类型。
