...
ms.openlocfilehash: a6fe7d229c15dd596b11223552bb1e43fc1e6ddd
ms.sourcegitcommit: 59db70ef3ed61538666fd1071dcf8d03864f10a9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2018
ms.locfileid: "52674892"
---
...
- 在 [Azure VM](metrics-store-custom-guestos-resource-manager-vm.md)、[虚拟机规模集](metrics-store-custom-guestos-resource-manager-vmss.md)、[经典 VM](metrics-store-custom-guestos-classic-vm.md) 或[经典云服务](metrics-store-custom-guestos-classic-cloud-service.md)上安装 Windows Azure 诊断 (WAD) 扩展，并将性能计数器发送到 Azure Monitor。 
- 在 Azure Linux VM 上安装 [InfluxData Telegraf 代理](metrics-store-custom-linux-telegraf.md)，并使用 Azure Monitor 输出插件发送指标。
...
### <a name="region"></a>区域
此属性捕获针对其发出指标的资源所部署到的 Azure 区域。 必须将指标发出到资源部署区域所在的同一个 Azure Monitor 区域终结点。 例如，部署在中国北部的 VM 的自定义指标必须发送到 ChinaNorth 区域 Azure Monitor 终结点。 区域信息也在 API 调用的 URL 中编码。
...
|Azure 区域|区域终结点前缀|
|---|---|
|中国东部|https://chinaeast.monitoring.azure.com/|
|中国东部|https://chinaeast.monitoring.azure.com/|
|中国北部|https://chinaeast.monitoring.azure.com/|
|中国北部 2|https://chinanorth2.monitoring.azure.com/|
|中国东部|https://chinaeast.monitoring.azure.com/|
|中国北部|https://northeurope.monitoring.azure.com/|
|中国北部|https://chinanorth.monitoring.azure.com/|
...
在不同的服务中使用自定义指标： 
 ...
 - [Azure 虚拟机（经典）](metrics-store-custom-guestos-classic-vm.md)
 - [使用 Telegraf 代理的 Linux 虚拟机](metrics-store-custom-linux-telegraf.md)
 - [REST API](metrics-store-custom-rest-api.md)
 - [经典云服务](metrics-store-custom-guestos-classic-cloud-service.md)
