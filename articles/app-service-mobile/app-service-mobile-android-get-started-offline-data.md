...
ms.date: 10/01/2016
ms.author: v-yiso
ms.openlocfilehash: 1ef117364aa6680d7fbc96552f1e1aa19e8b1f76
...
若要在设备与 Azure 移动服务之间推送和拉取更改，可以使用同步上下文 (*MobileServiceClient.SyncContext*)，该上下文借助本地存储数据时所用的本地数据库进行初始化。
...
3. 使用 SQL 工具（如 *SQL Server Management Studio*）或 REST 客户端（如 *Fiddler* 或 *Postman*）查看 Azure *TodoItem* 表的内容。 验证新项是否 _未_ 同步到服务器
