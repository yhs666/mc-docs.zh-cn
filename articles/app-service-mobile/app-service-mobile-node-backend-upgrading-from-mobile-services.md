...
Azure 移动应用允许在服务中配置 Azure Active Directory 和 Microsoft 身份验证。  自定义身份验证需要另行开发。  有关详细信息，请参阅[身份验证概念]文档和[身份验证快速入门]文档。  
...
- [Android 2.2 版或更高版本](./app-service-mobile-android-how-to-use-client-library.md)
