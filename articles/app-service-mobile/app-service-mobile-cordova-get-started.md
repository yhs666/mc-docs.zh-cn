...
* 将[脱机数据添加](./app-service-mobile-cordova-get-started-offline-data.md)到 Apache Cordova 应用。
* 将[身份验证添加](./app-service-mobile-cordova-get-started-users.md)到 Apache Cordova 应用。
