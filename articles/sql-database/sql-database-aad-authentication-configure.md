...
## <a name="provision-an-azure-active-directory-administrator-for-your-azure-sql-server-by-using-powershell"></a>使用 PowerShell 为 Azure SQL Server 预配 Azure Active Directory 管理员
