...
ms.date: 04/17/2018
ms.author: v-johch
ms.openlocfilehash: 2ea41baceea97ee4ec4472f8a377b6a9f103c75a
ms.sourcegitcommit: c4437642dcdb90abe79a86ead4ce2010dc7a35b5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/23/2018
ms.locfileid: "31782185"
---
...
| [az sql server firewall create](https://docs.azure.cn/cli/sql/server/firewall-rule#az_sql_server_firewall_rule_create) | 创建一个防火墙规则，以允许从输入的 IP 地址范围访问服务器上的所有 SQL 数据库。 |
| [az sql db create](https://docs.azure.cn/cli/sql/db#az_sql_db_create) | 在逻辑服务器中创建 SQL 数据库。 |
| [az group delete](https://docs.azure.cn/cli/resource#az_resource_delete) | 删除资源组，包括所有嵌套的资源。 |
