...
ms.date: 11/06/2017
ms.author: v-johch
ms.openlocfilehash: e9703c6fc7ea30a694365328cbfb3665cfccc169
...
| [az sql server create](https://docs.azure.cn/cli/sql/server#create) | 创建用于托管 SQL 数据库的逻辑服务器。 |
| [az sql server firewall create](https://docs.azure.cn/cli/sql/server/firewall-rule#create) | 创建一个防火墙规则，以允许从输入的 IP 地址范围访问服务器上的所有 SQL 数据库。 |
| [az sql db create](https://docs.azure.cn/cli/sql/db#create) | 在逻辑服务器中创建 SQL 数据库。 |
| [az group delete](https://docs.azure.cn/cli/resource#delete) | 删除资源组，包括所有嵌套的资源。 |
