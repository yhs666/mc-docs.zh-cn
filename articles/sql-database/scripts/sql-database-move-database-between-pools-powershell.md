---
title: "PowerShell 示例 - 移动 Azure SQL 数据库 - SQL 弹性池 | Azure"
...
ms.date: 07/31/2017
ms.author: v-haiqya
ms.openlocfilehash: d04873c334f3fdc4262168e2013156c8e4414399
...
此 PowerShell 脚本示例创建两个弹性池，将数据库从一个弹性池移到另一个弹性池中，再将数据库移出弹性池，以实现单一数据库性能级别。 
