...
ms.date: 12/26/2016
ms.author: v-johch
ms.openlocfilehash: 3cd3a2ee383a870a13a3490786be14556606afb1
...
1. 生成并运行 **弹性数据库工具入门** 示例应用程序。 一直执行到[下载和运行示例应用](./sql-database-elastic-scale-get-started.md#Getting-started-with-elastic-database-tools)部分中的步骤 7。 在步骤 7 结束时，你将看到以下命令提示符：
...
2. 连接到 ElasticDBQuery 数据库，并执行以下 T-SQL 命令：
    ...
    “username”和“password”应该与[弹性数据库工具入门](./sql-database-elastic-scale-get-started.md)中[下载和运行示例应用](./sql-database-elastic-scale-get-started.md#Getting-started-with-elastic-database-tools)的步骤 6 中使用的登录信息相同。
