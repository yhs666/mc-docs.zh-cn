...
ms.date: 11/06/2017
ms.author: v-johch
ms.openlocfilehash: a4742d83a310bb3f850ac708a7041fbd9020bc4b
...
根据[针对业务连续性设计应用程序](sql-database-business-continuity.md)的方式，用于执行演练的工作流会有所不同。 下面会讨论在 Azure SQL 数据库上下文中执行灾难恢复演练的最佳实践。
