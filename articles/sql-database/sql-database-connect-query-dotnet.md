---
title: "使用 .NET (C#) 连接到 Azure SQL 数据库 | Azure"
...
在 macOS 上安装 .NET Core。 下载[正式的安装程序](https://go.microsoft.com/fwlink/?linkid=843444)。 此安装程序会安装工具并将其放置在 PATH 中，以便可以从控制台运行 dotnet
