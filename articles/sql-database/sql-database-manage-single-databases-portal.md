---
title: Azure 门户预览：创建和管理单一 Azure SQL 数据库 | Azure
...
可以使用 [Azure 门户预览](https://portal.azure.cn/)、PowerShell、Transact-SQL、REST API 或 C# 创建和管理单一 Azure SQL 数据库。本主题说明如何使用 Azure 门户预览。有关 PowerShell，请参阅[使用 Powershell 创建和管理单一数据库](./sql-database-manage-single-databases-powershell.md)。有关 Transact-SQL，请参阅[使用 Transact-SQL 创建和管理单一数据库](./sql-database-manage-single-databases-tsql.md)。
...
> [!TIP]
>有关使用 Azure 门户预览创建数据库的教程，请参阅[创建数据库 - Azure 门户预览](./sql-database-get-started.md)。
>    
