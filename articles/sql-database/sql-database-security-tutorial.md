...
ms.date: 07/31/2017
ms.author: v-haiqya
ms.openlocfilehash: 23af87cce6193d2ead50fc4d507edd3ec0e2a399
...
> [!TIP]
> 有关创建使用 Azure SQL 数据库的 .NET 应用程序的示例，请参阅[在 Azure 中生成使用 SQL 数据库的 ASP.NET 应用](/app-service-web/app-service-web-tutorial-dotnet-sqldatabase.md)。
>
...
4. 选择“存储详细信息”打开“审核日志存储”边栏选项卡。 选择日志要保存到的 Azure 存储帐户以及保留期（超过此期限的旧日志将被删除），然后单击底部的“确定”。 
