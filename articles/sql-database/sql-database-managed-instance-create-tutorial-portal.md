...
> [!IMPORTANT]
> 请等到托管实例成功预配后再继续。 该实例预配以后，请在托管实例的“概览”选项卡的“托管实例”字段中检索实例的主机名。 该名称类似于：**drfadfadsfd.tr23.chinanorth1-a.worker.database.chinacloudapi.cn**。
