...
ms.date: 05/20/2019
ms.openlocfilehash: db5e702115bfe5e521f48c364ff0cf89da46d706
ms.sourcegitcommit: f0f5cd71f92aa85411cdd7426aaeb7a4264b3382
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/15/2019
ms.locfileid: "65629214"
---
...
|每个池的最大数据库数|100|200|300|500|500|500|
...
|允许的最大会话数|30000|30000|30000|30000|30000|30000|
|每个池的最大数据库数|200|500|500|500|500|500|
...
|每个池的最大数据库数|200|500|500|500|500|500|500|
...
|日志速率限制 (MBps)|10 个|20 个|30|40|50|60|
|每个池的最大并发工作线程数（请求数）*|210|420|630|840|1050|1260|
