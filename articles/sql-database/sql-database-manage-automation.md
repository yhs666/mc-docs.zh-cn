...
ms.date: 07/03/2017
ms.author: v-johch
ms.openlocfilehash: 2d1d5af5dbb2e682a4488f2ab92260ead92bb42b
...
<a id="managing-azure-sql-databases-using-azure-automation" class="xliff"></a>
本指南介绍 Azure 自动化服务，以及如何使用它来简化 Azure SQL 数据库的管理。

## 什么是 Azure 自动化？
<a id="what-is-azure-automation" class="xliff"></a>
...
<a id="how-can-azure-automation-help-manage-azure-sql-databases" class="xliff"></a>
