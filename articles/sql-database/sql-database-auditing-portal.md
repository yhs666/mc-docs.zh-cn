---
title: "Azure 门户：管理 SQL 数据库审核 | Microsoft Docs"
...
以下部分介绍如何使用 Azure 门户配置和管理审核。 若要使用 PowerShell 配置和管理审核，请参阅[在 PowerShell 中配置审核](sql-database-auditing-powershell.md)。 
