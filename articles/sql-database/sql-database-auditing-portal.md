---
title: "Azure 门户预览版：管理 SQL 数据库审核 | Microsoft Docs"
...
# <a name="configure-and-manage-sql-database-auditing-in-the-azure-portal-preview"></a>在 Azure 门户预览版中配置和管理 SQL 数据库审核

以下部分介绍如何使用 Azure 门户预览版配置和管理审核。 若要使用 PowerShell 配置和管理审核，请参阅[在 PowerShell 中配置审核](sql-database-auditing-powershell.md)。 
...
* 通过 [Azure 门户预览版](https://portal.azure.cn) - 打开相关数据库。 在数据库的“审核和威胁检测”边栏选项卡顶部，单击“查看审核日志”。
