...
ms.date: 07/03/2017
ms.author: v-johch
ms.openlocfilehash: 3f1401fd0d0bb02eecb057981e0c3989cd8c9b97
ms.sourcegitcommit: 73b1d0f7686dea85647ef194111528c83dbec03b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/28/2017
---
# 使用 SQL 数据库和 SQL 数据仓库进行通用身份验证（MFA 的 SSMS 支持）
<a id="universal-authentication-with-sql-database-and-sql-data-warehouse-ssms-support-for-mfa" class="xliff"></a>
...
有关多重身份验证的说明，请参阅[多重身份验证](../multi-factor-authentication/multi-factor-authentication.md)。
...
<a id="azure-ad-domain-name-or-tenant-id-parameter" class="xliff"></a>   
...
<a id="universal-authentication-limitations-for-sql-database-and-sql-data-warehouse" class="xliff"></a>
...
* 有关 Azure AD 配置和管理的信息，请参阅[使用 SQL 数据库或 SQL 数据仓库配置和管理 Azure Active Directory 身份验证](sql-database-aad-authentication-configure.md)。