...
## 在云中自由翱翔
Nagalkar 及其团队发现了多个云选项，但大多数都是基于基础结构即服务 (IaaS) 的解决方案，需要 GEP 大量投入 IT 资源来配置和管理服务。最后证明 Azure 平台即服务 (PaaS) 解决方案是更合适的选项。
...
![SMART by GEP 体系结构](./media/sql-database-implementation-gep/figure1.png) 
图 1.SMART by GEP 体系结构
