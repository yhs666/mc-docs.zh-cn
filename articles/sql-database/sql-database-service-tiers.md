...
manager: digimobile
ms.author: v-jay
ms.openlocfilehash: 3e44434f4c1901be872af2f4a296d0795f4c28a3
ms.sourcegitcommit: 7ea906b9ec4f501f53b088ea6348465f31d6ebdc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/03/2018
ms.locfileid: "39486847"
---
...
系统会校准并控制性能级别，以便在选定服务层/性能级别所允许的最大范围内提供所需的资源来运行数据库工作负荷。 如果工作负荷达到了 CPU/数据 IO/日志 IO 限制中的其中一个限制，你将继续接收资源直到达到允许的最大级别，但是，你可能会发现查询延迟不断增加。 这些限制不会造成任何错误，而只会减慢工作负荷，直到严重变慢，以致于查询开始超时。如果达到了并发用户会话/请求（工作线程）的最大允许数目，你将看到明确的错误。 有关 CPU、内存、数据 IO 或事务日志 IO 以外的资源限制的信息，请参阅 [Azure SQL 数据库资源限制]( sql-database-resource-limits.md#what-happens-when-database-resource-limits-are-reached)。
