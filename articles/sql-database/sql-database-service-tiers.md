...
manager: digimobile
ms.author: v-nany
ms.openlocfilehash: 0e5c6efd6d0bbdd53a27355d71aa97c0793a7533
...
> 区域限制： 
>
> 基于 vCore 的购买模型在澳大利亚东南部尚不可用。 预览版在以下区域中不可用：西欧、法国中部、英国南部和英国西部。
> 
...
|可用性|1 个副本，无读取缩放组|3 个副本，1 个读取缩放组，区域冗余高可用性|
