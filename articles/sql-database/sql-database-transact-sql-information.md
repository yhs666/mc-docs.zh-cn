...
ms.date: 07/03/2017
ms.author: v-johch
ms.openlocfilehash: abdc0cec65b306155a06154718bad0d6603937ca
ms.sourcegitcommit: 73b1d0f7686dea85647ef194111528c83dbec03b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/28/2017
---
# 解析迁移到 SQL 数据库的过程中的 Transact-SQL 差异
<a id="resolving-transact-sql-differences-during-migration-to-sql-database" class="xliff"></a>   
...
有关 SQL 数据库支持和不支持的功能的列表，请参阅 [Azure SQL 数据库功能比较](sql-database-features.md)。 此页上的列表对该“准则和功能”主题进行了补充，并重点介绍了 Transact-SQL 语句。

## 具有部分差异的 Transact-SQL 语法语句
<a id="transact-sql-syntax-statements-with-partial-differences" class="xliff"></a>
...
<a id="transact-sql-syntax-not-supported-in-sql-database" class="xliff"></a>   
