...
ms.date: 05/20/2019
ms.openlocfilehash: 27a922a9ebebd37080e47214467e6553ed3c9fa6
...
包含已删除的托管实例的[虚拟群集](sql-database-managed-instance-connectivity-architecture.md#virtual-cluster-connectivity-architecture)在删除该实例后，将保留 12 个小时。 该虚拟群集将按设计保持活动状态，以便更快地在同一子网中创建托管实例。 在此期间，无法删除与该虚拟群集关联的子网。
