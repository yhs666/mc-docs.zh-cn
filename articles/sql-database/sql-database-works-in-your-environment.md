...
ms.date: 10/13/2016
ms.author: v-johch
ms.openlocfilehash: af5b4d7dae9af4db80dda6b8b33714bf735a08a8
ms.sourcegitcommit: 6728c686935e3cdfaa93a7a364b959ab2ebad361
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/21/2017
---
# <a name="azure-sql-database-works-in-your-environment"></a>Azure SQL 数据库在你的环境中正常工作

## <a name="connect-with-what-you-already-know"></a>使用你已知的内容进行连接
...
[了解有关 SQL 数据库开发的详细信息](./sql-database-develop-overview.md) 

## <a name="the-right-tools-for-the-job"></a>适合于作业的工具

开始使用 SQL 数据库时，不必学习一整套新工具。 可以利用开源工具，如 [cheetah](https://github.com/wunderlist/cheetah)、[sql-cli](https://www.npmjs.com/package/sql-cli) 和 [VS Code](https://code.visualstudio.com/)。 此外，Azure SQL 数据库可与 Microsoft 工具（如 [Visual Studio](https://www.visualstudio.com/visual-studio-homepage-vs.aspx) 和 [SQL Server Management Studio](https://msdn.microsoft.com/zh-cn/library/ms174173.aspx)）配合使用。  还可以使用 Azure 管理门户、PowerShell 和 REST API 帮助提高工作效率。
