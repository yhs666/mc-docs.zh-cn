...
<a id="daxkocsi-used-azure-to-accelerate-its-development-cycle-and-to-enhance-its-customer-services-and-performance" class="xliff"></a>
...
## 卸载到云
<a id="offloading-to-the-cloud" class="xliff"></a>
...
## 过渡到 Azure
<a id="making-the-transition-to-azure" class="xliff"></a>
...
## Azure 弹性池释放 IT 资源
<a id="azure-elastic-pools-free-up-it-resources" class="xliff"></a>
...
## Azure 活动异地复制加速报告
<a id="azure-active-geo-replication-accelerates-reporting" class="xliff"></a>
...
<a id="csi-software-application-logic-and-architecture" class="xliff"></a>
...
<a id="using-web-apps-and-a-web-plan-tier-for-mobile-apps" class="xliff"></a>
...
<a id="azure-lets-csi-software-developers-focus-on-apps-and-services" class="xliff"></a>
