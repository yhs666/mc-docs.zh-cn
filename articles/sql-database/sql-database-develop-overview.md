...
ms.date: 08/17/2016
ms.author: v-johch
ms.openlocfilehash: 882d6220099f1a240d9b974a174f2cd6a2529f04
...
* 如果客户端程序连接到 SQL 数据库 V12，而客户端运行在 Azure 虚拟机 (VM) 上，则必须打开 VM 上的特定端口范围。 详细信息：[用于 ADO.NET 4.5 和 SQL 数据库 V12 的非 1433 端口](./sql-database-develop-direct-route-ports-adonet-v12.md)
