---
title: Azure 门户预览：将 Azure SQL 数据库还原到以前的时间点 | Azure
...
本文介绍如何使用 PowerShell 将数据库从 [SQL 数据库自动备份](./sql-database-automated-backups.md)还原到以前的时间点。也可以[使用 PowerShell](./sql-database-point-in-time-restore-powershell.md) 执行此任务。

## 还原到以前的时间点 

> [!TIP]
有关教程，请参阅[开始使用备份和还原进行数据保护和恢复](./sql-database-get-started-backup-recovery-portal.md)
>
