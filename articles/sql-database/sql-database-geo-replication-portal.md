---
title: "Azure 门户预览版：SQL 数据库异地复制 | Microsoft Docs"
description: "在 Azure 门户预览版中为 Azure SQL 数据库配置异地复制，并启动故障转移"
...
---
# <a name="configure-active-geo-replication-for-azure-sql-database-in-the-azure-portal-preview-and-initiate-failover"></a>在 Azure 门户预览版中为 Azure SQL 数据库配置活动异地复制，并启动故障转移

本文说明如何在 [Azure 门户预览版](http://portal.azure.cn)中为 SQL 数据库配置活动异地复制，以及如何启动故障转移。

若要使用 Azure 门户预览版启动故障转移，请参阅[使用 Azure 门户预览版为 Azure SQL 数据库启动计划内或计划外故障转移](sql-database-geo-replication-failover-portal.md)。
...
若要使用 Azure 门户预览版配置活动异地复制，需要以下资源：
...
1. 在 [Azure 门户预览版](http://portal.azure.cn)中，浏览到需要设置以便进行异地复制的数据库。
...
1. 在 [Azure 门户预览版](http://portal.azure.cn)中浏览到异地复制合作关系中的主数据库。
