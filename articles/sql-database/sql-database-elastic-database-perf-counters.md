...
ms.date: 07/11/2016
ms.author: v-johch
ms.openlocfilehash: d94057d98370a2da3a30506fb0da0b60d0325999
...
* 缓存映射：为分片映射缓存的映射数目。
*  DDR 操作次数/秒：分片映射的数据相关路由操作速率。 对 [OpenConnectionForKey()](https://msdn.microsoft.com/zh-cn/library/azure/microsoft.azure.sqldatabase.elasticscale.shardmanagement.shardmap.openconnectionforkey.aspx) 的调用成功建立与目标分片的连接时，将更新此计数器。 
