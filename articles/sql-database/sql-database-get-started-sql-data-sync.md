...
ms.date: 02/25/2019
ms.openlocfilehash: 91ab894f0f540d64588406334ff5860887839d6f
ms.sourcegitcommit: b8fb6890caed87831b28c82738d6cecfe50674fd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/29/2019
ms.locfileid: "58627553"
---
...
2. 在选定数据库的“SQL 数据库”页中，选择“同步到其他数据库”。

    ![“同步到其他数据库”选项](media/sql-database-get-started-sql-data-sync/datasync-overview.png)

3. 在“同步到其他数据库”页中，选择“新建同步组”。 “新建同步组”页随即打开，其中突出显示“创建同步组(步骤 1)”。
...
2. 在“选择同步代理”页中，选择是使用现有代理还是创建代理。
   ...
   3. 选择“创建并生成密钥”并将代理密钥复制到剪贴板。

   4. 选择“确定”，关闭“选择同步代理”页。

3. 在 SQL Server 计算机上，找到并运行客户端同步代理应用程序。
...
4. 在门户的“配置本地数据库”页中，选择“选择数据库”。

5. 在“选择数据库”页的“同步成员名称”字段中，输入新同步成员的名称。 此名称不同于数据库本身的名称。 从列表中选择数据库。 在“同步方向”字段中，选择“双向同步”、“向中心同步”或“从中心同步”。

    ![选择本地数据库](media/sql-database-get-started-sql-data-sync/datasync-preview-selectdb.png)

6. 选择“确定”，关闭“选择数据库”页。 再选择“确定”，关闭“配置本地数据库”页，并等待新同步成员创建和部署完成。 最后，选择“确定”，关闭“选择同步成员”页。
