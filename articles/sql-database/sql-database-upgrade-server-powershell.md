...
ms.date: 09/19/2016
ms.author: v-johch
ms.openlocfilehash: dfe04a01a8598bdfb9e2a0af206c2c78f74dd7c2
...
- 检查和暂停异地复制：如果 Azure SQL 数据库已针对异地复制进行配置，则应记录其当前配置并停止[异地复制](./sql-database-geo-replication-portal.md#remove-secondary-database)。 升级完成后，请重新为异地复制配置数据库。
...
## <a name="configure-your-credentials-and-select-your-subscription"></a>配置凭据，然后选择订阅
