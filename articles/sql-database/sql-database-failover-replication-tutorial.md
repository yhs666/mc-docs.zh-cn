---
title: "对 Azure SQL 数据库解决方案进行复制和故障转移 | Azure"
...
ms.date: 04/18/2017
ms.author: v-johch
ms.openlocfilehash: ab31bc86686ce316d101aa15476a21150c286357
...
在此步骤中，创建或标识可作为用户添加到 Azure SQL 数据库逻辑服务器和示例数据库的 Azure Active Directory 用户。
