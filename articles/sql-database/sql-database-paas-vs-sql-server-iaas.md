...
* 有想要迁移或扩展到云中的现有本地应用程序，或者如果要构建大于 4 TB 的企业应用程序。 此方法提供的优点包括：可以使用所选的 SQL Server 版本、大数据库容量、可完全控制 SQL Server 和 Windows/Linux，以及通过隧道安全连接到本地。 此方法可以降低开发和修改现有应用程序的成本。
