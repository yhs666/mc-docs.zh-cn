...
ms.date: 07/02/2018
ms.author: v-johch
ms.openlocfilehash: 204a204c173f7eb8353a360cee3d069db617684f
ms.sourcegitcommit: 7ea906b9ec4f501f53b088ea6348465f31d6ebdc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/03/2018
ms.locfileid: "39486561"
---
...
* SQL 数据库、托管实例和 SQL 数据仓库通过 CLI 支持 Azure AD 身份验证。 有关详细信息，请参阅[使用 SQL 数据库或 SQL 数据仓库配置和管理 Azure Active Directory 身份验证](sql-database-aad-authentication-configure.md)和 [SQL Server - az sql server](https://docs.azure.cn/cli/sql/server)。
