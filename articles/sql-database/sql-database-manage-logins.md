...
> [!TIP]
>有关如何使用 SQL Server 身份验证的教程，请参阅[教程：SQL Server 身份验证](./sql-database-control-access-sql-authentication-get-started.md)。有关如何使用 Azure Active Directory 身份验证的教程，请参阅[教程：AAD 身份验证](./sql-database-control-access-aad-authentication-get-started.md)。
>
...
- 有关如何使用 SQL Server 身份验证的教程，请参阅[教程：SQL Server 身份验证](./sql-database-control-access-sql-authentication-get-started.md)。
- 有关如何使用 Azure Active Directory 身份验证的教程，请参阅[教程：AAD 身份验证](./sql-database-control-access-aad-authentication-get-started.md)。
