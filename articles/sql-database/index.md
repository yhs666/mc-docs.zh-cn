---
title: Azure SQL 数据库文档 - 教程、API 参考 | Azure
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="https://docs.microsoft.com/powershell/elasticdatabasejobs/v0.8.33/elasticdatabasejobs">PowerShell（弹性 DB）</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="https://docs.microsoft.com/rest/api/sql/">REST API 参考</a></p>
                    </div>
                </div>
            </div>
        </div>
