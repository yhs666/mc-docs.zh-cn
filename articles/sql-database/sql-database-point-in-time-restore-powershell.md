---
title: PowerShell：将 Azure SQL 数据库还原到以前的时间点 | Azure
...
本文介绍如何使用 PowerShell 将数据库从 [SQL 数据库自动备份](./sql-database-automated-backups.md)还原到以前的时间点。也可以[使用 Azure 门户预览](./sql-database-point-in-time-restore-portal.md)执行此任务。
