---
title: PowerShell：创建和管理单一 Azure SQL 数据库 | Azure
...
可以使用 [Azure 门户预览](https://portal.azure.cn/)、PowerShell、Transact-SQL、REST API 或 C# 创建和管理单一 Azure SQL 数据库。本主题说明如何使用 PowerShell。对于 Azure 门户预览，请参阅[使用 Azure 门户预览创建和管理单一数据库](./sql-database-manage-single-databases-powershell.md)。有关 Transact-SQL，请参阅[使用 Transact-SQL 创建和管理单一数据库](./sql-database-manage-single-databases-tsql.md)。
