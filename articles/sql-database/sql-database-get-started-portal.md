...
ms.date: 1/22/2018
ms.author: v-nany
ms.openlocfilehash: 66e9108fa7975c955978d3ab34ecf6656445c9f8
...
1. 在数据库的 SQL 数据库页的左侧菜单中找到并单击“数据资源管理器(预览)”

   ![查找查询编辑器](./media/sql-database-get-started-portal/find-query-editor.PNG)

2. 单击“登录”，查看登录信息，然后单击“确定”，以便通过 SQL Server 身份验证使用此前创建的服务器管理员登录名和密码进行登录。

   ![登录](./media/sql-database-get-started-portal/login-menu.png)

3. 单击“确定”登录。

4. 完成 ServerAdmin 身份验证后，在查询编辑器窗格中键入以下查询。
