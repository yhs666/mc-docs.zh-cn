---
title: PowerShell：管理 Azure SQL 数据库审核 | Azure
...
以下部分介绍如何使用 PowerShell 配置和管理审核。若要使用 Azure 门户预览配置和管理审核，请参阅[在 Azure 门户预览中配置审核](./sql-database-auditing-portal.md)。若要使用 REST API 配置和管理审核，请参阅[使用 REST API 配置审核](./sql-database-auditing-rest.md)。
