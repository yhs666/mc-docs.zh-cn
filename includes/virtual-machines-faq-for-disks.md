...
ms.openlocfilehash: 08c1db8f8dda74254d789243353801a53b6383d3
ms.sourcegitcommit: 3b05a8982213653ee498806dc9d0eb8be7e70562
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/04/2019
ms.locfileid: "59004535"
---
...
**用于实现优化磁盘 IOPS 和带宽的标准 SSD 和标准 HDD 磁盘的建议 VM 大小是多少？**

<!--Not Available on for large disk sizes (>4TiB)-->

要使标准 SSD 和标准 HDD 的磁盘吞吐量超过 500 IOPS 和 60 MiB/秒，我们建议部署下列 VM 大小之一的新 VM 来优化性能：B 系列、DSv2 系列、Dsv3 系列、ESv3 系列、Fs 系列、Fsv2 系列、M 系列或 NCv3 系列。

<!-- Not Available on GS-series, NCv2-series, Ls-Series -->
<!--Not Available on **How can I upgrade my disks (>4 TiB) which were deployed during the larger disk sizes preview in order to get the higher IOPS & bandwidth at GA?**-->
<!-- Not Available on **What regions are the managed disk sizes of 8 TiB, 16 TiB, and 32 TiB supported in?**-->
<!-- Available on West US Central only-->
**是否支持在所有磁盘大小上启用主机缓存？**

我们支持在小于 4 TiB 的磁盘大小上启用只读和读/写主机缓存。 

<!--For disk sizes more than 4 TiB, -->
