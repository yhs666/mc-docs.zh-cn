...
用户必须具有 Azure 订阅（这是允许用户访问各种 Azure 服务的计划），才能创建存储帐户。 可以从 [1 元帐户](https://www.azure.cn/pricing/1rmb-trial/)开始使用 Azure。 一旦决定购买某个订阅计划，可从各种 [购买选项](https://www.azure.cn/pricing/purchase-options/)中进行选择。 有关批量定价的信息，请参阅 [Azure 存储定价 ](https://www.azure.cn/pricing/details/storage/) 。
