...
4. 对于“应用服务计划”，请选择默认计划（在[标准层](https://azure.microsoft.com/pricing/details/app-service/)中）。 还可以选择其他计划，或[创建一个新计划](../articles/app-service/app-service-plan-manage.md#create-an-app-service-plan)。 
