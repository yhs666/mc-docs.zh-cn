---
 title: include 文件 description: include 文件 services: active-directory author: curtand ms.service: active-directory ms.topic: include origin.date:11/06/2018 ms.date:12/07/2018 ms.author: v-junlch ms.custom: include 文件
---
...
| 访问面板 |<ul><li>对应用程序的数量没有限制，应用程序可在每位获得 Azure AD Premium 或企业移动套件许可的最终用户的“访问面板”中查看。</li><li>每位获得免费版或 Azure AD 基本版 Azure Active Directory 许可的最终用户最多可在“访问面板”中查看 10 个应用磁贴（示例：Box、Salesforce 或 Dropbox）。 此限制不适用于管理员帐户。</li></ul> |
