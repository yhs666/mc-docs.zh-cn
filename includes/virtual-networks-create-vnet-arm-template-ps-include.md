...
2. 必要时运行 **`New-AzureRmResourceGroup`** cmdlet 创建一个新的资源组。 以下命令在*中国北部* Azure 区域创建一个名为 *TestRG* 的资源组。 有关资源组的详细信息，请访问 [Azure Resource Manager 概述](../articles/azure-resource-manager/resource-group-overview.md)。
...
3. 运行 **`New-AzureRmResourceGroupDeployment`** cmdlet，使用在前面下载并修改的模板和参数文件部署新 VNet。
