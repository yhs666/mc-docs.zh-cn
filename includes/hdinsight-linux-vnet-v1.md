> 不能将 v1（经典）、Azure 虚拟网络与基于 Linux 的 HDInsight 配合使用。 虚拟网络必须是 v2 (Azure Resource Manager) 才能在 Azure 门户中的 HDInsight 群集创建过程中列为选项，或者在通过 Azure CLI 或 Azure PowerShell 创建群集时可用。
> 
