...
2. 使用图像下面的表格中指定的函数应用设置。
    ...
    ![定义新的函数应用设置](./media/functions-create-function-app-portal/1.png)
    ...
    | **[存储](../articles/storage/common/storage-create-storage-account.md#create-a-storage-account)** |  全局唯一名称 |  Function App 使用的新存储帐户的名称。 存储帐户名称必须为 3 到 24 个字符，并且只能包含数字和小写字母。 也可以使用现有帐户。 |
