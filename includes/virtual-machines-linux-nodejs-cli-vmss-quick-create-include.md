...
获取 [Azure 订阅试用版](https://www.azure.cn/pricing/1rmb-trial/)和[连接到 Azure 帐户](../articles/xplat-cli-connect.md)的 [Azure CLI 1.0](../articles/cli-install-nodejs.md)（如果尚未这样做）。 请确保 Azure CLI 处于 Resource Manager 模式下，如下所示：
