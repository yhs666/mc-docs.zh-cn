#<a name="how-to-use-the-azure-command-line-tools-for-mac-and-linux"></a>如何使用适用于 Mac 和 Linux 的 Azure 命令行工具
...
###<a name="set-up-publishing-from-github"></a>设置为从 GitHub 发布
