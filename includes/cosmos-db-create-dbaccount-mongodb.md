...
ms.openlocfilehash: e500df2a62664b1615c960c3dc38a121a6f9366e
ms.sourcegitcommit: b56dae931f7f590479bf1428b76187917c444bbd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/28/2019
ms.locfileid: "56988051"
---
...
3. 在“创建 Azure Cosmos DB 帐户”页中，输入新 Azure Cosmos DB 帐户的设置。 
    ...
    API|Azure Cosmos DB 的用于 MongoDB 的 API|API 确定要创建的帐户的类型。 Azure Cosmos DB 提供两种 API：适用于文档数据库的 Core(SQL) 和适用于文档数据库的 Azure Cosmos DB 的 API MongoDB。 目前，你必须为每种 API 创建单独的帐户。 <br><br>选择“MongoDB”，因为本快速入门将创建使用 MongoDB 的表。|
