...
2. 单击“恢复服务”，然后选择要注册服务器的备份保管库。 随后将显示该备份保管库的“快速启动”页。
...
6. Azure 备份代理将安装 .NET Framework 4.5 和 Windows PowerShell（如果没有）以完成安装。
...
9. 在“加密设置”屏幕中，可以生成一个通行短语，或者提供一个通行短语（最少包含 16 个字符）。 请记住将通行短语保存在安全位置。
...
10. 单击“完成”按钮后，计算机即会成功注册到保管库，现在，可以开始备份到 Microsoft Azure。
