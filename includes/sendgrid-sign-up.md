...
5. 输入“名称”以标识 Azure 设置中的 SendGrid 服务。 名称的长度必须介于 1 到 100 个字符之间，并且只能包含字母数字字符、短划线、句点和下划线。 名称在已订阅 Azure 应用商店项目列表中必须是唯一的。
6. 输入并确认“密码”。
7. 选择“订阅”。
8. 新建“资源组”或使用现有资源组。
9. 在“定价层”部分，选择要注册的 SendGrid 计划。
...
4. 至少提供“此密钥的名称”和对“邮件发送”的完全访问权限，并选择“保存”。
...
1. 单击密钥图标，查找“用户名”。
    ...
    ![key][key]
2. 密码是用户设置时选择的密码。 如需进行任何更改，可选择“更改密码”或“重置密码”。
