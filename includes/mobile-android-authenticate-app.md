...
2. 将以下方法添加到 **ToDoActivity** 类：
        ...
        public static final int MICROSOFTACCOUT_LOGIN_REQUEST_CODE = 1;

        private void authenticate() {
            // Login using the Microsoft account.
            mClient.login("MicrosoftAccount", "{url_scheme_of_your_app}", MICROSOFTACCOUT_LOGIN_REQUEST_CODE);
        }
        ...
        protected void onActivityResult(int requestCode, int resultCode, Intent data) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (requestCode == MICROSOFTACCOUT_LOGIN_REQUEST_CODE) {
    ...
    > [!NOTE]
    > 如果使用的标识提供者不是 MicrosoftAccount，请将传递给上述 **login** 方法的值更改为：_windowsazureactivedirectory_ 。
