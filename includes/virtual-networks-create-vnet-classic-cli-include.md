...
2. 运行 **azure network vnet create** 命令创建 VNet 和子网，如下所示。 在输出后显示的列表说明了所使用的参数。
...
3. 运行 **azure network vnet subnet create** 命令创建子网，如下所示。 在输出后显示的列表说明了所使用的参数。
...
4. 运行 **azure network vnet show** 命令查看新 vnet 的属性，如下所示。
