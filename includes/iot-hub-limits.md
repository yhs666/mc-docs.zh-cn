---
ms.openlocfilehash: 74e4b335e1bb5cfcf6c0f2369c3fa55a2a511db6
ms.sourcegitcommit: b8fb6890caed87831b28c82738d6cecfe50674fd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/29/2019
ms.locfileid: "58632861"
---
...
| 文件上传操作 |83.33 个文件上传通知/秒/单位（5,000/分钟/单位）（适用于 S3），1.67 个文件上传通知/秒/单位（100/分钟/单位）（适用于 S1 和 S2）。 <br/> Azure 存储帐户一次可传出 10,000 个 SAS URI。<br/> 每台设备一次可传出 10 个 SAS URI。 |
