...
ms.openlocfilehash: d37efd584f478f1c0212b72079c7e178a252524a
ms.sourcegitcommit: 878a2d65e042b466c083d3ede1ab0988916eaa3d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/17/2019
ms.locfileid: "65835813"
---
...
为租户 2 创建一个服务主体，以便通过使用浏览器请求登录来访问应用程序。 请将 *<Tenant2 ID>* 替换为要与其共享映像库的租户的租户 ID。 请将 *<Application (client) ID>* 替换为创建的应用注册的应用程序 ID。 完成替换后，将 URL 粘贴到浏览器中，然后遵照登录提示登录到租户 2。
...
<!-- Update_Description: new article about VM share images across tenants-->
<!--ms.date: 05/20/2019-->