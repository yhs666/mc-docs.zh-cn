...
ms.openlocfilehash: 852003ec0a5f2d7dc1643ab9b43a1f543c494277
ms.sourcegitcommit: c5529b45bd838791379d8f7fe90088828a1a67a1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/25/2018
ms.locfileid: "50035007"
---
...
* 如果需要部署的 N 系列 VM 较多，请考虑使用预付费订阅或其他购买选项。 如果使用的是 [Azure 试用帐户](https://www.azure.cn/pricing/1rmb-trial/)，则仅可使用有限数量的 Azure 计算核心。
