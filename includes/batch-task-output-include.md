---
 title: include 文件 description: include 文件 services: batch author: dlepow ms.service: batch ms.topic: include origin.date: 04/06/2018 ms.date: 05/16/2018 ms.author: v-junlch ms.custom: include file
---
