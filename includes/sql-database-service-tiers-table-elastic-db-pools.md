...
|:---|---:|---:|---:| ---: | ---: | ---: | ---: | ---: |
| 每个池的最大存储* | 5 GB| 10 GB| 20 GB| 29 GB| 39 GB| 78 GB| 117 GB| 156 GB|
...
|:---|---:|---:|---:| ---: | ---: | ---: | 
| 每个池的最大存储* | 50 GB| 100 GB| 200 GB | 300 GB| 400 GB | 800 GB | 
...
|:---|---:|---:|---:| ---: | ---: |
| 每个池的最大存储* | 1.2 TB | 1.6 TB | 2 TB | 2.4 TB | 2.9 TB | 
...
|:---|---:|---:|---:| ---: | ---: | 
| 每个池的最大存储* | 250 GB| 500 GB| 750 GB| 750 GB| 750 GB| 
...
|:---|---:|---:|---:| ---: | ---: | 
| 每个池的最大存储* | 750 GB | 750 GB | 750 GB | 750 GB | 750 GB |
...
\* 入池数据库共享池存储，因此数据库存储限制为池的剩余存储或每个数据库的最大存储（取二者之中的较小者）。 每个数据库的最大存储是指数据文件的最大存储，不包括日志文件使用的空间。